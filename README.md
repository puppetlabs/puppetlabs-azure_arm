...
The Azure ARM module is generated from the [REST API specifications](https://github.com/Azure/azure-rest-api-specs/) for Microsoft Azure.  For additional information, see the [Azure documentation](https://docs.microsoft.com/azure/) (available in many languages).
