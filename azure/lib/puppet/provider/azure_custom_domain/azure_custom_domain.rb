...
Puppet::Type.type(:azure_custom_domain).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:custom_domain_name] = key_values["customDomainName"] unless key_values["customDomainName"].nil?
    path_params[:custom_domain_name] = ENV["azure_custom_domain_name"] unless ENV["azure_custom_domain_name"].nil?
    path_params[:custom_domain_name] = resource[:name] unless resource.nil? or resource[:name].nil?
    path_params[:custom_domain_properties] = key_values["customDomainProperties"] unless key_values["customDomainProperties"].nil?
    path_params[:custom_domain_properties] = ENV["azure_custom_domain_properties"] unless ENV["azure_custom_domain_properties"].nil?
    path_params[:custom_domain_properties] = resource[:properties] unless resource.nil? or resource[:properties].nil?
    ...
    path_params[:endpoint_name] = resource[:endpoint_name] unless resource.nil? or resource[:endpoint_name].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Cdn/profiles/%{profile_name}/endpoints/%{endpoint_name}/customDomains/%{custom_domain_name}" % path_params
