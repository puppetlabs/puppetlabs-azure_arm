...
Puppet::Type.type(:azure_deployment).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:deployment] = key_values["deployment"] unless key_values["deployment"].nil?
    path_params[:deployment] = ENV["azure_deployment"] unless ENV["azure_deployment"].nil?
    path_params[:deployment] = resource[:deployment] unless resource.nil? or resource[:deployment].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/deployments/%{id}" % path_params
