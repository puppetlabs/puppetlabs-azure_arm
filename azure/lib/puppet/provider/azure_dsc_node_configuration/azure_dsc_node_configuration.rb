...
Puppet::Type.type(:azure_dsc_node_configuration).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:automation_account_name] = key_values["automationAccountName"] unless key_values["automationAccountName"].nil?
    path_params[:automation_account_name] = ENV["azure_automation_account_name"] unless ENV["azure_automation_account_name"].nil?
    path_params[:automation_account_name] = resource[:automation_account_name] unless resource.nil? or resource[:automation_account_name].nil?
    path_params[:node_configuration_name] = key_values["nodeConfigurationName"] unless key_values["nodeConfigurationName"].nil?
    path_params[:node_configuration_name] = ENV["azure_node_configuration_name"] unless ENV["azure_node_configuration_name"].nil?
    path_params[:node_configuration_name] = resource[:node_configuration_name] unless resource.nil? or resource[:node_configuration_name].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Automation/automationAccounts/%{automation_account_name}/nodeConfigurations/%{node_configuration_name}" % path_params
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Automation/automationAccounts/%{automation_account_name}/nodeConfigurations" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
