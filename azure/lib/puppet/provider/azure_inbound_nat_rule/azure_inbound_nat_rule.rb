...
Puppet::Type.type(:azure_inbound_nat_rule).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type InboundNatRule")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type InboundNatRule - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    inbound_nat_rule = {}
    inbound_nat_rule["etag"] = resource[:etag] unless resource[:etag].nil?
    inbound_nat_rule["id"] = resource[:id] unless resource[:id].nil?
    inbound_nat_rule["name"] = resource[:name] unless resource[:name].nil?
    inbound_nat_rule["properties"] = resource[:properties] unless resource[:properties].nil?
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation InboundNatRules_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    path_params[:inbound_nat_rule_name] = key_values["inboundNatRuleName"] unless key_values["inboundNatRuleName"].nil?
    path_params[:inbound_nat_rule_name] = ENV["azure_inbound_nat_rule_name"] unless ENV["azure_inbound_nat_rule_name"].nil?
    path_params[:inbound_nat_rule_name] = resource[:name] unless resource.nil? or resource[:name].nil?
    path_params[:inbound_nat_rule_parameters] = key_values["inboundNatRuleParameters"] unless key_values["inboundNatRuleParameters"].nil?
    path_params[:inbound_nat_rule_parameters] = ENV["azure_inbound_nat_rule_parameters"] unless ENV["azure_inbound_nat_rule_parameters"].nil?
    path_params[:inbound_nat_rule_parameters] = resource[:inbound_nat_rule_parameters] unless resource.nil? or resource[:inbound_nat_rule_parameters].nil?
    path_params[:load_balancer_name] = key_values["loadBalancerName"] unless key_values["loadBalancerName"].nil?
    path_params[:load_balancer_name] = ENV["azure_load_balancer_name"] unless ENV["azure_load_balancer_name"].nil?
    path_params[:load_balancer_name] = resource[:load_balancer_name] unless resource.nil? or resource[:load_balancer_name].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/loadBalancers/%{load_balancer_name}/inboundNatRules/%{inbound_nat_rule_name}" % path_params
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation InboundNatRules_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation InboundNatRules_List")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/loadBalancers/%{load_balancer_name}/inboundNatRules" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json text/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation InboundNatRules_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
