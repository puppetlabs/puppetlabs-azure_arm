...
Puppet::Type.type(:azure_integration_account_agreement).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type IntegrationAccountAgreement")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type IntegrationAccountAgreement - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    integration_account_agreement = {}
    integration_account_agreement["id"] = resource[:id] unless resource[:id].nil?
    integration_account_agreement["location"] = resource[:location] unless resource[:location].nil?
    integration_account_agreement["name"] = resource[:name] unless resource[:name].nil?
    integration_account_agreement["properties"] = resource[:properties] unless resource[:properties].nil?
    integration_account_agreement["tags"] = resource[:tags] unless resource[:tags].nil?
    integration_account_agreement["type"] = resource[:type] unless resource[:type].nil?
    return integration_account_agreement
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Agreements_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    path_params[:agreement] = key_values["agreement"] unless key_values["agreement"].nil?
    path_params[:agreement] = ENV["azure_agreement"] unless ENV["azure_agreement"].nil?
    path_params[:agreement] = resource[:agreement] unless resource.nil? or resource[:agreement].nil?
    path_params[:agreement_name] = key_values["agreementName"] unless key_values["agreementName"].nil?
    path_params[:agreement_name] = ENV["azure_agreement_name"] unless ENV["azure_agreement_name"].nil?
    path_params[:agreement_name] = resource[:agreement_name] unless resource.nil? or resource[:agreement_name].nil?
    ...
    path_params[:integration_account_name] = resource[:integration_account_name] unless resource.nil? or resource[:integration_account_name].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}/agreements/%{agreement_name}" % path_params
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Agreements_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    path_params[:agreement_name] = key_values["agreementName"] unless key_values["agreementName"].nil?
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Agreements_ListByIntegrationAccounts")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}/agreements" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Agreements_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    path_params[:agreement_name] = key_values["agreementName"] unless key_values["agreementName"].nil?
