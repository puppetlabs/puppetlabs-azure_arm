...
Puppet::Type.type(:azure_integration_account_map).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:map] = key_values["map"] unless key_values["map"].nil?
    path_params[:map] = ENV["azure_map"] unless ENV["azure_map"].nil?
    path_params[:map] = resource[:map] unless resource.nil? or resource[:map].nil?
    path_params[:map_name] = key_values["mapName"] unless key_values["mapName"].nil?
    path_params[:map_name] = ENV["azure_map_name"] unless ENV["azure_map_name"].nil?
    path_params[:map_name] = resource[:map_name] unless resource.nil? or resource[:map_name].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}/maps/%{map_name}" % path_params
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}/maps" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
