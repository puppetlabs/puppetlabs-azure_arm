...
Puppet::Type.type(:azure_log_profile_resource).provide(:arm) do
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/providers/microsoft.insights/logprofiles" % path_params
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    query_params["api-version"] = ENV["azure_api_version"] unless ENV["azure_api_version"].nil?
    query_params["api-version"] = resource[:api_version] unless resource.nil? or resource[:api_version].nil?
    path_params[:log_profile_name] = key_values["logProfileName"] unless key_values["logProfileName"].nil?
    path_params[:log_profile_name] = ENV["azure_log_profile_name"] unless ENV["azure_log_profile_name"].nil?
    path_params[:log_profile_name] = resource[:log_profile_name] unless resource.nil? or resource[:log_profile_name].nil?
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/providers/microsoft.insights/logprofiles/%{log_profile_name}" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
