...
Puppet::Type.type(:azure_protection_policy_resource).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:resource_protection_policy] = key_values["resourceProtectionPolicy"] unless key_values["resourceProtectionPolicy"].nil?
    path_params[:resource_protection_policy] = ENV["azure_resource_protection_policy"] unless ENV["azure_resource_protection_policy"].nil?
    path_params[:resource_protection_policy] = resource[:resource_protection_policy] unless resource.nil? or resource[:resource_protection_policy].nil?
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    path_params[:vault_name] = ENV["azure_vault_name"] unless ENV["azure_vault_name"].nil?
    path_params[:vault_name] = resource[:vault_name] unless resource.nil? or resource[:vault_name].nil?
    uri_string = "https://management.azure.com/Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{vault_name}/backupPolicies" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
