...
Puppet::Type.type(:azure_recipient_user_contract).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type RecipientUserContract")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type RecipientUserContract - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    recipient_user_contract = {}
    recipient_user_contract["id"] = resource[:id] unless resource[:id].nil?
    recipient_user_contract["name"] = resource[:name] unless resource[:name].nil?
    recipient_user_contract["properties"] = resource[:properties] unless resource[:properties].nil?
    recipient_user_contract["type"] = resource[:type] unless resource[:type].nil?
    return recipient_user_contract
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation NotificationRecipientUser_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    path_params[:uid] = key_values["uid"] unless key_values["uid"].nil?
    path_params[:uid] = ENV["azure_uid"] unless ENV["azure_uid"].nil?
    path_params[:uid] = resource[:uid] unless resource.nil? or resource[:uid].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ApiManagement/service/%{service_name}/notifications/%{notification_name}/recipientUsers/%{uid}" % path_params
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation NotificationRecipientUser_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation NotificationRecipientUser_ListByNotification")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ApiManagement/service/%{service_name}/notifications/%{notification_name}/recipientUsers" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
