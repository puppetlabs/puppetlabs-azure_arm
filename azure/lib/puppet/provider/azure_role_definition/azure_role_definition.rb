...
Puppet::Type.type(:azure_role_definition).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:role_definition] = key_values["roleDefinition"] unless key_values["roleDefinition"].nil?
    path_params[:role_definition] = ENV["azure_role_definition"] unless ENV["azure_role_definition"].nil?
    path_params[:role_definition] = resource[:role_definition] unless resource.nil? or resource[:role_definition].nil?
    path_params[:role_definition_id] = key_values["roleDefinitionId"] unless key_values["roleDefinitionId"].nil?
    path_params[:role_definition_id] = ENV["azure_role_definition_id"] unless ENV["azure_role_definition_id"].nil?
    path_params[:role_definition_id] = resource[:id] unless resource.nil? or resource[:id].nil?
    ...
    uri_string = "https://management.azure.com/%{scope}/providers/Microsoft.Authorization/roleDefinitions/%{role_definition_id}" % path_params
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    path_params[:scope] = ENV["azure_scope"] unless ENV["azure_scope"].nil?
    path_params[:scope] = resource[:scope] unless resource.nil? or resource[:scope].nil?
    uri_string = "https://management.azure.com/%{scope}/providers/Microsoft.Authorization/roleDefinitions" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json text/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
