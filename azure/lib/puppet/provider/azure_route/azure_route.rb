...
Puppet::Type.type(:azure_route).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:route_name] = resource[:name] unless resource.nil? or resource[:name].nil?
    path_params[:route_parameters] = key_values["routeParameters"] unless key_values["routeParameters"].nil?
    path_params[:route_parameters] = ENV["azure_route_parameters"] unless ENV["azure_route_parameters"].nil?
    path_params[:route_parameters] = resource[:route_parameters] unless resource.nil? or resource[:route_parameters].nil?
    path_params[:route_table_name] = key_values["routeTableName"] unless key_values["routeTableName"].nil?
    path_params[:route_table_name] = ENV["azure_route_table_name"] unless ENV["azure_route_table_name"].nil?
    path_params[:route_table_name] = resource[:route_table_name] unless resource.nil? or resource[:route_table_name].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/routeTables/%{route_table_name}/routes/%{route_name}" % path_params
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/routeTables/%{route_table_name}/routes" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json text/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
