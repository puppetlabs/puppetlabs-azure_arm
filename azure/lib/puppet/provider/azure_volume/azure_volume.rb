...
Puppet::Type.type(:azure_volume).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type Volume")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type Volume - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    volume["kind"] = resource[:kind] unless resource[:kind].nil?
    volume["name"] = resource[:name] unless resource[:name].nil?
    volume["properties"] = resource[:properties] unless resource[:properties].nil?
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Volumes_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    path_params[:volume_container_name] = resource[:volume_container_name] unless resource.nil? or resource[:volume_container_name].nil?
    path_params[:volume_name] = key_values["volumeName"] unless key_values["volumeName"].nil?
    path_params[:volume_name] = ENV["azure_volume_name"] unless ENV["azure_volume_name"].nil?
    path_params[:volume_name] = resource[:name] unless resource.nil? or resource[:name].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorSimple/managers/%{manager_name}/devices/%{device_name}/volumeContainers/%{volume_container_name}/volumes/%{volume_name}" % path_params
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Volumes_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Volumes_ListByVolumeContainer")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
    ...
    path_params[:volume_container_name] = ENV["azure_volume_container_name"] unless ENV["azure_volume_container_name"].nil?
    path_params[:volume_container_name] = resource[:volume_container_name] unless resource.nil? or resource[:volume_container_name].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorSimple/managers/%{manager_name}/devices/%{device_name}/volumeContainers/%{volume_container_name}/volumes" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Volumes_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
