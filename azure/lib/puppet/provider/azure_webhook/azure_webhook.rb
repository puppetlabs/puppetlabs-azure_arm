...
Puppet::Type.type(:azure_webhook).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type Webhook")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type Webhook - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    webhook = {}
    webhook["id"] = resource[:id] unless resource[:id].nil?
    webhook["location"] = resource[:location] unless resource[:location].nil?
    webhook["name"] = resource[:name] unless resource[:name].nil?
    webhook["properties"] = resource[:properties] unless resource[:properties].nil?
    webhook["tags"] = resource[:tags] unless resource[:tags].nil?
    webhook["type"] = resource[:type] unless resource[:type].nil?
    return webhook
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Webhooks_Create")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    path_params[:registry_name] = key_values["registryName"] unless key_values["registryName"].nil?
    path_params[:registry_name] = ENV["azure_registry_name"] unless ENV["azure_registry_name"].nil?
    path_params[:registry_name] = resource[:registry_name] unless resource.nil? or resource[:registry_name].nil?
    ...
    path_params[:webhook_create_parameters] = key_values["webhookCreateParameters"] unless key_values["webhookCreateParameters"].nil?
    path_params[:webhook_create_parameters] = ENV["azure_webhook_create_parameters"] unless ENV["azure_webhook_create_parameters"].nil?
    path_params[:webhook_create_parameters] = resource[:webhook_create_parameters] unless resource.nil? or resource[:webhook_create_parameters].nil?
    path_params[:webhook_name] = key_values["webhookName"] unless key_values["webhookName"].nil?
    path_params[:webhook_name] = ENV["azure_webhook_name"] unless ENV["azure_webhook_name"].nil?
    path_params[:webhook_name] = resource[:name] unless resource.nil? or resource[:name].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ContainerRegistry/registries/%{registry_name}/webhooks/%{webhook_name}" % path_params
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Webhooks_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Webhooks_List")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ContainerRegistry/registries/%{registry_name}/webhooks" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Webhooks_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
