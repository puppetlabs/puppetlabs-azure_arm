...
|List - list all|`/providers/Microsoft.Authorization/policyDefinitions`|Get|This operation retrieves a list of all the built-in policy definitions.|PolicyDefinitions_ListBuiltIn|
...
|List - get list using params|`/providers/Microsoft.Authorization/policyDefinitions`|Get|This operation retrieves a list of all the built-in policy definitions.|PolicyDefinitions_ListBuiltIn|
