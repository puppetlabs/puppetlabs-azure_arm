...
Path: "/root/specs/specification/servicefabric/resource-manager/Microsoft.ServiceFabric/stable/2016-09-01/servicefabric.json")
...
$azure_cluster_properties = {
  ...
  clusterEndpoint => "clusterEndpoint (optional)",
...
|clusterEndpoint | String | false | The endpoint for the cluster connecting to servicefabric resource provider |
|clusterId | String | false | The unique identifier for the cluster resource |
|clusterState | String | false | The state for the cluster |
...
|provisioningState | String | false | The provisioning state of the cluster resource |
