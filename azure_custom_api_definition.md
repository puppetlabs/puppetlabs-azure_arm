...
|List - get list using params|`/subscriptions/%{subscription_id}/providers/Microsoft.Web/customApis`|Get|Gets a list of all custom APIs for a subscription id|CustomApis_List|
