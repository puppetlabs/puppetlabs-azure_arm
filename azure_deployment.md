...
|List - list all|``||||
|List - get one|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/deployments/%{id}/log`|Get|List deployment log for specific deployment for an app, or a deployment slot.|WebApps_ListDeploymentLogSlot|
