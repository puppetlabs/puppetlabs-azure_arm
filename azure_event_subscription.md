...
$azure_event_subscription_properties = {
  ...
  expirationTimeUtc => "expirationTimeUtc (optional)",
...
|expirationTimeUtc | String | false | Expiration time of the event subscription. |
...
$azure_event_subscription_filter = {
  advancedFilters => $azure_advanced_filter
...
| Name        | Type           | Required       | Description       |
| ------------- | ------------- | ------------- | ------------- |
|advancedFilters | [AdvancedFilter](#advancedfilter) | false | An array of advanced filters that are used for filtering event subscriptions. |
|includedEventTypes | Array | false | A list of applicable event types that need to be part of the event subscription. If it is desired to subscribe to all default event types, set the IncludedEventTypes to null. |
...
| Name        | Type           | Required       | Description       |
| ------------- | ------------- | ------------- | ------------- |
|key | String | false | The field/property in the event based on which you want to filter. |
|operatorType | String | true | The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others. |
