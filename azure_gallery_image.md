...
Specifies information about the gallery image that you want to create or update.
...
Describes the properties of a gallery image.
...
| Name        | Type           | Required       | Description       |
| ------------- | ------------- | ------------- | ------------- |
|description | String | false | The description of this gallery image resource. |
|disallowed | [Disallowed](#disallowed) | false |  |
|endOfLifeDate | String | false | The end of life of this gallery image. |
|eula | String | false | The Eula agreement for the gallery image. |
|identifier | [GalleryImageIdentifier](#galleryimageidentifier) | false |  |
|osState | String | false | The OS State. |
...
| Name        | Type           | Required       | Description       |
| ------------- | ------------- | ------------- | ------------- |
|offer | String | false | The gallery image offer name. |
|publisher | String | false | The gallery image publisher name. |
|sku | String | false | The gallery image sku name. |
        
## ImagePurchasePlan

Describes the gallery image purchase plan. This is used by marketplace images.
...
| ------------- | ------------- | ------------- | ------------- | ------------- |
|Create|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/galleries/%{gallery_name}/images/%{gallery_image_name}`|Put|Create or update a gallery image.|GalleryImages_CreateOrUpdate|
|List - list all|``||||
|List - get one|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/galleries/%{gallery_name}/images/%{gallery_image_name}`|Get|Retrieves information about a gallery image.|GalleryImages_Get|
|List - get list using params|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/galleries/%{gallery_name}/images`|Get|List gallery images under a gallery.|GalleryImages_ListByGallery|
|Update|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/galleries/%{gallery_name}/images/%{gallery_image_name}`|Put|Create or update a gallery image.|GalleryImages_CreateOrUpdate|
