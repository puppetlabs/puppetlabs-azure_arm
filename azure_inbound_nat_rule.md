...
Path: "https://github.com/Azure/azure-rest-api-specs/blob/c9269dbd9a589cd49775b3f65b87c556c2f52cce/specification/network/resource-manager/Microsoft.Network/stable/2018-11-01/loadBalancer.json")
...
azure_inbound_nat_rule {
  ...
  etag => "etag (optional)",
  id => "id (optional)",
  inbound_nat_rule_parameters => "inboundNatRuleParameters",
...
|inbound_nat_rule_parameters | Hash | true | Parameters supplied to the create or update inbound nat rule operation. |
|load_balancer_name | String | true | The name of the load balancer. |
...
Here is a list of endpoints that we use to create, read, update and delete the InboundNatRule

| Operation | Path | Verb | Description | OperationID |
| ------------- | ------------- | ------------- | ------------- | ------------- |
|Create|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/loadBalancers/%{load_balancer_name}/inboundNatRules/%{inbound_nat_rule_name}`|Put|Creates or updates a load balancer inbound nat rule.|InboundNatRules_CreateOrUpdate|
|List - list all|``||||
|List - get one|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/loadBalancers/%{load_balancer_name}/inboundNatRules/%{inbound_nat_rule_name}`|Get|Gets the specified load balancer inbound nat rule.|InboundNatRules_Get|
|List - get list using params|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/loadBalancers/%{load_balancer_name}/inboundNatRules`|Get|Gets all the inbound nat rules in a load balancer.|InboundNatRules_List|
|Update|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/loadBalancers/%{load_balancer_name}/inboundNatRules/%{inbound_nat_rule_name}`|Put|Creates or updates a load balancer inbound nat rule.|InboundNatRules_CreateOrUpdate|
|Delete|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/loadBalancers/%{load_balancer_name}/inboundNatRules/%{inbound_nat_rule_name}`|Delete|Deletes the specified load balancer inbound nat rule.|InboundNatRules_Delete|
