Document: "interfaceEndpoint"


Path: "https://github.com/Azure/azure-rest-api-specs/blob/2fbb5118cd34f412a51d9bc8a274224b216763cf/specification/network/resource-manager/Microsoft.Network/stable/2019-02-01/interfaceEndpoint.json")
...
|parameters | Hash | true | Parameters supplied to the create or update interface endpoint operation |
...
|protocol | String | true | Network protocol this rule applies to. Possible values are 'Tcp', 'Udp', 'Icmp', 'Esp', and '*'. |
|provisioningState | String | false | The provisioning state of the public IP resource. Possible values are: 'Updating', 'Deleting', and 'Failed'. |
...
Here is a list of endpoints that we use to create, read, update and delete the InterfaceEndpoint

| Operation | Path | Verb | Description | OperationID |
| ------------- | ------------- | ------------- | ------------- | ------------- |
|Create|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/interfaceEndpoints/%{interface_endpoint_name}`|Put|Creates or updates an interface endpoint in the specified resource group.|InterfaceEndpoints_CreateOrUpdate|
|List - list all|`/subscriptions/%{subscription_id}/providers/Microsoft.Network/interfaceEndpoints`|Get|Gets all interface endpoints in a subscription.|InterfaceEndpoints_ListBySubscription|
|List - get one|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/interfaceEndpoints/%{interface_endpoint_name}`|Get|Gets the specified interface endpoint by resource group.|InterfaceEndpoints_Get|
|List - get list using params|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/interfaceEndpoints`|Get|Gets all interface endpoints in a resource group.|InterfaceEndpoints_List|
|Update|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/interfaceEndpoints/%{interface_endpoint_name}`|Put|Creates or updates an interface endpoint in the specified resource group.|InterfaceEndpoints_CreateOrUpdate|
|Delete|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/interfaceEndpoints/%{interface_endpoint_name}`|Delete|Deletes the specified interface endpoint.|InterfaceEndpoints_Delete|
