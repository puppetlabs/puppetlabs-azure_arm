...
Path: "https://github.com/Azure/azure-rest-api-specs/blob/c9269dbd9a589cd49775b3f65b87c556c2f52cce/specification/containerservices/resource-manager/Microsoft.ContainerService/stable/2018-03-31/managedClusters.json")
...
|agentPoolProfiles | [ManagedClusterAgentPoolProfile](#managedclusteragentpoolprofile) | false | Properties of the agent pool. Currently only one agent pool can exist. |
...
|storageProfile | [ContainerServiceStorageProfile](#containerservicestorageprofile) | false | Storage profile specifies what kind of storage used. Defaults to ManagedDisks. |
