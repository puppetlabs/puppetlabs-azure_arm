...
Path: "https://github.com/Azure/azure-rest-api-specs/blob/2fbb5118cd34f412a51d9bc8a274224b216763cf/specification/network/resource-manager/Microsoft.Network/stable/2019-06-01/networkInterface.json")
...
azure_network_interface_tap_configuration {
  ...
  tap_configuration_parameters => "tapConfigurationParameters",
}
```
...
|network_interface_name | String | true | The name of the network interface. |
...
|tap_configuration_name | String | true | The name of the tap configuration. |
|tap_configuration_parameters | Hash | true | Parameters supplied to the create or update tap configuration operation. |
...
Here is a list of endpoints that we use to create, read, update and delete the NetworkInterfaceTapConfiguration

| Operation | Path | Verb | Description | OperationID |
| ------------- | ------------- | ------------- | ------------- | ------------- |
|Create|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkInterfaces/%{network_interface_name}/tapConfigurations/%{tap_configuration_name}`|Put|Creates or updates a Tap configuration in the specified NetworkInterface.|NetworkInterfaceTapConfigurations_CreateOrUpdate|
|List - list all|``||||
|List - get one|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkInterfaces/%{network_interface_name}/tapConfigurations/%{tap_configuration_name}`|Get|Get the specified tap configuration on a network interface.|NetworkInterfaceTapConfigurations_Get|
|List - get list using params|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkInterfaces/%{network_interface_name}/tapConfigurations`|Get|Get all Tap configurations in a network interface.|NetworkInterfaceTapConfigurations_List|
|Update|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkInterfaces/%{network_interface_name}/tapConfigurations/%{tap_configuration_name}`|Put|Creates or updates a Tap configuration in the specified NetworkInterface.|NetworkInterfaceTapConfigurations_CreateOrUpdate|
|Delete|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkInterfaces/%{network_interface_name}/tapConfigurations/%{tap_configuration_name}`|Delete|Deletes the specified tap configuration from the NetworkInterface.|NetworkInterfaceTapConfigurations_Delete|
