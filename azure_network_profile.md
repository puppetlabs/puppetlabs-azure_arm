...
|List - get list using params|`/subscriptions/%{subscription_id}/providers/Microsoft.Network/trafficmanagerprofiles`|Get|Lists all Traffic Manager profiles within a subscription.|Profiles_ListBySubscription|
