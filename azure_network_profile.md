Document: "networkProfile"


Path: "https://github.com/Azure/azure-rest-api-specs/blob/c9269dbd9a589cd49775b3f65b87c556c2f52cce/specification/network/resource-manager/Microsoft.Network/stable/2018-11-01/networkProfile.json")
...
azure_network_profile {
  ...
  properties => $azure_network_profile_properties_format
...
|parameters | Hash | true | Parameters supplied to the create or update network profile operation. |
|properties | [NetworkProfilePropertiesFormat](#networkprofilepropertiesformat) | false | Network profile properties. |
...
```puppet
$azure_network_profile_properties_format = {
  containerNetworkInterfaceConfigurations => $azure_container_network_interface_configuration
  containerNetworkInterfaces => $azure_container_network_interface
}
```

| Name        | Type           | Required       | Description       |
| ------------- | ------------- | ------------- | ------------- |
|containerNetworkInterfaceConfigurations | [ContainerNetworkInterfaceConfiguration](#containernetworkinterfaceconfiguration) | false | List of chid container network interface configurations. |
|containerNetworkInterfaces | [ContainerNetworkInterface](#containernetworkinterface) | false | List of child container network interfaces. |
...
```puppet
$azure_container_network_interface_configuration = {
  etag => "etag (optional)",
  id => "id (optional)",
  name => "name (optional)",
  properties => $azure_container_network_interface_configuration_properties_format
}
```
...
|properties | [ContainerNetworkInterfaceConfigurationPropertiesFormat](#containernetworkinterfaceconfigurationpropertiesformat) | false | Container network interface configuration properties. |
...
```puppet
$azure_container_network_interface_configuration_properties_format = {
  containerNetworkInterfaces => $azure_sub_resource
  ipConfigurations => $azure_ip_configuration_profile
}
```

| Name        | Type           | Required       | Description       |
| ------------- | ------------- | ------------- | ------------- |
|containerNetworkInterfaces | [SubResource](#subresource) | false | A list of container network interfaces created from this container network interface configuration. |
|ipConfigurations | [IPConfigurationProfile](#ipconfigurationprofile) | false | A list of ip configurations of the container network interface configuration. |
...
```puppet
$azure_container_network_interface = {
  etag => "etag (optional)",
  id => "id (optional)",
  name => "name (optional)",
  properties => $azure_container_network_interface_properties_format
}
```
...
|id | String | false | Resource ID. |
|name | String | false | The name of the resource. This name can be used to access the resource. |
|properties | [ContainerNetworkInterfacePropertiesFormat](#containernetworkinterfacepropertiesformat) | false | Container network interface properties. |
...
```puppet
$azure_container_network_interface_properties_format = {
  container => $azure_container
  containerNetworkInterfaceConfiguration => $azure_container_network_interface_configuration
  ipConfigurations => $azure_container_network_interface_ip_configuration
}
```

| Name        | Type           | Required       | Description       |
| ------------- | ------------- | ------------- | ------------- |
|container | [Container](#container) | false | Reference to the conatinaer to which this container network interface is attached. |
|containerNetworkInterfaceConfiguration | [ContainerNetworkInterfaceConfiguration](#containernetworkinterfaceconfiguration) | false | Container network interface configuration from which this container network interface is created. |
|ipConfigurations | [ContainerNetworkInterfaceIpConfiguration](#containernetworkinterfaceipconfiguration) | false | Reference to the ip configuration on this container nic. |
...
```puppet
$azure_container_network_interface_ip_configuration = {
  etag => "etag (optional)",
  name => "name (optional)",
  properties => $azure_container_network_interface_ip_configuration_properties_format
}
```
...
|etag | String | false | A unique read-only string that changes whenever the resource is updated. |
|name | String | false | The name of the resource. This name can be used to access the resource. |
|properties | [ContainerNetworkInterfaceIpConfigurationPropertiesFormat](#containernetworkinterfaceipconfigurationpropertiesformat) | false | Properties of the container network interface IP configuration. |
...
```puppet
$azure_container_network_interface_ip_configuration_properties_format = {
}
```
...
Here is a list of endpoints that we use to create, read, update and delete the NetworkProfile

| Operation | Path | Verb | Description | OperationID |
| ------------- | ------------- | ------------- | ------------- | ------------- |
|Create|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkProfiles/%{network_profile_name}`|Put|Creates or updates a network profile.|NetworkProfiles_CreateOrUpdate|
|List - list all|`/subscriptions/%{subscription_id}/providers/Microsoft.Network/networkProfiles`|Get|Gets all the network profiles in a subscription.|NetworkProfiles_ListAll|
|List - get one|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkProfiles/%{network_profile_name}`|Get|Gets the specified network profile in a specified resource group.|NetworkProfiles_Get|
|List - get list using params|`/subscriptions/%{subscription_id}/providers/Microsoft.Network/networkProfiles`|Get|Gets all the network profiles in a subscription.|NetworkProfiles_ListAll|
|Update|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkProfiles/%{network_profile_name}`|Put|Creates or updates a network profile.|NetworkProfiles_CreateOrUpdate|
|Delete|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkProfiles/%{network_profile_name}`|Delete|Deletes the specified network profile.|NetworkProfiles_Delete|
