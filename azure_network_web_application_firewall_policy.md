...
Path: "https://github.com/Azure/azure-rest-api-specs/blob/2fbb5118cd34f412a51d9bc8a274224b216763cf/specification/network/resource-manager/Microsoft.Network/stable/2019-06-01/webapplicationfirewall.json")
...
azure_network_web_application_firewall_policy {
  ...
  properties => $azure_web_application_firewall_policy_properties_format
...
|policy_name | String | true | The name of the policy. |
|properties | [WebApplicationFirewallPolicyPropertiesFormat](#webapplicationfirewallpolicypropertiesformat) | false | Properties of the web application firewall policy. |
...
```puppet
$azure_web_application_firewall_policy_properties_format = {
  applicationGateways => $azure_application_gateway
  customRules => $azure_web_application_firewall_custom_rule
...
| Name        | Type           | Required       | Description       |
| ------------- | ------------- | ------------- | ------------- |
|applicationGateways | [ApplicationGateway](#applicationgateway) | false | A collection of references to application gateways. |
|customRules | [WebApplicationFirewallCustomRule](#webapplicationfirewallcustomrule) | false | Describes custom rules inside the policy. |
|policySettings | [PolicySettings](#policysettings) | false | Describes policySettings for policy. |
...
| Name        | Type           | Required       | Description       |
| ------------- | ------------- | ------------- | ------------- |
|action | String | true | Type of Actions. |
|matchConditions | [MatchCondition](#matchcondition) | true | List of match conditions. |
|name | String | false | Gets name of the resource that is unique within a policy. This name can be used to access the resource. |
...
$azure_match_condition = {
  ...
  matchVariables => $azure_match_variable
  negationConditon => "negationConditon (optional)",
  operator => "operator",
  transforms => $azure_transform
}
```

| Name        | Type           | Required       | Description       |
| ------------- | ------------- | ------------- | ------------- |
|matchValues | Array | true | Match value. |
|matchVariables | [MatchVariable](#matchvariable) | true | List of match variables. |
|negationConditon | Boolean | false | Describes if this is negate condition or not. |
|operator | String | true | Describes operator to be matched. |
|transforms | [Transform](#transform) | false | List of transforms. |
...
| Name        | Type           | Required       | Description       |
| ------------- | ------------- | ------------- | ------------- |
|selector | String | false | Describes field of the matchVariable collection. |
|variableName | String | true | Match Variable. |
...
| Name        | Type           | Required       | Description       |
| ------------- | ------------- | ------------- | ------------- |
|enabledState | String | false | Describes if the policy is in enabled state or disabled state. |
...
| ------------- | ------------- | ------------- | ------------- | ------------- |
|Create|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies/%{policy_name}`|Put|Creates or update policy with specified rule set name within a resource group.|WebApplicationFirewallPolicies_CreateOrUpdate|
|List - list all|`/subscriptions/%{subscription_id}/providers/Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies`|Get|Gets all the WAF policies in a subscription.|WebApplicationFirewallPolicies_ListAll|
|List - get one|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies/%{policy_name}`|Get|Retrieve protection policy with specified name within a resource group.|WebApplicationFirewallPolicies_Get|
|List - get list using params|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies`|Get|Lists all of the protection policies within a resource group.|WebApplicationFirewallPolicies_List|
|Update|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies/%{policy_name}`|Put|Creates or update policy with specified rule set name within a resource group.|WebApplicationFirewallPolicies_CreateOrUpdate|
|Delete|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies/%{policy_name}`|Delete|Deletes Policy.|WebApplicationFirewallPolicies_Delete|
