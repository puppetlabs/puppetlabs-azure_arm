...
|List - list all|``||||
|List - get one|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/premieraddons`|Get|Gets the premier add-ons of an app.|WebApps_ListPremierAddOnsSlot|
