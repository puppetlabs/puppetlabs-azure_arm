Document: "privateLinkService"


Path: "https://github.com/Azure/azure-rest-api-specs/blob/2fbb5118cd34f412a51d9bc8a274224b216763cf/specification/network/resource-manager/Microsoft.Network/stable/2019-06-01/privateLinkService.json")
...
azure_private_link_service {
  ...
  properties => $azure_private_link_service_properties
...
|parameters | Hash | true | Parameters supplied to the create or update private link service operation. |
|properties | [PrivateLinkServiceProperties](#privatelinkserviceproperties) | false | Properties of the private link service. |
|resource_group_name | String | true | The name of the resource group. |
|service_name | String | true | The name of the private link service. |
...
```puppet
$azure_private_link_service_properties = {
  autoApproval => "autoApproval (optional)",
  fqdns => "fqdns (optional)",
  ipConfigurations => $azure_private_link_service_ip_configuration
  loadBalancerFrontendIpConfigurations => $azure_frontend_ip_configuration
  networkInterfaces => $azure_network_interface
  privateEndpointConnections => $azure_private_endpoint_connection
...
| Name        | Type           | Required       | Description       |
| ------------- | ------------- | ------------- | ------------- |
|autoApproval | String | false | The auto-approval list of the private link service. |
|fqdns | Array | false | The list of Fqdn. |
|ipConfigurations | [PrivateLinkServiceIpConfiguration](#privatelinkserviceipconfiguration) | false | An array of references to the private link service IP configuration. |
|loadBalancerFrontendIpConfigurations | [FrontendIPConfiguration](#frontendipconfiguration) | false | An array of references to the load balancer IP configurations. |
|networkInterfaces | [NetworkInterface](#networkinterface) | false | Gets an array of references to the network interfaces created for this private link service. |
|privateEndpointConnections | [PrivateEndpointConnection](#privateendpointconnection) | false | An array of list about connections to the private endpoint. |
|provisioningState | [ProvisioningState](#provisioningstate) | false | The provisioning state of the private link service. |
|visibility | String | false | The visibility list of the private link service. |
...
$azure_private_link_service_ip_configuration = {
  id => "id (optional)",
  name => "name (optional)",
  properties => $azure_private_link_service_ip_configuration_properties
}
```
...
| ------------- | ------------- | ------------- | ------------- |
|id | String | false | Resource ID. |
|name | String | false | The name of private link service ip configuration. |
|properties | [PrivateLinkServiceIpConfigurationProperties](#privatelinkserviceipconfigurationproperties) | false | Properties of the private link service ip configuration. |
...
```puppet
$azure_private_link_service_ip_configuration_properties = {
...
| Name        | Type           | Required       | Description       |
| ------------- | ------------- | ------------- | ------------- |
|primary | Boolean | false | Whether the ip configuration is primary or not. |
...
|provisioningState | [ProvisioningState](#provisioningstate) | false | The provisioning state of the private link service ip configuration. |
...
$azure_private_endpoint_connection = {
  id => "id (optional)",
  name => "name (optional)",
  properties => $azure_private_endpoint_connection_properties
}
```
...
|id | String | false | Resource ID. |
|name | String | false | The name of the resource that is unique within a resource group. This name can be used to access the resource. |
|properties | [PrivateEndpointConnectionProperties](#privateendpointconnectionproperties) | false | Properties of the private end point connection. |
...
```puppet
$azure_private_endpoint_connection_properties = {
  privateEndpoint => $azure_private_endpoint
  privateLinkServiceConnectionState => $azure_private_link_service_connection_state
  provisioningState => $azure_provisioning_state
}
...
| Name        | Type           | Required       | Description       |
| ------------- | ------------- | ------------- | ------------- |
|privateEndpoint | [PrivateEndpoint](#privateendpoint) | false | The resource of private end point. |
|privateLinkServiceConnectionState | [PrivateLinkServiceConnectionState](#privatelinkserviceconnectionstate) | false | A collection of information about the state of the connection between service consumer and provider. |
|provisioningState | [ProvisioningState](#provisioningstate) | false | The provisioning state of the private endpoint connection. |
...
Here is a list of endpoints that we use to create, read, update and delete the PrivateLinkService

| Operation | Path | Verb | Description | OperationID |
| ------------- | ------------- | ------------- | ------------- | ------------- |
|Create|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/privateLinkServices/%{service_name}`|Put|Creates or updates an private link service in the specified resource group.|PrivateLinkServices_CreateOrUpdate|
|List - list all|`/subscriptions/%{subscription_id}/providers/Microsoft.Network/privateLinkServices`|Get|Gets all private link service in a subscription.|PrivateLinkServices_ListBySubscription|
|List - get one|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/privateLinkServices/%{service_name}`|Get|Gets the specified private link service by resource group.|PrivateLinkServices_Get|
|List - get list using params|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/privateLinkServices`|Get|Gets all private link services in a resource group.|PrivateLinkServices_List|
|Update|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/privateLinkServices/%{service_name}`|Put|Creates or updates an private link service in the specified resource group.|PrivateLinkServices_CreateOrUpdate|
|Delete|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/privateLinkServices/%{service_name}`|Delete|Deletes the specified private link service.|PrivateLinkServices_Delete|
