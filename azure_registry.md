...
|policies | [Policies](#policies) | false | The policies for a container registry. |
...
```puppet
$azure_policies = {
  quarantinePolicy => $azure_quarantine_policy
  retentionPolicy => $azure_retention_policy
  trustPolicy => $azure_trust_policy
}
```

| Name        | Type           | Required       | Description       |
| ------------- | ------------- | ------------- | ------------- |
|quarantinePolicy | [QuarantinePolicy](#quarantinepolicy) | false | The quarantine policy for a container registry. |
|retentionPolicy | [RetentionPolicy](#retentionpolicy) | false | The retention policy for a container registry. |
|trustPolicy | [TrustPolicy](#trustpolicy) | false | The content trust policy for a container registry. |
...
| Name        | Type           | Required       | Description       |
| ------------- | ------------- | ------------- | ------------- |
|status | String | false | The value that indicates whether the policy is enabled or not. |
...
| Name        | Type           | Required       | Description       |
| ------------- | ------------- | ------------- | ------------- |
|days | Integer | false | The number of days to retain an untagged manifest after which it gets purged. |
|status | String | false | The value that indicates whether the policy is enabled or not. |
...
| ------------- | ------------- | ------------- | ------------- |
|status | String | false | The value that indicates whether the policy is enabled or not. |
|type | String | false | The type of trust policy. |
