...
|clientAccessRights | [ClientAccessRight](#clientaccessright) | false | List of IP addresses and corresponding access rights on the share(required for NFS protocol). |
...
|userAccessRights | [UserAccessRight](#useraccessright) | false | Mapping of users and corresponding access rights on the share (required for SMB protocol). |
