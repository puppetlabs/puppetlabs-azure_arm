...
$azure_storage_account_properties = {
  azureFilesIdentityBasedAuthentication => $azure_azure_files_identity_based_authentication
  customDomain => $azure_custom_domain
  encryption => $azure_encryption
  geoReplicationStats => $azure_geo_replication_stats
  isHnsEnabled => "isHnsEnabled (optional)",
...
| Name        | Type           | Required       | Description       |
| ------------- | ------------- | ------------- | ------------- |
|azureFilesIdentityBasedAuthentication | [AzureFilesIdentityBasedAuthentication](#azurefilesidentitybasedauthentication) | false | Provides the identity based authentication settings for Azure Files. |
...
|geoReplicationStats | [GeoReplicationStats](#georeplicationstats) | false | Geo Replication Stats |
|isHnsEnabled | Boolean | false | Account HierarchicalNamespace enabled if sets to true. |
...
```puppet
$azure_azure_files_identity_based_authentication = {
...
| Name        | Type           | Required       | Description       |
| ------------- | ------------- | ------------- | ------------- |
|directoryServiceOptions | String | true | Indicates the directory service used. |
...
$azure_custom_domain = {
  name => "name",
  useSubDomainName => "useSubDomainName (optional)",
}
```
...
|useSubDomainName | Boolean | false | Indicates whether indirect CName validation is enabled. Default value is false. This should only be set on updates. |
