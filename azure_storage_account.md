...
Path: "https://github.com/Azure/azure-rest-api-specs/blob/c9269dbd9a589cd49775b3f65b87c556c2f52cce/specification/storage/resource-manager/Microsoft.Storage/stable/2018-07-01/storage.json")
...
$azure_storage_account_properties = {
  azureFilesAadIntegration => "azureFilesAadIntegration (optional)",
...
| Name        | Type           | Required       | Description       |
| ------------- | ------------- | ------------- | ------------- |
|azureFilesAadIntegration | Boolean | false | Enables Azure Files AAD Integration for SMB if sets to true. |
