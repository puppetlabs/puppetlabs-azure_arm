...
azure_subnet {
  ...
  subnet_parameters => "subnetParameters",
...
|subnet_parameters | Hash | true | Parameters supplied to the create or update subnet operation. |
...
| ------------- | ------------- | ------------- | ------------- | ------------- |
|Create|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualNetworks/%{virtual_network_name}/subnets/%{subnet_name}`|Put|Creates or updates a subnet in the specified virtual network.|Subnets_CreateOrUpdate|
|List - list all|``||||
|List - get one|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualNetworks/%{virtual_network_name}/subnets/%{subnet_name}`|Get|Gets the specified subnet by virtual network and resource group.|Subnets_Get|
|List - get list using params|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualNetworks/%{virtual_network_name}/subnets`|Get|Gets all subnets in a virtual network.|Subnets_List|
|Update|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualNetworks/%{virtual_network_name}/subnets/%{subnet_name}`|Put|Creates or updates a subnet in the specified virtual network.|Subnets_CreateOrUpdate|
|Delete|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualNetworks/%{virtual_network_name}/subnets/%{subnet_name}`|Delete|Deletes the specified subnet.|Subnets_Delete|