...
|List - get list using params|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/virtualMachines/%{vm_name}`|Get|Retrieves information about the model view or the instance view of a virtual machine.|VirtualMachines_Get|
