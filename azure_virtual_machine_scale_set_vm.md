...
|instance_id | String | false | The virtual machine instance ID. |
...
$azure_virtual_machine_scale_set_vm_properties = {
  ...
  latestModelApplied => "latestModelApplied (optional)",
...
|latestModelApplied | Boolean | false | Specifies whether the latest model has been applied to the virtual machine. |
...
|vmId | String | false | Azure VM unique ID. |
