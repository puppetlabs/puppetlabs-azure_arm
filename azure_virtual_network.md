...
|List - get list using params|`/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualNetworks`|Get|Gets all virtual networks in a resource group.|VirtualNetworks_List|
