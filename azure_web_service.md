...
$azure_web_service_properties = {
  ...
  swaggerLocation => "swaggerLocation (optional)",
...
|createdOn | String | false | Read Only: The date and time when the web service was created. |
...
|modifiedOn | String | false | Read Only: The date and time when the web service was last modified. |
...
|payloadsLocation | [BlobLocation](#bloblocation) | false | The URI of the payload blob. This paramater contains a value only if the payloadsInBlobStorage parameter is set to true. Otherwise is set to null. |
|provisioningState | String | false | Read Only: The provision state of the web service. Valid values are Unknown, Provisioning, Succeeded, and Failed. |
...
|swaggerLocation | String | false | Read Only: Contains the URI of the swagger spec associated with this web service. |
