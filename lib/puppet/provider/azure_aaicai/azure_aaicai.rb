...
Puppet::Type.type(:azure_aaicai).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type aaicai")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type aaicai - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    aaicai = {}
    aaicai["Content"] = resource[:content] unless resource[:content].nil?
    aaicai["Id"] = resource[:id] unless resource[:id].nil?
    aaicai["Name"] = resource[:name] unless resource[:name].nil?
    aaicai["Properties"] = resource[:properties] unless resource[:properties].nil?
    aaicai["Scope"] = resource[:scope] unless resource[:scope].nil?
    aaicai["TimeCreated"] = resource[:time_created] unless resource[:time_created].nil?
    aaicai["TimeModified"] = resource[:time_modified] unless resource[:time_modified].nil?
    aaicai["Type"] = resource[:type] unless resource[:type].nil?
    aaicai["Version"] = resource[:version] unless resource[:version].nil?
    return aaicai
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation AnalyticsItems_Put")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("content", "body", "content", "content"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("itemProperties", "body", "item_properties", "item_properties"),
      self.op_param("name", "body", "name", "name"),
      self.op_param("overrideItem", "query", "override_item", "override_item"),
      ...
      self.op_param("scope", "body", "scope", "scope"),
      self.op_param("scopePath", "path", "scope_path", "scope_path"),
      self.op_param("subscriptionId", "path", "subscription_id", "subscription_id"),
      self.op_param("timecreated", "body", "time_created", "timecreated"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/microsoft.insights/components/%{resource_name}/%{scope_path}/item", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation AnalyticsItems_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/microsoft.insights/components/%{resource_name}/%{scope_path}/item", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation AnalyticsItems_List")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    op_params = [
      ...
      self.op_param("content", "body", "content", "content"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("includeContent", "query", "include_content", "include_content"),
      self.op_param("name", "body", "name", "name"),
      self.op_param("properties", "body", "properties", "properties"),
      self.op_param("resourceGroupName", "path", "resource_group_name", "resource_group_name"),
      self.op_param("resourceName", "path", "resource_name", "resource_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/microsoft.insights/components/%{resource_name}/%{scope_path}", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation AnalyticsItems_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/microsoft.insights/components/%{resource_name}/%{scope_path}/item", "Get", "[application/json]")
  end
