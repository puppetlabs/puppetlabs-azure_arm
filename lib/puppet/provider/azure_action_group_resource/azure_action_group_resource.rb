...
Puppet::Type.type(:azure_action_group_resource).provide(:arm) do
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/providers/microsoft.insights/actionGroups" % path_params
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    query_params = {}
    header_params = {}
    path_params[:action_group] = key_values["actionGroup"] unless key_values["actionGroup"].nil?
    path_params[:action_group] = ENV["azure_action_group"] unless ENV["azure_action_group"].nil?
    path_params[:action_group] = resource[:action_group] unless resource.nil? or resource[:action_group].nil?
    path_params[:action_group_name] = key_values["actionGroupName"] unless key_values["actionGroupName"].nil?
    path_params[:action_group_name] = ENV["azure_action_group_name"] unless ENV["azure_action_group_name"].nil?
    path_params[:action_group_name] = resource[:action_group_name] unless resource.nil? or resource[:action_group_name].nil?
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
    query_params["api-version"] = ENV["azure_api_version"] unless ENV["azure_api_version"].nil?
    query_params["api-version"] = resource[:api_version] unless resource.nil? or resource[:api_version].nil?
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/microsoft.insights/actionGroups/%{action_group_name}" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
