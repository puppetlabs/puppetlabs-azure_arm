...
Puppet::Type.type(:azure_action_group_resource).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          action_group: item["actionGroup"],
          action_group_name: item["actionGroupName"],
  ...
  def self.instance_to_hash(instance)
    {
      ...
      action_group: instance.action_group.respond_to?(:to_hash) ? instance.action_group.to_hash : instance.action_group,
      action_group_name: instance.action_group_name.respond_to?(:to_hash) ? instance.action_group_name.to_hash : instance.action_group_name,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type ActionGroupResource")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type ActionGroupResource - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    action_group_resource["id"] = resource[:id] unless resource[:id].nil?
    action_group_resource["location"] = resource[:location] unless resource[:location].nil?
    action_group_resource["name"] = resource[:name] unless resource[:name].nil?
    action_group_resource["properties"] = resource[:properties] unless resource[:properties].nil?
    action_group_resource["tags"] = resource[:tags] unless resource[:tags].nil?
    action_group_resource["type"] = resource[:type] unless resource[:type].nil?
    return action_group_resource
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation ActionGroups_ListBySubscriptionId")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/microsoft.insights/actionGroups", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ActionGroups_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}

    op_params = [
      self.op_param("actionGroup", "body", "action_group"),
      self.op_param("actionGroupName", "path", "action_group_name"),
      self.op_param("api-version", "query", "api_version"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/microsoft.insights/actionGroups/%{action_group_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ActionGroups_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/microsoft.insights/actionGroups/%{action_group_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ActionGroups_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/microsoft.insights/actionGroups", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ActionGroups_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/microsoft.insights/actionGroups/%{action_group_name}", "Get", "[application/json]")
  end
