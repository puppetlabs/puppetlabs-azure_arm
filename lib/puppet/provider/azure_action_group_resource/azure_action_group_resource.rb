...
Puppet::Type.type(:azure_action_group_resource).provide(:arm) do
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "emailReceivers", "status"])
        self.deep_delete(hash, [:properties, "enabled"])

        self.deep_delete(hash, [:properties, "smsReceivers", "status"])

        self.deep_delete(hash, [:properties, "webhookReceivers", "useAadAuth"])
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      self.op_param("actionGroup", "body", "action_group", "action_group"),
      self.op_param("actionGroupName", "path", "action_group_name", "action_group_name"),
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
