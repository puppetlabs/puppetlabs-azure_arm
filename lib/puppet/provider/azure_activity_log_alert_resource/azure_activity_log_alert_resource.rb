...
Puppet::Type.type(:azure_activity_log_alert_resource).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          activity_log_alert: item["activityLogAlert"],
          activity_log_alert_name: item["activityLogAlertName"],
  ...
  def self.instance_to_hash(instance)
    {
      ...
      activity_log_alert: instance.activity_log_alert.respond_to?(:to_hash) ? instance.activity_log_alert.to_hash : instance.activity_log_alert,
      activity_log_alert_name: instance.activity_log_alert_name.respond_to?(:to_hash) ? instance.activity_log_alert_name.to_hash : instance.activity_log_alert_name,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type ActivityLogAlertResource")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type ActivityLogAlertResource - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    activity_log_alert_resource = {}
    activity_log_alert_resource["id"] = resource[:id] unless resource[:id].nil?
    activity_log_alert_resource["location"] = resource[:location] unless resource[:location].nil?
    activity_log_alert_resource["name"] = resource[:name] unless resource[:name].nil?
    activity_log_alert_resource["properties"] = resource[:properties] unless resource[:properties].nil?
    activity_log_alert_resource["tags"] = resource[:tags] unless resource[:tags].nil?
    activity_log_alert_resource["type"] = resource[:type] unless resource[:type].nil?
    return activity_log_alert_resource
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation ActivityLogAlerts_ListBySubscriptionId")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/microsoft.insights/activityLogAlerts", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ActivityLogAlerts_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}

    op_params = [
      self.op_param("activityLogAlert", "body", "activity_log_alert"),
      self.op_param("activityLogAlertName", "path", "activity_log_alert_name"),
      self.op_param("api-version", "query", "api_version"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/microsoft.insights/activityLogAlerts/%{activity_log_alert_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ActivityLogAlerts_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/microsoft.insights/activityLogAlerts/%{activity_log_alert_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ActivityLogAlerts_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/microsoft.insights/activityLogAlerts", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ActivityLogAlerts_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/microsoft.insights/activityLogAlerts/%{activity_log_alert_name}", "Get", "[application/json]")
  end
