...
Puppet::Type.type(:azure_activity_log_alert_resource).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      self.op_param("activityLogAlert", "body", "activity_log_alert", "activity_log_alert"),
      self.op_param("activityLogAlertName", "path", "activity_log_alert_name", "activity_log_alert_name"),
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
