...
Puppet::Type.type(:azure_adc_catalog).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type ADCCatalog")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type ADCCatalog - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    adc_catalog = {}
    adc_catalog["etag"] = resource[:etag] unless resource[:etag].nil?
    adc_catalog["id"] = resource[:id] unless resource[:id].nil?
    adc_catalog["location"] = resource[:location] unless resource[:location].nil?
    adc_catalog["name"] = resource[:name] unless resource[:name].nil?
    adc_catalog["properties"] = resource[:properties] unless resource[:properties].nil?
    adc_catalog["tags"] = resource[:tags] unless resource[:tags].nil?
    adc_catalog["type"] = resource[:type] unless resource[:type].nil?
    return adc_catalog
  end

  def self.build_key_values
    key_values = {}
    key_values["api-version"] = "2016-03-30"
    key_values
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation ADCCatalogs_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("catalogName", "path", "catalog_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataCatalog/catalogs/%{catalog_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ADCCatalogs_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.4"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataCatalog/catalogs/%{catalog_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ADCCatalogs_ListtByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.4"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataCatalog/catalogs", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ADCCatalogs_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.4"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataCatalog/catalogs/%{catalog_name}", "Get", "[application/json]")
  end
