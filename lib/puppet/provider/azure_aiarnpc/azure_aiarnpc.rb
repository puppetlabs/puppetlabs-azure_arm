...
Puppet::Type.type(:azure_aiarnpc).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type aiarnpc")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type aiarnpc - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    aiarnpc = {}
    aiarnpc["id"] = resource[:id] unless resource[:id].nil?
    aiarnpc["location"] = resource[:location] unless resource[:location].nil?
    aiarnpc["name"] = resource[:name] unless resource[:name].nil?
    aiarnpc["properties"] = resource[:properties] unless resource[:properties].nil?
    aiarnpc["tags"] = resource[:tags] unless resource[:tags].nil?
    aiarnpc["type"] = resource[:type] unless resource[:type].nil?
    return aiarnpc
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation RosettaNetProcessConfigurations_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("rosettaNetProcessConfiguration", "body", "rosetta_net_process_configuration", "rosetta_net_process_configuration"),
      self.op_param("rosettaNetProcessConfigurationName", "path", "rosetta_net_process_configuration_name", "rosetta_net_process_configuration_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}/rosettanetprocessconfigurations/%{rosetta_net_process_configuration_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation RosettaNetProcessConfigurations_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}/rosettanetprocessconfigurations/%{rosetta_net_process_configuration_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation RosettaNetProcessConfigurations_ListByIntegrationAccounts")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}/rosettanetprocessconfigurations", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation RosettaNetProcessConfigurations_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}/rosettanetprocessconfigurations/%{rosetta_net_process_configuration_name}", "Get", "[application/json]")
  end
