...
Puppet::Type.type(:azure_alert_rule).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type AlertRule")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type AlertRule - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    alert_rule = {}
    alert_rule["id"] = resource[:id] unless resource[:id].nil?
    alert_rule["location"] = resource[:location] unless resource[:location].nil?
    alert_rule["name"] = resource[:name] unless resource[:name].nil?
    alert_rule["properties"] = resource[:properties] unless resource[:properties].nil?
    alert_rule["tags"] = resource[:tags] unless resource[:tags].nil?
    alert_rule["type"] = resource[:type] unless resource[:type].nil?
    return alert_rule
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation SmartDetectorAlertRules_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("expandDetector", "query", "expand_detector", "expand_detector"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/microsoft.alertsManagement/smartDetectorAlertRules", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation SmartDetectorAlertRules_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    op_params = [
      self.op_param("alertRuleName", "path", "name", "alert_rule_name"),
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/microsoft.alertsManagement/smartDetectorAlertRules/%{alert_rule_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation SmartDetectorAlertRules_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/microsoft.alertsManagement/smartDetectorAlertRules/%{alert_rule_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation SmartDetectorAlertRules_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/microsoft.alertsManagement/smartDetectorAlertRules/%{alert_rule_name}", "Get", "[application/json]")
  end
