...
Puppet::Type.type(:azure_analysis_services_server).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          server_parameters: item["serverParameters"],
          sku: item["sku"],
        ...
        self.deep_delete(hash, [:properties, "serverFullName"])
        self.deep_delete(hash, [:properties, "state"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      server_name: instance.server_name.respond_to?(:to_hash) ? instance.server_name.to_hash : instance.server_name,
      server_parameters: instance.server_parameters.respond_to?(:to_hash) ? instance.server_parameters.to_hash : instance.server_parameters,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type AnalysisServicesServer")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type AnalysisServicesServer - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    analysis_services_server["id"] = resource[:id] unless resource[:id].nil?
    analysis_services_server["location"] = resource[:location] unless resource[:location].nil?
    analysis_services_server["name"] = resource[:name] unless resource[:name].nil?
    analysis_services_server["properties"] = resource[:properties] unless resource[:properties].nil?
    analysis_services_server["sku"] = resource[:sku] unless resource[:sku].nil?
    analysis_services_server["tags"] = resource[:tags] unless resource[:tags].nil?
    analysis_services_server["type"] = resource[:type] unless resource[:type].nil?
    return analysis_services_server
  end

  def self.build_key_values
    key_values = {}
    key_values["api-version"] = "2017-08-01"
    key_values
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Servers_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.AnalysisServices/servers", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Servers_Create")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    op_params = [
      ...
      self.op_param("serverName", "path", "server_name", "server_name"),
      self.op_param("serverParameters", "body", "server_parameters", "server_parameters"),
      self.op_param("sku", "body", "sku", "sku"),
      self.op_param("subscriptionId", "path", "subscription_id", "subscription_id"),
      self.op_param("tags", "body", "tags", "tags"),
      self.op_param("type", "body", "type", "type"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.AnalysisServices/servers/%{server_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Servers_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.AnalysisServices/servers/%{server_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Servers_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.AnalysisServices/servers", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Servers_GetDetails")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.AnalysisServices/servers/%{server_name}", "Get", "[application/json]")
  end
