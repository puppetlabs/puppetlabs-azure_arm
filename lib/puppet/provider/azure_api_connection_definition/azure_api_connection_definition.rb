...
Puppet::Type.type(:azure_api_connection_definition).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type ApiConnectionDefinition")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type ApiConnectionDefinition - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    api_connection_definition = {}
    api_connection_definition["etag"] = resource[:etag] unless resource[:etag].nil?
    api_connection_definition["id"] = resource[:id] unless resource[:id].nil?
    api_connection_definition["location"] = resource[:location] unless resource[:location].nil?
    api_connection_definition["name"] = resource[:name] unless resource[:name].nil?
    api_connection_definition["properties"] = resource[:properties] unless resource[:properties].nil?
    api_connection_definition["tags"] = resource[:tags] unless resource[:tags].nil?
    api_connection_definition["type"] = resource[:type] unless resource[:type].nil?
    return api_connection_definition
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Connections_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("connection", "body", "connection"),
      self.op_param("connectionName", "path", "connection_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/connections/%{connection_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Connections_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.4"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/connections/%{connection_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Connections_List")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.4"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/connections", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Connections_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.4"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/connections/%{connection_name}", "Get", "[application/json]")
  end
