...
Puppet::Type.type(:azure_api_management_service_resource).provide(:arm) do
  mk_resource_methods
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "createdAtUtc"])
        self.deep_delete(hash, [:properties, "gatewayRegionalUrl"])
        self.deep_delete(hash, [:properties, "gatewayUrl"])
        self.deep_delete(hash, [:properties, "managementApiUrl"])
        self.deep_delete(hash, [:properties, "portalUrl"])
        self.deep_delete(hash, [:properties, "privateIPAddresses"])
        self.deep_delete(hash, [:properties, "provisioningState"])
        self.deep_delete(hash, [:properties, "publicIPAddresses"])
        self.deep_delete(hash, [:properties, "scmUrl"])
        self.deep_delete(hash, [:properties, "targetProvisioningState"])
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type ApiManagementServiceResource")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type ApiManagementServiceResource - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    api_management_service_resource = {}
    api_management_service_resource["etag"] = resource[:etag] unless resource[:etag].nil?
    api_management_service_resource["id"] = resource[:id] unless resource[:id].nil?
    api_management_service_resource["identity"] = resource[:identity] unless resource[:identity].nil?
    api_management_service_resource["location"] = resource[:location] unless resource[:location].nil?
    api_management_service_resource["name"] = resource[:name] unless resource[:name].nil?
    api_management_service_resource["properties"] = resource[:properties] unless resource[:properties].nil?
    api_management_service_resource["sku"] = resource[:sku] unless resource[:sku].nil?
    api_management_service_resource["tags"] = resource[:tags] unless resource[:tags].nil?
    api_management_service_resource["type"] = resource[:type] unless resource[:type].nil?
    return api_management_service_resource
  end

  def self.build_key_values
    key_values = {}
    key_values["api-version"] = "2019-01-01"
    key_values
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation ApiManagementService_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.ApiManagement/service", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ApiManagementService_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ApiManagement/service/%{service_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ApiManagementService_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ApiManagement/service/%{service_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ApiManagementService_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ApiManagement/service", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ApiManagementService_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ApiManagement/service/%{service_name}", "Get", "[application/json]")
  end
