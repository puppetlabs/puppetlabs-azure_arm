...
Puppet::Type.type(:azure_app).provide(:arm) do
  mk_resource_methods
  ...
  def self.instance_to_hash(instance)
    {
      ...
      app: instance.app.respond_to?(:to_hash) ? instance.app.to_hash : instance.app,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type App")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type App - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    app = {}
    app["id"] = resource[:id] unless resource[:id].nil?
    app["location"] = resource[:location] unless resource[:location].nil?
    app["name"] = resource[:name] unless resource[:name].nil?
    app["properties"] = resource[:properties] unless resource[:properties].nil?
    app["sku"] = resource[:sku] unless resource[:sku].nil?
    app["tags"] = resource[:tags] unless resource[:tags].nil?
    app["type"] = resource[:type] unless resource[:type].nil?
    return app
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Apps_ListBySubscription")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.IoTCentral/IoTApps", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Apps_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("App", "body", "app", "app"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
      self.op_param("properties", "body", "properties", "properties"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.IoTCentral/IoTApps/%{resource_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Apps_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.IoTCentral/IoTApps/%{resource_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Apps_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.IoTCentral/IoTApps/%{resource_name}", "Get", "[application/json]")
  end
