...
Puppet::Type.type(:azure_app_service_certificate_order).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          certificate_distinguished_name: item["certificateDistinguishedName"],
          certificate_order_name: item["certificateOrderName"],
          id: item["id"],
          kind: item["kind"],
  ...
  def self.instance_to_hash(instance)
    {
      ...
      certificate_distinguished_name: instance.certificate_distinguished_name.respond_to?(:to_hash) ? instance.certificate_distinguished_name.to_hash : instance.certificate_distinguished_name,
      certificate_order_name: instance.certificate_order_name.respond_to?(:to_hash) ? instance.certificate_order_name.to_hash : instance.certificate_order_name,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type AppServiceCertificateOrder")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type AppServiceCertificateOrder - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    app_service_certificate_order["id"] = resource[:id] unless resource[:id].nil?
    app_service_certificate_order["kind"] = resource[:kind] unless resource[:kind].nil?
    app_service_certificate_order["location"] = resource[:location] unless resource[:location].nil?
    app_service_certificate_order["name"] = resource[:name] unless resource[:name].nil?
    app_service_certificate_order["properties"] = resource[:properties] unless resource[:properties].nil?
    app_service_certificate_order["tags"] = resource[:tags] unless resource[:tags].nil?
    app_service_certificate_order["type"] = resource[:type] unless resource[:type].nil?
    return app_service_certificate_order
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation AppServiceCertificateOrders_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.CertificateRegistration/certificateOrders", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation AppServiceCertificateOrders_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("certificateDistinguishedName", "body", "certificate_distinguished_name", "certificate_distinguished_name"),
      self.op_param("certificateOrderName", "path", "certificate_order_name", "certificate_order_name"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("kind", "body", "kind", "kind"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CertificateRegistration/certificateOrders/%{certificate_order_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation AppServiceCertificateOrders_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CertificateRegistration/certificateOrders/%{certificate_order_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation AppServiceCertificateOrders_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CertificateRegistration/certificateOrders", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation AppServiceCertificateOrders_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CertificateRegistration/certificateOrders/%{certificate_order_name}", "Get", "[application/json]")
  end
