...
Puppet::Type.type(:azure_app_service_certificate_resource).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type AppServiceCertificateResource")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type AppServiceCertificateResource - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    app_service_certificate_resource = {}
    app_service_certificate_resource["id"] = resource[:id] unless resource[:id].nil?
    app_service_certificate_resource["kind"] = resource[:kind] unless resource[:kind].nil?
    app_service_certificate_resource["location"] = resource[:location] unless resource[:location].nil?
    app_service_certificate_resource["name"] = resource[:name] unless resource[:name].nil?
    app_service_certificate_resource["properties"] = resource[:properties] unless resource[:properties].nil?
    app_service_certificate_resource["tags"] = resource[:tags] unless resource[:tags].nil?
    app_service_certificate_resource["type"] = resource[:type] unless resource[:type].nil?
    return app_service_certificate_resource
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation AppServiceCertificateOrders_CreateOrUpdateCertificate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("keyVaultCertificate", "body", "key_vault_certificate", "key_vault_certificate"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CertificateRegistration/certificateOrders/%{certificate_order_name}/certificates/%{name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation AppServiceCertificateOrders_DeleteCertificate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CertificateRegistration/certificateOrders/%{certificate_order_name}/certificates/%{name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation AppServiceCertificateOrders_ListCertificates")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CertificateRegistration/certificateOrders/%{certificate_order_name}/certificates", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation AppServiceCertificateOrders_GetCertificate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CertificateRegistration/certificateOrders/%{certificate_order_name}/certificates/%{name}", "Get", "[application/json]")
  end
