...
Puppet::Type.type(:azure_app_service_environment_resource).provide(:arm) do
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "allowedMultiSizes"])
        self.deep_delete(hash, [:properties, "allowedWorkerSizes"])

        self.deep_delete(hash, [:properties, "databaseEdition"])
        self.deep_delete(hash, [:properties, "databaseServiceObjective"])
        self.deep_delete(hash, [:properties, "defaultFrontEndScaleFactor"])

        self.deep_delete(hash, [:properties, "environmentIsHealthy"])
        self.deep_delete(hash, [:properties, "environmentStatus"])
        self.deep_delete(hash, [:properties, "lastAction"])
        self.deep_delete(hash, [:properties, "lastActionResult"])
        self.deep_delete(hash, [:properties, "maximumNumberOfMachines"])

        self.deep_delete(hash, [:properties, "provisioningState"])
        self.deep_delete(hash, [:properties, "resourceGroup"])
        self.deep_delete(hash, [:properties, "status"])
        self.deep_delete(hash, [:properties, "subscriptionId"])
        self.deep_delete(hash, [:properties, "upgradeDomains"])

        self.deep_delete(hash, [:properties, "virtualNetwork", "name"])
        self.deep_delete(hash, [:properties, "virtualNetwork", "type"])

        self.deep_delete(hash, [:properties, "workerPools", "instanceNames"])
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Web/hostingEnvironments", "Get", "[application/json]")
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/hostingEnvironments/%{name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/hostingEnvironments/%{name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation AppServiceEnvironments_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/hostingEnvironments", "Get", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/hostingEnvironments/%{name}", "Get", "[application/json]")
  end
