...
Puppet::Type.type(:azure_application_definition).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation ApplicationDefinitions_CreateOrUpdateById")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    path_params[:application_definition_id] = key_values["applicationDefinitionId"] unless key_values["applicationDefinitionId"].nil?
    path_params[:application_definition_id] = ENV["azure_application_definition_id"] unless ENV["azure_application_definition_id"].nil?
    path_params[:application_definition_id] = resource[:id] unless resource.nil? or resource[:id].nil?
    ...
    uri_string = "https://management.azure.com/%{application_definition_id}" % path_params
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ApplicationDefinitions_DeleteById")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Solutions/applicationDefinitions" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ApplicationDefinitions_GetById")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
