...
Puppet::Type.type(:azure_application_insights_component).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          id: item["id"],
          insight_properties: item["InsightProperties"],
          kind: item["kind"],
        ...
        self.deep_delete(hash, [:properties, "AppId"])
        self.deep_delete(hash, [:properties, "ApplicationId"])
        self.deep_delete(hash, [:properties, "CreationDate"])
        self.deep_delete(hash, [:properties, "HockeyAppToken"])
        self.deep_delete(hash, [:properties, "InstrumentationKey"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      insight_properties: instance.insight_properties.respond_to?(:to_hash) ? instance.insight_properties.to_hash : instance.insight_properties,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type ApplicationInsightsComponent")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type ApplicationInsightsComponent - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    application_insights_component = {}
    application_insights_component["id"] = resource[:id] unless resource[:id].nil?
    application_insights_component["kind"] = resource[:kind] unless resource[:kind].nil?
    application_insights_component["location"] = resource[:location] unless resource[:location].nil?
    application_insights_component["name"] = resource[:name] unless resource[:name].nil?
    application_insights_component["properties"] = resource[:properties] unless resource[:properties].nil?
    application_insights_component["tags"] = resource[:tags] unless resource[:tags].nil?
    application_insights_component["type"] = resource[:type] unless resource[:type].nil?
    return application_insights_component
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Components_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Insights/components", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Components_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("InsightProperties", "body", "insight_properties", "insight_properties"),
      self.op_param("kind", "body", "kind", "kind"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
      self.op_param("properties", "body", "properties", "properties"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Insights/components/%{resource_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Components_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Insights/components/%{resource_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Components_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Insights/components", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Components_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Insights/components/%{resource_name}", "Get", "[application/json]")
  end
