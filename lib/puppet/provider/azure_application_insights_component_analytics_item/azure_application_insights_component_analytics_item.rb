...
Puppet::Type.type(:azure_application_insights_component_analytics_item).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("itemProperties", "body", "item_properties"),
      self.op_param("overrideItem", "query", "override_item"),
      self.op_param("resourceGroupName", "path", "resource_group_name"),
      self.op_param("resourceName", "path", "resource_name"),
      self.op_param("scopePath", "path", "scope_path"),
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version"),
      self.op_param("id", "query", "id"),
      self.op_param("name", "query", "name"),
      self.op_param("resourceGroupName", "path", "resource_group_name"),
      self.op_param("resourceName", "path", "resource_name"),
      self.op_param("scopePath", "path", "scope_path"),
      self.op_param("subscriptionId", "path", "subscription_id"),
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version"),
      self.op_param("includeContent", "query", "include_content"),
      self.op_param("resourceGroupName", "path", "resource_group_name"),
      self.op_param("resourceName", "path", "resource_name"),
      self.op_param("scope", "query", "scope"),
      self.op_param("scopePath", "path", "scope_path"),
      self.op_param("subscriptionId", "path", "subscription_id"),
      self.op_param("type", "query", "type"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
      name = i[:name]
