...
Puppet::Type.type(:azure_application_insights_component_favorite).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("favoriteId", "path", "favorite_id"),
      self.op_param("favoriteProperties", "body", "favorite_properties"),
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("favoriteType", "query", "favorite_type"),
      self.op_param("resourceGroupName", "path", "resource_group_name"),
      self.op_param("resourceName", "path", "resource_name"),
      self.op_param("sourceType", "query", "source_type"),
      self.op_param("subscriptionId", "path", "subscription_id"),
