...
Puppet::Type.type(:azure_assessment).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type Assessment")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type Assessment - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    assessment = {}
    assessment["eTag"] = resource[:e_tag] unless resource[:e_tag].nil?
    assessment["id"] = resource[:id] unless resource[:id].nil?
    assessment["name"] = resource[:name] unless resource[:name].nil?
    assessment["properties"] = resource[:properties] unless resource[:properties].nil?
    assessment["type"] = resource[:type] unless resource[:type].nil?
    return assessment
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Assessments_Create")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    path_params[:assessment] = key_values["assessment"] unless key_values["assessment"].nil?
    path_params[:assessment] = ENV["azure_assessment"] unless ENV["azure_assessment"].nil?
    path_params[:assessment] = resource[:assessment] unless resource.nil? or resource[:assessment].nil?
    path_params[:assessment_name] = key_values["assessmentName"] unless key_values["assessmentName"].nil?
    path_params[:assessment_name] = ENV["azure_assessment_name"] unless ENV["azure_assessment_name"].nil?
    path_params[:assessment_name] = resource[:name] unless resource.nil? or resource[:name].nil?
    path_params[:group_name] = key_values["groupName"] unless key_values["groupName"].nil?
    path_params[:group_name] = ENV["azure_group_name"] unless ENV["azure_group_name"].nil?
    path_params[:group_name] = resource[:group_name] unless resource.nil? or resource[:group_name].nil?
    path_params[:project_name] = key_values["projectName"] unless key_values["projectName"].nil?
    path_params[:project_name] = ENV["azure_project_name"] unless ENV["azure_project_name"].nil?
    path_params[:project_name] = resource[:project_name] unless resource.nil? or resource[:project_name].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Migrate/projects/%{project_name}/groups/%{group_name}/assessments/%{assessment_name}" % path_params
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Assessments_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    path_params[:accept_language] = key_values["Accept-Language"] unless key_values["Accept-Language"].nil?
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Assessments_ListByGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    path_params[:accept_language] = key_values["Accept-Language"] unless key_values["Accept-Language"].nil?
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Migrate/projects/%{project_name}/groups/%{group_name}/assessments" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Assessments_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    path_params[:accept_language] = key_values["Accept-Language"] unless key_values["Accept-Language"].nil?
