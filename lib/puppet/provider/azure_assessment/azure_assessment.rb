...
Puppet::Type.type(:azure_assessment).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      self.op_param("Accept-Language", "header", "accept_language"),
      self.op_param("api-version", "query", "api_version"),
      self.op_param("assessment", "body", "assessment"),
      self.op_param("assessmentName", "path", "name"),
      self.op_param("groupName", "path", "group_name"),
      self.op_param("projectName", "path", "project_name"),
