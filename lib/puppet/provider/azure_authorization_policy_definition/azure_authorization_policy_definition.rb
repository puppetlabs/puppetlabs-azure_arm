...
Puppet::Type.type(:azure_authorization_policy_definition).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type PolicyDefinition")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type PolicyDefinition - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    policy_definition = {}
    policy_definition["id"] = resource[:id] unless resource[:id].nil?
    policy_definition["name"] = resource[:name] unless resource[:name].nil?
    policy_definition["properties"] = resource[:properties] unless resource[:properties].nil?
    policy_definition["type"] = resource[:type] unless resource[:type].nil?
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Authorization/policyDefinitions", "Get", "[application/json]")
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("policyDefinitionName", "path", "name", "policy_definition_name"),
      self.op_param("subscriptionId", "path", "subscription_id", "subscription_id"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Authorization/policyDefinitions/%{policy_definition_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Authorization/policyDefinitions/%{policy_definition_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/providers/Microsoft.Management/managementgroups/%{management_group_id}/providers/Microsoft.Authorization/policyDefinitions", "Get", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Authorization/policyDefinitions/%{policy_definition_name}", "Get", "[application/json]")
  end
