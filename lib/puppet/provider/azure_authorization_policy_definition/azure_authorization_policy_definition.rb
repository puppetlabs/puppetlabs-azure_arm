...
Puppet::Type.type(:azure_authorization_policy_definition).provide(:arm) do
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation PolicyDefinitions_ListBuiltIn")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/providers/Microsoft.Authorization/policyDefinitions", "Get", "[application/json]")
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("policyDefinitionName", "path", "name"),
