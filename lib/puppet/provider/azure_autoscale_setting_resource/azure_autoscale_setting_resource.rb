...
Puppet::Type.type(:azure_autoscale_setting_resource).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          autoscale_setting_name: item["autoscaleSettingName"],
          id: item["id"],
        ...
        self.deep_delete(hash, [:properties, "enabled"])

        self.deep_delete(hash, [:properties, "profiles", "rules", "scaleAction", "value"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      autoscale_setting_name: instance.autoscale_setting_name.respond_to?(:to_hash) ? instance.autoscale_setting_name.to_hash : instance.autoscale_setting_name,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type AutoscaleSettingResource")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type AutoscaleSettingResource - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    autoscale_setting_resource["id"] = resource[:id] unless resource[:id].nil?
    autoscale_setting_resource["location"] = resource[:location] unless resource[:location].nil?
    autoscale_setting_resource["name"] = resource[:name] unless resource[:name].nil?
    autoscale_setting_resource["properties"] = resource[:properties] unless resource[:properties].nil?
    autoscale_setting_resource["tags"] = resource[:tags] unless resource[:tags].nil?
    autoscale_setting_resource["type"] = resource[:type] unless resource[:type].nil?
    return autoscale_setting_resource
  end

  def self.build_key_values
    key_values = {}
    key_values["api-version"] = "2015-04-01"
    key_values
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation AutoscaleSettings_ListBySubscription")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/microsoft.insights/autoscalesettings", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation AutoscaleSettings_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("autoscaleSettingName", "path", "autoscale_setting_name", "autoscale_setting_name"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/microsoft.insights/autoscalesettings/%{autoscale_setting_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation AutoscaleSettings_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/microsoft.insights/autoscalesettings/%{autoscale_setting_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation AutoscaleSettings_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/microsoft.insights/autoscalesettings", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation AutoscaleSettings_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/microsoft.insights/autoscalesettings/%{autoscale_setting_name}", "Get", "[application/json]")
  end
