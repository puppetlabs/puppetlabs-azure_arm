...
Puppet::Type.type(:azure_azure_firewall).provide(:arm) do
  mk_resource_methods
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "applicationRuleCollections", "etag"])

        self.deep_delete(hash, [:properties, "hubIpAddresses"])

        self.deep_delete(hash, [:properties, "ipConfigurations", "etag"])

        self.deep_delete(hash, [:properties, "ipConfigurations", "properties", "privateIPAddress"])

        self.deep_delete(hash, [:properties, "natRuleCollections", "etag"])

        self.deep_delete(hash, [:properties, "networkRuleCollections", "etag"])
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type AzureFirewall")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type AzureFirewall - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    azure_firewall = {}
    azure_firewall["etag"] = resource[:etag] unless resource[:etag].nil?
    azure_firewall["id"] = resource[:id] unless resource[:id].nil?
    azure_firewall["location"] = resource[:location] unless resource[:location].nil?
    azure_firewall["name"] = resource[:name] unless resource[:name].nil?
    azure_firewall["properties"] = resource[:properties] unless resource[:properties].nil?
    azure_firewall["tags"] = resource[:tags] unless resource[:tags].nil?
    azure_firewall["type"] = resource[:type] unless resource[:type].nil?
    azure_firewall["zones"] = resource[:zones] unless resource[:zones].nil?
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation AzureFirewalls_ListAll")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Network/azureFirewalls", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation AzureFirewalls_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("azureFirewallName", "path", "name", "azure_firewall_name"),
      self.op_param("etag", "body", "etag", "etag"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/azureFirewalls/%{azure_firewall_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation AzureFirewalls_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/azureFirewalls/%{azure_firewall_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation AzureFirewalls_List")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/azureFirewalls", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation AzureFirewalls_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/azureFirewalls/%{azure_firewall_name}", "Get", "[application/json]")
  end
