...
Puppet::Type.type(:azure_backup_schedule).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type BackupSchedule")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type BackupSchedule - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    backup_schedule = {}
    backup_schedule["id"] = resource[:id] unless resource[:id].nil?
    backup_schedule["kind"] = resource[:kind] unless resource[:kind].nil?
    backup_schedule["name"] = resource[:name] unless resource[:name].nil?
    backup_schedule["properties"] = resource[:properties] unless resource[:properties].nil?
    backup_schedule["type"] = resource[:type] unless resource[:type].nil?
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation BackupSchedules_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    path_params[:backup_policy_name] = key_values["backupPolicyName"] unless key_values["backupPolicyName"].nil?
    path_params[:backup_policy_name] = ENV["azure_backup_policy_name"] unless ENV["azure_backup_policy_name"].nil?
    path_params[:backup_policy_name] = resource[:backup_policy_name] unless resource.nil? or resource[:backup_policy_name].nil?
    path_params[:backup_schedule_name] = key_values["backupScheduleName"] unless key_values["backupScheduleName"].nil?
    path_params[:backup_schedule_name] = ENV["azure_backup_schedule_name"] unless ENV["azure_backup_schedule_name"].nil?
    path_params[:backup_schedule_name] = resource[:name] unless resource.nil? or resource[:name].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorSimple/managers/%{manager_name}/devices/%{device_name}/backupPolicies/%{backup_policy_name}/schedules/%{backup_schedule_name}" % path_params
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation BackupSchedules_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation BackupSchedules_ListByBackupPolicy")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorSimple/managers/%{manager_name}/devices/%{device_name}/backupPolicies/%{backup_policy_name}/schedules" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation BackupSchedules_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
