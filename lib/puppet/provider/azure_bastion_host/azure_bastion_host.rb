...
Puppet::Type.type(:azure_bastion_host).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type BastionHost")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type BastionHost - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    bastion_host = {}
    bastion_host["etag"] = resource[:etag] unless resource[:etag].nil?
    bastion_host["id"] = resource[:id] unless resource[:id].nil?
    bastion_host["location"] = resource[:location] unless resource[:location].nil?
    bastion_host["name"] = resource[:name] unless resource[:name].nil?
    bastion_host["properties"] = resource[:properties] unless resource[:properties].nil?
    bastion_host["tags"] = resource[:tags] unless resource[:tags].nil?
    bastion_host["type"] = resource[:type] unless resource[:type].nil?
    return bastion_host
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation BastionHosts_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Network/bastionHosts", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation BastionHosts_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("bastionHostName", "path", "name", "bastion_host_name"),
      self.op_param("etag", "body", "etag", "etag"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/bastionHosts/%{bastion_host_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation BastionHosts_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/bastionHosts/%{bastion_host_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation BastionHosts_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/bastionHosts/%{bastion_host_name}", "Get", "[application/json]")
  end
