...
Puppet::Type.type(:azure_batch_configuration).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type BatchConfiguration")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type BatchConfiguration - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    batch_configuration = {}
    batch_configuration["id"] = resource[:id] unless resource[:id].nil?
    batch_configuration["location"] = resource[:location] unless resource[:location].nil?
    batch_configuration["name"] = resource[:name] unless resource[:name].nil?
    batch_configuration["properties"] = resource[:properties] unless resource[:properties].nil?
    batch_configuration["tags"] = resource[:tags] unless resource[:tags].nil?
    batch_configuration["type"] = resource[:type] unless resource[:type].nil?
    return batch_configuration
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation IntegrationAccountBatchConfigurations_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("batchConfiguration", "body", "batch_configuration", "batch_configuration"),
      self.op_param("batchConfigurationName", "path", "name", "batch_configuration_name"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("integrationAccountName", "path", "integration_account_name", "integration_account_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}/batchConfigurations/%{batch_configuration_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation IntegrationAccountBatchConfigurations_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}/batchConfigurations/%{batch_configuration_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation IntegrationAccountBatchConfigurations_List")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}/batchConfigurations", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation IntegrationAccountBatchConfigurations_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}/batchConfigurations/%{batch_configuration_name}", "Get", "[application/json]")
  end
