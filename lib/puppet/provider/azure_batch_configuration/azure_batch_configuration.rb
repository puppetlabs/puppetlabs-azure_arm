...
Puppet::Type.type(:azure_batch_configuration).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("batchConfiguration", "body", "batch_configuration"),
      self.op_param("batchConfigurationName", "path", "name"),
      self.op_param("integrationAccountName", "path", "integration_account_name"),
