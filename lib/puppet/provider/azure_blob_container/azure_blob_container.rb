...
Puppet::Type.type(:azure_blob_container).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:blob_container] = key_values["blobContainer"] unless key_values["blobContainer"].nil?
    path_params[:blob_container] = ENV["azure_blob_container"] unless ENV["azure_blob_container"].nil?
    path_params[:blob_container] = resource[:blob_container] unless resource.nil? or resource[:blob_container].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Storage/storageAccounts/%{account_name}/blobServices/default/containers/%{container_name}" % path_params
