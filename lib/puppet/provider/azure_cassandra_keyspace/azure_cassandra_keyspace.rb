...
Puppet::Type.type(:azure_cassandra_keyspace).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type CassandraKeyspace")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type CassandraKeyspace - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    cassandra_keyspace = {}
    cassandra_keyspace["id"] = resource[:id] unless resource[:id].nil?
    cassandra_keyspace["location"] = resource[:location] unless resource[:location].nil?
    cassandra_keyspace["name"] = resource[:name] unless resource[:name].nil?
    cassandra_keyspace["properties"] = resource[:properties] unless resource[:properties].nil?
    cassandra_keyspace["tags"] = resource[:tags] unless resource[:tags].nil?
    cassandra_keyspace["type"] = resource[:type] unless resource[:type].nil?
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation DatabaseAccounts_CreateUpdateCassandraKeyspace")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("createUpdateCassandraKeyspaceParameters", "body", "create_update_cassandra_keyspace_parameters", "create_update_cassandra_keyspace_parameters"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/apis/cassandra/keyspaces/%{keyspace_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DatabaseAccounts_DeleteCassandraKeyspace")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/apis/cassandra/keyspaces/%{keyspace_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DatabaseAccounts_ListCassandraKeyspaces")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/apis/cassandra/keyspaces", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DatabaseAccounts_GetCassandraKeyspace")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/apis/cassandra/keyspaces/%{keyspace_name}", "Get", "[application/json]")
  end
