...
Puppet::Type.type(:azure_cassandra_table).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type CassandraTable")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type CassandraTable - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    cassandra_table = {}
    cassandra_table["id"] = resource[:id] unless resource[:id].nil?
    cassandra_table["location"] = resource[:location] unless resource[:location].nil?
    cassandra_table["name"] = resource[:name] unless resource[:name].nil?
    cassandra_table["properties"] = resource[:properties] unless resource[:properties].nil?
    cassandra_table["tags"] = resource[:tags] unless resource[:tags].nil?
    cassandra_table["type"] = resource[:type] unless resource[:type].nil?
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation DatabaseAccounts_CreateUpdateCassandraTable")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("createUpdateCassandraTableParameters", "body", "create_update_cassandra_table_parameters", "create_update_cassandra_table_parameters"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("keyspaceName", "path", "keyspace_name", "keyspace_name"),
      ...
      self.op_param("tableName", "path", "table_name", "table_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/apis/cassandra/keyspaces/%{keyspace_name}/tables/%{table_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DatabaseAccounts_DeleteCassandraTable")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/apis/cassandra/keyspaces/%{keyspace_name}/tables/%{table_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DatabaseAccounts_ListCassandraTables")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/apis/cassandra/keyspaces/%{keyspace_name}/tables", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DatabaseAccounts_GetCassandraTable")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/apis/cassandra/keyspaces/%{keyspace_name}/tables/%{table_name}", "Get", "[application/json]")
  end
