...
Puppet::Type.type(:azure_certificate).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          certificate_envelope: item["certificateEnvelope"],
          id: item["id"],
          kind: item["kind"],
  ...
  def self.instance_to_hash(instance)
    {
      ...
      certificate_envelope: instance.certificate_envelope.respond_to?(:to_hash) ? instance.certificate_envelope.to_hash : instance.certificate_envelope,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type Certificate")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type Certificate - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    certificate = {}
    certificate["id"] = resource[:id] unless resource[:id].nil?
    certificate["kind"] = resource[:kind] unless resource[:kind].nil?
    certificate["location"] = resource[:location] unless resource[:location].nil?
    certificate["name"] = resource[:name] unless resource[:name].nil?
    certificate["properties"] = resource[:properties] unless resource[:properties].nil?
    certificate["tags"] = resource[:tags] unless resource[:tags].nil?
    certificate["type"] = resource[:type] unless resource[:type].nil?
    return certificate
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Web/certificates", "Get", "[application/json]")
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("certificateEnvelope", "body", "certificate_envelope", "certificate_envelope"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("kind", "body", "kind", "kind"),
      self.op_param("location", "body", "location", "location"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/certificates/%{name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/certificates/%{name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Certificates_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/certificates", "Get", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/certificates/%{name}", "Get", "[application/json]")
  end
