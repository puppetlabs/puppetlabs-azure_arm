...
Puppet::Type.type(:azure_certificate_order_certificate).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type CertificateOrderCertificate")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type CertificateOrderCertificate - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    certificate_order_certificate = {}
    certificate_order_certificate["id"] = resource[:id] unless resource[:id].nil?
    certificate_order_certificate["kind"] = resource[:kind] unless resource[:kind].nil?
    certificate_order_certificate["location"] = resource[:location] unless resource[:location].nil?
    certificate_order_certificate["name"] = resource[:name] unless resource[:name].nil?
    certificate_order_certificate["properties"] = resource[:properties] unless resource[:properties].nil?
    certificate_order_certificate["tags"] = resource[:tags] unless resource[:tags].nil?
    certificate_order_certificate["type"] = resource[:type] unless resource[:type].nil?
    return certificate_order_certificate
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation CertificateOrders_CreateOrUpdateCertificate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CertificateRegistration/certificateOrders/%{certificate_order_name}/certificates/%{name}", "Put", "[]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation CertificateOrders_DeleteCertificate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CertificateRegistration/certificateOrders/%{certificate_order_name}/certificates/%{name}", "Delete", "[]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation CertificateOrders_GetCertificates")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CertificateRegistration/certificateOrders/%{certificate_order_name}/certificates", "Get", "[]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation CertificateOrders_GetCertificate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CertificateRegistration/certificateOrders/%{certificate_order_name}/certificates/%{name}", "Get", "[]")
  end
