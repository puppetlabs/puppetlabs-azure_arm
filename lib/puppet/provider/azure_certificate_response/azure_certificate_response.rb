...
Puppet::Type.type(:azure_certificate_response).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("certificateDescription", "body", "certificate_description"),
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version"),
      self.op_param("certificate.created", "query", "certificate.created"),
      self.op_param("certificate.hasPrivateKey", "query", "certificate.has_private_key"),
      self.op_param("certificate.isVerified", "query", "certificate.is_verified"),
      self.op_param("certificate.lastUpdated", "query", "certificate.last_updated"),
      self.op_param("certificate.name", "query", "certificate.name"),
      self.op_param("certificate.nonce", "query", "certificate.nonce"),
      self.op_param("certificate.purpose", "query", "certificate.purpose"),
      self.op_param("certificate.rawBytes", "query", "certificate.raw_bytes"),
      self.op_param("certificateName", "path", "certificate_name"),
      self.op_param("If-Match", "header", "if_match"),
      self.op_param("provisioningServiceName", "path", "provisioning_service_name"),
      self.op_param("resourceGroupName", "path", "resource_group_name"),
