...
Puppet::Type.type(:azure_certificate_response).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("certificateDescription", "body", "certificate_description", "certificate_description"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Devices/provisioningServices/%{provisioning_service_name}/certificates/%{certificate_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("certificate.created", "query", "certificate.created", "certificate.created"),
      self.op_param("certificate.hasPrivateKey", "query", "certificate.has_private_key", "certificate.has_private_key"),
      self.op_param("certificate.isVerified", "query", "certificate.is_verified", "certificate.is_verified"),
      self.op_param("certificate.lastUpdated", "query", "certificate.last_updated", "certificate.last_updated"),
      self.op_param("certificate.name", "query", "certificate.name", "certificate.name"),
      self.op_param("certificate.nonce", "query", "certificate.nonce", "certificate.nonce"),
      self.op_param("certificate.purpose", "query", "certificate.purpose", "certificate.purpose"),
      self.op_param("certificate.rawBytes", "query", "certificate.raw_bytes", "certificate.raw_bytes"),
      self.op_param("certificateName", "path", "certificate_name", "certificate_name"),
      self.op_param("etag", "body", "etag", "etag"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("If-Match", "header", "if_match", "if_match"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Devices/provisioningServices/%{provisioning_service_name}/certificates/%{certificate_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Devices/provisioningServices/%{provisioning_service_name}/certificates", "Get", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Devices/provisioningServices/%{provisioning_service_name}/certificates/%{certificate_name}", "Get", "[application/json]")
  end
