...
Puppet::Type.type(:azure_cluster).provide(:arm) do
  mk_resource_methods
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "dataIngestionUri"])
        self.deep_delete(hash, [:properties, "enableStreamingIngest"])

        self.deep_delete(hash, [:properties, "provisioningState"])
        self.deep_delete(hash, [:properties, "state"])

        self.deep_delete(hash, [:properties, "uri"])
  ...
  def build_hash
    ...
    cluster["sku"] = resource[:sku] unless resource[:sku].nil?
    cluster["tags"] = resource[:tags] unless resource[:tags].nil?
    cluster["type"] = resource[:type] unless resource[:type].nil?
    cluster["zones"] = resource[:zones] unless resource[:zones].nil?
    return cluster
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Kusto/clusters", "Get", "[application/json]")
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Kusto/clusters/%{cluster_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Kusto/clusters/%{cluster_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Kusto/clusters/%{cluster_name}", "Get", "[application/json]")
  end
