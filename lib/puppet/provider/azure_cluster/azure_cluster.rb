...
Puppet::Type.type(:azure_cluster).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    query_params["api-version"] = ENV["azure_api_version"] unless ENV["azure_api_version"].nil?
    query_params["api-version"] = resource[:api_version] unless resource.nil? or resource[:api_version].nil?
    path_params[:cluster_name] = key_values["clusterName"] unless key_values["clusterName"].nil?
    path_params[:cluster_name] = ENV["azure_cluster_name"] unless ENV["azure_cluster_name"].nil?
    path_params[:cluster_name] = resource[:name] unless resource.nil? or resource[:name].nil?
