...
Puppet::Type.type(:azure_cognitive_services_account).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type CognitiveServicesAccount")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type CognitiveServicesAccount - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    cognitive_services_account["etag"] = resource[:etag] unless resource[:etag].nil?
    cognitive_services_account["id"] = resource[:id] unless resource[:id].nil?
    cognitive_services_account["kind"] = resource[:kind] unless resource[:kind].nil?
    cognitive_services_account["location"] = resource[:location] unless resource[:location].nil?
    cognitive_services_account["name"] = resource[:name] unless resource[:name].nil?
    cognitive_services_account["properties"] = resource[:properties] unless resource[:properties].nil?
    cognitive_services_account["sku"] = resource[:sku] unless resource[:sku].nil?
    cognitive_services_account["tags"] = resource[:tags] unless resource[:tags].nil?
    cognitive_services_account["type"] = resource[:type] unless resource[:type].nil?
    return cognitive_services_account
  end

  def self.build_key_values
    key_values = {}
    key_values["api-version"] = "2017-04-18"
    key_values
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Accounts_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.CognitiveServices/accounts", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Accounts_Create")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CognitiveServices/accounts/%{account_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CognitiveServices/accounts/%{account_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CognitiveServices/accounts", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Accounts_GetProperties")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CognitiveServices/accounts/%{account_name}", "Get", "[application/json]")
  end
