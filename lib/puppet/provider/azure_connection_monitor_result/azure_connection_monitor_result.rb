...
Puppet::Type.type(:azure_connection_monitor_result).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type ConnectionMonitorResult")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type ConnectionMonitorResult - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    connection_monitor_result["etag"] = resource[:etag] unless resource[:etag].nil?
    connection_monitor_result["id"] = resource[:id] unless resource[:id].nil?
    connection_monitor_result["location"] = resource[:location] unless resource[:location].nil?
    connection_monitor_result["name"] = resource[:name] unless resource[:name].nil?
    connection_monitor_result["properties"] = resource[:properties] unless resource[:properties].nil?
    connection_monitor_result["tags"] = resource[:tags] unless resource[:tags].nil?
    connection_monitor_result["type"] = resource[:type] unless resource[:type].nil?
    return connection_monitor_result
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation ConnectionMonitors_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("connectionMonitorName", "path", "connection_monitor_name", "connection_monitor_name"),
      self.op_param("networkWatcherName", "path", "network_watcher_name", "network_watcher_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkWatchers/%{network_watcher_name}/connectionMonitors/%{connection_monitor_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ConnectionMonitors_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkWatchers/%{network_watcher_name}/connectionMonitors/%{connection_monitor_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ConnectionMonitors_List")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkWatchers/%{network_watcher_name}/connectionMonitors", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ConnectionMonitors_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkWatchers/%{network_watcher_name}/connectionMonitors/%{connection_monitor_name}", "Get", "[application/json]")
  end
