...
Puppet::Type.type(:azure_connector_mapping_resource_format).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type ConnectorMappingResourceFormat")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type ConnectorMappingResourceFormat - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    connector_mapping_resource_format = {}
    connector_mapping_resource_format["id"] = resource[:id] unless resource[:id].nil?
    connector_mapping_resource_format["name"] = resource[:name] unless resource[:name].nil?
    connector_mapping_resource_format["properties"] = resource[:properties] unless resource[:properties].nil?
    connector_mapping_resource_format["type"] = resource[:type] unless resource[:type].nil?
    return connector_mapping_resource_format
  end

  def self.build_key_values
    key_values = {}
    key_values["api-version"] = "2017-04-26"
    key_values
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation ConnectorMappings_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("connectorName", "path", "connector_name", "connector_name"),
      self.op_param("hubName", "path", "hub_name", "hub_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CustomerInsights/hubs/%{hub_name}/connectors/%{connector_name}/mappings/%{mapping_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ConnectorMappings_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CustomerInsights/hubs/%{hub_name}/connectors/%{connector_name}/mappings/%{mapping_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ConnectorMappings_ListByConnector")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CustomerInsights/hubs/%{hub_name}/connectors/%{connector_name}/mappings", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ConnectorMappings_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CustomerInsights/hubs/%{hub_name}/connectors/%{connector_name}/mappings/%{mapping_name}", "Get", "[application/json]")
  end
