...
Puppet::Type.type(:azure_content_key_policy).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type ContentKeyPolicy")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type ContentKeyPolicy - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    content_key_policy = {}
    content_key_policy["id"] = resource[:id] unless resource[:id].nil?
    content_key_policy["name"] = resource[:name] unless resource[:name].nil?
    content_key_policy["properties"] = resource[:properties] unless resource[:properties].nil?
    content_key_policy["type"] = resource[:type] unless resource[:type].nil?
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation ContentKeyPolicies_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("contentKeyPolicyName", "path", "name", "content_key_policy_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Media/mediaServices/%{account_name}/contentKeyPolicies/%{content_key_policy_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ContentKeyPolicies_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Media/mediaServices/%{account_name}/contentKeyPolicies/%{content_key_policy_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ContentKeyPolicies_List")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    op_params = [
      ...
      self.op_param("$orderby", "query", "$orderby", "$orderby"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Media/mediaServices/%{account_name}/contentKeyPolicies", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ContentKeyPolicies_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Media/mediaServices/%{account_name}/contentKeyPolicies/%{content_key_policy_name}", "Get", "[application/json]")
  end
