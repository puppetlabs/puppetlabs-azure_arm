...
Puppet::Type.type(:azure_controller).provide(:arm) do
  mk_resource_methods
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "dataPlaneFqdn"])
        self.deep_delete(hash, [:properties, "hostSuffix"])
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type Controller")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type Controller - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    controller = {}
    controller["id"] = resource[:id] unless resource[:id].nil?
    controller["location"] = resource[:location] unless resource[:location].nil?
    controller["name"] = resource[:name] unless resource[:name].nil?
    controller["properties"] = resource[:properties] unless resource[:properties].nil?
    controller["sku"] = resource[:sku] unless resource[:sku].nil?
    controller["tags"] = resource[:tags] unless resource[:tags].nil?
    controller["type"] = resource[:type] unless resource[:type].nil?
    return controller
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Controllers_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.DevSpaces/controllers", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Controllers_Create")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("controller", "body", "controller", "controller"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("location", "body", "location", "location"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DevSpaces/controllers/%{name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Controllers_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DevSpaces/controllers/%{name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Controllers_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DevSpaces/controllers", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Controllers_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DevSpaces/controllers/%{name}", "Get", "[application/json]")
  end
