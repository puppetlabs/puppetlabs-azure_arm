...
Puppet::Type.type(:azure_csr).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type Csr")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type Csr - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    csr = {}
    csr["id"] = resource[:id] unless resource[:id].nil?
    csr["kind"] = resource[:kind] unless resource[:kind].nil?
    csr["location"] = resource[:location] unless resource[:location].nil?
    csr["name"] = resource[:name] unless resource[:name].nil?
    csr["properties"] = resource[:properties] unless resource[:properties].nil?
    csr["tags"] = resource[:tags] unless resource[:tags].nil?
    csr["type"] = resource[:type] unless resource[:type].nil?
    return csr
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Certificates_CreateOrUpdateCsr")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("csrEnvelope", "body", "csr_envelope"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/csrs/%{name}", "Put", "[]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Certificates_DeleteCsr")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.4"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/csrs/%{name}", "Delete", "[]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Certificates_GetCsrs")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.4"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/csrs", "Get", "[]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Certificates_GetCsr")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.4"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/csrs/%{name}", "Get", "[]")
  end
