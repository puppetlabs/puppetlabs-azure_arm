...
Puppet::Type.type(:azure_custom_api_definition).provide(:arm) do
  mk_resource_methods
  ...
  def self.instance_to_hash(instance)
    {
      ...
      api_name: instance.api_name.respond_to?(:to_hash) ? instance.api_name.to_hash : instance.api_name,
      custom_api: instance.custom_api.respond_to?(:to_hash) ? instance.custom_api.to_hash : instance.custom_api,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type CustomApiDefinition")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type CustomApiDefinition - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    custom_api_definition = {}
    custom_api_definition["etag"] = resource[:etag] unless resource[:etag].nil?
    custom_api_definition["id"] = resource[:id] unless resource[:id].nil?
    custom_api_definition["location"] = resource[:location] unless resource[:location].nil?
    custom_api_definition["name"] = resource[:name] unless resource[:name].nil?
    custom_api_definition["properties"] = resource[:properties] unless resource[:properties].nil?
    custom_api_definition["tags"] = resource[:tags] unless resource[:tags].nil?
    custom_api_definition["type"] = resource[:type] unless resource[:type].nil?
    return custom_api_definition
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation CustomApis_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Web/customApis", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation CustomApis_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("apiName", "path", "api_name", "api_name"),
      self.op_param("customApi", "body", "custom_api", "custom_api"),
      self.op_param("etag", "body", "etag", "etag"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/customApis/%{api_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation CustomApis_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/customApis/%{api_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation CustomApis_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/customApis", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation CustomApis_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/customApis/%{api_name}", "Get", "[application/json]")
  end
