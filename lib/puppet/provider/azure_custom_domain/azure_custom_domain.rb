...
Puppet::Type.type(:azure_custom_domain).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("customDomainName", "path", "name"),
      self.op_param("customDomainProperties", "body", "properties"),
      self.op_param("endpointName", "path", "endpoint_name"),
      self.op_param("profileName", "path", "profile_name"),
