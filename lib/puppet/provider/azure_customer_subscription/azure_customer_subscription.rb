...
Puppet::Type.type(:azure_customer_subscription).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("customerCreationParameters", "body", "customer_creation_parameters"),
      self.op_param("customerSubscriptionName", "path", "name"),
      self.op_param("registrationName", "path", "registration_name"),
