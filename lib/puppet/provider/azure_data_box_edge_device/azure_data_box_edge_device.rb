...
Puppet::Type.type(:azure_data_box_edge_device).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          data_box_edge_device: item["DataBoxEdgeDevice"],
        ...
        self.deep_delete(hash, [:properties, "configuredRoleTypes"])
        self.deep_delete(hash, [:properties, "culture"])
        self.deep_delete(hash, [:properties, "deviceHcsVersion"])
        self.deep_delete(hash, [:properties, "deviceLocalCapacity"])
        self.deep_delete(hash, [:properties, "deviceModel"])
        self.deep_delete(hash, [:properties, "deviceSoftwareVersion"])
        self.deep_delete(hash, [:properties, "deviceType"])
        self.deep_delete(hash, [:properties, "serialNumber"])
        self.deep_delete(hash, [:properties, "timeZone"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      data_box_edge_device: instance.data_box_edge_device.respond_to?(:to_hash) ? instance.data_box_edge_device.to_hash : instance.data_box_edge_device,
      device_name: instance.device_name.respond_to?(:to_hash) ? instance.device_name.to_hash : instance.device_name,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type DataBoxEdgeDevice")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type DataBoxEdgeDevice - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    data_box_edge_device["etag"] = resource[:etag] unless resource[:etag].nil?
    data_box_edge_device["id"] = resource[:id] unless resource[:id].nil?
    data_box_edge_device["location"] = resource[:location] unless resource[:location].nil?
    data_box_edge_device["name"] = resource[:name] unless resource[:name].nil?
    data_box_edge_device["properties"] = resource[:properties] unless resource[:properties].nil?
    data_box_edge_device["sku"] = resource[:sku] unless resource[:sku].nil?
    data_box_edge_device["tags"] = resource[:tags] unless resource[:tags].nil?
    data_box_edge_device["type"] = resource[:type] unless resource[:type].nil?
    return data_box_edge_device
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Devices_ListBySubscription")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Devices_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("DataBoxEdgeDevice", "body", "data_box_edge_device", "data_box_edge_device"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/%{device_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Devices_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/%{device_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Devices_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Devices_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/%{device_name}", "Get", "[application/json]")
  end
