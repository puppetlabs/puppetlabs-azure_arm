...
Puppet::Type.type(:azure_data_lake_analytics_account).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type DataLakeAnalyticsAccount")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type DataLakeAnalyticsAccount - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    data_lake_analytics_account["id"] = resource[:id] unless resource[:id].nil?
    data_lake_analytics_account["location"] = resource[:location] unless resource[:location].nil?
    data_lake_analytics_account["name"] = resource[:name] unless resource[:name].nil?
    data_lake_analytics_account["properties"] = resource[:properties] unless resource[:properties].nil?
    data_lake_analytics_account["tags"] = resource[:tags] unless resource[:tags].nil?
    data_lake_analytics_account["type"] = resource[:type] unless resource[:type].nil?
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataLakeAnalytics/accounts/%{account_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataLakeAnalytics/accounts/%{account_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataLakeAnalytics/accounts/%{account_name}", "Get", "[application/json]")
  end
