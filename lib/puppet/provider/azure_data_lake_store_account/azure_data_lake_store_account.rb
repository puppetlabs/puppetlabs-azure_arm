...
Puppet::Type.type(:azure_data_lake_store_account).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataLakeStore/accounts/%{account_name}" % path_params
