...
Puppet::Type.type(:azure_data_manager).provide(:arm) do
  mk_resource_methods
  ...
  def self.instance_to_hash(instance)
    {
      ...
      data_manager: instance.data_manager.respond_to?(:to_hash) ? instance.data_manager.to_hash : instance.data_manager,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type DataManager")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type DataManager - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    data_manager = {}
    data_manager["etag"] = resource[:etag] unless resource[:etag].nil?
    data_manager["id"] = resource[:id] unless resource[:id].nil?
    data_manager["location"] = resource[:location] unless resource[:location].nil?
    data_manager["name"] = resource[:name] unless resource[:name].nil?
    data_manager["sku"] = resource[:sku] unless resource[:sku].nil?
    data_manager["tags"] = resource[:tags] unless resource[:tags].nil?
    data_manager["type"] = resource[:type] unless resource[:type].nil?
    return data_manager
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation DataManagers_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.HybridData/dataManagers", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DataManagers_Create")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("dataManager", "body", "data_manager", "data_manager"),
      self.op_param("dataManagerName", "path", "name", "data_manager_name"),
      self.op_param("etag", "body", "etag", "etag"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.HybridData/dataManagers/%{data_manager_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DataManagers_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.HybridData/dataManagers/%{data_manager_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DataManagers_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.HybridData/dataManagers/%{data_manager_name}", "Get", "[application/json]")
  end
