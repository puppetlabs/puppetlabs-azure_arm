...
Puppet::Type.type(:azure_database_account).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          create_update_parameters: item["createUpdateParameters"],
          id: item["id"],
          kind: item["kind"],
        ...
        self.deep_delete(hash, [:properties, "databaseAccountOfferType"])
        self.deep_delete(hash, [:properties, "documentEndpoint"])
        self.deep_delete(hash, [:properties, "failoverPolicies"])

        self.deep_delete(hash, [:properties, "readLocations"])

        self.deep_delete(hash, [:properties, "writeLocations"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      create_update_parameters: instance.create_update_parameters.respond_to?(:to_hash) ? instance.create_update_parameters.to_hash : instance.create_update_parameters,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type DatabaseAccount")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type DatabaseAccount - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    database_account = {}
    database_account["id"] = resource[:id] unless resource[:id].nil?
    database_account["kind"] = resource[:kind] unless resource[:kind].nil?
    database_account["location"] = resource[:location] unless resource[:location].nil?
    database_account["name"] = resource[:name] unless resource[:name].nil?
    database_account["properties"] = resource[:properties] unless resource[:properties].nil?
    database_account["tags"] = resource[:tags] unless resource[:tags].nil?
    database_account["type"] = resource[:type] unless resource[:type].nil?
    return database_account
  end

  def self.build_key_values
    key_values = {}
    key_values["api-version"] = "2015-04-08"
    key_values
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation DatabaseAccounts_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.DocumentDB/databaseAccounts", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DatabaseAccounts_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    op_params = [
      ...
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("createUpdateParameters", "body", "create_update_parameters", "create_update_parameters"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("kind", "body", "kind", "kind"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DatabaseAccounts_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DatabaseAccounts_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DatabaseAccounts_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}", "Get", "[application/json]")
  end
