...
Puppet::Type.type(:azure_database_account).provide(:arm) do
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "failoverPolicies", "id"])

        self.deep_delete(hash, [:properties, "readLocations", "documentEndpoint"])
        self.deep_delete(hash, [:properties, "readLocations", "id"])
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("api-version", "query", "api_version"),
      self.op_param("createUpdateParameters", "body", "create_update_parameters"),
