...
Puppet::Type.type(:azure_ddos_custom_policy).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type DdosCustomPolicy")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type DdosCustomPolicy - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ddos_custom_policy = {}
    ddos_custom_policy["etag"] = resource[:etag] unless resource[:etag].nil?
    ddos_custom_policy["id"] = resource[:id] unless resource[:id].nil?
    ddos_custom_policy["location"] = resource[:location] unless resource[:location].nil?
    ddos_custom_policy["name"] = resource[:name] unless resource[:name].nil?
    ddos_custom_policy["properties"] = resource[:properties] unless resource[:properties].nil?
    ddos_custom_policy["tags"] = resource[:tags] unless resource[:tags].nil?
    ddos_custom_policy["type"] = resource[:type] unless resource[:type].nil?
    return ddos_custom_policy
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation DdosCustomPolicies_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("ddosCustomPolicyName", "path", "name", "ddos_custom_policy_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/ddosCustomPolicies/%{ddos_custom_policy_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DdosCustomPolicies_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/ddosCustomPolicies/%{ddos_custom_policy_name}", "Delete", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DdosCustomPolicies_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/ddosCustomPolicies/%{ddos_custom_policy_name}", "Get", "[application/json]")
  end
