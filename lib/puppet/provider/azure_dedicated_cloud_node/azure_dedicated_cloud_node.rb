...
Puppet::Type.type(:azure_dedicated_cloud_node).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          dedicated_cloud_node_request: item["dedicatedCloudNodeRequest"],
          id: item["id"],
        ...
        self.deep_delete(hash, [:properties, "availabilityZoneName"])
        self.deep_delete(hash, [:properties, "cloudRackName"])
        self.deep_delete(hash, [:properties, "created"])
        self.deep_delete(hash, [:properties, "placementGroupName"])
        self.deep_delete(hash, [:properties, "privateCloudId"])
        self.deep_delete(hash, [:properties, "privateCloudName"])
        self.deep_delete(hash, [:properties, "provisioningState"])

        self.deep_delete(hash, [:properties, "status"])
        self.deep_delete(hash, [:properties, "vmwareClusterName"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      dedicated_cloud_node_request: instance.dedicated_cloud_node_request.respond_to?(:to_hash) ? instance.dedicated_cloud_node_request.to_hash : instance.dedicated_cloud_node_request,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type DedicatedCloudNode")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type DedicatedCloudNode - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    dedicated_cloud_node["id"] = resource[:id] unless resource[:id].nil?
    dedicated_cloud_node["location"] = resource[:location] unless resource[:location].nil?
    dedicated_cloud_node["name"] = resource[:name] unless resource[:name].nil?
    dedicated_cloud_node["properties"] = resource[:properties] unless resource[:properties].nil?
    dedicated_cloud_node["sku"] = resource[:sku] unless resource[:sku].nil?
    dedicated_cloud_node["tags"] = resource[:tags] unless resource[:tags].nil?
    dedicated_cloud_node["type"] = resource[:type] unless resource[:type].nil?
    return dedicated_cloud_node
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation dedicatedCloudNode_ListBySubscription")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.VMwareCloudSimple/dedicatedCloudNodes", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation dedicatedCloudNode_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("dedicatedCloudNodeName", "path", "name", "dedicated_cloud_node_name"),
      self.op_param("dedicatedCloudNodeRequest", "body", "dedicated_cloud_node_request", "dedicated_cloud_node_request"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
      self.op_param("properties", "body", "properties", "properties"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.VMwareCloudSimple/dedicatedCloudNodes/%{dedicated_cloud_node_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation dedicatedCloudNode_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.VMwareCloudSimple/dedicatedCloudNodes/%{dedicated_cloud_node_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation dedicatedCloudNode_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.VMwareCloudSimple/dedicatedCloudNodes/%{dedicated_cloud_node_name}", "Get", "[application/json]")
  end
