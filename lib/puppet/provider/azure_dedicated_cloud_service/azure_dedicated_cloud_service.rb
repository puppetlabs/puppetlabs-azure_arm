...
Puppet::Type.type(:azure_dedicated_cloud_service).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          dedicated_cloud_service_request: item["dedicatedCloudServiceRequest"],
          id: item["id"],
        ...
        self.deep_delete(hash, [:properties, "isAccountOnboarded"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      dedicated_cloud_service_request: instance.dedicated_cloud_service_request.respond_to?(:to_hash) ? instance.dedicated_cloud_service_request.to_hash : instance.dedicated_cloud_service_request,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type DedicatedCloudService")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type DedicatedCloudService - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    dedicated_cloud_service["id"] = resource[:id] unless resource[:id].nil?
    dedicated_cloud_service["location"] = resource[:location] unless resource[:location].nil?
    dedicated_cloud_service["name"] = resource[:name] unless resource[:name].nil?
    dedicated_cloud_service["properties"] = resource[:properties] unless resource[:properties].nil?
    dedicated_cloud_service["tags"] = resource[:tags] unless resource[:tags].nil?
    dedicated_cloud_service["type"] = resource[:type] unless resource[:type].nil?
    return dedicated_cloud_service
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation dedicatedCloudService_ListBySubscription")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.VMwareCloudSimple/dedicatedCloudServices", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation dedicatedCloudService_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("dedicatedCloudServiceName", "path", "name", "dedicated_cloud_service_name"),
      self.op_param("dedicatedCloudServiceRequest", "body", "dedicated_cloud_service_request", "dedicated_cloud_service_request"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
      self.op_param("properties", "body", "properties", "properties"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.VMwareCloudSimple/dedicatedCloudServices/%{dedicated_cloud_service_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation dedicatedCloudService_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.VMwareCloudSimple/dedicatedCloudServices/%{dedicated_cloud_service_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation dedicatedCloudService_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.VMwareCloudSimple/dedicatedCloudServices", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation dedicatedCloudService_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.VMwareCloudSimple/dedicatedCloudServices/%{dedicated_cloud_service_name}", "Get", "[application/json]")
  end
