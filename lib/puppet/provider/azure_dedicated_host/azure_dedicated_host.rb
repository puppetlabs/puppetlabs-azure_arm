...
Puppet::Type.type(:azure_dedicated_host).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type DedicatedHost")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type DedicatedHost - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    dedicated_host = {}
    dedicated_host["id"] = resource[:id] unless resource[:id].nil?
    dedicated_host["location"] = resource[:location] unless resource[:location].nil?
    dedicated_host["name"] = resource[:name] unless resource[:name].nil?
    dedicated_host["properties"] = resource[:properties] unless resource[:properties].nil?
    dedicated_host["sku"] = resource[:sku] unless resource[:sku].nil?
    dedicated_host["tags"] = resource[:tags] unless resource[:tags].nil?
    dedicated_host["type"] = resource[:type] unless resource[:type].nil?
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation DedicatedHosts_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("hostName", "path", "host_name", "host_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/hostGroups/%{host_group_name}/hosts/%{host_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DedicatedHosts_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/hostGroups/%{host_group_name}/hosts/%{host_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DedicatedHosts_ListByHostGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/hostGroups/%{host_group_name}/hosts", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DedicatedHosts_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/hostGroups/%{host_group_name}/hosts/%{host_name}", "Get", "[application/json]")
  end
