...
Puppet::Type.type(:azure_dedicated_host_group).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          host_group_name: item["hostGroupName"],
          id: item["id"],
        ...
        self.deep_delete(hash, [:properties, "hosts"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      host_group_name: instance.host_group_name.respond_to?(:to_hash) ? instance.host_group_name.to_hash : instance.host_group_name,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type DedicatedHostGroup")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type DedicatedHostGroup - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    dedicated_host_group["id"] = resource[:id] unless resource[:id].nil?
    dedicated_host_group["location"] = resource[:location] unless resource[:location].nil?
    dedicated_host_group["name"] = resource[:name] unless resource[:name].nil?
    dedicated_host_group["properties"] = resource[:properties] unless resource[:properties].nil?
    dedicated_host_group["tags"] = resource[:tags] unless resource[:tags].nil?
    dedicated_host_group["type"] = resource[:type] unless resource[:type].nil?
    dedicated_host_group["zones"] = resource[:zones] unless resource[:zones].nil?
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation DedicatedHostGroups_ListBySubscription")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Compute/hostGroups", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DedicatedHostGroups_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("hostGroupName", "path", "host_group_name", "host_group_name"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/hostGroups/%{host_group_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DedicatedHostGroups_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/hostGroups/%{host_group_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DedicatedHostGroups_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/hostGroups/%{host_group_name}", "Get", "[application/json]")
  end
