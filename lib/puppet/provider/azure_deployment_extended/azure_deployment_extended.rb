...
Puppet::Type.type(:azure_deployment_extended).provide(:arm) do
  mk_resource_methods
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "correlationId"])

        self.deep_delete(hash, [:properties, "onErrorDeployment", "provisioningState"])

        self.deep_delete(hash, [:properties, "providers", "id"])
        self.deep_delete(hash, [:properties, "providers", "registrationState"])

        self.deep_delete(hash, [:properties, "provisioningState"])

        self.deep_delete(hash, [:properties, "timestamp"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      deployment_name: instance.deployment_name.respond_to?(:to_hash) ? instance.deployment_name.to_hash : instance.deployment_name,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type DeploymentExtended")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type DeploymentExtended - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    deployment_extended = {}
    deployment_extended["id"] = resource[:id] unless resource[:id].nil?
    deployment_extended["location"] = resource[:location] unless resource[:location].nil?
    deployment_extended["name"] = resource[:name] unless resource[:name].nil?
    deployment_extended["properties"] = resource[:properties] unless resource[:properties].nil?
    return deployment_extended
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Deployments_ListAtSubscriptionScope")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Resources/deployments/", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Deployments_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.4"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version"),
      self.op_param("deploymentName", "path", "deployment_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/Microsoft.Resources/deployments/%{deployment_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Deployments_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.4"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/Microsoft.Resources/deployments/%{deployment_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Deployments_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.4"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/Microsoft.Resources/deployments/%{deployment_name}", "Get", "[application/json]")
  end
