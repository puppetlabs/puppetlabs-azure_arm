...
Puppet::Type.type(:azure_device_service).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          device_service: item["deviceService"],
          etag: item["etag"],
          id: item["id"],
        ...
        self.deep_delete(hash, [:properties, "startDate"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      device_service: instance.device_service.respond_to?(:to_hash) ? instance.device_service.to_hash : instance.device_service,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type DeviceService")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type DeviceService - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    device_service = {}
    device_service["etag"] = resource[:etag] unless resource[:etag].nil?
    device_service["id"] = resource[:id] unless resource[:id].nil?
    device_service["location"] = resource[:location] unless resource[:location].nil?
    device_service["name"] = resource[:name] unless resource[:name].nil?
    device_service["properties"] = resource[:properties] unless resource[:properties].nil?
    device_service["tags"] = resource[:tags] unless resource[:tags].nil?
    device_service["type"] = resource[:type] unless resource[:type].nil?
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Services_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.WindowsIoT/deviceServices", "Get", "[application/json]")
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("deviceService", "body", "device_service", "device_service"),
      self.op_param("etag", "body", "etag", "etag"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("If-Match", "header", "if_match", "if_match"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
      self.op_param("properties", "body", "properties", "properties"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.WindowsIoT/deviceServices/%{device_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.WindowsIoT/deviceServices/%{device_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.WindowsIoT/deviceServices", "Get", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.WindowsIoT/deviceServices/%{device_name}", "Get", "[application/json]")
  end
