...
Puppet::Type.type(:azure_diagnostic_settings_resource).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type DiagnosticSettingsResource")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type DiagnosticSettingsResource - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    diagnostic_settings_resource["id"] = resource[:id] unless resource[:id].nil?
    diagnostic_settings_resource["name"] = resource[:name] unless resource[:name].nil?
    diagnostic_settings_resource["properties"] = resource[:properties] unless resource[:properties].nil?
    diagnostic_settings_resource["type"] = resource[:type] unless resource[:type].nil?
    return diagnostic_settings_resource
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation DiagnosticSettings_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/providers/microsoft.aadiam/diagnosticSettings", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DiagnosticSettings_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/providers/microsoft.aadiam/diagnosticSettings/%{name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DiagnosticSettings_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/providers/microsoft.aadiam/diagnosticSettings/%{name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DiagnosticSettings_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/providers/microsoft.aadiam/diagnosticSettings/%{name}", "Get", "[application/json]")
  end
