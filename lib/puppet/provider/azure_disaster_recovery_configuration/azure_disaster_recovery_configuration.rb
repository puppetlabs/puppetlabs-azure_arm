...
Puppet::Type.type(:azure_disaster_recovery_configuration).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type DisasterRecoveryConfiguration")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type DisasterRecoveryConfiguration - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    disaster_recovery_configuration["id"] = resource[:id] unless resource[:id].nil?
    disaster_recovery_configuration["location"] = resource[:location] unless resource[:location].nil?
    disaster_recovery_configuration["name"] = resource[:name] unless resource[:name].nil?
    disaster_recovery_configuration["properties"] = resource[:properties] unless resource[:properties].nil?
    disaster_recovery_configuration["type"] = resource[:type] unless resource[:type].nil?
    return disaster_recovery_configuration
  end

  def self.build_key_values
    key_values = {}
    key_values["api-version"] = "2014-04-01"
    key_values
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation DisasterRecoveryConfigurations_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("disasterRecoveryConfigurationName", "path", "name", "disaster_recovery_configuration_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Sql/servers/%{server_name}/disasterRecoveryConfiguration/%{disaster_recovery_configuration_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DisasterRecoveryConfigurations_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Sql/servers/%{server_name}/disasterRecoveryConfiguration/%{disaster_recovery_configuration_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DisasterRecoveryConfigurations_List")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Sql/servers/%{server_name}/disasterRecoveryConfiguration", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DisasterRecoveryConfigurations_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Sql/servers/%{server_name}/disasterRecoveryConfiguration/%{disaster_recovery_configuration_name}", "Get", "[application/json]")
  end
