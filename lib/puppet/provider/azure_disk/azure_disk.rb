...
Puppet::Type.type(:azure_disk).provide(:arm) do
  mk_resource_methods
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:managed_by])

        self.deep_delete(hash, [:properties, "creationData", "sourceUniqueId"])
        self.deep_delete(hash, [:properties, "diskSizeBytes"])
        self.deep_delete(hash, [:properties, "diskState"])

        self.deep_delete(hash, [:properties, "provisioningState"])
        self.deep_delete(hash, [:properties, "timeCreated"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      disk: instance.disk.respond_to?(:to_hash) ? instance.disk.to_hash : instance.disk,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type Disk")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type Disk - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    disk = {}
    disk["id"] = resource[:id] unless resource[:id].nil?
    disk["location"] = resource[:location] unless resource[:location].nil?
    disk["managedBy"] = resource[:managed_by] unless resource[:managed_by].nil?
    disk["name"] = resource[:name] unless resource[:name].nil?
    disk["properties"] = resource[:properties] unless resource[:properties].nil?
    disk["sku"] = resource[:sku] unless resource[:sku].nil?
    disk["tags"] = resource[:tags] unless resource[:tags].nil?
    disk["type"] = resource[:type] unless resource[:type].nil?
    disk["zones"] = resource[:zones] unless resource[:zones].nil?
    return disk
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Disks_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Compute/disks", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Disks_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("disk", "body", "disk", "disk"),
      self.op_param("diskName", "path", "name", "disk_name"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("managedby", "body", "managed_by", "managedby"),
      self.op_param("name", "body", "name", "name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/disks/%{disk_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Disks_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/disks/%{disk_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Disks_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/disks", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Disks_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/disks/%{disk_name}", "Get", "[application/json]")
  end
