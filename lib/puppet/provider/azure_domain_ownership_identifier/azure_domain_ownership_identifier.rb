...
Puppet::Type.type(:azure_domain_ownership_identifier).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:domain_name] = resource[:domain_name] unless resource.nil? or resource[:domain_name].nil?
    path_params[:domain_ownership_identifier] = key_values["domainOwnershipIdentifier"] unless key_values["domainOwnershipIdentifier"].nil?
    path_params[:domain_ownership_identifier] = ENV["azure_domain_ownership_identifier"] unless ENV["azure_domain_ownership_identifier"].nil?
    path_params[:domain_ownership_identifier] = resource[:domain_ownership_identifier] unless resource.nil? or resource[:domain_ownership_identifier].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DomainRegistration/domains/%{domain_name}/domainOwnershipIdentifiers/%{name}" % path_params
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DomainRegistration/domains/%{domain_name}/domainOwnershipIdentifiers" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
