...
Puppet::Type.type(:azure_domain_ownership_identifier).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type DomainOwnershipIdentifier")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type DomainOwnershipIdentifier - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    domain_ownership_identifier["id"] = resource[:id] unless resource[:id].nil?
    domain_ownership_identifier["kind"] = resource[:kind] unless resource[:kind].nil?
    domain_ownership_identifier["name"] = resource[:name] unless resource[:name].nil?
    domain_ownership_identifier["properties"] = resource[:properties] unless resource[:properties].nil?
    domain_ownership_identifier["type"] = resource[:type] unless resource[:type].nil?
    return domain_ownership_identifier
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Domains_CreateOrUpdateOwnershipIdentifier")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("domainName", "path", "domain_name", "domain_name"),
      self.op_param("domainOwnershipIdentifier", "body", "domain_ownership_identifier", "domain_ownership_identifier"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DomainRegistration/domains/%{domain_name}/domainOwnershipIdentifiers/%{name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Domains_DeleteOwnershipIdentifier")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DomainRegistration/domains/%{domain_name}/domainOwnershipIdentifiers/%{name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Domains_ListOwnershipIdentifiers")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DomainRegistration/domains/%{domain_name}/domainOwnershipIdentifiers", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Domains_GetOwnershipIdentifier")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DomainRegistration/domains/%{domain_name}/domainOwnershipIdentifiers/%{name}", "Get", "[application/json]")
  end
