...
Puppet::Type.type(:azure_domain_service).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          domain_service: item["domainService"],
          etag: item["etag"],
          id: item["id"],
        ...
        self.deep_delete(hash, [:properties, "domainControllerIpAddress"])

        self.deep_delete(hash, [:properties, "healthAlerts", "id"])
        self.deep_delete(hash, [:properties, "healthAlerts", "issue"])
        self.deep_delete(hash, [:properties, "healthAlerts", "lastDetected"])
        self.deep_delete(hash, [:properties, "healthAlerts", "name"])
        self.deep_delete(hash, [:properties, "healthAlerts", "raised"])
        self.deep_delete(hash, [:properties, "healthAlerts", "resolutionUri"])
        self.deep_delete(hash, [:properties, "healthAlerts", "severity"])
        self.deep_delete(hash, [:properties, "healthLastEvaluated"])

        self.deep_delete(hash, [:properties, "healthMonitors", "details"])
        self.deep_delete(hash, [:properties, "healthMonitors", "id"])
        self.deep_delete(hash, [:properties, "healthMonitors", "name"])

        self.deep_delete(hash, [:properties, "ldapsSettings", "certificateNotAfter"])
        self.deep_delete(hash, [:properties, "ldapsSettings", "certificateThumbprint"])
        self.deep_delete(hash, [:properties, "ldapsSettings", "externalAccessIpAddress"])
        self.deep_delete(hash, [:properties, "ldapsSettings", "publicCertificate"])

        self.deep_delete(hash, [:properties, "provisioningState"])
        self.deep_delete(hash, [:properties, "serviceStatus"])
        self.deep_delete(hash, [:properties, "tenantId"])
        self.deep_delete(hash, [:properties, "vnetSiteId"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      domain_service: instance.domain_service.respond_to?(:to_hash) ? instance.domain_service.to_hash : instance.domain_service,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type DomainService")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type DomainService - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    domain_service = {}
    domain_service["etag"] = resource[:etag] unless resource[:etag].nil?
    domain_service["id"] = resource[:id] unless resource[:id].nil?
    domain_service["location"] = resource[:location] unless resource[:location].nil?
    domain_service["name"] = resource[:name] unless resource[:name].nil?
    domain_service["properties"] = resource[:properties] unless resource[:properties].nil?
    domain_service["tags"] = resource[:tags] unless resource[:tags].nil?
    domain_service["type"] = resource[:type] unless resource[:type].nil?
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation DomainServices_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.AAD/domainServices", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DomainServices_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("domainService", "body", "domain_service", "domain_service"),
      self.op_param("domainServiceName", "path", "name", "domain_service_name"),
      self.op_param("etag", "body", "etag", "etag"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.AAD/domainServices/%{domain_service_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DomainServices_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.AAD/domainServices/%{domain_service_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DomainServices_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.AAD/domainServices/%{domain_service_name}", "Get", "[application/json]")
  end
