...
Puppet::Type.type(:azure_dsc_node_configuration).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("automationAccountName", "path", "automation_account_name"),
      self.op_param("nodeConfigurationName", "path", "node_configuration_name"),
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("$inlinecount", "query", "$inlinecount"),
