...
Puppet::Type.type(:azure_dsc_node_configuration).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type DscNodeConfiguration")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type DscNodeConfiguration - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    dsc_node_configuration["id"] = resource[:id] unless resource[:id].nil?
    dsc_node_configuration["name"] = resource[:name] unless resource[:name].nil?
    dsc_node_configuration["properties"] = resource[:properties] unless resource[:properties].nil?
    dsc_node_configuration["type"] = resource[:type] unless resource[:type].nil?
    return dsc_node_configuration
  end

  def self.build_key_values
    key_values = {}
    key_values["api-version"] = "2018-01-15"
    key_values
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation DscNodeConfiguration_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("automationAccountName", "path", "automation_account_name", "automation_account_name"),
      self.op_param("nodeConfigurationName", "path", "node_configuration_name", "node_configuration_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Automation/automationAccounts/%{automation_account_name}/nodeConfigurations/%{node_configuration_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DscNodeConfiguration_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Automation/automationAccounts/%{automation_account_name}/nodeConfigurations/%{node_configuration_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DscNodeConfiguration_ListByAutomationAccount")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    op_params = [
      ...
      self.op_param("$inlinecount", "query", "$inlinecount", "$inlinecount"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Automation/automationAccounts/%{automation_account_name}/nodeConfigurations", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DscNodeConfiguration_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Automation/automationAccounts/%{automation_account_name}/nodeConfigurations/%{node_configuration_name}", "Get", "[application/json]")
  end
