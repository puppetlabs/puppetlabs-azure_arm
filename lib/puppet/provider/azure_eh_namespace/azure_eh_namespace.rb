...
Puppet::Type.type(:azure_eh_namespace).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type EHNamespace")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type EHNamespace - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    eh_namespace = {}
    eh_namespace["id"] = resource[:id] unless resource[:id].nil?
    eh_namespace["location"] = resource[:location] unless resource[:location].nil?
    eh_namespace["name"] = resource[:name] unless resource[:name].nil?
    eh_namespace["properties"] = resource[:properties] unless resource[:properties].nil?
    eh_namespace["sku"] = resource[:sku] unless resource[:sku].nil?
    eh_namespace["tags"] = resource[:tags] unless resource[:tags].nil?
    eh_namespace["type"] = resource[:type] unless resource[:type].nil?
    return eh_namespace
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.EventHub/namespaces", "Get", "[application/json]")
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.EventHub/namespaces/%{namespace_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.EventHub/namespaces/%{namespace_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.EventHub/namespaces", "Get", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.EventHub/namespaces/%{namespace_name}", "Get", "[application/json]")
  end
