...
Puppet::Type.type(:azure_environment).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type Environment")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type Environment - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    environment = {}
    environment["id"] = resource[:id] unless resource[:id].nil?
    environment["location"] = resource[:location] unless resource[:location].nil?
    environment["name"] = resource[:name] unless resource[:name].nil?
    environment["properties"] = resource[:properties] unless resource[:properties].nil?
    environment["tags"] = resource[:tags] unless resource[:tags].nil?
    environment["type"] = resource[:type] unless resource[:type].nil?
    return environment
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("environment", "body", "environment", "environment"),
      self.op_param("environmentName", "path", "name", "environment_name"),
      self.op_param("environmentSettingName", "path", "environment_setting_name", "environment_setting_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.LabServices/labaccounts/%{lab_account_name}/labs/%{lab_name}/environmentsettings/%{environment_setting_name}/environments/%{environment_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.LabServices/labaccounts/%{lab_account_name}/labs/%{lab_name}/environmentsettings/%{environment_setting_name}/environments/%{environment_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.LabServices/labaccounts/%{lab_account_name}/labs/%{lab_name}/environmentsettings/%{environment_setting_name}/environments/%{environment_name}", "Get", "[application/json]")
  end
