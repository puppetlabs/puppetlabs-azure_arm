...
Puppet::Type.type(:azure_environment_resource).provide(:arm) do
  mk_resource_methods
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "dataAccessFqdn"])
        self.deep_delete(hash, [:properties, "dataAccessId"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      environment_name: instance.environment_name.respond_to?(:to_hash) ? instance.environment_name.to_hash : instance.environment_name,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type EnvironmentResource")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type EnvironmentResource - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    environment_resource["id"] = resource[:id] unless resource[:id].nil?
    environment_resource["location"] = resource[:location] unless resource[:location].nil?
    environment_resource["name"] = resource[:name] unless resource[:name].nil?
    environment_resource["properties"] = resource[:properties] unless resource[:properties].nil?
    environment_resource["sku"] = resource[:sku] unless resource[:sku].nil?
    environment_resource["tags"] = resource[:tags] unless resource[:tags].nil?
    environment_resource["type"] = resource[:type] unless resource[:type].nil?
    return environment_resource
  end

  def self.build_key_values
    key_values = {}
    key_values["api-version"] = "2017-11-15"
    key_values
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Environments_ListBySubscription")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.TimeSeriesInsights/environments", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Environments_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("environmentName", "path", "environment_name", "environment_name"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.TimeSeriesInsights/environments/%{environment_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Environments_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.TimeSeriesInsights/environments/%{environment_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Environments_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.TimeSeriesInsights/environments", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Environments_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    op_params = [
      self.op_param("$expand", "query", "$expand", "$expand"),
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("environmentName", "path", "environment_name", "environment_name"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("location", "body", "location", "location"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.TimeSeriesInsights/environments/%{environment_name}", "Get", "[application/json]")
  end
