...
Puppet::Type.type(:azure_environment_setting).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type EnvironmentSetting")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type EnvironmentSetting - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    environment_setting = {}
    environment_setting["id"] = resource[:id] unless resource[:id].nil?
    environment_setting["location"] = resource[:location] unless resource[:location].nil?
    environment_setting["name"] = resource[:name] unless resource[:name].nil?
    environment_setting["properties"] = resource[:properties] unless resource[:properties].nil?
    environment_setting["tags"] = resource[:tags] unless resource[:tags].nil?
    environment_setting["type"] = resource[:type] unless resource[:type].nil?
    return environment_setting
  end

  def self.build_key_values
    key_values = {}
    key_values["api-version"] = "2018-10-15"
    key_values
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation EnvironmentSettings_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("environmentSetting", "body", "environment_setting", "environment_setting"),
      self.op_param("environmentSettingName", "path", "name", "environment_setting_name"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("labAccountName", "path", "lab_account_name", "lab_account_name"),
      self.op_param("labName", "path", "lab_name", "lab_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.LabServices/labaccounts/%{lab_account_name}/labs/%{lab_name}/environmentsettings/%{environment_setting_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation EnvironmentSettings_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.LabServices/labaccounts/%{lab_account_name}/labs/%{lab_name}/environmentsettings/%{environment_setting_name}", "Delete", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation EnvironmentSettings_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.LabServices/labaccounts/%{lab_account_name}/labs/%{lab_name}/environmentsettings/%{environment_setting_name}", "Get", "[application/json]")
  end
