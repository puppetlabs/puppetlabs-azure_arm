...
Puppet::Type.type(:azure_event_hub_consumer_group_info).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type EventHubConsumerGroupInfo")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type EventHubConsumerGroupInfo - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    event_hub_consumer_group_info = {}
    event_hub_consumer_group_info["etag"] = resource[:etag] unless resource[:etag].nil?
    event_hub_consumer_group_info["id"] = resource[:id] unless resource[:id].nil?
    event_hub_consumer_group_info["name"] = resource[:name] unless resource[:name].nil?
    event_hub_consumer_group_info["properties"] = resource[:properties] unless resource[:properties].nil?
    event_hub_consumer_group_info["type"] = resource[:type] unless resource[:type].nil?
    return event_hub_consumer_group_info
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation IotHubResource_CreateEventHubConsumerGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("eventHubEndpointName", "path", "event_hub_endpoint_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Devices/IotHubs/%{resource_name}/eventHubEndpoints/%{event_hub_endpoint_name}/ConsumerGroups/%{name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation IotHubResource_DeleteEventHubConsumerGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Devices/IotHubs/%{resource_name}/eventHubEndpoints/%{event_hub_endpoint_name}/ConsumerGroups/%{name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation IotHubResource_ListEventHubConsumerGroups")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Devices/IotHubs/%{resource_name}/eventHubEndpoints/%{event_hub_endpoint_name}/ConsumerGroups", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation IotHubResource_GetEventHubConsumerGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Devices/IotHubs/%{resource_name}/eventHubEndpoints/%{event_hub_endpoint_name}/ConsumerGroups/%{name}", "Get", "[application/json]")
  end
