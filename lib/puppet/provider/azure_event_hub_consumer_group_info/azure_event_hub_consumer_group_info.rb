...
Puppet::Type.type(:azure_event_hub_consumer_group_info).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:event_hub_endpoint_name] = key_values["eventHubEndpointName"] unless key_values["eventHubEndpointName"].nil?
    path_params[:event_hub_endpoint_name] = ENV["azure_event_hub_endpoint_name"] unless ENV["azure_event_hub_endpoint_name"].nil?
    path_params[:event_hub_endpoint_name] = resource[:event_hub_endpoint_name] unless resource.nil? or resource[:event_hub_endpoint_name].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Devices/IotHubs/%{resource_name}/eventHubEndpoints/%{event_hub_endpoint_name}/ConsumerGroups/%{name}" % path_params
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Devices/IotHubs/%{resource_name}/eventHubEndpoints/%{event_hub_endpoint_name}/ConsumerGroups" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
