...
Puppet::Type.type(:azure_express_route_circuit).provide(:arm) do
  mk_resource_methods
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "authorizations", "etag"])

        self.deep_delete(hash, [:properties, "peerings", "etag"])

        self.deep_delete(hash, [:properties, "peerings", "properties", "connections", "etag"])

        self.deep_delete(hash, [:properties, "peerings", "properties", "connections", "properties", "circuitConnectionStatus"])
        self.deep_delete(hash, [:properties, "peerings", "properties", "connections", "properties", "provisioningState"])

        self.deep_delete(hash, [:properties, "peerings", "properties", "expressRouteConnection", "id"])

        self.deep_delete(hash, [:properties, "peerings", "properties", "ipv6PeeringConfig", "routeFilter", "etag"])
        self.deep_delete(hash, [:properties, "peerings", "properties", "ipv6PeeringConfig", "routeFilter", "name"])

        self.deep_delete(hash, [:properties, "peerings", "properties", "ipv6PeeringConfig", "routeFilter", "properties", "provisioningState"])

        self.deep_delete(hash, [:properties, "peerings", "properties", "ipv6PeeringConfig", "routeFilter", "properties", "rules", "etag"])

        self.deep_delete(hash, [:properties, "peerings", "properties", "ipv6PeeringConfig", "routeFilter", "properties", "rules", "properties", "provisioningState"])
        self.deep_delete(hash, [:properties, "peerings", "properties", "ipv6PeeringConfig", "routeFilter", "type"])

        self.deep_delete(hash, [:properties, "stag"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      circuit_name: instance.circuit_name.respond_to?(:to_hash) ? instance.circuit_name.to_hash : instance.circuit_name,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type ExpressRouteCircuit")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type ExpressRouteCircuit - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    express_route_circuit["etag"] = resource[:etag] unless resource[:etag].nil?
    express_route_circuit["id"] = resource[:id] unless resource[:id].nil?
    express_route_circuit["location"] = resource[:location] unless resource[:location].nil?
    express_route_circuit["name"] = resource[:name] unless resource[:name].nil?
    express_route_circuit["properties"] = resource[:properties] unless resource[:properties].nil?
    express_route_circuit["sku"] = resource[:sku] unless resource[:sku].nil?
    express_route_circuit["tags"] = resource[:tags] unless resource[:tags].nil?
    express_route_circuit["type"] = resource[:type] unless resource[:type].nil?
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation ExpressRouteCircuits_ListAll")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Network/expressRouteCircuits", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ExpressRouteCircuits_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("circuitName", "path", "circuit_name", "circuit_name"),
      self.op_param("etag", "body", "etag", "etag"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/expressRouteCircuits/%{circuit_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ExpressRouteCircuits_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/expressRouteCircuits/%{circuit_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ExpressRouteCircuits_List")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/expressRouteCircuits", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ExpressRouteCircuits_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/expressRouteCircuits/%{circuit_name}", "Get", "[application/json]")
  end
