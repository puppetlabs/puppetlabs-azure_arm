  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "authorizations", "type"])
        ...
        self.deep_delete(hash, [:properties, "peerings", "properties", "connections", "type"])

        self.deep_delete(hash, [:properties, "peerings", "properties", "expressRouteConnection", "id"])

        self.deep_delete(hash, [:properties, "peerings", "properties", "peeredConnections"])

        self.deep_delete(hash, [:properties, "peerings", "type"])
