...
Puppet::Type.type(:azure_express_route_circuit_authorization).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:authorization_name] = key_values["authorizationName"] unless key_values["authorizationName"].nil?
    path_params[:authorization_name] = ENV["azure_authorization_name"] unless ENV["azure_authorization_name"].nil?
    path_params[:authorization_name] = resource[:authorization_name] unless resource.nil? or resource[:authorization_name].nil?
    path_params[:authorization_parameters] = key_values["authorizationParameters"] unless key_values["authorizationParameters"].nil?
    path_params[:authorization_parameters] = ENV["azure_authorization_parameters"] unless ENV["azure_authorization_parameters"].nil?
    path_params[:authorization_parameters] = resource[:authorization_parameters] unless resource.nil? or resource[:authorization_parameters].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/expressRouteCircuits/%{circuit_name}/authorizations/%{authorization_name}" % path_params
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/expressRouteCircuits/%{circuit_name}/authorizations" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json text/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
