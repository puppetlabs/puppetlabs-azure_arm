...
Puppet::Type.type(:azure_express_route_circuit_authorization).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type ExpressRouteCircuitAuthorization")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type ExpressRouteCircuitAuthorization - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    express_route_circuit_authorization["etag"] = resource[:etag] unless resource[:etag].nil?
    express_route_circuit_authorization["id"] = resource[:id] unless resource[:id].nil?
    express_route_circuit_authorization["name"] = resource[:name] unless resource[:name].nil?
    express_route_circuit_authorization["properties"] = resource[:properties] unless resource[:properties].nil?
    express_route_circuit_authorization["type"] = resource[:type] unless resource[:type].nil?
    return express_route_circuit_authorization
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation ExpressRouteCircuitAuthorizations_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("authorizationName", "path", "authorization_name", "authorization_name"),
      self.op_param("authorizationParameters", "body", "authorization_parameters", "authorization_parameters"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/expressRouteCircuits/%{circuit_name}/authorizations/%{authorization_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ExpressRouteCircuitAuthorizations_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/expressRouteCircuits/%{circuit_name}/authorizations/%{authorization_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ExpressRouteCircuitAuthorizations_List")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/expressRouteCircuits/%{circuit_name}/authorizations", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ExpressRouteCircuitAuthorizations_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/expressRouteCircuits/%{circuit_name}/authorizations/%{authorization_name}", "Get", "[application/json]")
  end
