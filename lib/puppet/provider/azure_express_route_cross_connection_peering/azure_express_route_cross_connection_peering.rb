...
Puppet::Type.type(:azure_express_route_cross_connection_peering).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:cross_connection_name] = key_values["crossConnectionName"] unless key_values["crossConnectionName"].nil?
    path_params[:cross_connection_name] = ENV["azure_cross_connection_name"] unless ENV["azure_cross_connection_name"].nil?
    path_params[:cross_connection_name] = resource[:cross_connection_name] unless resource.nil? or resource[:cross_connection_name].nil?
    ...
    path_params[:peering_parameters] = key_values["peeringParameters"] unless key_values["peeringParameters"].nil?
    path_params[:peering_parameters] = ENV["azure_peering_parameters"] unless ENV["azure_peering_parameters"].nil?
    path_params[:peering_parameters] = resource[:peering_parameters] unless resource.nil? or resource[:peering_parameters].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/expressRouteCrossConnections/%{cross_connection_name}/peerings/%{peering_name}" % path_params
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/expressRouteCrossConnections/%{cross_connection_name}/peerings" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json text/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
