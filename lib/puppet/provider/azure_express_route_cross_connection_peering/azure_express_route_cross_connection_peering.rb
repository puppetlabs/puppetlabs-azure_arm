...
Puppet::Type.type(:azure_express_route_cross_connection_peering).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("crossConnectionName", "path", "cross_connection_name"),
      self.op_param("peeringName", "path", "peering_name"),
      self.op_param("peeringParameters", "body", "peering_parameters"),
