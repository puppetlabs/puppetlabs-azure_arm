...
Puppet::Type.type(:azure_express_route_gateway).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          put_express_route_gateway_parameters: item["putExpressRouteGatewayParameters"],
        ...
        self.deep_delete(hash, [:properties, "expressRouteConnections", "properties", "provisioningState"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      put_express_route_gateway_parameters: instance.put_express_route_gateway_parameters.respond_to?(:to_hash) ? instance.put_express_route_gateway_parameters.to_hash : instance.put_express_route_gateway_parameters,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type ExpressRouteGateway")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type ExpressRouteGateway - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    express_route_gateway["etag"] = resource[:etag] unless resource[:etag].nil?
    express_route_gateway["id"] = resource[:id] unless resource[:id].nil?
    express_route_gateway["location"] = resource[:location] unless resource[:location].nil?
    express_route_gateway["name"] = resource[:name] unless resource[:name].nil?
    express_route_gateway["properties"] = resource[:properties] unless resource[:properties].nil?
    express_route_gateway["tags"] = resource[:tags] unless resource[:tags].nil?
    express_route_gateway["type"] = resource[:type] unless resource[:type].nil?
    return express_route_gateway
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation ExpressRouteGateways_ListBySubscription")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Network/expressRouteGateways", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ExpressRouteGateways_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("etag", "body", "etag", "etag"),
      self.op_param("expressRouteGatewayName", "path", "name", "express_route_gateway_name"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
      self.op_param("properties", "body", "properties", "properties"),
      self.op_param("putExpressRouteGatewayParameters", "body", "put_express_route_gateway_parameters", "put_express_route_gateway_parameters"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/expressRouteGateways/%{express_route_gateway_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ExpressRouteGateways_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/expressRouteGateways/%{express_route_gateway_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ExpressRouteGateways_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/expressRouteGateways/%{express_route_gateway_name}", "Get", "[application/json]")
  end
