...
Puppet::Type.type(:azure_express_route_port).provide(:arm) do
  mk_resource_methods
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "allocationDate"])
        self.deep_delete(hash, [:properties, "circuits"])
        self.deep_delete(hash, [:properties, "etherType"])

        self.deep_delete(hash, [:properties, "links", "etag"])

        self.deep_delete(hash, [:properties, "links", "properties", "connectorType"])
        self.deep_delete(hash, [:properties, "links", "properties", "interfaceName"])
        self.deep_delete(hash, [:properties, "links", "properties", "patchPanelId"])
        self.deep_delete(hash, [:properties, "links", "properties", "provisioningState"])
        self.deep_delete(hash, [:properties, "links", "properties", "rackId"])
        self.deep_delete(hash, [:properties, "links", "properties", "routerName"])
        self.deep_delete(hash, [:properties, "mtu"])
        self.deep_delete(hash, [:properties, "provisionedBandwidthInGbps"])
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type ExpressRoutePort")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type ExpressRoutePort - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    express_route_port = {}
    express_route_port["etag"] = resource[:etag] unless resource[:etag].nil?
    express_route_port["id"] = resource[:id] unless resource[:id].nil?
    express_route_port["location"] = resource[:location] unless resource[:location].nil?
    express_route_port["name"] = resource[:name] unless resource[:name].nil?
    express_route_port["properties"] = resource[:properties] unless resource[:properties].nil?
    express_route_port["tags"] = resource[:tags] unless resource[:tags].nil?
    express_route_port["type"] = resource[:type] unless resource[:type].nil?
    return express_route_port
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation ExpressRoutePorts_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Network/ExpressRoutePorts", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ExpressRoutePorts_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("etag", "body", "etag", "etag"),
      self.op_param("expressRoutePortName", "path", "name", "express_route_port_name"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/ExpressRoutePorts/%{express_route_port_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ExpressRoutePorts_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/ExpressRoutePorts/%{express_route_port_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ExpressRoutePorts_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/ExpressRoutePorts", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ExpressRoutePorts_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/ExpressRoutePorts/%{express_route_port_name}", "Get", "[application/json]")
  end
