...
Puppet::Type.type(:azure_factory).provide(:arm) do
  mk_resource_methods
  ...
  def self.instance_to_hash(instance)
    {
      ...
      factory: instance.factory.respond_to?(:to_hash) ? instance.factory.to_hash : instance.factory,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type Factory")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type Factory - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    factory = {}
    factory["eTag"] = resource[:e_tag] unless resource[:e_tag].nil?
    factory["id"] = resource[:id] unless resource[:id].nil?
    factory["identity"] = resource[:identity] unless resource[:identity].nil?
    factory["location"] = resource[:location] unless resource[:location].nil?
    factory["name"] = resource[:name] unless resource[:name].nil?
    factory["properties"] = resource[:properties] unless resource[:properties].nil?
    factory["tags"] = resource[:tags] unless resource[:tags].nil?
    factory["type"] = resource[:type] unless resource[:type].nil?
    return factory
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Factories_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.DataFactory/factories", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Factories_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("etag", "body", "e_tag", "etag"),
      self.op_param("factory", "body", "factory", "factory"),
      self.op_param("factoryName", "path", "name", "factory_name"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("identity", "body", "identity", "identity"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Factories_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Factories_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Factories_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}", "Get", "[application/json]")
  end
