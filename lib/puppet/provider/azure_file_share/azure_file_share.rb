...
Puppet::Type.type(:azure_file_share).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type FileShare")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type FileShare - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    file_share = {}
    file_share["etag"] = resource[:etag] unless resource[:etag].nil?
    file_share["id"] = resource[:id] unless resource[:id].nil?
    file_share["name"] = resource[:name] unless resource[:name].nil?
    file_share["properties"] = resource[:properties] unless resource[:properties].nil?
    file_share["type"] = resource[:type] unless resource[:type].nil?
    return file_share
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation FileShares_Create")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("fileShare", "body", "file_share", "file_share"),
      ...
      self.op_param("shareName", "path", "share_name", "share_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Storage/storageAccounts/%{account_name}/fileServices/default/shares/%{share_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation FileShares_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Storage/storageAccounts/%{account_name}/fileServices/default/shares/%{share_name}", "Delete", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation FileShares_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Storage/storageAccounts/%{account_name}/fileServices/default/shares/%{share_name}", "Get", "[application/json]")
  end
