...
Puppet::Type.type(:azure_firewall_policy_rule_group).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type FirewallPolicyRuleGroup")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type FirewallPolicyRuleGroup - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    firewall_policy_rule_group["etag"] = resource[:etag] unless resource[:etag].nil?
    firewall_policy_rule_group["id"] = resource[:id] unless resource[:id].nil?
    firewall_policy_rule_group["name"] = resource[:name] unless resource[:name].nil?
    firewall_policy_rule_group["properties"] = resource[:properties] unless resource[:properties].nil?
    firewall_policy_rule_group["type"] = resource[:type] unless resource[:type].nil?
    return firewall_policy_rule_group
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation FirewallPolicyRuleGroups_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("firewallPolicyName", "path", "firewall_policy_name", "firewall_policy_name"),
      ...
      self.op_param("ruleGroupName", "path", "rule_group_name", "rule_group_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/firewallPolicies/%{firewall_policy_name}/ruleGroups/%{rule_group_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation FirewallPolicyRuleGroups_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/firewallPolicies/%{firewall_policy_name}/ruleGroups/%{rule_group_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation FirewallPolicyRuleGroups_List")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/firewallPolicies/%{firewall_policy_name}/ruleGroups", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation FirewallPolicyRuleGroups_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/firewallPolicies/%{firewall_policy_name}/ruleGroups/%{rule_group_name}", "Get", "[application/json]")
  end
