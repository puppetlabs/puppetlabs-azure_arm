...
Puppet::Type.type(:azure_front_door).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          front_door_parameters: item["frontDoorParameters"],
          id: item["id"],
        ...
        self.deep_delete(hash, [:properties, "cname"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      front_door_parameters: instance.front_door_parameters.respond_to?(:to_hash) ? instance.front_door_parameters.to_hash : instance.front_door_parameters,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type FrontDoor")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type FrontDoor - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    front_door = {}
    front_door["id"] = resource[:id] unless resource[:id].nil?
    front_door["location"] = resource[:location] unless resource[:location].nil?
    front_door["name"] = resource[:name] unless resource[:name].nil?
    front_door["properties"] = resource[:properties] unless resource[:properties].nil?
    front_door["tags"] = resource[:tags] unless resource[:tags].nil?
    front_door["type"] = resource[:type] unless resource[:type].nil?
    return front_door
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation FrontDoors_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Network/frontDoors", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation FrontDoors_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("frontDoorName", "path", "name", "front_door_name"),
      self.op_param("frontDoorParameters", "body", "front_door_parameters", "front_door_parameters"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
      self.op_param("properties", "body", "properties", "properties"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/frontDoors/%{front_door_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation FrontDoors_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/frontDoors/%{front_door_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation FrontDoors_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/frontDoors", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation FrontDoors_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/frontDoors/%{front_door_name}", "Get", "[application/json]")
  end
