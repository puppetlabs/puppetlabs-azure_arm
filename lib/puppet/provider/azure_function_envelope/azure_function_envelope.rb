...
Puppet::Type.type(:azure_function_envelope).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type FunctionEnvelope")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type FunctionEnvelope - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    function_envelope = {}
    function_envelope["id"] = resource[:id] unless resource[:id].nil?
    function_envelope["kind"] = resource[:kind] unless resource[:kind].nil?
    function_envelope["name"] = resource[:name] unless resource[:name].nil?
    function_envelope["properties"] = resource[:properties] unless resource[:properties].nil?
    function_envelope["type"] = resource[:type] unless resource[:type].nil?
    return function_envelope
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation WebApps_CreateInstanceFunctionSlot")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("function_envelope", "body", "function_envelope"),
      self.op_param("functionName", "path", "function_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/functions/%{function_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation WebApps_DeleteInstanceFunctionSlot")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/functions/%{function_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation WebApps_ListInstanceFunctionsSlot")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/functions", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation WebApps_GetInstanceFunctionSlot")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/functions/%{function_name}", "Get", "[application/json]")
  end
