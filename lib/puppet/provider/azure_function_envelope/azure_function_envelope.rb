...
Puppet::Type.type(:azure_function_envelope).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:function_envelope] = key_values["function_envelope"] unless key_values["function_envelope"].nil?
    path_params[:function_envelope] = ENV["azure_function_envelope"] unless ENV["azure_function_envelope"].nil?
    path_params[:function_envelope] = resource[:function_envelope] unless resource.nil? or resource[:function_envelope].nil?
    path_params[:function_name] = key_values["functionName"] unless key_values["functionName"].nil?
    path_params[:function_name] = ENV["azure_function_name"] unless ENV["azure_function_name"].nil?
    path_params[:function_name] = resource[:function_name] unless resource.nil? or resource[:function_name].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/functions/%{function_name}" % path_params
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/functions" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
