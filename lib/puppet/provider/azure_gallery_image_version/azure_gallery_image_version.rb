...
Puppet::Type.type(:azure_gallery_image_version).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("galleryImageName", "path", "gallery_image_name"),
      self.op_param("galleryImageVersion", "body", "gallery_image_version"),
      self.op_param("galleryImageVersionName", "path", "name"),
      self.op_param("galleryName", "path", "gallery_name"),
