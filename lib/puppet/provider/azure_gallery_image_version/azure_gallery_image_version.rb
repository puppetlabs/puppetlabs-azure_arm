...
Puppet::Type.type(:azure_gallery_image_version).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type GalleryImageVersion")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type GalleryImageVersion - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    gallery_image_version["id"] = resource[:id] unless resource[:id].nil?
    gallery_image_version["location"] = resource[:location] unless resource[:location].nil?
    gallery_image_version["name"] = resource[:name] unless resource[:name].nil?
    gallery_image_version["properties"] = resource[:properties] unless resource[:properties].nil?
    gallery_image_version["tags"] = resource[:tags] unless resource[:tags].nil?
    gallery_image_version["type"] = resource[:type] unless resource[:type].nil?
    return gallery_image_version
  end

  def self.build_key_values
    key_values = {}
    key_values["api-version"] = "2019-07-01"
    key_values
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation GalleryImageVersions_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("galleryImageName", "path", "gallery_image_name", "gallery_image_name"),
      self.op_param("galleryImageVersion", "body", "gallery_image_version", "gallery_image_version"),
      self.op_param("galleryImageVersionName", "path", "name", "gallery_image_version_name"),
      self.op_param("galleryName", "path", "gallery_name", "gallery_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/galleries/%{gallery_name}/images/%{gallery_image_name}/versions/%{gallery_image_version_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation GalleryImageVersions_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/galleries/%{gallery_name}/images/%{gallery_image_name}/versions/%{gallery_image_version_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation GalleryImageVersions_ListByGalleryImage")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/galleries/%{gallery_name}/images/%{gallery_image_name}/versions", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation GalleryImageVersions_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/galleries/%{gallery_name}/images/%{gallery_image_name}/versions/%{gallery_image_version_name}", "Get", "[application/json]")
  end
