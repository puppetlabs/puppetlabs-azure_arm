...
Puppet::Type.type(:azure_gremlin_database).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type GremlinDatabase")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type GremlinDatabase - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    gremlin_database = {}
    gremlin_database["id"] = resource[:id] unless resource[:id].nil?
    gremlin_database["location"] = resource[:location] unless resource[:location].nil?
    gremlin_database["name"] = resource[:name] unless resource[:name].nil?
    gremlin_database["properties"] = resource[:properties] unless resource[:properties].nil?
    gremlin_database["tags"] = resource[:tags] unless resource[:tags].nil?
    gremlin_database["type"] = resource[:type] unless resource[:type].nil?
    return gremlin_database
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation DatabaseAccounts_CreateUpdateGremlinDatabase")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("createUpdateGremlinDatabaseParameters", "body", "create_update_gremlin_database_parameters", "create_update_gremlin_database_parameters"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/apis/gremlin/databases/%{database_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DatabaseAccounts_DeleteGremlinDatabase")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/apis/gremlin/databases/%{database_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DatabaseAccounts_ListGremlinDatabases")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/apis/gremlin/databases", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DatabaseAccounts_GetGremlinDatabase")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/apis/gremlin/databases/%{database_name}", "Get", "[application/json]")
  end
