...
Puppet::Type.type(:azure_gremlin_graph).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type GremlinGraph")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type GremlinGraph - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    gremlin_graph = {}
    gremlin_graph["id"] = resource[:id] unless resource[:id].nil?
    gremlin_graph["location"] = resource[:location] unless resource[:location].nil?
    gremlin_graph["name"] = resource[:name] unless resource[:name].nil?
    gremlin_graph["properties"] = resource[:properties] unless resource[:properties].nil?
    gremlin_graph["tags"] = resource[:tags] unless resource[:tags].nil?
    gremlin_graph["type"] = resource[:type] unless resource[:type].nil?
    return gremlin_graph
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation DatabaseAccounts_CreateUpdateGremlinGraph")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("createUpdateGremlinGraphParameters", "body", "create_update_gremlin_graph_parameters", "create_update_gremlin_graph_parameters"),
      self.op_param("databaseName", "path", "database_name", "database_name"),
      self.op_param("graphName", "path", "graph_name", "graph_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/apis/gremlin/databases/%{database_name}/graphs/%{graph_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DatabaseAccounts_DeleteGremlinGraph")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/apis/gremlin/databases/%{database_name}/graphs/%{graph_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DatabaseAccounts_ListGremlinGraphs")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/apis/gremlin/databases/%{database_name}/graphs", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DatabaseAccounts_GetGremlinGraph")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/apis/gremlin/databases/%{database_name}/graphs/%{graph_name}", "Get", "[application/json]")
  end
