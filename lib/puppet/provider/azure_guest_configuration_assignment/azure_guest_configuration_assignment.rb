...
Puppet::Type.type(:azure_guest_configuration_assignment).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type GuestConfigurationAssignment")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type GuestConfigurationAssignment - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    guest_configuration_assignment = {}
    guest_configuration_assignment["id"] = resource[:id] unless resource[:id].nil?
    guest_configuration_assignment["location"] = resource[:location] unless resource[:location].nil?
    guest_configuration_assignment["name"] = resource[:name] unless resource[:name].nil?
    guest_configuration_assignment["properties"] = resource[:properties] unless resource[:properties].nil?
    guest_configuration_assignment["type"] = resource[:type] unless resource[:type].nil?
    return guest_configuration_assignment
  end

  def self.build_key_values
    key_values = {}
    key_values["api-version"] = "2018-11-20"
    key_values
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation GuestConfigurationAssignments_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("guestConfigurationAssignmentName", "path", "name", "guest_configuration_assignment_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/virtualMachines/%{vm_name}/providers/Microsoft.GuestConfiguration/guestConfigurationAssignments/%{guest_configuration_assignment_name}", "Put", "[]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation GuestConfigurationAssignments_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/virtualMachines/%{vm_name}/providers/Microsoft.GuestConfiguration/guestConfigurationAssignments/%{guest_configuration_assignment_name}", "Delete", "[]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation GuestConfigurationAssignments_List")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/virtualMachines/%{vm_name}/providers/Microsoft.GuestConfiguration/guestConfigurationAssignments", "Get", "[]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation GuestConfigurationAssignments_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/virtualMachines/%{vm_name}/providers/Microsoft.GuestConfiguration/guestConfigurationAssignments/%{guest_configuration_assignment_name}", "Get", "[]")
  end
