...
Puppet::Type.type(:azure_host_name_binding).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:host_name] = key_values["hostName"] unless key_values["hostName"].nil?
    path_params[:host_name] = ENV["azure_host_name"] unless ENV["azure_host_name"].nil?
    path_params[:host_name] = resource[:host_name] unless resource.nil? or resource[:host_name].nil?
    path_params[:host_name_binding] = key_values["hostNameBinding"] unless key_values["hostNameBinding"].nil?
    path_params[:host_name_binding] = ENV["azure_host_name_binding"] unless ENV["azure_host_name_binding"].nil?
    path_params[:host_name_binding] = resource[:host_name_binding] unless resource.nil? or resource[:host_name_binding].nil?
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/hostNameBindings" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of []
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
