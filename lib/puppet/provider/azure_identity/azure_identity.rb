...
Puppet::Type.type(:azure_identity).provide(:arm) do
  mk_resource_methods
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "clientId"])
        self.deep_delete(hash, [:properties, "clientSecretUrl"])
        self.deep_delete(hash, [:properties, "principalId"])
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type Identity")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type Identity - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    identity = {}
    identity["id"] = resource[:id] unless resource[:id].nil?
    identity["location"] = resource[:location] unless resource[:location].nil?
    identity["name"] = resource[:name] unless resource[:name].nil?
    identity["properties"] = resource[:properties] unless resource[:properties].nil?
    identity["tags"] = resource[:tags] unless resource[:tags].nil?
    identity["type"] = resource[:type] unless resource[:type].nil?
    return identity
  end

  def self.build_key_values
    key_values = {}
    key_values["api-version"] = "2018-11-30"
    key_values
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation UserAssignedIdentities_ListBySubscription")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.ManagedIdentity/userAssignedIdentities", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation UserAssignedIdentities_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/%{resource_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation UserAssignedIdentities_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/%{resource_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation UserAssignedIdentities_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/%{resource_name}", "Get", "[application/json]")
  end
