...
Puppet::Type.type(:azure_image_list).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("Content-Type", "header", "content_type"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
      name = i[:name]
    ...
    self.call_op(path_params, query_params, header_params, body_params, "", "/contentmoderator/lists/v1.0/imagelists", "Post", "[]")
  end
  ...
  def self.invoke_update(resource = nil, body_params = nil)
    ...
    op_params = [
      self.op_param("body", "body", "body"),
      self.op_param("Content-Type", "header", "content_type"),
      self.op_param("listId", "path", "list_id"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
      name = i[:name]
    ...
    self.call_op(path_params, query_params, header_params, body_params, "", "/contentmoderator/lists/v1.0/imagelists/%{list_id}", "Put", "[]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "", "/contentmoderator/lists/v1.0/imagelists/%{list_id}", "Delete", "[]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "", "/contentmoderator/lists/v1.0/imagelists/%{list_id}", "Get", "[]")
  end
