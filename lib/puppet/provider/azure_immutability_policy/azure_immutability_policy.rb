...
Puppet::Type.type(:azure_immutability_policy).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type ImmutabilityPolicy")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type ImmutabilityPolicy - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    immutability_policy = {}
    immutability_policy["etag"] = resource[:etag] unless resource[:etag].nil?
    immutability_policy["id"] = resource[:id] unless resource[:id].nil?
    immutability_policy["name"] = resource[:name] unless resource[:name].nil?
    immutability_policy["properties"] = resource[:properties] unless resource[:properties].nil?
    immutability_policy["type"] = resource[:type] unless resource[:type].nil?
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation BlobContainers_CreateOrUpdateImmutabilityPolicy")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    path_params[:container_name] = key_values["containerName"] unless key_values["containerName"].nil?
    path_params[:container_name] = ENV["azure_container_name"] unless ENV["azure_container_name"].nil?
    path_params[:container_name] = resource[:container_name] unless resource.nil? or resource[:container_name].nil?
    ...
    path_params[:immutability_policy_name] = key_values["immutabilityPolicyName"] unless key_values["immutabilityPolicyName"].nil?
    path_params[:immutability_policy_name] = ENV["azure_immutability_policy_name"] unless ENV["azure_immutability_policy_name"].nil?
    path_params[:immutability_policy_name] = resource[:name] unless resource.nil? or resource[:name].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Storage/storageAccounts/%{account_name}/blobServices/default/containers/%{container_name}/immutabilityPolicies/%{immutability_policy_name}" % path_params
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation BlobContainers_DeleteImmutabilityPolicy")
    path_params = {}
    query_params = {}
    header_params = {}
    path_params[:account_name] = key_values["accountName"] unless key_values["accountName"].nil?
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation BlobContainers_GetImmutabilityPolicy")
    path_params = {}
    query_params = {}
    header_params = {}
    path_params[:account_name] = key_values["accountName"] unless key_values["accountName"].nil?
