...
Puppet::Type.type(:azure_inbound_nat_rule).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("inboundNatRuleName", "path", "name"),
      self.op_param("inboundNatRuleParameters", "body", "inbound_nat_rule_parameters"),
      self.op_param("loadBalancerName", "path", "load_balancer_name"),
