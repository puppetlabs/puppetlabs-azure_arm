...
Puppet::Type.type(:azure_integration_account).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          id: item["id"],
          integration_account: item["integrationAccount"],
  ...
  def self.instance_to_hash(instance)
    {
      ...
      integration_account: instance.integration_account.respond_to?(:to_hash) ? instance.integration_account.to_hash : instance.integration_account,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type IntegrationAccount")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type IntegrationAccount - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    integration_account = {}
    integration_account["id"] = resource[:id] unless resource[:id].nil?
    integration_account["location"] = resource[:location] unless resource[:location].nil?
    integration_account["name"] = resource[:name] unless resource[:name].nil?
    integration_account["properties"] = resource[:properties] unless resource[:properties].nil?
    integration_account["sku"] = resource[:sku] unless resource[:sku].nil?
    integration_account["tags"] = resource[:tags] unless resource[:tags].nil?
    integration_account["type"] = resource[:type] unless resource[:type].nil?
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation IntegrationAccounts_ListBySubscription")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Logic/integrationAccounts", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation IntegrationAccounts_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("integrationAccount", "body", "integration_account", "integration_account"),
      self.op_param("integrationAccountName", "path", "name", "integration_account_name"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
      self.op_param("properties", "body", "properties", "properties"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation IntegrationAccounts_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation IntegrationAccounts_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation IntegrationAccounts_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}", "Get", "[application/json]")
  end
