...
Puppet::Type.type(:azure_integration_account_certificate).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type IntegrationAccountCertificate")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type IntegrationAccountCertificate - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    integration_account_certificate["id"] = resource[:id] unless resource[:id].nil?
    integration_account_certificate["location"] = resource[:location] unless resource[:location].nil?
    integration_account_certificate["name"] = resource[:name] unless resource[:name].nil?
    integration_account_certificate["properties"] = resource[:properties] unless resource[:properties].nil?
    integration_account_certificate["tags"] = resource[:tags] unless resource[:tags].nil?
    integration_account_certificate["type"] = resource[:type] unless resource[:type].nil?
    return integration_account_certificate
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("certificate", "body", "certificate", "certificate"),
      self.op_param("certificateName", "path", "certificate_name", "certificate_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}/certificates/%{certificate_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}/certificates/%{certificate_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Certificates_ListByIntegrationAccounts")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}/certificates", "Get", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}/certificates/%{certificate_name}", "Get", "[application/json]")
  end
