...
Puppet::Type.type(:azure_integration_account_schema).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:schema] = key_values["schema"] unless key_values["schema"].nil?
    path_params[:schema] = ENV["azure_schema"] unless ENV["azure_schema"].nil?
    path_params[:schema] = resource[:schema] unless resource.nil? or resource[:schema].nil?
    path_params[:schema_name] = key_values["schemaName"] unless key_values["schemaName"].nil?
    path_params[:schema_name] = ENV["azure_schema_name"] unless ENV["azure_schema_name"].nil?
    path_params[:schema_name] = resource[:schema_name] unless resource.nil? or resource[:schema_name].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}/schemas/%{schema_name}" % path_params
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}/schemas" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
