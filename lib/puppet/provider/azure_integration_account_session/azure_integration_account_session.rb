...
Puppet::Type.type(:azure_integration_account_session).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type IntegrationAccountSession")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type IntegrationAccountSession - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    integration_account_session["id"] = resource[:id] unless resource[:id].nil?
    integration_account_session["location"] = resource[:location] unless resource[:location].nil?
    integration_account_session["name"] = resource[:name] unless resource[:name].nil?
    integration_account_session["properties"] = resource[:properties] unless resource[:properties].nil?
    integration_account_session["tags"] = resource[:tags] unless resource[:tags].nil?
    integration_account_session["type"] = resource[:type] unless resource[:type].nil?
    return integration_account_session
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Sessions_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    path_params[:session] = key_values["session"] unless key_values["session"].nil?
    path_params[:session] = ENV["azure_session"] unless ENV["azure_session"].nil?
    path_params[:session] = resource[:session] unless resource.nil? or resource[:session].nil?
    path_params[:session_name] = key_values["sessionName"] unless key_values["sessionName"].nil?
    path_params[:session_name] = ENV["azure_session_name"] unless ENV["azure_session_name"].nil?
    path_params[:session_name] = resource[:session_name] unless resource.nil? or resource[:session_name].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}/sessions/%{session_name}" % path_params
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Sessions_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Sessions_ListByIntegrationAccounts")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}/sessions" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Sessions_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
