...
Puppet::Type.type(:azure_integration_runtime_resource).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type IntegrationRuntimeResource")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type IntegrationRuntimeResource - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    integration_runtime_resource["etag"] = resource[:etag] unless resource[:etag].nil?
    integration_runtime_resource["id"] = resource[:id] unless resource[:id].nil?
    integration_runtime_resource["name"] = resource[:name] unless resource[:name].nil?
    integration_runtime_resource["properties"] = resource[:properties] unless resource[:properties].nil?
    integration_runtime_resource["type"] = resource[:type] unless resource[:type].nil?
    return integration_runtime_resource
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation IntegrationRuntimes_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("factoryName", "path", "factory_name", "factory_name"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("If-Match", "header", "if_match", "if_match"),
      self.op_param("integrationRuntime", "body", "integration_runtime", "integration_runtime"),
      self.op_param("integrationRuntimeName", "path", "integration_runtime_name", "integration_runtime_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}/integrationRuntimes/%{integration_runtime_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation IntegrationRuntimes_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}/integrationRuntimes/%{integration_runtime_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation IntegrationRuntimes_ListByFactory")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}/integrationRuntimes", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation IntegrationRuntimes_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}/integrationRuntimes/%{integration_runtime_name}", "Get", "[application/json]")
  end
