...
Puppet::Type.type(:azure_io_t_security_solution_model).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          id: item["id"],
          iot_security_solution_data: item["iotSecuritySolutionData"],
        ...
        self.deep_delete(hash, [:properties, "autoDiscoveredResources"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      iot_security_solution_data: instance.iot_security_solution_data.respond_to?(:to_hash) ? instance.iot_security_solution_data.to_hash : instance.iot_security_solution_data,
      ...
      solution_name: instance.solution_name.respond_to?(:to_hash) ? instance.solution_name.to_hash : instance.solution_name,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type IoTSecuritySolutionModel")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type IoTSecuritySolutionModel - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    io_t_security_solution_model = {}
    io_t_security_solution_model["id"] = resource[:id] unless resource[:id].nil?
    io_t_security_solution_model["location"] = resource[:location] unless resource[:location].nil?
    io_t_security_solution_model["name"] = resource[:name] unless resource[:name].nil?
    io_t_security_solution_model["properties"] = resource[:properties] unless resource[:properties].nil?
    io_t_security_solution_model["tags"] = resource[:tags] unless resource[:tags].nil?
    io_t_security_solution_model["type"] = resource[:type] unless resource[:type].nil?
    return io_t_security_solution_model
  end

  def self.build_key_values
    key_values = {}
    key_values["api-version"] = "2019-08-01"
    key_values
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation IoTSecuritySolutions_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Security/iotSecuritySolutions", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation IotSecuritySolution_Create")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("iotSecuritySolutionData", "body", "iot_security_solution_data", "iot_security_solution_data"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
      self.op_param("properties", "body", "properties", "properties"),
      self.op_param("resourceGroupName", "path", "resource_group_name", "resource_group_name"),
      self.op_param("solutionName", "path", "solution_name", "solution_name"),
      self.op_param("subscriptionId", "path", "subscription_id", "subscription_id"),
      self.op_param("tags", "body", "tags", "tags"),
      self.op_param("type", "body", "type", "type"),
    ]
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Security/iotSecuritySolutions/%{solution_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation IotSecuritySolution_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Security/iotSecuritySolutions/%{solution_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation IotSecuritySolution_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Security/iotSecuritySolutions/%{solution_name}", "Get", "[application/json]")
  end
