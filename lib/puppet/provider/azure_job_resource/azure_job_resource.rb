...
Puppet::Type.type(:azure_job_resource).provide(:arm) do
  mk_resource_methods
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "cancellationReason"])

        self.deep_delete(hash, [:properties, "details", "chainOfCustodySasKey"])

        self.deep_delete(hash, [:properties, "details", "copyLogDetails", "copyLogDetailsType"])

        self.deep_delete(hash, [:properties, "details", "deliveryPackage", "carrierName"])
        self.deep_delete(hash, [:properties, "details", "deliveryPackage", "trackingId"])
        self.deep_delete(hash, [:properties, "details", "deliveryPackage", "trackingUrl"])

        self.deep_delete(hash, [:properties, "details", "errorDetails", "errorCode"])
        self.deep_delete(hash, [:properties, "details", "errorDetails", "errorMessage"])
        self.deep_delete(hash, [:properties, "details", "errorDetails", "exceptionMessage"])
        self.deep_delete(hash, [:properties, "details", "errorDetails", "recommendedAction"])

        self.deep_delete(hash, [:properties, "details", "jobStages", "displayName"])
        self.deep_delete(hash, [:properties, "details", "jobStages", "jobStageDetails"])
        self.deep_delete(hash, [:properties, "details", "jobStages", "stageName"])
        self.deep_delete(hash, [:properties, "details", "jobStages", "stageStatus"])
        self.deep_delete(hash, [:properties, "details", "jobStages", "stageTime"])

        self.deep_delete(hash, [:properties, "details", "reverseShipmentLabelSasKey"])

        self.deep_delete(hash, [:properties, "error", "code"])
        self.deep_delete(hash, [:properties, "error", "message"])
        self.deep_delete(hash, [:properties, "isCancellable"])
        self.deep_delete(hash, [:properties, "isDeletable"])
        self.deep_delete(hash, [:properties, "isShippingAddressEditable"])
        self.deep_delete(hash, [:properties, "startTime"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      job_resource: instance.job_resource.respond_to?(:to_hash) ? instance.job_resource.to_hash : instance.job_resource,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type JobResource")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type JobResource - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    job_resource = {}
    job_resource["id"] = resource[:id] unless resource[:id].nil?
    job_resource["location"] = resource[:location] unless resource[:location].nil?
    job_resource["name"] = resource[:name] unless resource[:name].nil?
    job_resource["properties"] = resource[:properties] unless resource[:properties].nil?
    job_resource["sku"] = resource[:sku] unless resource[:sku].nil?
    job_resource["tags"] = resource[:tags] unless resource[:tags].nil?
    job_resource["type"] = resource[:type] unless resource[:type].nil?
    return job_resource
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Jobs_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      self.op_param("$skipToken", "query", "$skip_token", "$skip_token"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.DataBox/jobs", "Get", "[application/json]")
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("jobName", "path", "job_name", "job_name"),
      self.op_param("jobResource", "body", "job_resource", "job_resource"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
      self.op_param("properties", "body", "properties", "properties"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataBox/jobs/%{job_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataBox/jobs/%{job_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataBox/jobs/%{job_name}", "Get", "[application/json]")
  end
