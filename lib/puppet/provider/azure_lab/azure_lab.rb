...
Puppet::Type.type(:azure_lab).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type Lab")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type Lab - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    lab = {}
    lab["id"] = resource[:id] unless resource[:id].nil?
    lab["location"] = resource[:location] unless resource[:location].nil?
    lab["name"] = resource[:name] unless resource[:name].nil?
    lab["properties"] = resource[:properties] unless resource[:properties].nil?
    lab["tags"] = resource[:tags] unless resource[:tags].nil?
    lab["type"] = resource[:type] unless resource[:type].nil?
    return lab
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Labs_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("lab", "body", "lab", "lab"),
      self.op_param("labAccountName", "path", "lab_account_name", "lab_account_name"),
      self.op_param("labName", "path", "name", "lab_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.LabServices/labaccounts/%{lab_account_name}/labs/%{lab_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Labs_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.LabServices/labaccounts/%{lab_account_name}/labs/%{lab_name}", "Delete", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Labs_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.LabServices/labaccounts/%{lab_account_name}/labs/%{lab_name}", "Get", "[application/json]")
  end
