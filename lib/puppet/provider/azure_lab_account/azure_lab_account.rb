...
Puppet::Type.type(:azure_lab_account).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type LabAccount")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type LabAccount - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    lab_account = {}
    lab_account["id"] = resource[:id] unless resource[:id].nil?
    lab_account["location"] = resource[:location] unless resource[:location].nil?
    lab_account["name"] = resource[:name] unless resource[:name].nil?
    lab_account["properties"] = resource[:properties] unless resource[:properties].nil?
    lab_account["tags"] = resource[:tags] unless resource[:tags].nil?
    lab_account["type"] = resource[:type] unless resource[:type].nil?
    return lab_account
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation LabAccounts_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("labAccount", "body", "lab_account", "lab_account"),
      self.op_param("labAccountName", "path", "name", "lab_account_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.LabServices/labaccounts/%{lab_account_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation LabAccounts_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.LabServices/labaccounts/%{lab_account_name}", "Delete", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation LabAccounts_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.LabServices/labaccounts/%{lab_account_name}", "Get", "[application/json]")
  end
