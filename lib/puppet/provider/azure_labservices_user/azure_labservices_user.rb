...
Puppet::Type.type(:azure_labservices_user).provide(:arm) do
  mk_resource_methods
  ...
  def build_hash
    user = {}
    user["id"] = resource[:id] unless resource[:id].nil?
    user["location"] = resource[:location] unless resource[:location].nil?
    user["name"] = resource[:name] unless resource[:name].nil?
    user["properties"] = resource[:properties] unless resource[:properties].nil?
    user["tags"] = resource[:tags] unless resource[:tags].nil?
    user["type"] = resource[:type] unless resource[:type].nil?
    return user
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Users_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("user", "body", "user", "user"),
      self.op_param("userName", "path", "name", "user_name"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
      name = i[:name]
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.LabServices/labaccounts/%{lab_account_name}/labs/%{lab_name}/users/%{user_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.LabServices/labaccounts/%{lab_account_name}/labs/%{lab_name}/users/%{user_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.LabServices/labaccounts/%{lab_account_name}/labs/%{lab_name}/users/%{user_name}", "Get", "[application/json]")
  end
