...
Puppet::Type.type(:azure_load_balancing_settings_model).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type LoadBalancingSettingsModel")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type LoadBalancingSettingsModel - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    load_balancing_settings_model = {}
    load_balancing_settings_model["id"] = resource[:id] unless resource[:id].nil?
    load_balancing_settings_model["name"] = resource[:name] unless resource[:name].nil?
    load_balancing_settings_model["properties"] = resource[:properties] unless resource[:properties].nil?
    load_balancing_settings_model["type"] = resource[:type] unless resource[:type].nil?
    return load_balancing_settings_model
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation LoadBalancingSettings_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("frontDoorName", "path", "front_door_name", "front_door_name"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("loadBalancingSettingsName", "path", "load_balancing_settings_name", "load_balancing_settings_name"),
      self.op_param("loadBalancingSettingsParameters", "body", "load_balancing_settings_parameters", "load_balancing_settings_parameters"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/frontDoors/%{front_door_name}/loadBalancingSettings/%{load_balancing_settings_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation LoadBalancingSettings_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/frontDoors/%{front_door_name}/loadBalancingSettings/%{load_balancing_settings_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation LoadBalancingSettings_ListByFrontDoor")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/frontDoors/%{front_door_name}/loadBalancingSettings", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation LoadBalancingSettings_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/frontDoors/%{front_door_name}/loadBalancingSettings/%{load_balancing_settings_name}", "Get", "[application/json]")
  end
