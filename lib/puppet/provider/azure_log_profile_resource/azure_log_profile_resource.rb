...
Puppet::Type.type(:azure_log_profile_resource).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          log_profile_name: item["logProfileName"],
          name: item["name"],
  ...
  def self.instance_to_hash(instance)
    {
      ...
      log_profile_name: instance.log_profile_name.respond_to?(:to_hash) ? instance.log_profile_name.to_hash : instance.log_profile_name,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type LogProfileResource")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type LogProfileResource - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    log_profile_resource = {}
    log_profile_resource["id"] = resource[:id] unless resource[:id].nil?
    log_profile_resource["location"] = resource[:location] unless resource[:location].nil?
    log_profile_resource["name"] = resource[:name] unless resource[:name].nil?
    log_profile_resource["properties"] = resource[:properties] unless resource[:properties].nil?
    log_profile_resource["tags"] = resource[:tags] unless resource[:tags].nil?
    log_profile_resource["type"] = resource[:type] unless resource[:type].nil?
    return log_profile_resource
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation LogProfiles_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/microsoft.insights/logprofiles", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation LogProfiles_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    op_params = [
      ...
      self.op_param("id", "body", "id", "id"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("logProfileName", "path", "log_profile_name", "log_profile_name"),
      self.op_param("name", "body", "name", "name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/microsoft.insights/logprofiles/%{log_profile_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation LogProfiles_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/microsoft.insights/logprofiles/%{log_profile_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation LogProfiles_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/microsoft.insights/logprofiles/%{log_profile_name}", "Get", "[application/json]")
  end
