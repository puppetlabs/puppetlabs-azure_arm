...
Puppet::Type.type(:azure_log_search_rule_resource).provide(:arm) do
  mk_resource_methods
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "lastUpdatedTime"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      rule_name: instance.rule_name.respond_to?(:to_hash) ? instance.rule_name.to_hash : instance.rule_name,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type LogSearchRuleResource")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type LogSearchRuleResource - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    log_search_rule_resource = {}
    log_search_rule_resource["id"] = resource[:id] unless resource[:id].nil?
    log_search_rule_resource["location"] = resource[:location] unless resource[:location].nil?
    log_search_rule_resource["name"] = resource[:name] unless resource[:name].nil?
    log_search_rule_resource["properties"] = resource[:properties] unless resource[:properties].nil?
    log_search_rule_resource["tags"] = resource[:tags] unless resource[:tags].nil?
    log_search_rule_resource["type"] = resource[:type] unless resource[:type].nil?
    return log_search_rule_resource
  end

  def self.build_key_values
    key_values = {}
    key_values["api-version"] = "2018-04-16"
    key_values
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation ScheduledQueryRules_ListBySubscription")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/microsoft.insights/scheduledQueryRules", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ScheduledQueryRules_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    op_params = [
      ...
      self.op_param("ruleName", "path", "rule_name", "rule_name"),
      self.op_param("subscriptionId", "path", "subscription_id", "subscription_id"),
      self.op_param("tags", "body", "tags", "tags"),
      self.op_param("type", "body", "type", "type"),
    ]
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/microsoft.insights/scheduledQueryRules/%{rule_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ScheduledQueryRules_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/microsoft.insights/scheduledQueryRules/%{rule_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ScheduledQueryRules_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/microsoft.insights/scheduledQueryRules", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ScheduledQueryRules_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/microsoft.insights/scheduledQueryRules/%{rule_name}", "Get", "[application/json]")
  end
