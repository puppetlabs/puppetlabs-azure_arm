...
Puppet::Type.type(:azure_manager_extended_info).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type ManagerExtendedInfo")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type ManagerExtendedInfo - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    manager_extended_info["etag"] = resource[:etag] unless resource[:etag].nil?
    manager_extended_info["id"] = resource[:id] unless resource[:id].nil?
    manager_extended_info["kind"] = resource[:kind] unless resource[:kind].nil?
    manager_extended_info["name"] = resource[:name] unless resource[:name].nil?
    manager_extended_info["properties"] = resource[:properties] unless resource[:properties].nil?
    manager_extended_info["type"] = resource[:type] unless resource[:type].nil?
    return manager_extended_info
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Managers_CreateExtendedInfo")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorSimple/managers/%{manager_name}/extendedInformation/vaultExtendedInfo", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Managers_DeleteExtendedInfo")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorSimple/managers/%{manager_name}/extendedInformation/vaultExtendedInfo", "Delete", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Managers_GetExtendedInfo")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorSimple/managers/%{manager_name}/extendedInformation/vaultExtendedInfo", "Get", "[application/json]")
  end
