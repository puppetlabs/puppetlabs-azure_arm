...
Puppet::Type.type(:azure_maps_account).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          maps_account_create_parameters: item["MapsAccountCreateParameters"],
          name: item["name"],
        ...
        self.deep_delete(hash, [:location])
        self.deep_delete(hash, [:properties])
        self.deep_delete(hash, [:sku])
        self.deep_delete(hash, [:tags])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      maps_account_create_parameters: instance.maps_account_create_parameters.respond_to?(:to_hash) ? instance.maps_account_create_parameters.to_hash : instance.maps_account_create_parameters,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type MapsAccount")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type MapsAccount - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    maps_account = {}
    maps_account["id"] = resource[:id] unless resource[:id].nil?
    maps_account["location"] = resource[:location] unless resource[:location].nil?
    maps_account["name"] = resource[:name] unless resource[:name].nil?
    maps_account["properties"] = resource[:properties] unless resource[:properties].nil?
    maps_account["sku"] = resource[:sku] unless resource[:sku].nil?
    maps_account["tags"] = resource[:tags] unless resource[:tags].nil?
    maps_account["type"] = resource[:type] unless resource[:type].nil?
    return maps_account
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Accounts_ListBySubscription")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Maps/accounts", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Accounts_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    op_params = [
      ...
      self.op_param("id", "body", "id", "id"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("MapsAccountCreateParameters", "body", "maps_account_create_parameters", "maps_account_create_parameters"),
      self.op_param("name", "body", "name", "name"),
      self.op_param("properties", "body", "properties", "properties"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Maps/accounts/%{account_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Accounts_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Maps/accounts/%{account_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Accounts_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Maps/accounts", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Accounts_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Maps/accounts/%{account_name}", "Get", "[application/json]")
  end
