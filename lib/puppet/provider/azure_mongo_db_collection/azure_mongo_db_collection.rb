...
Puppet::Type.type(:azure_mongo_db_collection).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type MongoDBCollection")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type MongoDBCollection - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    mongo_db_collection = {}
    mongo_db_collection["id"] = resource[:id] unless resource[:id].nil?
    mongo_db_collection["location"] = resource[:location] unless resource[:location].nil?
    mongo_db_collection["name"] = resource[:name] unless resource[:name].nil?
    mongo_db_collection["properties"] = resource[:properties] unless resource[:properties].nil?
    mongo_db_collection["tags"] = resource[:tags] unless resource[:tags].nil?
    mongo_db_collection["type"] = resource[:type] unless resource[:type].nil?
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation DatabaseAccounts_CreateUpdateMongoDBCollection")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("collectionName", "path", "collection_name", "collection_name"),
      self.op_param("createUpdateMongoDBCollectionParameters", "body", "create_update_mongo_db_collection_parameters", "create_update_mongo_db_collection_parameters"),
      self.op_param("databaseName", "path", "database_name", "database_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/apis/mongodb/databases/%{database_name}/collections/%{collection_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DatabaseAccounts_DeleteMongoDBCollection")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/apis/mongodb/databases/%{database_name}/collections/%{collection_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DatabaseAccounts_ListMongoDBCollections")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/apis/mongodb/databases/%{database_name}/collections", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DatabaseAccounts_GetMongoDBCollection")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/apis/mongodb/databases/%{database_name}/collections/%{collection_name}", "Get", "[application/json]")
  end
