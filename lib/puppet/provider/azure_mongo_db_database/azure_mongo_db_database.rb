...
Puppet::Type.type(:azure_mongo_db_database).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type MongoDBDatabase")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type MongoDBDatabase - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    mongo_db_database = {}
    mongo_db_database["id"] = resource[:id] unless resource[:id].nil?
    mongo_db_database["location"] = resource[:location] unless resource[:location].nil?
    mongo_db_database["name"] = resource[:name] unless resource[:name].nil?
    mongo_db_database["properties"] = resource[:properties] unless resource[:properties].nil?
    mongo_db_database["tags"] = resource[:tags] unless resource[:tags].nil?
    mongo_db_database["type"] = resource[:type] unless resource[:type].nil?
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation DatabaseAccounts_CreateUpdateMongoDBDatabase")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("createUpdateMongoDBDatabaseParameters", "body", "create_update_mongo_db_database_parameters", "create_update_mongo_db_database_parameters"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/apis/mongodb/databases/%{database_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DatabaseAccounts_DeleteMongoDBDatabase")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/apis/mongodb/databases/%{database_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DatabaseAccounts_ListMongoDBDatabases")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/apis/mongodb/databases", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DatabaseAccounts_GetMongoDBDatabase")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/apis/mongodb/databases/%{database_name}", "Get", "[application/json]")
  end
