...
Puppet::Type.type(:azure_nat_gateway).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type NatGateway")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type NatGateway - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    nat_gateway = {}
    nat_gateway["etag"] = resource[:etag] unless resource[:etag].nil?
    nat_gateway["id"] = resource[:id] unless resource[:id].nil?
    nat_gateway["location"] = resource[:location] unless resource[:location].nil?
    nat_gateway["name"] = resource[:name] unless resource[:name].nil?
    nat_gateway["properties"] = resource[:properties] unless resource[:properties].nil?
    nat_gateway["sku"] = resource[:sku] unless resource[:sku].nil?
    nat_gateway["tags"] = resource[:tags] unless resource[:tags].nil?
    nat_gateway["type"] = resource[:type] unless resource[:type].nil?
    nat_gateway["zones"] = resource[:zones] unless resource[:zones].nil?
    return nat_gateway
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation NatGateways_ListAll")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Network/natGateways", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation NatGateways_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    op_params = [
      ...
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
      self.op_param("natGatewayName", "path", "name", "nat_gateway_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/natGateways/%{nat_gateway_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation NatGateways_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/natGateways/%{nat_gateway_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation NatGateways_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/natGateways/%{nat_gateway_name}", "Get", "[application/json]")
  end
