  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "ipConfigurations", "properties", "publicIPAddress", "properties", "ipConfiguration", "properties", "subnet", "properties", "networkSecurityGroup", "name"])

        self.deep_delete(hash, [:properties, "ipConfigurations", "properties", "publicIPAddress", "properties", "ipConfiguration", "properties", "subnet", "properties", "networkSecurityGroup", "type"])

        self.deep_delete(hash, [:properties, "ipConfigurations", "properties", "publicIPAddress", "properties", "ipConfiguration", "properties", "subnet", "properties", "resourceNavigationLinks", "etag"])

        self.deep_delete(hash, [:properties, "ipConfigurations", "properties", "publicIPAddress", "properties", "ipConfiguration", "properties", "subnet", "properties", "resourceNavigationLinks", "properties", "provisioningState"])

        self.deep_delete(hash, [:properties, "ipConfigurations", "properties", "publicIPAddress", "properties", "ipConfiguration", "properties", "subnet", "properties", "routeTable", "name"])

        self.deep_delete(hash, [:properties, "ipConfigurations", "properties", "publicIPAddress", "properties", "ipConfiguration", "properties", "subnet", "properties", "routeTable", "type"])
