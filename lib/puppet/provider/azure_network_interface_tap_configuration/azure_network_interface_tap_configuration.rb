...
Puppet::Type.type(:azure_network_interface_tap_configuration).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type NetworkInterfaceTapConfiguration")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type NetworkInterfaceTapConfiguration - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    network_interface_tap_configuration = {}
    network_interface_tap_configuration["etag"] = resource[:etag] unless resource[:etag].nil?
    network_interface_tap_configuration["id"] = resource[:id] unless resource[:id].nil?
    network_interface_tap_configuration["name"] = resource[:name] unless resource[:name].nil?
    network_interface_tap_configuration["properties"] = resource[:properties] unless resource[:properties].nil?
    network_interface_tap_configuration["type"] = resource[:type] unless resource[:type].nil?
    return network_interface_tap_configuration
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation NetworkInterfaceTapConfigurations_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("networkInterfaceName", "path", "network_interface_name", "network_interface_name"),
      ...
      self.op_param("tapConfigurationName", "path", "tap_configuration_name", "tap_configuration_name"),
      self.op_param("tapConfigurationParameters", "body", "tap_configuration_parameters", "tap_configuration_parameters"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkInterfaces/%{network_interface_name}/tapConfigurations/%{tap_configuration_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation NetworkInterfaceTapConfigurations_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkInterfaces/%{network_interface_name}/tapConfigurations/%{tap_configuration_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation NetworkInterfaceTapConfigurations_List")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkInterfaces/%{network_interface_name}/tapConfigurations", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation NetworkInterfaceTapConfigurations_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkInterfaces/%{network_interface_name}/tapConfigurations/%{tap_configuration_name}", "Get", "[application/json]")
  end
