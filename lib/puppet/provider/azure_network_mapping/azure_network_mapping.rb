...
Puppet::Type.type(:azure_network_mapping).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type NetworkMapping")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type NetworkMapping - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    network_mapping = {}
    network_mapping["id"] = resource[:id] unless resource[:id].nil?
    network_mapping["location"] = resource[:location] unless resource[:location].nil?
    network_mapping["name"] = resource[:name] unless resource[:name].nil?
    network_mapping["properties"] = resource[:properties] unless resource[:properties].nil?
    network_mapping["type"] = resource[:type] unless resource[:type].nil?
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation ReplicationNetworkMappings_Create")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("networkMappingName", "path", "name", "network_mapping_name"),
      self.op_param("networkName", "path", "network_name", "network_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationFabrics/%{fabric_name}/replicationNetworks/%{network_name}/replicationNetworkMappings/%{network_mapping_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ReplicationNetworkMappings_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationFabrics/%{fabric_name}/replicationNetworks/%{network_name}/replicationNetworkMappings/%{network_mapping_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ReplicationNetworkMappings_List")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationNetworkMappings", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ReplicationNetworkMappings_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationFabrics/%{fabric_name}/replicationNetworks/%{network_name}/replicationNetworkMappings/%{network_mapping_name}", "Get", "[application/json]")
  end
