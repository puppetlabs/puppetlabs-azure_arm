...
Puppet::Type.type(:azure_network_record_set).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type RecordSet")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type RecordSet - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    record_set = {}
    record_set["etag"] = resource[:etag] unless resource[:etag].nil?
    record_set["id"] = resource[:id] unless resource[:id].nil?
    record_set["name"] = resource[:name] unless resource[:name].nil?
    record_set["properties"] = resource[:properties] unless resource[:properties].nil?
    record_set["type"] = resource[:type] unless resource[:type].nil?
    return record_set
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation RecordSets_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("recordType", "path", "record_type", "record_type"),
      self.op_param("relativeRecordSetName", "path", "relative_record_set_name", "relative_record_set_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/privateDnsZones/%{private_zone_name}/%{record_type}/%{relative_record_set_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation RecordSets_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/privateDnsZones/%{private_zone_name}/%{record_type}/%{relative_record_set_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/privateDnsZones/%{private_zone_name}/%{record_type}", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation RecordSets_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/privateDnsZones/%{private_zone_name}/%{record_type}/%{relative_record_set_name}", "Get", "[application/json]")
  end
