...
Puppet::Type.type(:azure_network_web_application_firewall_policy).provide(:arm) do
  mk_resource_methods
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "applicationGateways"])

        self.deep_delete(hash, [:properties, "customRules", "etag"])

        self.deep_delete(hash, [:properties, "provisioningState"])
        self.deep_delete(hash, [:properties, "resourceState"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      policy_name: instance.policy_name.respond_to?(:to_hash) ? instance.policy_name.to_hash : instance.policy_name,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type WebApplicationFirewallPolicy")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type WebApplicationFirewallPolicy - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    web_application_firewall_policy["etag"] = resource[:etag] unless resource[:etag].nil?
    web_application_firewall_policy["id"] = resource[:id] unless resource[:id].nil?
    web_application_firewall_policy["location"] = resource[:location] unless resource[:location].nil?
    web_application_firewall_policy["name"] = resource[:name] unless resource[:name].nil?
    web_application_firewall_policy["properties"] = resource[:properties] unless resource[:properties].nil?
    web_application_firewall_policy["tags"] = resource[:tags] unless resource[:tags].nil?
    web_application_firewall_policy["type"] = resource[:type] unless resource[:type].nil?
    return web_application_firewall_policy
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation WebApplicationFirewallPolicies_ListAll")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation WebApplicationFirewallPolicies_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies/%{policy_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation WebApplicationFirewallPolicies_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies/%{policy_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation WebApplicationFirewallPolicies_List")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation WebApplicationFirewallPolicies_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies/%{policy_name}", "Get", "[application/json]")
  end
