...
Puppet::Type.type(:azure_p2_s_vpn_gateway).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          name: item["name"],
          p2_s_vpn_gateway_parameters: item["p2SVpnGatewayParameters"],
        ...
        self.deep_delete(hash, [:properties, "vpnClientConnectionHealth", "totalEgressBytesTransferred"])
        self.deep_delete(hash, [:properties, "vpnClientConnectionHealth", "totalIngressBytesTransferred"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      p2_s_vpn_gateway_parameters: instance.p2_s_vpn_gateway_parameters.respond_to?(:to_hash) ? instance.p2_s_vpn_gateway_parameters.to_hash : instance.p2_s_vpn_gateway_parameters,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type P2SVpnGateway")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type P2SVpnGateway - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    p2_s_vpn_gateway = {}
    p2_s_vpn_gateway["etag"] = resource[:etag] unless resource[:etag].nil?
    p2_s_vpn_gateway["id"] = resource[:id] unless resource[:id].nil?
    p2_s_vpn_gateway["location"] = resource[:location] unless resource[:location].nil?
    p2_s_vpn_gateway["name"] = resource[:name] unless resource[:name].nil?
    p2_s_vpn_gateway["properties"] = resource[:properties] unless resource[:properties].nil?
    p2_s_vpn_gateway["tags"] = resource[:tags] unless resource[:tags].nil?
    p2_s_vpn_gateway["type"] = resource[:type] unless resource[:type].nil?
    return p2_s_vpn_gateway
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation P2sVpnGateways_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Network/p2svpnGateways", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation P2sVpnGateways_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    op_params = [
      ...
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
      self.op_param("p2SVpnGatewayParameters", "body", "p2_s_vpn_gateway_parameters", "p2_s_vpn_gateway_parameters"),
      self.op_param("properties", "body", "properties", "properties"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/p2svpnGateways/%{gateway_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation P2sVpnGateways_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/p2svpnGateways/%{gateway_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation P2sVpnGateways_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/p2svpnGateways", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation P2sVpnGateways_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/p2svpnGateways/%{gateway_name}", "Get", "[application/json]")
  end
