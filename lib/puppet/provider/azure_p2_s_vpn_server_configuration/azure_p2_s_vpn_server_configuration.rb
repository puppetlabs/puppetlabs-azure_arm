...
Puppet::Type.type(:azure_p2_s_vpn_server_configuration).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type P2SVpnServerConfiguration")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type P2SVpnServerConfiguration - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    p2_s_vpn_server_configuration["etag"] = resource[:etag] unless resource[:etag].nil?
    p2_s_vpn_server_configuration["id"] = resource[:id] unless resource[:id].nil?
    p2_s_vpn_server_configuration["name"] = resource[:name] unless resource[:name].nil?
    p2_s_vpn_server_configuration["properties"] = resource[:properties] unless resource[:properties].nil?
    return p2_s_vpn_server_configuration
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation P2sVpnServerConfigurations_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("p2SVpnServerConfigurationName", "path", "name", "p2_s_vpn_server_configuration_name"),
      self.op_param("p2SVpnServerConfigurationParameters", "body", "p2_s_vpn_server_configuration_parameters", "p2_s_vpn_server_configuration_parameters"),
      ...
      self.op_param("virtualWanName", "path", "virtual_wan_name", "virtual_wan_name"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
      name = i[:name]
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualWans/%{virtual_wan_name}/p2sVpnServerConfigurations/%{p2_s_vpn_server_configuration_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation P2sVpnServerConfigurations_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualWans/%{virtual_wan_name}/p2sVpnServerConfigurations/%{p2_s_vpn_server_configuration_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation P2sVpnServerConfigurations_ListByVirtualWan")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualWans/%{virtual_wan_name}/p2sVpnServerConfigurations", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation P2sVpnServerConfigurations_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualWans/%{virtual_wan_name}/p2sVpnServerConfigurations/%{p2_s_vpn_server_configuration_name}", "Get", "[application/json]")
  end
