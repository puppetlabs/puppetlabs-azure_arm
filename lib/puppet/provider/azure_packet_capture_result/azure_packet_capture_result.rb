...
Puppet::Type.type(:azure_packet_capture_result).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:packet_capture_name] = key_values["packetCaptureName"] unless key_values["packetCaptureName"].nil?
    path_params[:packet_capture_name] = ENV["azure_packet_capture_name"] unless ENV["azure_packet_capture_name"].nil?
    path_params[:packet_capture_name] = resource[:packet_capture_name] unless resource.nil? or resource[:packet_capture_name].nil?
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkWatchers/%{network_watcher_name}/packetCaptures" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json text/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
