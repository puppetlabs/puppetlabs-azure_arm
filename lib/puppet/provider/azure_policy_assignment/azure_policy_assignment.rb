...
Puppet::Type.type(:azure_policy_assignment).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("policyAssignmentName", "path", "name"),
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/%{scope}/providers/Microsoft.Authorization/policyassignments/%{policy_assignment_name}", "Get", "[application/json text/json]")
  end
