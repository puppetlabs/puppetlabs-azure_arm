...
Puppet::Type.type(:azure_policy_contract).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type PolicyContract")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type PolicyContract - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    policy_contract = {}
    policy_contract["id"] = resource[:id] unless resource[:id].nil?
    policy_contract["name"] = resource[:name] unless resource[:name].nil?
    policy_contract["properties"] = resource[:properties] unless resource[:properties].nil?
    policy_contract["type"] = resource[:type] unless resource[:type].nil?
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Policy_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("policyId", "path", "policy_id", "policy_id"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ApiManagement/service/%{service_name}/policies/%{policy_id}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ApiManagement/service/%{service_name}/policies/%{policy_id}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Policy_ListByService")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("resourceGroupName", "path", "resource_group_name", "resource_group_name"),
      self.op_param("scope", "query", "scope", "scope"),
      self.op_param("serviceName", "path", "service_name", "service_name"),
      self.op_param("subscriptionId", "path", "subscription_id", "subscription_id"),
    ]
    op_params.each do |i|
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ApiManagement/service/%{service_name}/policies", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Policy_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ApiManagement/service/%{service_name}/policies/%{policy_id}", "Get", "[application/json]")
  end
