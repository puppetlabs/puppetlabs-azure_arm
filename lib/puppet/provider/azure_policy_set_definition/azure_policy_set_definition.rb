...
Puppet::Type.type(:azure_policy_set_definition).provide(:arm) do
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation PolicySetDefinitions_ListBuiltIn")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/providers/Microsoft.Authorization/policySetDefinitions", "Get", "[application/json]")
  end
