...
Puppet::Type.type(:azure_private_zone).provide(:arm) do
  mk_resource_methods
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "maxNumberOfRecordSets"])
        self.deep_delete(hash, [:properties, "maxNumberOfVirtualNetworkLinks"])
        self.deep_delete(hash, [:properties, "maxNumberOfVirtualNetworkLinksWithRegistration"])
        self.deep_delete(hash, [:properties, "numberOfRecordSets"])
        self.deep_delete(hash, [:properties, "numberOfVirtualNetworkLinks"])
        self.deep_delete(hash, [:properties, "numberOfVirtualNetworkLinksWithRegistration"])
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type PrivateZone")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type PrivateZone - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    private_zone = {}
    private_zone["etag"] = resource[:etag] unless resource[:etag].nil?
    private_zone["id"] = resource[:id] unless resource[:id].nil?
    private_zone["location"] = resource[:location] unless resource[:location].nil?
    private_zone["name"] = resource[:name] unless resource[:name].nil?
    private_zone["properties"] = resource[:properties] unless resource[:properties].nil?
    private_zone["tags"] = resource[:tags] unless resource[:tags].nil?
    private_zone["type"] = resource[:type] unless resource[:type].nil?
    return private_zone
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation PrivateZones_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Network/privateDnsZones", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation PrivateZones_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    op_params = [
      ...
      self.op_param("privateZoneName", "path", "name", "private_zone_name"),
      self.op_param("properties", "body", "properties", "properties"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/privateDnsZones/%{private_zone_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation PrivateZones_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/privateDnsZones/%{private_zone_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation PrivateZones_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/privateDnsZones/%{private_zone_name}", "Get", "[application/json]")
  end
