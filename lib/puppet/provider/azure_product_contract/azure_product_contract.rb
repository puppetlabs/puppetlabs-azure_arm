...
Puppet::Type.type(:azure_product_contract).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type ProductContract")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type ProductContract - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    product_contract = {}
    product_contract["id"] = resource[:id] unless resource[:id].nil?
    product_contract["name"] = resource[:name] unless resource[:name].nil?
    product_contract["properties"] = resource[:properties] unless resource[:properties].nil?
    product_contract["type"] = resource[:type] unless resource[:type].nil?
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Product_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ApiManagement/service/%{service_name}/products/%{product_id}" % path_params
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Product_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
    query_params["api-version"] = ENV["azure_api_version"] unless ENV["azure_api_version"].nil?
    query_params["api-version"] = resource[:api_version] unless resource.nil? or resource[:api_version].nil?
    query_params["deleteSubscriptions"] = key_values["deleteSubscriptions"] unless key_values["deleteSubscriptions"].nil?
    query_params["deleteSubscriptions"] = ENV["azure_delete_subscriptions"] unless ENV["azure_delete_subscriptions"].nil?
    query_params["deleteSubscriptions"] = resource[:delete_subscriptions] unless resource.nil? or resource[:delete_subscriptions].nil?
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Product_ListByService")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    query_params["api-version"] = ENV["azure_api_version"] unless ENV["azure_api_version"].nil?
    query_params["api-version"] = resource[:api_version] unless resource.nil? or resource[:api_version].nil?
    query_params["expandGroups"] = key_values["expandGroups"] unless key_values["expandGroups"].nil?
    query_params["expandGroups"] = ENV["azure_expand_groups"] unless ENV["azure_expand_groups"].nil?
    query_params["expandGroups"] = resource[:expand_groups] unless resource.nil? or resource[:expand_groups].nil?
    path_params[:resource_group_name] = key_values["resourceGroupName"] unless key_values["resourceGroupName"].nil?
    path_params[:resource_group_name] = ENV["azure_resource_group_name"] unless ENV["azure_resource_group_name"].nil?
    path_params[:resource_group_name] = resource[:resource_group_name] unless resource.nil? or resource[:resource_group_name].nil?
    path_params[:service_name] = key_values["serviceName"] unless key_values["serviceName"].nil?
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ApiManagement/service/%{service_name}/products" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Product_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
