...
Puppet::Type.type(:azure_profile_resource_format).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type ProfileResourceFormat")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type ProfileResourceFormat - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    profile_resource_format = {}
    profile_resource_format["id"] = resource[:id] unless resource[:id].nil?
    profile_resource_format["name"] = resource[:name] unless resource[:name].nil?
    profile_resource_format["properties"] = resource[:properties] unless resource[:properties].nil?
    profile_resource_format["type"] = resource[:type] unless resource[:type].nil?
    return profile_resource_format
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CustomerInsights/hubs/%{hub_name}/profiles/%{profile_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("hubName", "path", "hub_name", "hub_name"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("locale-code", "query", "locale_code", "locale_code"),
      self.op_param("name", "body", "name", "name"),
      self.op_param("profileName", "path", "profile_name", "profile_name"),
      self.op_param("properties", "body", "properties", "properties"),
      self.op_param("resourceGroupName", "path", "resource_group_name", "resource_group_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CustomerInsights/hubs/%{hub_name}/profiles/%{profile_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Profiles_ListByHub")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CustomerInsights/hubs/%{hub_name}/profiles", "Get", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CustomerInsights/hubs/%{hub_name}/profiles/%{profile_name}", "Get", "[application/json]")
  end
