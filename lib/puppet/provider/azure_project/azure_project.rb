...
Puppet::Type.type(:azure_project).provide(:arm) do
  mk_resource_methods
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "createdTimestamp"])
        self.deep_delete(hash, [:properties, "discoveryStatus"])
        self.deep_delete(hash, [:properties, "lastAssessmentTimestamp"])
        self.deep_delete(hash, [:properties, "lastDiscoverySessionId"])
        self.deep_delete(hash, [:properties, "lastDiscoveryTimestamp"])
        self.deep_delete(hash, [:properties, "numberOfAssessments"])
        self.deep_delete(hash, [:properties, "numberOfGroups"])
        self.deep_delete(hash, [:properties, "numberOfMachines"])
        self.deep_delete(hash, [:properties, "updatedTimestamp"])
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type Project")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type Project - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    project = {}
    project["eTag"] = resource[:e_tag] unless resource[:e_tag].nil?
    project["id"] = resource[:id] unless resource[:id].nil?
    project["location"] = resource[:location] unless resource[:location].nil?
    project["name"] = resource[:name] unless resource[:name].nil?
    project["properties"] = resource[:properties] unless resource[:properties].nil?
    project["tags"] = resource[:tags] unless resource[:tags].nil?
    project["type"] = resource[:type] unless resource[:type].nil?
    return project
  end

  def self.build_key_values
    key_values = {}
    key_values["api-version"] = "2018-02-02"
    key_values
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Projects_ListBySubscription")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      self.op_param("Accept-Language", "header", "accept_language", "accept_language"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Migrate/projects", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Projects_Create")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    op_params = [
      ...
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
      self.op_param("project", "body", "project", "project"),
      self.op_param("projectName", "path", "name", "project_name"),
      self.op_param("properties", "body", "properties", "properties"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/Microsoft.Migrate/projects/%{project_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Projects_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/Microsoft.Migrate/projects/%{project_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Projects_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/Microsoft.Migrate/projects", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Projects_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/Microsoft.Migrate/projects/%{project_name}", "Get", "[application/json]")
  end
