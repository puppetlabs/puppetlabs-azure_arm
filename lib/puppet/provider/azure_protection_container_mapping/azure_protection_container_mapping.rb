...
Puppet::Type.type(:azure_protection_container_mapping).provide(:arm) do
  ...
  def self.build_key_values
    key_values = {}
    key_values["api-version"] = "2018-07-10"
    key_values
  end
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ReplicationProtectionContainerMappings_List")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationProtectionContainerMappings", "Get", "[application/json]")
  end
