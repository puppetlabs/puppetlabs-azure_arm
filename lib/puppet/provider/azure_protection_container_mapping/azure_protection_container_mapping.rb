...
Puppet::Type.type(:azure_protection_container_mapping).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:creation_input] = key_values["creationInput"] unless key_values["creationInput"].nil?
    path_params[:creation_input] = ENV["azure_creation_input"] unless ENV["azure_creation_input"].nil?
    path_params[:creation_input] = resource[:creation_input] unless resource.nil? or resource[:creation_input].nil?
    ...
    path_params[:mapping_name] = key_values["mappingName"] unless key_values["mappingName"].nil?
    path_params[:mapping_name] = ENV["azure_mapping_name"] unless ENV["azure_mapping_name"].nil?
    path_params[:mapping_name] = resource[:mapping_name] unless resource.nil? or resource[:mapping_name].nil?
    ...
    uri_string = "https://management.azure.com/Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationFabrics/%{fabric_name}/replicationProtectionContainers/%{protection_container_name}/replicationProtectionContainerMappings/%{mapping_name}" % path_params
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationFabrics/%{fabric_name}/replicationProtectionContainers/%{protection_container_name}/replicationProtectionContainerMappings" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
