...
Puppet::Type.type(:azure_protection_intent_resource).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type ProtectionIntentResource")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type ProtectionIntentResource - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    protection_intent_resource = {}
    protection_intent_resource["eTag"] = resource[:e_tag] unless resource[:e_tag].nil?
    protection_intent_resource["id"] = resource[:id] unless resource[:id].nil?
    protection_intent_resource["location"] = resource[:location] unless resource[:location].nil?
    protection_intent_resource["name"] = resource[:name] unless resource[:name].nil?
    protection_intent_resource["properties"] = resource[:properties] unless resource[:properties].nil?
    protection_intent_resource["tags"] = resource[:tags] unless resource[:tags].nil?
    protection_intent_resource["type"] = resource[:type] unless resource[:type].nil?
    return protection_intent_resource
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation ProtectionIntent_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("intentObjectName", "path", "intent_object_name", "intent_object_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{vault_name}/backupFabrics/%{fabric_name}/backupProtectionIntent/%{intent_object_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ProtectionIntent_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{vault_name}/backupFabrics/%{fabric_name}/backupProtectionIntent/%{intent_object_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation BackupProtectionIntent_List")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{vault_name}/backupProtectionIntents", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ProtectionIntent_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{vault_name}/backupFabrics/%{fabric_name}/backupProtectionIntent/%{intent_object_name}", "Get", "[application/json]")
  end
