...
Puppet::Type.type(:azure_provisioning_service_description).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          etag: item["etag"],
          id: item["id"],
          iot_dps_description: item["iotDpsDescription"],
          location: item["location"],
          name: item["name"],
          properties: item["properties"],
          provisioning_service_name: item["provisioningServiceName"],
        ...
        self.deep_delete(hash, [:properties, "deviceProvisioningHostName"])
        self.deep_delete(hash, [:properties, "idScope"])

        self.deep_delete(hash, [:properties, "iotHubs", "name"])
        self.deep_delete(hash, [:properties, "serviceOperationsHostName"])

        self.deep_delete(hash, [:sku, "tier"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      iot_dps_description: instance.iot_dps_description.respond_to?(:to_hash) ? instance.iot_dps_description.to_hash : instance.iot_dps_description,
      ...
      provisioning_service_name: instance.provisioning_service_name.respond_to?(:to_hash) ? instance.provisioning_service_name.to_hash : instance.provisioning_service_name,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type ProvisioningServiceDescription")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type ProvisioningServiceDescription - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    provisioning_service_description = {}
    provisioning_service_description["etag"] = resource[:etag] unless resource[:etag].nil?
    provisioning_service_description["id"] = resource[:id] unless resource[:id].nil?
    provisioning_service_description["location"] = resource[:location] unless resource[:location].nil?
    provisioning_service_description["name"] = resource[:name] unless resource[:name].nil?
    provisioning_service_description["properties"] = resource[:properties] unless resource[:properties].nil?
    provisioning_service_description["sku"] = resource[:sku] unless resource[:sku].nil?
    provisioning_service_description["tags"] = resource[:tags] unless resource[:tags].nil?
    provisioning_service_description["type"] = resource[:type] unless resource[:type].nil?
    return provisioning_service_description
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation IotDpsResource_ListBySubscription")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Devices/provisioningServices", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation IotDpsResource_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    op_params = [
      ...
      self.op_param("etag", "body", "etag", "etag"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("iotDpsDescription", "body", "iot_dps_description", "iot_dps_description"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
      self.op_param("properties", "body", "properties", "properties"),
      self.op_param("provisioningServiceName", "path", "provisioning_service_name", "provisioning_service_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Devices/provisioningServices/%{provisioning_service_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation IotDpsResource_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Devices/provisioningServices/%{provisioning_service_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation IotDpsResource_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Devices/provisioningServices", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation IotDpsResource_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Devices/provisioningServices/%{provisioning_service_name}", "Get", "[application/json]")
  end
