...
Puppet::Type.type(:azure_proximity_placement_group).provide(:arm) do
  mk_resource_methods
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "availabilitySets"])
        self.deep_delete(hash, [:properties, "virtualMachines"])
        self.deep_delete(hash, [:properties, "virtualMachineScaleSets"])
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type ProximityPlacementGroup")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type ProximityPlacementGroup - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    proximity_placement_group["id"] = resource[:id] unless resource[:id].nil?
    proximity_placement_group["location"] = resource[:location] unless resource[:location].nil?
    proximity_placement_group["name"] = resource[:name] unless resource[:name].nil?
    proximity_placement_group["properties"] = resource[:properties] unless resource[:properties].nil?
    proximity_placement_group["tags"] = resource[:tags] unless resource[:tags].nil?
    proximity_placement_group["type"] = resource[:type] unless resource[:type].nil?
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation ProximityPlacementGroups_ListBySubscription")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Compute/proximityPlacementGroups", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ProximityPlacementGroups_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    op_params = [
      ...
      self.op_param("properties", "body", "properties", "properties"),
      self.op_param("proximityPlacementGroupName", "path", "name", "proximity_placement_group_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/proximityPlacementGroups/%{proximity_placement_group_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ProximityPlacementGroups_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/proximityPlacementGroups/%{proximity_placement_group_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ProximityPlacementGroups_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/proximityPlacementGroups/%{proximity_placement_group_name}", "Get", "[application/json]")
  end
