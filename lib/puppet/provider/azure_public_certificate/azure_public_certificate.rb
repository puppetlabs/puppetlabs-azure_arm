...
Puppet::Type.type(:azure_public_certificate).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:public_certificate] = key_values["publicCertificate"] unless key_values["publicCertificate"].nil?
    path_params[:public_certificate] = ENV["azure_public_certificate"] unless ENV["azure_public_certificate"].nil?
    path_params[:public_certificate] = resource[:public_certificate] unless resource.nil? or resource[:public_certificate].nil?
    path_params[:public_certificate_name] = key_values["publicCertificateName"] unless key_values["publicCertificateName"].nil?
    path_params[:public_certificate_name] = ENV["azure_public_certificate_name"] unless ENV["azure_public_certificate_name"].nil?
    path_params[:public_certificate_name] = resource[:name] unless resource.nil? or resource[:name].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/publicCertificates/%{public_certificate_name}" % path_params
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/publicCertificates" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
