  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "ipConfiguration", "properties", "subnet", "properties", "networkSecurityGroup", "name"])

        self.deep_delete(hash, [:properties, "ipConfiguration", "properties", "subnet", "properties", "networkSecurityGroup", "properties", "defaultSecurityRules", "properties", "destinationApplicationSecurityGroups", "etag"])
        self.deep_delete(hash, [:properties, "ipConfiguration", "properties", "subnet", "properties", "networkSecurityGroup", "properties", "defaultSecurityRules", "properties", "destinationApplicationSecurityGroups", "name"])

        self.deep_delete(hash, [:properties, "ipConfiguration", "properties", "subnet", "properties", "networkSecurityGroup", "properties", "defaultSecurityRules", "properties", "destinationApplicationSecurityGroups", "properties", "provisioningState"])
        self.deep_delete(hash, [:properties, "ipConfiguration", "properties", "subnet", "properties", "networkSecurityGroup", "properties", "defaultSecurityRules", "properties", "destinationApplicationSecurityGroups", "properties", "resourceGuid"])
        self.deep_delete(hash, [:properties, "ipConfiguration", "properties", "subnet", "properties", "networkSecurityGroup", "properties", "defaultSecurityRules", "properties", "destinationApplicationSecurityGroups", "type"])

        self.deep_delete(hash, [:properties, "ipConfiguration", "properties", "subnet", "properties", "networkSecurityGroup", "properties", "networkInterfaces", "name"])

        self.deep_delete(hash, [:properties, "ipConfiguration", "properties", "subnet", "properties", "networkSecurityGroup", "properties", "networkInterfaces", "type"])
        self.deep_delete(hash, [:properties, "ipConfiguration", "properties", "subnet", "properties", "networkSecurityGroup", "type"])
