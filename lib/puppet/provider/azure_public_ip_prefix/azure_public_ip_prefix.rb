...
Puppet::Type.type(:azure_public_ip_prefix).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type PublicIPPrefix")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type PublicIPPrefix - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    public_ip_prefix = {}
    public_ip_prefix["etag"] = resource[:etag] unless resource[:etag].nil?
    public_ip_prefix["id"] = resource[:id] unless resource[:id].nil?
    public_ip_prefix["location"] = resource[:location] unless resource[:location].nil?
    public_ip_prefix["name"] = resource[:name] unless resource[:name].nil?
    public_ip_prefix["properties"] = resource[:properties] unless resource[:properties].nil?
    public_ip_prefix["sku"] = resource[:sku] unless resource[:sku].nil?
    public_ip_prefix["tags"] = resource[:tags] unless resource[:tags].nil?
    public_ip_prefix["type"] = resource[:type] unless resource[:type].nil?
    public_ip_prefix["zones"] = resource[:zones] unless resource[:zones].nil?
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation PublicIPPrefixes_ListAll")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Network/publicIPPrefixes", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation PublicIPPrefixes_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    op_params = [
      ...
      self.op_param("properties", "body", "properties", "properties"),
      self.op_param("publicIpPrefixName", "path", "name", "public_ip_prefix_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/publicIPPrefixes/%{public_ip_prefix_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation PublicIPPrefixes_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/publicIPPrefixes/%{public_ip_prefix_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation PublicIPPrefixes_List")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/publicIPPrefixes", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation PublicIPPrefixes_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/publicIPPrefixes/%{public_ip_prefix_name}", "Get", "[application/json]")
  end
