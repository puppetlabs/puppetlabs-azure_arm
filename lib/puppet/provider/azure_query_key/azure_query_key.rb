...
Puppet::Type.type(:azure_query_key).provide(:arm) do
  mk_resource_methods
  ...
  def key=(value)
    Puppet.info("key setter called to change to #{value}")
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type QueryKey")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type QueryKey - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    query_key = {}
    query_key["key"] = resource[:key] unless resource[:key].nil?
    query_key["name"] = resource[:name] unless resource[:name].nil?
    return query_key
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation QueryKeys_Create")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    path_params[:search_service_name] = resource[:search_service_name] unless resource.nil? or resource[:search_service_name].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Search/searchServices/%{search_service_name}/createQueryKey/%{name}" % path_params
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation QueryKeys_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
    query_params["api-version"] = ENV["azure_api_version"] unless ENV["azure_api_version"].nil?
    query_params["api-version"] = resource[:api_version] unless resource.nil? or resource[:api_version].nil?
    path_params[:key] = key_values["key"] unless key_values["key"].nil?
    path_params[:key] = ENV["azure_key"] unless ENV["azure_key"].nil?
    path_params[:key] = resource[:key] unless resource.nil? or resource[:key].nil?
    path_params[:resource_group_name] = key_values["resourceGroupName"] unless key_values["resourceGroupName"].nil?
    path_params[:resource_group_name] = ENV["azure_resource_group_name"] unless ENV["azure_resource_group_name"].nil?
    path_params[:resource_group_name] = resource[:resource_group_name] unless resource.nil? or resource[:resource_group_name].nil?
    path_params[:search_service_name] = key_values["searchServiceName"] unless key_values["searchServiceName"].nil?
    ...
    path_params[:x_ms_client_request_id] = ENV["azure_x_ms_client_request_id"] unless ENV["azure_x_ms_client_request_id"].nil?
    path_params[:x_ms_client_request_id] = resource[:x_ms_client_request_id] unless resource.nil? or resource[:x_ms_client_request_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Search/searchServices/%{search_service_name}/deleteQueryKey/%{key}" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation QueryKeys_ListBySearchService")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
    ...
    path_params[:x_ms_client_request_id] = ENV["azure_x_ms_client_request_id"] unless ENV["azure_x_ms_client_request_id"].nil?
    path_params[:x_ms_client_request_id] = resource[:x_ms_client_request_id] unless resource.nil? or resource[:x_ms_client_request_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Search/searchServices/%{search_service_name}/listQueryKeys" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
