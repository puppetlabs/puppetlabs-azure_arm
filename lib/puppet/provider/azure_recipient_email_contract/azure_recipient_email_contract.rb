...
Puppet::Type.type(:azure_recipient_email_contract).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type RecipientEmailContract")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type RecipientEmailContract - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    recipient_email_contract = {}
    recipient_email_contract["id"] = resource[:id] unless resource[:id].nil?
    recipient_email_contract["name"] = resource[:name] unless resource[:name].nil?
    recipient_email_contract["properties"] = resource[:properties] unless resource[:properties].nil?
    recipient_email_contract["type"] = resource[:type] unless resource[:type].nil?
    return recipient_email_contract
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation NotificationRecipientEmail_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    path_params[:email] = key_values["email"] unless key_values["email"].nil?
    path_params[:email] = ENV["azure_email"] unless ENV["azure_email"].nil?
    path_params[:email] = resource[:email] unless resource.nil? or resource[:email].nil?
    path_params[:notification_name] = key_values["notificationName"] unless key_values["notificationName"].nil?
    path_params[:notification_name] = ENV["azure_notification_name"] unless ENV["azure_notification_name"].nil?
    path_params[:notification_name] = resource[:notification_name] unless resource.nil? or resource[:notification_name].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ApiManagement/service/%{service_name}/notifications/%{notification_name}/recipientEmails/%{email}" % path_params
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation NotificationRecipientEmail_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation NotificationRecipientEmail_ListByNotification")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ApiManagement/service/%{service_name}/notifications/%{notification_name}/recipientEmails" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
  ...
  def exists?
    Puppet.info("exists_list for resource #{name} of type <no value>")
    return exists_list(resource)
  end

  
  def exists_list(resource)
    response = self.class.invoke_list_with_params(resource)
