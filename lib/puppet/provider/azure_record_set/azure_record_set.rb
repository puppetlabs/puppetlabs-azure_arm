...
Puppet::Type.type(:azure_record_set).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("recordType", "path", "record_type"),
      self.op_param("relativeRecordSetName", "path", "relative_record_set_name"),
      self.op_param("resourceGroupName", "path", "resource_group_name"),
      self.op_param("subscriptionId", "path", "subscription_id"),
      self.op_param("zoneName", "path", "zone_name"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
      name = i[:name]
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    op_params = [
      self.op_param("$recordsetnamesuffix", "query", "$recordsetnamesuffix"),
