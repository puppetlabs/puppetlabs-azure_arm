...
Puppet::Type.type(:azure_recovery_services_provider).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type RecoveryServicesProvider")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type RecoveryServicesProvider - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    recovery_services_provider = {}
    recovery_services_provider["id"] = resource[:id] unless resource[:id].nil?
    recovery_services_provider["location"] = resource[:location] unless resource[:location].nil?
    recovery_services_provider["name"] = resource[:name] unless resource[:name].nil?
    recovery_services_provider["properties"] = resource[:properties] unless resource[:properties].nil?
    recovery_services_provider["type"] = resource[:type] unless resource[:type].nil?
    return recovery_services_provider
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation ReplicationRecoveryServicesProviders_Create")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      self.op_param("addProviderInput", "body", "add_provider_input", "add_provider_input"),
      ...
      self.op_param("providerName", "path", "provider_name", "provider_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationFabrics/%{fabric_name}/replicationRecoveryServicesProviders/%{provider_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ReplicationRecoveryServicesProviders_Purge")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationFabrics/%{fabric_name}/replicationRecoveryServicesProviders/%{provider_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ReplicationRecoveryServicesProviders_ListByReplicationFabrics")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationFabrics/%{fabric_name}/replicationRecoveryServicesProviders", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ReplicationRecoveryServicesProviders_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationFabrics/%{fabric_name}/replicationRecoveryServicesProviders/%{provider_name}", "Get", "[application/json]")
  end
