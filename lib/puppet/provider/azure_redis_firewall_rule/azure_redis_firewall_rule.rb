...
Puppet::Type.type(:azure_redis_firewall_rule).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type RedisFirewallRule")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type RedisFirewallRule - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    redis_firewall_rule = {}
    redis_firewall_rule["id"] = resource[:id] unless resource[:id].nil?
    redis_firewall_rule["name"] = resource[:name] unless resource[:name].nil?
    redis_firewall_rule["properties"] = resource[:properties] unless resource[:properties].nil?
    redis_firewall_rule["type"] = resource[:type] unless resource[:type].nil?
    return redis_firewall_rule
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("cacheName", "path", "cache_name", "cache_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Cache/Redis/%{cache_name}/firewallRules/%{rule_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Cache/Redis/%{cache_name}/firewallRules/%{rule_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation FirewallRules_ListByRedisResource")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Cache/Redis/%{cache_name}/firewallRules", "Get", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Cache/Redis/%{cache_name}/firewallRules/%{rule_name}", "Get", "[application/json]")
  end
