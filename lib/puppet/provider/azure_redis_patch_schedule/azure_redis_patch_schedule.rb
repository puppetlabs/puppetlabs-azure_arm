...
Puppet::Type.type(:azure_redis_patch_schedule).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:default] = key_values["default"] unless key_values["default"].nil?
    path_params[:default] = ENV["azure_default"] unless ENV["azure_default"].nil?
    path_params[:default] = resource[:default] unless resource.nil? or resource[:default].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Cache/Redis/%{name}/patchSchedules/%{default}" % path_params
