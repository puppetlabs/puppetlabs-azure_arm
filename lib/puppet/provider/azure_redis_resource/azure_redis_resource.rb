...
Puppet::Type.type(:azure_redis_resource).provide(:arm) do
  mk_resource_methods
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "accessKeys", "primaryKey"])
        self.deep_delete(hash, [:properties, "accessKeys", "secondaryKey"])
        self.deep_delete(hash, [:properties, "hostName"])

        self.deep_delete(hash, [:properties, "linkedServers", "id"])
        self.deep_delete(hash, [:properties, "port"])
        self.deep_delete(hash, [:properties, "provisioningState"])
        self.deep_delete(hash, [:properties, "redisVersion"])
        self.deep_delete(hash, [:properties, "sslPort"])
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type RedisResource")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type RedisResource - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    redis_resource = {}
    redis_resource["id"] = resource[:id] unless resource[:id].nil?
    redis_resource["location"] = resource[:location] unless resource[:location].nil?
    redis_resource["name"] = resource[:name] unless resource[:name].nil?
    redis_resource["properties"] = resource[:properties] unless resource[:properties].nil?
    redis_resource["tags"] = resource[:tags] unless resource[:tags].nil?
    redis_resource["type"] = resource[:type] unless resource[:type].nil?
    redis_resource["zones"] = resource[:zones] unless resource[:zones].nil?
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Redis_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Cache/Redis", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Redis_Create")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Cache/Redis/%{name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Redis_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Cache/Redis/%{name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Redis_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Cache/Redis", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Redis_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Cache/Redis/%{name}", "Get", "[application/json]")
  end
