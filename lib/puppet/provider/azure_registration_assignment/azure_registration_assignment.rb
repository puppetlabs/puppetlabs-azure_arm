...
Puppet::Type.type(:azure_registration_assignment).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type RegistrationAssignment")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type RegistrationAssignment - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    registration_assignment["id"] = resource[:id] unless resource[:id].nil?
    registration_assignment["name"] = resource[:name] unless resource[:name].nil?
    registration_assignment["properties"] = resource[:properties] unless resource[:properties].nil?
    registration_assignment["type"] = resource[:type] unless resource[:type].nil?
    return registration_assignment
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation RegistrationAssignments_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("registrationAssignmentId", "path", "id", "registration_assignment_id"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/%{scope}/providers/Microsoft.ManagedServices/registrationAssignments/%{registration_assignment_id}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation RegistrationAssignments_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/%{scope}/providers/Microsoft.ManagedServices/registrationAssignments/%{registration_assignment_id}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation RegistrationAssignments_List")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/%{scope}/providers/Microsoft.ManagedServices/registrationAssignments", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation RegistrationAssignments_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/%{scope}/providers/Microsoft.ManagedServices/registrationAssignments/%{registration_assignment_id}", "Get", "[application/json]")
  end
