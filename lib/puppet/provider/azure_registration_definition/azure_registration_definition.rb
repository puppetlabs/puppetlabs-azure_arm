...
Puppet::Type.type(:azure_registration_definition).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type RegistrationDefinition")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type RegistrationDefinition - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    registration_definition["id"] = resource[:id] unless resource[:id].nil?
    registration_definition["name"] = resource[:name] unless resource[:name].nil?
    registration_definition["plan"] = resource[:plan] unless resource[:plan].nil?
    registration_definition["properties"] = resource[:properties] unless resource[:properties].nil?
    registration_definition["type"] = resource[:type] unless resource[:type].nil?
    return registration_definition
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation RegistrationDefinitions_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("registrationDefinitionId", "path", "id", "registration_definition_id"),
      self.op_param("requestBody", "body", "request_body", "request_body"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/%{scope}/providers/Microsoft.ManagedServices/registrationDefinitions/%{registration_definition_id}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation RegistrationDefinitions_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/%{scope}/providers/Microsoft.ManagedServices/registrationDefinitions/%{registration_definition_id}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation RegistrationDefinitions_List")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/%{scope}/providers/Microsoft.ManagedServices/registrationDefinitions", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation RegistrationDefinitions_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/%{scope}/providers/Microsoft.ManagedServices/registrationDefinitions/%{registration_definition_id}", "Get", "[application/json]")
  end
