...
Puppet::Type.type(:azure_registry).provide(:arm) do
  mk_resource_methods
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "adminUserEnabled"])
        self.deep_delete(hash, [:properties, "creationDate"])
        self.deep_delete(hash, [:properties, "loginServer"])

        self.deep_delete(hash, [:properties, "networkRuleSet", "defaultAction"])

        self.deep_delete(hash, [:properties, "networkRuleSet", "ipRules", "action"])

        self.deep_delete(hash, [:properties, "networkRuleSet", "virtualNetworkRules", "action"])

        self.deep_delete(hash, [:properties, "policies", "quarantinePolicy", "status"])

        self.deep_delete(hash, [:properties, "policies", "retentionPolicy", "days"])
        self.deep_delete(hash, [:properties, "policies", "retentionPolicy", "lastUpdatedTime"])
        self.deep_delete(hash, [:properties, "policies", "retentionPolicy", "status"])

        self.deep_delete(hash, [:properties, "policies", "trustPolicy", "status"])
        self.deep_delete(hash, [:properties, "policies", "trustPolicy", "type"])
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type Registry")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type Registry - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    registry = {}
    registry["id"] = resource[:id] unless resource[:id].nil?
    registry["location"] = resource[:location] unless resource[:location].nil?
    registry["name"] = resource[:name] unless resource[:name].nil?
    registry["properties"] = resource[:properties] unless resource[:properties].nil?
    registry["sku"] = resource[:sku] unless resource[:sku].nil?
    registry["tags"] = resource[:tags] unless resource[:tags].nil?
    registry["type"] = resource[:type] unless resource[:type].nil?
    return registry
  end

  def self.build_key_values
    key_values = {}
    key_values["api-version"] = "2019-05-01"
    key_values
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Registries_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.ContainerRegistry/registries", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Registries_Create")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    op_params = [
      ...
      self.op_param("name", "body", "name", "name"),
      self.op_param("properties", "body", "properties", "properties"),
      self.op_param("registry", "body", "registry", "registry"),
      self.op_param("registryName", "path", "name", "registry_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ContainerRegistry/registries/%{registry_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Registries_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ContainerRegistry/registries/%{registry_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Registries_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ContainerRegistry/registries/%{registry_name}", "Get", "[application/json]")
  end
