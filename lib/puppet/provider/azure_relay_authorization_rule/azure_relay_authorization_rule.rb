...
Puppet::Type.type(:azure_relay_authorization_rule).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type AuthorizationRule")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type AuthorizationRule - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    authorization_rule = {}
    authorization_rule["id"] = resource[:id] unless resource[:id].nil?
    authorization_rule["name"] = resource[:name] unless resource[:name].nil?
    authorization_rule["properties"] = resource[:properties] unless resource[:properties].nil?
    authorization_rule["type"] = resource[:type] unless resource[:type].nil?
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("authorizationRuleName", "path", "name", "authorization_rule_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Relay/namespaces/%{namespace_name}/authorizationRules/%{authorization_rule_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Relay/namespaces/%{namespace_name}/authorizationRules/%{authorization_rule_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation WCFRelays_ListAuthorizationRules")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("namespaceName", "path", "namespace_name", "namespace_name"),
      self.op_param("relayName", "path", "relay_name", "relay_name"),
      self.op_param("resourceGroupName", "path", "resource_group_name", "resource_group_name"),
      self.op_param("subscriptionId", "path", "subscription_id", "subscription_id"),
    ]
    op_params.each do |i|
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Relay/namespaces/%{namespace_name}/wcfRelays/%{relay_name}/authorizationRules", "Get", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Relay/namespaces/%{namespace_name}/authorizationRules/%{authorization_rule_name}", "Get", "[application/json]")
  end
