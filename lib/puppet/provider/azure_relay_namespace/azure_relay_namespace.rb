...
Puppet::Type.type(:azure_relay_namespace).provide(:arm) do
  mk_resource_methods
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "createdAt"])
        self.deep_delete(hash, [:properties, "metricId"])
        self.deep_delete(hash, [:properties, "provisioningState"])
        self.deep_delete(hash, [:properties, "serviceBusEndpoint"])
        self.deep_delete(hash, [:properties, "updatedAt"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      namespace_name: instance.namespace_name.respond_to?(:to_hash) ? instance.namespace_name.to_hash : instance.namespace_name,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type RelayNamespace")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type RelayNamespace - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    relay_namespace = {}
    relay_namespace["id"] = resource[:id] unless resource[:id].nil?
    relay_namespace["location"] = resource[:location] unless resource[:location].nil?
    relay_namespace["name"] = resource[:name] unless resource[:name].nil?
    relay_namespace["properties"] = resource[:properties] unless resource[:properties].nil?
    relay_namespace["sku"] = resource[:sku] unless resource[:sku].nil?
    relay_namespace["tags"] = resource[:tags] unless resource[:tags].nil?
    relay_namespace["type"] = resource[:type] unless resource[:type].nil?
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Namespaces_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Relay/namespaces", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Namespaces_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Relay/namespaces/%{namespace_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Namespaces_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Relay/namespaces/%{namespace_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Namespaces_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Relay/namespaces", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Namespaces_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Relay/namespaces/%{namespace_name}", "Get", "[application/json]")
  end
