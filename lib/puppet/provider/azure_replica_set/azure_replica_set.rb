...
Puppet::Type.type(:azure_replica_set).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type ReplicaSet")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type ReplicaSet - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    replica_set = {}
    replica_set["etag"] = resource[:etag] unless resource[:etag].nil?
    replica_set["id"] = resource[:id] unless resource[:id].nil?
    replica_set["location"] = resource[:location] unless resource[:location].nil?
    replica_set["name"] = resource[:name] unless resource[:name].nil?
    replica_set["properties"] = resource[:properties] unless resource[:properties].nil?
    replica_set["tags"] = resource[:tags] unless resource[:tags].nil?
    replica_set["type"] = resource[:type] unless resource[:type].nil?
    return replica_set
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation ReplicaSets_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("domainServiceName", "path", "domain_service_name", "domain_service_name"),
      ...
      self.op_param("replicaSet", "body", "replica_set", "replica_set"),
      self.op_param("replicaSetName", "path", "name", "replica_set_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.AAD/domainServices/%{domain_service_name}/replicaSets/%{replica_set_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ReplicaSets_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.AAD/domainServices/%{domain_service_name}/replicaSets/%{replica_set_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ReplicaSets_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.AAD/domainServices/%{domain_service_name}/replicaSets", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ReplicaSets_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.AAD/domainServices/%{domain_service_name}/replicaSets/%{replica_set_name}", "Get", "[application/json]")
  end
