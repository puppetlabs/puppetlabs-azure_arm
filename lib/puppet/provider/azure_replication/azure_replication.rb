...
Puppet::Type.type(:azure_replication).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:replication] = key_values["replication"] unless key_values["replication"].nil?
    path_params[:replication] = ENV["azure_replication"] unless ENV["azure_replication"].nil?
    path_params[:replication] = resource[:replication] unless resource.nil? or resource[:replication].nil?
    path_params[:replication_name] = key_values["replicationName"] unless key_values["replicationName"].nil?
    path_params[:replication_name] = ENV["azure_replication_name"] unless ENV["azure_replication_name"].nil?
    path_params[:replication_name] = resource[:name] unless resource.nil? or resource[:name].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ContainerRegistry/registries/%{registry_name}/replications/%{replication_name}" % path_params
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ContainerRegistry/registries/%{registry_name}/replications" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
