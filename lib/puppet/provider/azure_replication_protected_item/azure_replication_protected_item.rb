...
Puppet::Type.type(:azure_replication_protected_item).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("replicatedProtectedItemName", "path", "replicated_protected_item_name", "replicated_protected_item_name"),
  ...
  def self.invoke_update(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("properties", "body", "properties", "properties"),
      self.op_param("protectionContainerName", "path", "protection_container_name", "protection_container_name"),
      self.op_param("replicationProtectedItemName", "path", "name", "replication_protected_item_name"),
      self.op_param("resourceGroupName", "path", "resource_group_name", "resource_group_name"),
      self.op_param("resourceName", "path", "resource_name", "resource_name"),
      self.op_param("subscriptionId", "path", "subscription_id", "subscription_id"),
      self.op_param("type", "body", "type", "type"),
      self.op_param("updateMobilityServiceRequest", "body", "update_mobility_service_request", "update_mobility_service_request"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
      name = i[:name]
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationFabrics/%{fabric_name}/replicationProtectionContainers/%{protection_container_name}/replicationProtectedItems/%{replicated_protected_item_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationProtectedItems", "Get", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationFabrics/%{fabric_name}/replicationProtectionContainers/%{protection_container_name}/replicationProtectedItems/%{replicated_protected_item_name}", "Get", "[application/json]")
  end
