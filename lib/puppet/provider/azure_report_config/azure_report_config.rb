...
Puppet::Type.type(:azure_report_config).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type ReportConfig")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type ReportConfig - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    report_config = {}
    report_config["id"] = resource[:id] unless resource[:id].nil?
    report_config["name"] = resource[:name] unless resource[:name].nil?
    report_config["properties"] = resource[:properties] unless resource[:properties].nil?
    report_config["tags"] = resource[:tags] unless resource[:tags].nil?
    report_config["type"] = resource[:type] unless resource[:type].nil?
    return report_config
  end

  def self.build_key_values
    key_values = {}
    key_values["api-version"] = "2018-05-31"
    key_values
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation ReportConfig_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Consumption/reportconfigs", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ReportConfig_CreateOrUpdateByResourceGroupName")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.4"
    ...
    op_params = [
      ...
      self.op_param("reportConfigName", "path", "name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Consumption/reportconfigs/%{report_config_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ReportConfig_DeleteByResourceGroupName")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.4"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Consumption/reportconfigs/%{report_config_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ReportConfig_ListByResourceGroupName")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.4"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Consumption/reportconfigs", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ReportConfig_GetByResourceGroupName")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.4"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Consumption/reportconfigs/%{report_config_name}", "Get", "[application/json]")
  end
