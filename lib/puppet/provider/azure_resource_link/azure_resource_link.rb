...
Puppet::Type.type(:azure_resource_link).provide(:arm) do
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/providers/Microsoft.Resources/links" % path_params
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    query_params["api-version"] = ENV["azure_api_version"] unless ENV["azure_api_version"].nil?
    query_params["api-version"] = resource[:api_version] unless resource.nil? or resource[:api_version].nil?
    path_params[:link_id] = key_values["linkId"] unless key_values["linkId"].nil?
    path_params[:link_id] = ENV["azure_link_id"] unless ENV["azure_link_id"].nil?
    path_params[:link_id] = resource[:link_id] unless resource.nil? or resource[:link_id].nil?
    ...
    uri_string = "https://management.azure.com/%{link_id}" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ResourceLinks_ListAtSourceScope")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["$filter"] = key_values["$filter"] unless key_values["$filter"].nil?
    ...
    uri_string = "https://management.azure.com/%{scope}/providers/Microsoft.Resources/links" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
