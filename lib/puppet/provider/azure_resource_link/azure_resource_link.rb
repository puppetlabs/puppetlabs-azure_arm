...
Puppet::Type.type(:azure_resource_link).provide(:arm) do
  mk_resource_methods
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "sourceId"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      link_id: instance.link_id.respond_to?(:to_hash) ? instance.link_id.to_hash : instance.link_id,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type ResourceLink")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type ResourceLink - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    resource_link = {}
    resource_link["id"] = resource[:id] unless resource[:id].nil?
    resource_link["name"] = resource[:name] unless resource[:name].nil?
    resource_link["properties"] = resource[:properties] unless resource[:properties].nil?
    resource_link["type"] = resource[:type] unless resource[:type].nil?
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation ResourceLinks_ListAtSubscription")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Resources/links", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ResourceLinks_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("linkId", "path", "link_id", "link_id"),
      self.op_param("name", "body", "name", "name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/%{link_id}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ResourceLinks_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/%{link_id}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ResourceLinks_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/%{link_id}", "Get", "[application/json]")
  end
