...
Puppet::Type.type(:azure_role_assignment).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type RoleAssignment")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type RoleAssignment - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    role_assignment = {}
    role_assignment["id"] = resource[:id] unless resource[:id].nil?
    role_assignment["name"] = resource[:name] unless resource[:name].nil?
    role_assignment["properties"] = resource[:properties] unless resource[:properties].nil?
    role_assignment["type"] = resource[:type] unless resource[:type].nil?
    return role_assignment
  end

  def self.build_key_values
    key_values = {}
    key_values["api-version"] = "2015-07-01"
    key_values
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation RoleAssignments_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Authorization/roleAssignments", "Get", "[application/json text/json]")
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("roleAssignmentName", "path", "name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/%{scope}/providers/Microsoft.Authorization/roleAssignments/%{role_assignment_name}", "Put", "[application/json text/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/%{scope}/providers/Microsoft.Authorization/roleAssignments/%{role_assignment_name}", "Delete", "[application/json text/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation RoleAssignments_ListForResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.4"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Authorization/roleAssignments", "Get", "[application/json text/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/%{scope}/providers/Microsoft.Authorization/roleAssignments/%{role_assignment_name}", "Get", "[application/json text/json]")
  end
