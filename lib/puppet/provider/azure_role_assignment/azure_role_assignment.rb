...
Puppet::Type.type(:azure_role_assignment).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("roleAssignmentName", "path", "name", "role_assignment_name"),
  ...
  def self.invoke_update(resource = nil, body_params = nil)
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("parameters", "body", "parameters", "parameters"),
      self.op_param("roleAssignmentId", "path", "id", "role_assignment_id"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
      name = i[:name]
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/%{role_assignment_id}", "Put", "[application/json text/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/%{role_assignment_id}", "Delete", "[application/json text/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/%{role_assignment_id}", "Get", "[application/json text/json]")
  end
