...
Puppet::Type.type(:azure_route_filter).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          route_filter_parameters: item["routeFilterParameters"],
        ...
        self.deep_delete(hash, [:properties, "ipv6Peerings", "etag"])

        self.deep_delete(hash, [:properties, "ipv6Peerings", "properties", "connections", "etag"])

        self.deep_delete(hash, [:properties, "ipv6Peerings", "properties", "connections", "properties", "provisioningState"])
        self.deep_delete(hash, [:properties, "ipv6Peerings", "properties", "connections", "type"])

        self.deep_delete(hash, [:properties, "ipv6Peerings", "properties", "expressRouteConnection", "id"])

        self.deep_delete(hash, [:properties, "ipv6Peerings", "properties", "peeredConnections"])

        self.deep_delete(hash, [:properties, "ipv6Peerings", "type"])
        self.deep_delete(hash, [:properties, "provisioningState"])

        self.deep_delete(hash, [:properties, "rules", "etag"])

        self.deep_delete(hash, [:properties, "rules", "properties", "provisioningState"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      route_filter_parameters: instance.route_filter_parameters.respond_to?(:to_hash) ? instance.route_filter_parameters.to_hash : instance.route_filter_parameters,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type RouteFilter")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type RouteFilter - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    route_filter = {}
    route_filter["etag"] = resource[:etag] unless resource[:etag].nil?
    route_filter["id"] = resource[:id] unless resource[:id].nil?
    route_filter["location"] = resource[:location] unless resource[:location].nil?
    route_filter["name"] = resource[:name] unless resource[:name].nil?
    route_filter["properties"] = resource[:properties] unless resource[:properties].nil?
    route_filter["tags"] = resource[:tags] unless resource[:tags].nil?
    route_filter["type"] = resource[:type] unless resource[:type].nil?
    return route_filter
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation RouteFilters_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Network/routeFilters", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation RouteFilters_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    op_params = [
      ...
      self.op_param("routeFilterName", "path", "name", "route_filter_name"),
      self.op_param("routeFilterParameters", "body", "route_filter_parameters", "route_filter_parameters"),
      self.op_param("subscriptionId", "path", "subscription_id", "subscription_id"),
      self.op_param("tags", "body", "tags", "tags"),
      self.op_param("type", "body", "type", "type"),
    ]
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/routeFilters/%{route_filter_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation RouteFilters_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/routeFilters/%{route_filter_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation RouteFilters_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/routeFilters", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation RouteFilters_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/routeFilters/%{route_filter_name}", "Get", "[application/json]")
  end
