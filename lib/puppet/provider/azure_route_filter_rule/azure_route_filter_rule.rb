...
Puppet::Type.type(:azure_route_filter_rule).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type RouteFilterRule")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type RouteFilterRule - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    route_filter_rule = {}
    route_filter_rule["etag"] = resource[:etag] unless resource[:etag].nil?
    route_filter_rule["id"] = resource[:id] unless resource[:id].nil?
    route_filter_rule["location"] = resource[:location] unless resource[:location].nil?
    route_filter_rule["name"] = resource[:name] unless resource[:name].nil?
    route_filter_rule["properties"] = resource[:properties] unless resource[:properties].nil?
    return route_filter_rule
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation RouteFilterRules_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    path_params[:route_filter_name] = resource[:route_filter_name] unless resource.nil? or resource[:route_filter_name].nil?
    path_params[:route_filter_rule_parameters] = key_values["routeFilterRuleParameters"] unless key_values["routeFilterRuleParameters"].nil?
    path_params[:route_filter_rule_parameters] = ENV["azure_route_filter_rule_parameters"] unless ENV["azure_route_filter_rule_parameters"].nil?
    path_params[:route_filter_rule_parameters] = resource[:route_filter_rule_parameters] unless resource.nil? or resource[:route_filter_rule_parameters].nil?
    path_params[:rule_name] = key_values["ruleName"] unless key_values["ruleName"].nil?
    path_params[:rule_name] = ENV["azure_rule_name"] unless ENV["azure_rule_name"].nil?
    path_params[:rule_name] = resource[:rule_name] unless resource.nil? or resource[:rule_name].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/routeFilters/%{route_filter_name}/routeFilterRules/%{rule_name}" % path_params
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation RouteFilterRules_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation RouteFilterRules_ListByRouteFilter")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/routeFilters/%{route_filter_name}/routeFilterRules" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation RouteFilterRules_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
