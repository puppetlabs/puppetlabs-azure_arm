...
Puppet::Type.type(:azure_rule).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:rule_name] = resource[:name] unless resource.nil? or resource[:name].nil?
    ...
    path_params[:subscription_name] = key_values["subscriptionName"] unless key_values["subscriptionName"].nil?
    path_params[:subscription_name] = ENV["azure_subscription_name"] unless ENV["azure_subscription_name"].nil?
    path_params[:subscription_name] = resource[:subscription_name] unless resource.nil? or resource[:subscription_name].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ServiceBus/namespaces/%{namespace_name}/topics/%{topic_name}/subscriptions/%{subscription_name}/rules/%{rule_name}" % path_params
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    path_params[:topic_name] = ENV["azure_topic_name"] unless ENV["azure_topic_name"].nil?
    path_params[:topic_name] = resource[:topic_name] unless resource.nil? or resource[:topic_name].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ServiceBus/namespaces/%{namespace_name}/topics/%{topic_name}/subscriptions/%{subscription_name}/rules" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
