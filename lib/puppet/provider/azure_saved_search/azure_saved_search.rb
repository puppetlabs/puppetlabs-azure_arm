...
Puppet::Type.type(:azure_saved_search).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:saved_search_name] = key_values["savedSearchName"] unless key_values["savedSearchName"].nil?
    path_params[:saved_search_name] = ENV["azure_saved_search_name"] unless ENV["azure_saved_search_name"].nil?
    path_params[:saved_search_name] = resource[:name] unless resource.nil? or resource[:name].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/Microsoft.OperationalInsights/workspaces/%{workspace_name}/savedSearches/%{saved_search_name}" % path_params
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    path_params[:workspace_name] = ENV["azure_workspace_name"] unless ENV["azure_workspace_name"].nil?
    path_params[:workspace_name] = resource[:workspace_name] unless resource.nil? or resource[:workspace_name].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/Microsoft.OperationalInsights/workspaces/%{workspace_name}/savedSearches" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
