...
Puppet::Type.type(:azure_sb_authorization_rule).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type SBAuthorizationRule")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type SBAuthorizationRule - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    sb_authorization_rule = {}
    sb_authorization_rule["id"] = resource[:id] unless resource[:id].nil?
    sb_authorization_rule["name"] = resource[:name] unless resource[:name].nil?
    sb_authorization_rule["properties"] = resource[:properties] unless resource[:properties].nil?
    sb_authorization_rule["type"] = resource[:type] unless resource[:type].nil?
    return sb_authorization_rule
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Queues_CreateOrUpdateAuthorizationRule")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("queueName", "path", "queue_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ServiceBus/namespaces/%{namespace_name}/queues/%{queue_name}/authorizationRules/%{authorization_rule_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_update(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ServiceBus/namespaces/%{namespace_name}/AuthorizationRules/%{authorization_rule_name}", "Put", "[application/json]")
  end

  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Queues_DeleteAuthorizationRule")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ServiceBus/namespaces/%{namespace_name}/queues/%{queue_name}/authorizationRules/%{authorization_rule_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DisasterRecoveryConfigs_ListAuthorizationRules")
    path_params = {}
    query_params = {}
    header_params = {}

    op_params = [
      self.op_param("alias", "path", "alias"),
      self.op_param("api-version", "query", "api_version"),
      self.op_param("namespaceName", "path", "namespace_name"),
      self.op_param("resourceGroupName", "path", "resource_group_name"),
      self.op_param("subscriptionId", "path", "subscription_id"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ServiceBus/namespaces/%{namespace_name}/disasterRecoveryConfigs/%{alias}/AuthorizationRules", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DisasterRecoveryConfigs_GetAuthorizationRule")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ServiceBus/namespaces/%{namespace_name}/disasterRecoveryConfigs/%{alias}/AuthorizationRules/%{authorization_rule_name}", "Get", "[application/json]")
  end
