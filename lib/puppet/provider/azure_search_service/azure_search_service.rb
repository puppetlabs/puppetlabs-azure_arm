...
Puppet::Type.type(:azure_search_service).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:search_service_name] = key_values["searchServiceName"] unless key_values["searchServiceName"].nil?
    path_params[:search_service_name] = ENV["azure_search_service_name"] unless ENV["azure_search_service_name"].nil?
    path_params[:search_service_name] = resource[:name] unless resource.nil? or resource[:name].nil?
    path_params[:service] = key_values["service"] unless key_values["service"].nil?
    path_params[:service] = ENV["azure_service"] unless ENV["azure_service"].nil?
    path_params[:service] = resource[:service] unless resource.nil? or resource[:service].nil?
    ...
    path_params[:x_ms_client_request_id] = key_values["x-ms-client-request-id"] unless key_values["x-ms-client-request-id"].nil?
    path_params[:x_ms_client_request_id] = ENV["azure_x_ms_client_request_id"] unless ENV["azure_x_ms_client_request_id"].nil?
    path_params[:x_ms_client_request_id] = resource[:x_ms_client_request_id] unless resource.nil? or resource[:x_ms_client_request_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Search/searchServices/%{search_service_name}" % path_params
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    path_params[:x_ms_client_request_id] = ENV["azure_x_ms_client_request_id"] unless ENV["azure_x_ms_client_request_id"].nil?
    path_params[:x_ms_client_request_id] = resource[:x_ms_client_request_id] unless resource.nil? or resource[:x_ms_client_request_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Search/searchServices" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
