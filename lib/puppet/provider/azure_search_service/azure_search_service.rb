...
Puppet::Type.type(:azure_search_service).provide(:arm) do
  mk_resource_methods
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "hostingMode"])
        self.deep_delete(hash, [:properties, "partitionCount"])
        self.deep_delete(hash, [:properties, "provisioningState"])
        self.deep_delete(hash, [:properties, "replicaCount"])
        self.deep_delete(hash, [:properties, "status"])
        self.deep_delete(hash, [:properties, "statusDetails"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      service: instance.service.respond_to?(:to_hash) ? instance.service.to_hash : instance.service,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type SearchService")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type SearchService - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    search_service = {}
    search_service["id"] = resource[:id] unless resource[:id].nil?
    search_service["identity"] = resource[:identity] unless resource[:identity].nil?
    search_service["location"] = resource[:location] unless resource[:location].nil?
    search_service["name"] = resource[:name] unless resource[:name].nil?
    search_service["properties"] = resource[:properties] unless resource[:properties].nil?
    search_service["sku"] = resource[:sku] unless resource[:sku].nil?
    search_service["tags"] = resource[:tags] unless resource[:tags].nil?
    search_service["type"] = resource[:type] unless resource[:type].nil?
    return search_service
  end

  def self.build_key_values
    key_values = {}
    key_values["api-version"] = "2015-08-19"
    key_values
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Services_ListBySubscription")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("x-ms-client-request-id", "header", "x_ms_client_request_id", "x_ms_client_request_id"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
      name = i[:name]
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Search/searchServices", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Services_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    op_params = [
      ...
      self.op_param("searchServiceName", "path", "name", "search_service_name"),
      self.op_param("service", "body", "service", "service"),
      self.op_param("sku", "body", "sku", "sku"),
      self.op_param("subscriptionId", "path", "subscription_id", "subscription_id"),
      self.op_param("tags", "body", "tags", "tags"),
      self.op_param("type", "body", "type", "type"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Search/searchServices/%{search_service_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Services_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Search/searchServices/%{search_service_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Services_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Search/searchServices", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Services_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Search/searchServices/%{search_service_name}", "Get", "[application/json]")
  end
