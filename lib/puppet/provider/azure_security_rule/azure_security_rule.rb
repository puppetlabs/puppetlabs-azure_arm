...
Puppet::Type.type(:azure_security_rule).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:network_security_group_name] = key_values["networkSecurityGroupName"] unless key_values["networkSecurityGroupName"].nil?
    path_params[:network_security_group_name] = ENV["azure_network_security_group_name"] unless ENV["azure_network_security_group_name"].nil?
    path_params[:network_security_group_name] = resource[:network_security_group_name] unless resource.nil? or resource[:network_security_group_name].nil?
    ...
    path_params[:security_rule_name] = key_values["securityRuleName"] unless key_values["securityRuleName"].nil?
    path_params[:security_rule_name] = ENV["azure_security_rule_name"] unless ENV["azure_security_rule_name"].nil?
    path_params[:security_rule_name] = resource[:name] unless resource.nil? or resource[:name].nil?
    path_params[:security_rule_parameters] = key_values["securityRuleParameters"] unless key_values["securityRuleParameters"].nil?
    path_params[:security_rule_parameters] = ENV["azure_security_rule_parameters"] unless ENV["azure_security_rule_parameters"].nil?
    path_params[:security_rule_parameters] = resource[:security_rule_parameters] unless resource.nil? or resource[:security_rule_parameters].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkSecurityGroups/%{network_security_group_name}/securityRules/%{security_rule_name}" % path_params
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkSecurityGroups/%{network_security_group_name}/securityRules" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json text/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation SecurityRules_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
