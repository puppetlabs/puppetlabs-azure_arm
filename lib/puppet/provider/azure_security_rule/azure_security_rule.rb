...
Puppet::Type.type(:azure_security_rule).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type SecurityRule")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type SecurityRule - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    security_rule = {}
    security_rule["etag"] = resource[:etag] unless resource[:etag].nil?
    security_rule["id"] = resource[:id] unless resource[:id].nil?
    security_rule["name"] = resource[:name] unless resource[:name].nil?
    security_rule["properties"] = resource[:properties] unless resource[:properties].nil?
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation SecurityRules_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("networkSecurityGroupName", "path", "network_security_group_name", "network_security_group_name"),
      ...
      self.op_param("securityRuleName", "path", "name", "security_rule_name"),
      self.op_param("securityRuleParameters", "body", "security_rule_parameters", "security_rule_parameters"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkSecurityGroups/%{network_security_group_name}/securityRules/%{security_rule_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation SecurityRules_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkSecurityGroups/%{network_security_group_name}/securityRules/%{security_rule_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation SecurityRules_List")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkSecurityGroups/%{network_security_group_name}/securityRules", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DefaultSecurityRules_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("defaultSecurityRuleName", "path", "default_security_rule_name", "default_security_rule_name"),
      self.op_param("etag", "body", "etag", "etag"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("name", "body", "name", "name"),
      self.op_param("networkSecurityGroupName", "path", "network_security_group_name", "network_security_group_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkSecurityGroups/%{network_security_group_name}/defaultSecurityRules/%{default_security_rule_name}", "Get", "[application/json]")
  end
