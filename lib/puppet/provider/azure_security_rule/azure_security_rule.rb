...
Puppet::Type.type(:azure_security_rule).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("networkSecurityGroupName", "path", "network_security_group_name"),
      self.op_param("resourceGroupName", "path", "resource_group_name"),
      self.op_param("securityRuleName", "path", "name"),
      self.op_param("securityRuleParameters", "body", "security_rule_parameters"),
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DefaultSecurityRules_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkSecurityGroups/%{network_security_group_name}/defaultSecurityRules", "Get", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version"),
      self.op_param("defaultSecurityRuleName", "path", "default_security_rule_name"),
      self.op_param("networkSecurityGroupName", "path", "network_security_group_name"),
      self.op_param("resourceGroupName", "path", "resource_group_name"),
      self.op_param("subscriptionId", "path", "subscription_id"),
    ]
