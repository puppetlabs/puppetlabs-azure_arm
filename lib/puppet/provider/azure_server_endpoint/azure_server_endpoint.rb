...
Puppet::Type.type(:azure_server_endpoint).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type ServerEndpoint")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type ServerEndpoint - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    server_endpoint = {}
    server_endpoint["id"] = resource[:id] unless resource[:id].nil?
    server_endpoint["name"] = resource[:name] unless resource[:name].nil?
    server_endpoint["properties"] = resource[:properties] unless resource[:properties].nil?
    server_endpoint["type"] = resource[:type] unless resource[:type].nil?
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation ServerEndpoints_Create")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("serverEndpointName", "path", "name", "server_endpoint_name"),
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ServerEndpoints_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ServerEndpoints_ListBySyncGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "azure.microsoft.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorageSync/storageSyncServices/%{storage_sync_service_name}/syncGroups/%{sync_group_name}/serverEndpoints", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ServerEndpoints_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
