...
Puppet::Type.type(:azure_server_farm_with_rich_sku).provide(:arm) do
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("detailed", "query", "detailed", "detailed"),
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("serverFarmEnvelope", "body", "server_farm_envelope", "server_farm_envelope"),
      self.op_param("sku", "body", "sku", "sku"),
      self.op_param("subscriptionId", "path", "subscription_id", "subscription_id"),
      self.op_param("tags", "body", "tags", "tags"),
      self.op_param("type", "body", "type", "type"),
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ManagedHostingEnvironments_GetManagedHostingEnvironmentWebHostingPlans")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/managedHostingEnvironments/%{name}/webhostingplans", "Get", "[]")
  end
