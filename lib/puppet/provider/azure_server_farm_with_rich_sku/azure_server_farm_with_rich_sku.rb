...
Puppet::Type.type(:azure_server_farm_with_rich_sku).provide(:arm) do
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("detailed", "query", "detailed"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Web/serverfarms", "Get", "[]")
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      self.op_param("allowPendingState", "query", "allow_pending_state"),
      self.op_param("api-version", "query", "api_version"),
      self.op_param("name", "path", "name"),
      self.op_param("resourceGroupName", "path", "resource_group_name"),
      self.op_param("serverFarmEnvelope", "body", "server_farm_envelope"),
      self.op_param("subscriptionId", "path", "subscription_id"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/serverfarms/%{name}", "Put", "[]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/serverfarms/%{name}", "Delete", "[]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ManagedHostingEnvironments_GetManagedHostingEnvironmentServerFarms")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.4"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/managedHostingEnvironments/%{name}/serverfarms", "Get", "[]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/serverfarms/%{name}/operationresults/%{operation_id}", "Get", "[]")
  end
