...
Puppet::Type.type(:azure_service_endpoint_policy).provide(:arm) do
  mk_resource_methods
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "serviceEndpointPolicyDefinitions", "properties", "provisioningState"])
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type ServiceEndpointPolicy")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type ServiceEndpointPolicy - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    service_endpoint_policy["etag"] = resource[:etag] unless resource[:etag].nil?
    service_endpoint_policy["id"] = resource[:id] unless resource[:id].nil?
    service_endpoint_policy["location"] = resource[:location] unless resource[:location].nil?
    service_endpoint_policy["name"] = resource[:name] unless resource[:name].nil?
    service_endpoint_policy["properties"] = resource[:properties] unless resource[:properties].nil?
    service_endpoint_policy["tags"] = resource[:tags] unless resource[:tags].nil?
    service_endpoint_policy["type"] = resource[:type] unless resource[:type].nil?
    return service_endpoint_policy
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation ServiceEndpointPolicies_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Network/ServiceEndpointPolicies", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ServiceEndpointPolicies_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    op_params = [
      ...
      self.op_param("serviceEndpointPolicyName", "path", "name", "service_endpoint_policy_name"),
      self.op_param("subscriptionId", "path", "subscription_id", "subscription_id"),
      self.op_param("tags", "body", "tags", "tags"),
      self.op_param("type", "body", "type", "type"),
    ]
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/serviceEndpointPolicies/%{service_endpoint_policy_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ServiceEndpointPolicies_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/serviceEndpointPolicies/%{service_endpoint_policy_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ServiceEndpointPolicies_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/serviceEndpointPolicies/%{service_endpoint_policy_name}", "Get", "[application/json]")
  end
