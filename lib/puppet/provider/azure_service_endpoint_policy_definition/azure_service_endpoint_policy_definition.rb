...
Puppet::Type.type(:azure_service_endpoint_policy_definition).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type ServiceEndpointPolicyDefinition")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type ServiceEndpointPolicyDefinition - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    service_endpoint_policy_definition["etag"] = resource[:etag] unless resource[:etag].nil?
    service_endpoint_policy_definition["id"] = resource[:id] unless resource[:id].nil?
    service_endpoint_policy_definition["name"] = resource[:name] unless resource[:name].nil?
    service_endpoint_policy_definition["properties"] = resource[:properties] unless resource[:properties].nil?
    return service_endpoint_policy_definition
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation ServiceEndpointPolicyDefinitions_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("serviceEndpointPolicyDefinitionName", "path", "name", "service_endpoint_policy_definition_name"),
      self.op_param("ServiceEndpointPolicyDefinitions", "body", "service_endpoint_policy_definitions", "service_endpoint_policy_definitions"),
      self.op_param("serviceEndpointPolicyName", "path", "service_endpoint_policy_name", "service_endpoint_policy_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/serviceEndpointPolicies/%{service_endpoint_policy_name}/serviceEndpointPolicyDefinitions/%{service_endpoint_policy_definition_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ServiceEndpointPolicyDefinitions_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ServiceEndpointPolicyDefinitions_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/serviceEndpointPolicies/%{service_endpoint_policy_name}/serviceEndpointPolicyDefinitions", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ServiceEndpointPolicyDefinitions_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/serviceEndpointPolicies/%{service_endpoint_policy_name}/serviceEndpointPolicyDefinitions/%{service_endpoint_policy_definition_name}", "Get", "[application/json]")
  end
