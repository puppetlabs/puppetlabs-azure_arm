...
Puppet::Type.type(:azure_services_description).provide(:arm) do
  mk_resource_methods
  ...
  def self.instance_to_hash(instance)
    {
      ...
      service_description: instance.service_description.respond_to?(:to_hash) ? instance.service_description.to_hash : instance.service_description,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type ServicesDescription")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type ServicesDescription - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    services_description["etag"] = resource[:etag] unless resource[:etag].nil?
    services_description["id"] = resource[:id] unless resource[:id].nil?
    services_description["kind"] = resource[:kind] unless resource[:kind].nil?
    services_description["location"] = resource[:location] unless resource[:location].nil?
    services_description["name"] = resource[:name] unless resource[:name].nil?
    services_description["properties"] = resource[:properties] unless resource[:properties].nil?
    services_description["tags"] = resource[:tags] unless resource[:tags].nil?
    services_description["type"] = resource[:type] unless resource[:type].nil?
    return services_description
  end

  def self.build_key_values
    key_values = {}
    key_values["api-version"] = "2019-09-16"
    key_values
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.HealthcareApis/services", "Get", "[application/json]")
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("serviceDescription", "body", "service_description", "service_description"),
      self.op_param("subscriptionId", "path", "subscription_id", "subscription_id"),
      self.op_param("tags", "body", "tags", "tags"),
      self.op_param("type", "body", "type", "type"),
    ]
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.HealthcareApis/services/%{resource_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.HealthcareApis/services/%{resource_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.HealthcareApis/services/%{resource_name}", "Get", "[application/json]")
  end
