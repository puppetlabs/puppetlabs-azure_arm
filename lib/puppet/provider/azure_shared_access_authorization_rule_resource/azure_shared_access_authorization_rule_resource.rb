...
Puppet::Type.type(:azure_shared_access_authorization_rule_resource).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type SharedAccessAuthorizationRuleResource")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type SharedAccessAuthorizationRuleResource - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    shared_access_authorization_rule_resource = {}
    shared_access_authorization_rule_resource["id"] = resource[:id] unless resource[:id].nil?
    shared_access_authorization_rule_resource["location"] = resource[:location] unless resource[:location].nil?
    shared_access_authorization_rule_resource["name"] = resource[:name] unless resource[:name].nil?
    shared_access_authorization_rule_resource["properties"] = resource[:properties] unless resource[:properties].nil?
    shared_access_authorization_rule_resource["sku"] = resource[:sku] unless resource[:sku].nil?
    shared_access_authorization_rule_resource["tags"] = resource[:tags] unless resource[:tags].nil?
    shared_access_authorization_rule_resource["type"] = resource[:type] unless resource[:type].nil?
    return shared_access_authorization_rule_resource
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Namespaces_CreateOrUpdateAuthorizationRule")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("authorizationRuleName", "path", "authorization_rule_name", "authorization_rule_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.NotificationHubs/namespaces/%{namespace_name}/AuthorizationRules/%{authorization_rule_name}", "Put", "[application/json]")
  end

  def self.invoke_update(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation NotificationHubs_CreateOrUpdateAuthorizationRule")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    op_params = [
      ...
      self.op_param("name", "body", "name", "name"),
      self.op_param("namespaceName", "path", "namespace_name", "namespace_name"),
      self.op_param("notificationHubName", "path", "notification_hub_name", "notification_hub_name"),
      self.op_param("parameters", "body", "parameters", "parameters"),
      self.op_param("properties", "body", "properties", "properties"),
      self.op_param("resourceGroupName", "path", "resource_group_name", "resource_group_name"),
      self.op_param("sku", "body", "sku", "sku"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.NotificationHubs/namespaces/%{namespace_name}/notificationHubs/%{notification_hub_name}/AuthorizationRules/%{authorization_rule_name}", "Put", "[application/json]")
  end

  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Namespaces_DeleteAuthorizationRule")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.NotificationHubs/namespaces/%{namespace_name}/AuthorizationRules/%{authorization_rule_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.NotificationHubs/namespaces/%{namespace_name}/notificationHubs/%{notification_hub_name}/AuthorizationRules", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Namespaces_GetAuthorizationRule")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.NotificationHubs/namespaces/%{namespace_name}/AuthorizationRules/%{authorization_rule_name}", "Get", "[application/json]")
  end
