...
Puppet::Type.type(:azure_shared_access_authorization_rule_resource).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("authorizationRuleName", "path", "authorization_rule_name"),
      self.op_param("namespaceName", "path", "namespace_name"),
  ...
  def self.invoke_update(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("authorizationRuleName", "path", "authorization_rule_name"),
      self.op_param("namespaceName", "path", "namespace_name"),
      self.op_param("notificationHubName", "path", "notification_hub_name"),
      self.op_param("parameters", "body", "parameters"),
      self.op_param("resourceGroupName", "path", "resource_group_name"),
      self.op_param("subscriptionId", "path", "subscription_id"),
    ]
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.NotificationHubs/namespaces/%{namespace_name}/AuthorizationRules", "Get", "[application/json]")
  end
