...
Puppet::Type.type(:azure_signal_r_resource).provide(:arm) do
  mk_resource_methods
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "externalIP"])
        self.deep_delete(hash, [:properties, "hostName"])
        self.deep_delete(hash, [:properties, "provisioningState"])
        self.deep_delete(hash, [:properties, "publicPort"])
        self.deep_delete(hash, [:properties, "serverPort"])
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type SignalRResource")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type SignalRResource - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    signal_r_resource = {}
    signal_r_resource["id"] = resource[:id] unless resource[:id].nil?
    signal_r_resource["location"] = resource[:location] unless resource[:location].nil?
    signal_r_resource["name"] = resource[:name] unless resource[:name].nil?
    signal_r_resource["properties"] = resource[:properties] unless resource[:properties].nil?
    signal_r_resource["sku"] = resource[:sku] unless resource[:sku].nil?
    signal_r_resource["tags"] = resource[:tags] unless resource[:tags].nil?
    signal_r_resource["type"] = resource[:type] unless resource[:type].nil?
    return signal_r_resource
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation SignalR_ListBySubscription")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.SignalRService/SignalR", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation SignalR_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.SignalRService/signalR/%{resource_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation SignalR_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.SignalRService/signalR/%{resource_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation SignalR_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.SignalRService/signalR/%{resource_name}", "Get", "[application/json]")
  end
