...
Puppet::Type.type(:azure_site).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Sites_CreateOrUpdateSite")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version"),
      self.op_param("forceDnsRegistration", "query", "force_dns_registration"),
      self.op_param("name", "path", "name"),
      self.op_param("resourceGroupName", "path", "resource_group_name"),
      self.op_param("siteEnvelope", "body", "site_envelope"),
      self.op_param("skipCustomDomainVerification", "query", "skip_custom_domain_verification"),
      self.op_param("skipDnsRegistration", "query", "skip_dns_registration"),
      self.op_param("subscriptionId", "path", "subscription_id"),
      self.op_param("ttlInSeconds", "query", "ttl_in_seconds"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
      name = i[:name]
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}", "Put", "[]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Sites_DeleteSite")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version"),
      self.op_param("deleteAllSlots", "query", "delete_all_slots"),
      self.op_param("deleteEmptyServerFarm", "query", "delete_empty_server_farm"),
      self.op_param("deleteMetrics", "query", "delete_metrics"),
      self.op_param("name", "path", "name"),
      self.op_param("resourceGroupName", "path", "resource_group_name"),
      self.op_param("skipDnsRegistration", "query", "skip_dns_registration"),
      self.op_param("subscriptionId", "path", "subscription_id"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}", "Delete", "[]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Sites_GetSite")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version"),
      self.op_param("name", "path", "name"),
      self.op_param("propertiesToInclude", "query", "properties_to_include"),
      self.op_param("resourceGroupName", "path", "resource_group_name"),
      self.op_param("subscriptionId", "path", "subscription_id"),
    ]
    op_params.each do |i|
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}", "Get", "[]")
  end
