...
Puppet::Type.type(:azure_snapshot).provide(:arm) do
  mk_resource_methods
  ...
  def self.instance_to_hash(instance)
    {
      ...
      snapshot: instance.snapshot.respond_to?(:to_hash) ? instance.snapshot.to_hash : instance.snapshot,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type Snapshot")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type Snapshot - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    snapshot = {}
    snapshot["id"] = resource[:id] unless resource[:id].nil?
    snapshot["location"] = resource[:location] unless resource[:location].nil?
    snapshot["managedBy"] = resource[:managed_by] unless resource[:managed_by].nil?
    snapshot["name"] = resource[:name] unless resource[:name].nil?
    snapshot["properties"] = resource[:properties] unless resource[:properties].nil?
    snapshot["sku"] = resource[:sku] unless resource[:sku].nil?
    snapshot["tags"] = resource[:tags] unless resource[:tags].nil?
    snapshot["type"] = resource[:type] unless resource[:type].nil?
    return snapshot
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Snapshots_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Compute/snapshots", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Snapshots_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    op_params = [
      ...
      self.op_param("snapshot", "body", "snapshot", "snapshot"),
      self.op_param("snapshotName", "path", "name", "snapshot_name"),
      self.op_param("subscriptionId", "path", "subscription_id", "subscription_id"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/snapshots/%{snapshot_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Snapshots_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/snapshots/%{snapshot_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Snapshots_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/snapshots", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Snapshots_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/snapshots/%{snapshot_name}", "Get", "[application/json]")
  end
