...
Puppet::Type.type(:azure_solutions_application).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version"),
      self.op_param("applicationId", "path", "id"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/%{application_id}", "Put", "[application/json]")
  end
