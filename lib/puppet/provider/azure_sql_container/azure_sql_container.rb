...
Puppet::Type.type(:azure_sql_container).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type SqlContainer")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type SqlContainer - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    sql_container = {}
    sql_container["id"] = resource[:id] unless resource[:id].nil?
    sql_container["location"] = resource[:location] unless resource[:location].nil?
    sql_container["name"] = resource[:name] unless resource[:name].nil?
    sql_container["properties"] = resource[:properties] unless resource[:properties].nil?
    sql_container["tags"] = resource[:tags] unless resource[:tags].nil?
    sql_container["type"] = resource[:type] unless resource[:type].nil?
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation DatabaseAccounts_CreateUpdateSqlContainer")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("containerName", "path", "container_name", "container_name"),
      self.op_param("createUpdateSqlContainerParameters", "body", "create_update_sql_container_parameters", "create_update_sql_container_parameters"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/apis/sql/databases/%{database_name}/containers/%{container_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DatabaseAccounts_DeleteSqlContainer")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/apis/sql/databases/%{database_name}/containers/%{container_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DatabaseAccounts_ListSqlContainers")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/apis/sql/databases/%{database_name}/containers", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation DatabaseAccounts_GetSqlContainer")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/apis/sql/databases/%{database_name}/containers/%{container_name}", "Get", "[application/json]")
  end
