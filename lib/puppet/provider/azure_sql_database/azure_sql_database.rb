...
Puppet::Type.type(:azure_sql_database).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("databaseName", "path", "name"),
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version"),
      self.op_param("recommendedElasticPoolName", "path", "recommended_elastic_pool_name"),
      self.op_param("resourceGroupName", "path", "resource_group_name"),
      self.op_param("serverName", "path", "server_name"),
      self.op_param("subscriptionId", "path", "subscription_id"),
    ]
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Databases_GetByRecommendedElasticPool")
    path_params = {}
    query_params = {}
    header_params = {}
