...
Puppet::Type.type(:azure_storage_account).provide(:arm) do
  mk_resource_methods
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:kind])

        self.deep_delete(hash, [:properties, "accessTier"])

        self.deep_delete(hash, [:properties, "creationTime"])
        self.deep_delete(hash, [:properties, "customDomain"])
        self.deep_delete(hash, [:properties, "encryption"])
        self.deep_delete(hash, [:properties, "failoverInProgress"])
        self.deep_delete(hash, [:properties, "geoReplicationStats"])
        self.deep_delete(hash, [:properties, "lastGeoFailoverTime"])
        self.deep_delete(hash, [:properties, "networkAcls"])
        self.deep_delete(hash, [:properties, "primaryEndpoints"])
        self.deep_delete(hash, [:properties, "primaryLocation"])
        self.deep_delete(hash, [:properties, "provisioningState"])
        self.deep_delete(hash, [:properties, "secondaryEndpoints"])
        self.deep_delete(hash, [:properties, "secondaryLocation"])
        self.deep_delete(hash, [:properties, "statusOfPrimary"])
        self.deep_delete(hash, [:properties, "statusOfSecondary"])
        self.deep_delete(hash, [:sku])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      account_name: instance.account_name.respond_to?(:to_hash) ? instance.account_name.to_hash : instance.account_name,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type StorageAccount")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type StorageAccount - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    storage_account = {}
    storage_account["id"] = resource[:id] unless resource[:id].nil?
    storage_account["identity"] = resource[:identity] unless resource[:identity].nil?
    storage_account["kind"] = resource[:kind] unless resource[:kind].nil?
    storage_account["location"] = resource[:location] unless resource[:location].nil?
    storage_account["name"] = resource[:name] unless resource[:name].nil?
    storage_account["properties"] = resource[:properties] unless resource[:properties].nil?
    storage_account["sku"] = resource[:sku] unless resource[:sku].nil?
    storage_account["tags"] = resource[:tags] unless resource[:tags].nil?
    storage_account["type"] = resource[:type] unless resource[:type].nil?
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation StorageAccounts_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Storage/storageAccounts", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation StorageAccounts_Create")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    op_params = [
      self.op_param("accountName", "path", "account_name", "account_name"),
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("identity", "body", "identity", "identity"),
      self.op_param("kind", "body", "kind", "kind"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Storage/storageAccounts/%{account_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation StorageAccounts_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Storage/storageAccounts/%{account_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation StorageAccounts_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Storage/storageAccounts", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation StorageAccounts_GetProperties")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Storage/storageAccounts/%{account_name}", "Get", "[application/json]")
  end
