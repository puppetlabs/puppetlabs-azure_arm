...
Puppet::Type.type(:azure_storage_classification_mapping).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type StorageClassificationMapping")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type StorageClassificationMapping - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    storage_classification_mapping = {}
    storage_classification_mapping["id"] = resource[:id] unless resource[:id].nil?
    storage_classification_mapping["location"] = resource[:location] unless resource[:location].nil?
    storage_classification_mapping["name"] = resource[:name] unless resource[:name].nil?
    storage_classification_mapping["properties"] = resource[:properties] unless resource[:properties].nil?
    storage_classification_mapping["type"] = resource[:type] unless resource[:type].nil?
    return storage_classification_mapping
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation ReplicationStorageClassificationMappings_Create")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    path_params[:pairing_input] = key_values["pairingInput"] unless key_values["pairingInput"].nil?
    path_params[:pairing_input] = ENV["azure_pairing_input"] unless ENV["azure_pairing_input"].nil?
    path_params[:pairing_input] = resource[:pairing_input] unless resource.nil? or resource[:pairing_input].nil?
    ...
    path_params[:storage_classification_mapping_name] = key_values["storageClassificationMappingName"] unless key_values["storageClassificationMappingName"].nil?
    path_params[:storage_classification_mapping_name] = ENV["azure_storage_classification_mapping_name"] unless ENV["azure_storage_classification_mapping_name"].nil?
    path_params[:storage_classification_mapping_name] = resource[:name] unless resource.nil? or resource[:name].nil?
    ...
    uri_string = "https://management.azure.com/Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationFabrics/%{fabric_name}/replicationStorageClassifications/%{storage_classification_name}/replicationStorageClassificationMappings/%{storage_classification_mapping_name}" % path_params
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ReplicationStorageClassificationMappings_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ReplicationStorageClassificationMappings_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
