...
Puppet::Type.type(:azure_storage_classification_mapping).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("pairingInput", "body", "pairing_input", "pairing_input"),
      ...
      self.op_param("storageClassificationMappingName", "path", "name", "storage_classification_mapping_name"),
      self.op_param("storageClassificationName", "path", "storage_classification_name", "storage_classification_name"),
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationFabrics/%{fabric_name}/replicationStorageClassifications/%{storage_classification_name}/replicationStorageClassificationMappings", "Get", "[application/json]")
  end
