...
Puppet::Type.type(:azure_storage_insight).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:storage_insight_name] = key_values["storageInsightName"] unless key_values["storageInsightName"].nil?
    path_params[:storage_insight_name] = ENV["azure_storage_insight_name"] unless ENV["azure_storage_insight_name"].nil?
    path_params[:storage_insight_name] = resource[:name] unless resource.nil? or resource[:name].nil?
    ...
    path_params[:workspace_name] = key_values["workspaceName"] unless key_values["workspaceName"].nil?
    path_params[:workspace_name] = ENV["azure_workspace_name"] unless ENV["azure_workspace_name"].nil?
    path_params[:workspace_name] = resource[:workspace_name] unless resource.nil? or resource[:workspace_name].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/Microsoft.OperationalInsights/workspaces/%{workspace_name}/storageInsightConfigs/%{storage_insight_name}" % path_params
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    path_params[:workspace_name] = ENV["azure_workspace_name"] unless ENV["azure_workspace_name"].nil?
    path_params[:workspace_name] = resource[:workspace_name] unless resource.nil? or resource[:workspace_name].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/Microsoft.OperationalInsights/workspaces/%{workspace_name}/storageInsightConfigs" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
