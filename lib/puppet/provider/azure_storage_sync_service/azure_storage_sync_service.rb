...
Puppet::Type.type(:azure_storage_sync_service).provide(:arm) do
  ...
  def self.build_key_values
    key_values = {}
    key_values["api-version"] = "2018-04-02"
    key_values
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "azure.microsoft.com", "/subscriptions/%{subscription_id}/providers/Microsoft.StorageSync/storageSyncServices", "Get", "[application/json]")
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "azure.microsoft.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorageSync/storageSyncServices/%{storage_sync_service_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "azure.microsoft.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorageSync/storageSyncServices/%{storage_sync_service_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "azure.microsoft.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorageSync/storageSyncServices", "Get", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "azure.microsoft.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorageSync/storageSyncServices/%{storage_sync_service_name}", "Get", "[application/json]")
  end
