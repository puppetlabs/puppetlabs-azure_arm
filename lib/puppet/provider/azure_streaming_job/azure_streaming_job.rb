...
Puppet::Type.type(:azure_streaming_job).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version"),
      self.op_param("If-Match", "header", "if_match"),
      self.op_param("If-None-Match", "header", "if_none_match"),
      self.op_param("jobName", "path", "job_name"),
      self.op_param("resourceGroupName", "path", "resource_group_name"),
      self.op_param("streamingJob", "body", "streaming_job"),
      self.op_param("subscriptionId", "path", "subscription_id"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
