...
Puppet::Type.type(:azure_streaming_job).provide(:arm) do
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "createdDate"])
        self.deep_delete(hash, [:properties, "etag"])

        self.deep_delete(hash, [:properties, "functions", "id"])

        self.deep_delete(hash, [:properties, "functions", "properties", "etag"])
        self.deep_delete(hash, [:properties, "functions", "type"])

        self.deep_delete(hash, [:properties, "inputs", "id"])

        self.deep_delete(hash, [:properties, "inputs", "properties", "diagnostics", "conditions", "code"])
        self.deep_delete(hash, [:properties, "inputs", "properties", "diagnostics", "conditions", "message"])
        self.deep_delete(hash, [:properties, "inputs", "properties", "diagnostics", "conditions", "since"])
        self.deep_delete(hash, [:properties, "inputs", "properties", "etag"])

        self.deep_delete(hash, [:properties, "inputs", "type"])
        self.deep_delete(hash, [:properties, "jobId"])
        self.deep_delete(hash, [:properties, "jobState"])
        self.deep_delete(hash, [:properties, "lastOutputEventTime"])

        self.deep_delete(hash, [:properties, "outputs", "id"])

        self.deep_delete(hash, [:properties, "outputs", "properties", "etag"])
        self.deep_delete(hash, [:properties, "outputs", "type"])

        self.deep_delete(hash, [:properties, "provisioningState"])

        self.deep_delete(hash, [:properties, "transformation", "id"])

        self.deep_delete(hash, [:properties, "transformation", "properties", "etag"])
        self.deep_delete(hash, [:properties, "transformation", "type"])
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.StreamAnalytics/streamingjobs", "Get", "[application/json]")
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("If-None-Match", "header", "if_none_match", "if_none_match"),
      self.op_param("jobName", "path", "job_name", "job_name"),
      self.op_param("resourceGroupName", "path", "resource_group_name", "resource_group_name"),
      self.op_param("streamingJob", "body", "streaming_job", "streaming_job"),
      self.op_param("subscriptionId", "path", "subscription_id", "subscription_id"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/Microsoft.StreamAnalytics/streamingjobs/%{job_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/Microsoft.StreamAnalytics/streamingjobs/%{job_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/Microsoft.StreamAnalytics/streamingjobs", "Get", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/Microsoft.StreamAnalytics/streamingjobs/%{job_name}", "Get", "[application/json]")
  end
