...
Puppet::Type.type(:azure_subnet).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type Subnet")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type Subnet - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    subnet = {}
    subnet["etag"] = resource[:etag] unless resource[:etag].nil?
    subnet["id"] = resource[:id] unless resource[:id].nil?
    subnet["name"] = resource[:name] unless resource[:name].nil?
    subnet["properties"] = resource[:properties] unless resource[:properties].nil?
    return subnet
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Subnets_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    path_params[:subnet_name] = key_values["subnetName"] unless key_values["subnetName"].nil?
    path_params[:subnet_name] = ENV["azure_subnet_name"] unless ENV["azure_subnet_name"].nil?
    path_params[:subnet_name] = resource[:name] unless resource.nil? or resource[:name].nil?
    path_params[:subnet_parameters] = key_values["subnetParameters"] unless key_values["subnetParameters"].nil?
    path_params[:subnet_parameters] = ENV["azure_subnet_parameters"] unless ENV["azure_subnet_parameters"].nil?
    path_params[:subnet_parameters] = resource[:subnet_parameters] unless resource.nil? or resource[:subnet_parameters].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualNetworks/%{virtual_network_name}/subnets/%{subnet_name}" % path_params
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Subnets_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Subnets_List")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
    ...
    path_params[:virtual_network_name] = ENV["azure_virtual_network_name"] unless ENV["azure_virtual_network_name"].nil?
    path_params[:virtual_network_name] = resource[:virtual_network_name] unless resource.nil? or resource[:virtual_network_name].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualNetworks/%{virtual_network_name}/subnets" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json text/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Subnets_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
