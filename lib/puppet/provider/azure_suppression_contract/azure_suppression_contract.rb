...
Puppet::Type.type(:azure_suppression_contract).provide(:arm) do
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    op_params = [
      self.op_param("$skipToken", "query", "$skip_token"),
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("recommendationId", "path", "recommendation_id"),
      self.op_param("resourceUri", "path", "resource_uri"),
      self.op_param("suppressionContract", "body", "suppression_contract"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
      name = i[:name]
