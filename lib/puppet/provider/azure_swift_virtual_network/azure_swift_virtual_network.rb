...
Puppet::Type.type(:azure_swift_virtual_network).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type SwiftVirtualNetwork")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type SwiftVirtualNetwork - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    swift_virtual_network = {}
    swift_virtual_network["id"] = resource[:id] unless resource[:id].nil?
    swift_virtual_network["kind"] = resource[:kind] unless resource[:kind].nil?
    swift_virtual_network["name"] = resource[:name] unless resource[:name].nil?
    swift_virtual_network["properties"] = resource[:properties] unless resource[:properties].nil?
    swift_virtual_network["type"] = resource[:type] unless resource[:type].nil?
    return swift_virtual_network
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation WebApps_CreateOrUpdateSwiftVirtualNetworkConnectionSlot")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/networkConfig/virtualNetwork", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation WebApps_DeleteSwiftVirtualNetworkSlot")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/networkConfig/virtualNetwork", "Delete", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation WebApps_GetSwiftVirtualNetworkConnectionSlot")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/networkConfig/virtualNetwork", "Get", "[application/json]")
  end
