...
Puppet::Type.type(:azure_tag_details).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    path_params[:tag_name] = key_values["tagName"] unless key_values["tagName"].nil?
    path_params[:tag_name] = ENV["azure_tag_name"] unless ENV["azure_tag_name"].nil?
    path_params[:tag_name] = resource[:tagname] unless resource.nil? or resource[:tagname].nil?
