...
Puppet::Type.type(:azure_tag_details).provide(:arm) do
  mk_resource_methods
  ...
  def count=(value)
    Puppet.info("count setter called to change to #{value}")
    @property_flush[:count] = value
  end
  ...
  def tag_name=(value)
    Puppet.info("tag_name setter called to change to #{value}")
    @property_flush[:tag_name] = value
  end

  def values=(value)
    Puppet.info("values setter called to change to #{value}")
    @property_flush[:values] = value
  end
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:values, "id"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      tag_name: instance.tag_name.respond_to?(:to_hash) ? instance.tag_name.to_hash : instance.tag_name,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type TagDetails")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type TagDetails - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    tag_details = {}
    tag_details["count"] = resource[:count] unless resource[:count].nil?
    tag_details["id"] = resource[:id] unless resource[:id].nil?
    tag_details["tagName"] = resource[:tag_name] unless resource[:tag_name].nil?
    tag_details["values"] = resource[:values] unless resource[:values].nil?
    return tag_details
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Tags_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("count", "body", "count", "count"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("subscriptionId", "path", "subscription_id", "subscription_id"),
      self.op_param("tagname", "body", "tag_name", "tagname"),
      self.op_param("values", "body", "values", "values"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
      name = i[:name]
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/tagNames", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Tags_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    op_params = [
      ...
      self.op_param("id", "body", "id", "id"),
      self.op_param("subscriptionId", "path", "subscription_id", "subscription_id"),
      self.op_param("tag_name", "path", "tag_name", "tag_name"),
      self.op_param("tagname", "body", "tag_name", "tagname"),
      self.op_param("values", "body", "values", "values"),
    ]
    op_params.each do |i|
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/tagNames/%{tag_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Tags_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/tagNames/%{tag_name}", "Delete", "[application/json]")
  end
