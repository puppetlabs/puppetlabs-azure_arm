...
Puppet::Type.type(:azure_user_metrics_model).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type UserMetricsModel")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type UserMetricsModel - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    user_metrics_model = {}
    user_metrics_model["id"] = resource[:id] unless resource[:id].nil?
    user_metrics_model["name"] = resource[:name] unless resource[:name].nil?
    user_metrics_model["properties"] = resource[:properties] unless resource[:properties].nil?
    user_metrics_model["type"] = resource[:type] unless resource[:type].nil?
    return user_metrics_model
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation TrafficManagerUserMetricsKeys_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Network/trafficManagerUserMetricsKeys/default", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation TrafficManagerUserMetricsKeys_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Network/trafficManagerUserMetricsKeys/default", "Delete", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation TrafficManagerUserMetricsKeys_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.0"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Network/trafficManagerUserMetricsKeys/default", "Get", "[application/json]")
  end
