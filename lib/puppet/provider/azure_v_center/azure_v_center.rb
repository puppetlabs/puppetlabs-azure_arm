...
Puppet::Type.type(:azure_v_center).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    query_params = {}
    header_params = {}
    path_params[:add_v_center_request] = key_values["addVCenterRequest"] unless key_values["addVCenterRequest"].nil?
    path_params[:add_v_center_request] = ENV["azure_add_v_center_request"] unless ENV["azure_add_v_center_request"].nil?
    path_params[:add_v_center_request] = resource[:add_v_center_request] unless resource.nil? or resource[:add_v_center_request].nil?
    ...
    path_params[:v_center_name] = key_values["vCenterName"] unless key_values["vCenterName"].nil?
    path_params[:v_center_name] = ENV["azure_v_center_name"] unless ENV["azure_v_center_name"].nil?
    path_params[:v_center_name] = resource[:name] unless resource.nil? or resource[:name].nil?
    uri_string = "https://management.azure.com/Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationFabrics/%{fabric_name}/replicationvCenters/%{v_center_name}" % path_params
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationFabrics/%{fabric_name}/replicationvCenters" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
