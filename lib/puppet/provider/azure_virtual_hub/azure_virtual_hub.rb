...
Puppet::Type.type(:azure_virtual_hub).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          tags: item["tags"],
          type: item["type"],
          virtual_hub_parameters: item["virtualHubParameters"],
          ensure: :present,
        }

        self.deep_delete(hash, [:etag])

        self.deep_delete(hash, [:properties, "hubVirtualNetworkConnections", "etag"])
        self.deep_delete(hash, [:properties, "hubVirtualNetworkConnections", "name"])

        self.deep_delete(hash, [:properties, "hubVirtualNetworkConnections", "type"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      virtual_hub_parameters: instance.virtual_hub_parameters.respond_to?(:to_hash) ? instance.virtual_hub_parameters.to_hash : instance.virtual_hub_parameters,
      object: instance,
    }
  end
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type VirtualHub")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type VirtualHub - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    virtual_hub = {}
    virtual_hub["etag"] = resource[:etag] unless resource[:etag].nil?
    virtual_hub["id"] = resource[:id] unless resource[:id].nil?
    virtual_hub["location"] = resource[:location] unless resource[:location].nil?
    virtual_hub["name"] = resource[:name] unless resource[:name].nil?
    virtual_hub["properties"] = resource[:properties] unless resource[:properties].nil?
    virtual_hub["tags"] = resource[:tags] unless resource[:tags].nil?
    virtual_hub["type"] = resource[:type] unless resource[:type].nil?
    return virtual_hub
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation VirtualHubs_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Network/virtualHubs", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation VirtualHubs_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("subscriptionId", "path", "subscription_id"),
      self.op_param("virtualHubName", "path", "name"),
      self.op_param("virtualHubParameters", "body", "virtual_hub_parameters"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
      name = i[:name]
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualHubs/%{virtual_hub_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation VirtualHubs_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualHubs/%{virtual_hub_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation VirtualHubs_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualHubs", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation VirtualHubs_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualHubs/%{virtual_hub_name}", "Get", "[application/json]")
  end
