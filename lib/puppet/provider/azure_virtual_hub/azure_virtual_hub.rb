...
Puppet::Type.type(:azure_virtual_hub).provide(:arm) do
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "virtualNetworkConnections", "etag"])
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("tags", "body", "tags", "tags"),
      self.op_param("type", "body", "type", "type"),
      self.op_param("virtualHubName", "path", "name", "virtual_hub_name"),
      self.op_param("virtualHubParameters", "body", "virtual_hub_parameters", "virtual_hub_parameters"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
      name = i[:name]
