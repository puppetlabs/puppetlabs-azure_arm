  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "instanceView", "bootDiagnostics", "consoleScreenshotBlobUri"])
        self.deep_delete(hash, [:properties, "instanceView", "bootDiagnostics", "serialConsoleLogBlobUri"])
