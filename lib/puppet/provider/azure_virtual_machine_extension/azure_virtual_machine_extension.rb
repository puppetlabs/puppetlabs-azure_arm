...
Puppet::Type.type(:azure_virtual_machine_extension).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:vm_extension_name] = key_values["vmExtensionName"] unless key_values["vmExtensionName"].nil?
    path_params[:vm_extension_name] = ENV["azure_vm_extension_name"] unless ENV["azure_vm_extension_name"].nil?
    path_params[:vm_extension_name] = resource[:vm_extension_name] unless resource.nil? or resource[:vm_extension_name].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/virtualMachines/%{vm_name}/extensions/%{vm_extension_name}" % path_params
