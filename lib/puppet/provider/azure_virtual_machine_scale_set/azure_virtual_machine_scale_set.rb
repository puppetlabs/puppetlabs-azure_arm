...
Puppet::Type.type(:azure_virtual_machine_scale_set).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          tags: item["tags"],
          type: item["type"],
          vm_scale_set_name: item["vmScaleSetName"],
          zones: item["zones"],
          ensure: :present,
        }
        ...
        self.deep_delete(hash, [:properties, "uniqueId"])

        self.deep_delete(hash, [:properties, "virtualMachineProfile", "extensionProfile", "extensions", "id"])

        self.deep_delete(hash, [:properties, "virtualMachineProfile", "extensionProfile", "extensions", "properties", "provisioningState"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      vm_scale_set_name: instance.vm_scale_set_name.respond_to?(:to_hash) ? instance.vm_scale_set_name.to_hash : instance.vm_scale_set_name,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type VirtualMachineScaleSet")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type VirtualMachineScaleSet - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    virtual_machine_scale_set["id"] = resource[:id] unless resource[:id].nil?
    virtual_machine_scale_set["identity"] = resource[:identity] unless resource[:identity].nil?
    virtual_machine_scale_set["location"] = resource[:location] unless resource[:location].nil?
    virtual_machine_scale_set["name"] = resource[:name] unless resource[:name].nil?
    virtual_machine_scale_set["plan"] = resource[:plan] unless resource[:plan].nil?
    virtual_machine_scale_set["properties"] = resource[:properties] unless resource[:properties].nil?
    virtual_machine_scale_set["sku"] = resource[:sku] unless resource[:sku].nil?
    virtual_machine_scale_set["tags"] = resource[:tags] unless resource[:tags].nil?
    virtual_machine_scale_set["type"] = resource[:type] unless resource[:type].nil?
    virtual_machine_scale_set["zones"] = resource[:zones] unless resource[:zones].nil?
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation VirtualMachineScaleSets_ListAll")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Compute/virtualMachineScaleSets", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation VirtualMachineScaleSets_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("subscriptionId", "path", "subscription_id"),
      self.op_param("vmScaleSetName", "path", "vm_scale_set_name"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
      name = i[:name]
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/virtualMachineScaleSets/%{vm_scale_set_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation VirtualMachineScaleSets_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/virtualMachineScaleSets/%{vm_scale_set_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation VirtualMachineScaleSets_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/virtualMachineScaleSets", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation VirtualMachineScaleSets_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/virtualMachineScaleSets/%{vm_scale_set_name}", "Get", "[application/json]")
  end
