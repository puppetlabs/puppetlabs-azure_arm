...
Puppet::Type.type(:azure_virtual_machine_scale_set_extension).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:extension_parameters] = key_values["extensionParameters"] unless key_values["extensionParameters"].nil?
    path_params[:extension_parameters] = ENV["azure_extension_parameters"] unless ENV["azure_extension_parameters"].nil?
    path_params[:extension_parameters] = resource[:extension_parameters] unless resource.nil? or resource[:extension_parameters].nil?
    ...
    path_params[:vmss_extension_name] = key_values["vmssExtensionName"] unless key_values["vmssExtensionName"].nil?
    path_params[:vmss_extension_name] = ENV["azure_vmss_extension_name"] unless ENV["azure_vmss_extension_name"].nil?
    path_params[:vmss_extension_name] = resource[:vmss_extension_name] unless resource.nil? or resource[:vmss_extension_name].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/virtualMachineScaleSets/%{vm_scale_set_name}/extensions/%{vmss_extension_name}" % path_params
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    path_params[:vm_scale_set_name] = ENV["azure_vm_scale_set_name"] unless ENV["azure_vm_scale_set_name"].nil?
    path_params[:vm_scale_set_name] = resource[:vm_scale_set_name] unless resource.nil? or resource[:vm_scale_set_name].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/virtualMachineScaleSets/%{vm_scale_set_name}/extensions" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
