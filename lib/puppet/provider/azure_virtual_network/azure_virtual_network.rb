...
Puppet::Type.type(:azure_virtual_network).provide(:arm) do
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "enableDdosProtection"])
        self.deep_delete(hash, [:properties, "enableVmProtection"])

        self.deep_delete(hash, [:properties, "subnets", "properties", "delegations", "properties", "provisioningState"])
        self.deep_delete(hash, [:properties, "subnets", "properties", "ipConfigurationProfiles"])
        self.deep_delete(hash, [:properties, "subnets", "properties", "ipConfigurations"])

        self.deep_delete(hash, [:properties, "subnets", "properties", "networkSecurityGroup", "name"])

        self.deep_delete(hash, [:properties, "subnets", "properties", "networkSecurityGroup", "properties", "defaultSecurityRules", "properties", "destinationApplicationSecurityGroups", "etag"])
        self.deep_delete(hash, [:properties, "subnets", "properties", "networkSecurityGroup", "properties", "defaultSecurityRules", "properties", "destinationApplicationSecurityGroups", "name"])

        self.deep_delete(hash, [:properties, "subnets", "properties", "networkSecurityGroup", "properties", "defaultSecurityRules", "properties", "destinationApplicationSecurityGroups", "properties", "provisioningState"])
        self.deep_delete(hash, [:properties, "subnets", "properties", "networkSecurityGroup", "properties", "defaultSecurityRules", "properties", "destinationApplicationSecurityGroups", "properties", "resourceGuid"])
        self.deep_delete(hash, [:properties, "subnets", "properties", "networkSecurityGroup", "properties", "defaultSecurityRules", "properties", "destinationApplicationSecurityGroups", "type"])

        self.deep_delete(hash, [:properties, "subnets", "properties", "networkSecurityGroup", "properties", "networkInterfaces"])
        self.deep_delete(hash, [:properties, "subnets", "properties", "networkSecurityGroup", "properties", "subnets"])
        self.deep_delete(hash, [:properties, "subnets", "properties", "networkSecurityGroup", "type"])
        self.deep_delete(hash, [:properties, "subnets", "properties", "privateEndpoints"])
        ...
        self.deep_delete(hash, [:properties, "subnets", "properties", "resourceNavigationLinks", "id"])

        self.deep_delete(hash, [:properties, "subnets", "properties", "resourceNavigationLinks", "properties", "provisioningState"])
        self.deep_delete(hash, [:properties, "subnets", "properties", "resourceNavigationLinks", "type"])

        self.deep_delete(hash, [:properties, "subnets", "properties", "routeTable", "name"])

        self.deep_delete(hash, [:properties, "subnets", "properties", "routeTable", "properties", "subnets"])
        ...
        self.deep_delete(hash, [:properties, "subnets", "properties", "serviceEndpointPolicies", "properties", "subnets"])
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Network/virtualNetworks", "Get", "[application/json]")
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualNetworks/%{virtual_network_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualNetworks/%{virtual_network_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualNetworks", "Get", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualNetworks/%{virtual_network_name}", "Get", "[application/json]")
  end
