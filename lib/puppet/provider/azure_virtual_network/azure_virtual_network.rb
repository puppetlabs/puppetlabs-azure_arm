...
Puppet::Type.type(:azure_virtual_network).provide(:arm) do
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "subnets", "properties", "ipConfigurations", "properties", "publicIPAddress", "name"])

        self.deep_delete(hash, [:properties, "subnets", "properties", "ipConfigurations", "properties", "publicIPAddress", "type"])
        ...
        self.deep_delete(hash, [:properties, "subnets", "properties", "networkSecurityGroup", "properties", "networkInterfaces", "name"])

        self.deep_delete(hash, [:properties, "subnets", "properties", "networkSecurityGroup", "properties", "networkInterfaces", "type"])
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("subscriptionId", "path", "subscription_id"),
      self.op_param("virtualNetworkName", "path", "name"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
      name = i[:name]
