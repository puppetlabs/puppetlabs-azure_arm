...
Puppet::Type.type(:azure_virtual_network_link).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type VirtualNetworkLink")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type VirtualNetworkLink - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    virtual_network_link["etag"] = resource[:etag] unless resource[:etag].nil?
    virtual_network_link["id"] = resource[:id] unless resource[:id].nil?
    virtual_network_link["location"] = resource[:location] unless resource[:location].nil?
    virtual_network_link["name"] = resource[:name] unless resource[:name].nil?
    virtual_network_link["properties"] = resource[:properties] unless resource[:properties].nil?
    virtual_network_link["tags"] = resource[:tags] unless resource[:tags].nil?
    virtual_network_link["type"] = resource[:type] unless resource[:type].nil?
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation VirtualNetworkLinks_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("privateZoneName", "path", "private_zone_name", "private_zone_name"),
      ...
      self.op_param("virtualNetworkLinkName", "path", "name", "virtual_network_link_name"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
      name = i[:name]
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/privateDnsZones/%{private_zone_name}/virtualNetworkLinks/%{virtual_network_link_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation VirtualNetworkLinks_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/privateDnsZones/%{private_zone_name}/virtualNetworkLinks/%{virtual_network_link_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation VirtualNetworkLinks_List")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/privateDnsZones/%{private_zone_name}/virtualNetworkLinks", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation VirtualNetworkLinks_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/privateDnsZones/%{private_zone_name}/virtualNetworkLinks/%{virtual_network_link_name}", "Get", "[application/json]")
  end
