...
Puppet::Type.type(:azure_virtual_network_peering).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      ...
      self.op_param("virtualNetworkName", "path", "virtual_network_name"),
      self.op_param("virtualNetworkPeeringName", "path", "name"),
      self.op_param("VirtualNetworkPeeringParameters", "body", "virtual_network_peering_parameters"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
      name = i[:name]
