...
Puppet::Type.type(:azure_virtual_network_peering).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type VirtualNetworkPeering")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type VirtualNetworkPeering - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    ...
    virtual_network_peering["etag"] = resource[:etag] unless resource[:etag].nil?
    virtual_network_peering["id"] = resource[:id] unless resource[:id].nil?
    virtual_network_peering["name"] = resource[:name] unless resource[:name].nil?
    virtual_network_peering["properties"] = resource[:properties] unless resource[:properties].nil?
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation VirtualNetworkPeerings_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    path_params[:virtual_network_name] = key_values["virtualNetworkName"] unless key_values["virtualNetworkName"].nil?
    path_params[:virtual_network_name] = ENV["azure_virtual_network_name"] unless ENV["azure_virtual_network_name"].nil?
    path_params[:virtual_network_name] = resource[:virtual_network_name] unless resource.nil? or resource[:virtual_network_name].nil?
    path_params[:virtual_network_peering_name] = key_values["virtualNetworkPeeringName"] unless key_values["virtualNetworkPeeringName"].nil?
    path_params[:virtual_network_peering_name] = ENV["azure_virtual_network_peering_name"] unless ENV["azure_virtual_network_peering_name"].nil?
    path_params[:virtual_network_peering_name] = resource[:name] unless resource.nil? or resource[:name].nil?
    path_params[:virtual_network_peering_parameters] = key_values["VirtualNetworkPeeringParameters"] unless key_values["VirtualNetworkPeeringParameters"].nil?
    path_params[:virtual_network_peering_parameters] = ENV["azure_virtual_network_peering_parameters"] unless ENV["azure_virtual_network_peering_parameters"].nil?
    path_params[:virtual_network_peering_parameters] = resource[:virtual_network_peering_parameters] unless resource.nil? or resource[:virtual_network_peering_parameters].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualNetworks/%{virtual_network_name}/virtualNetworkPeerings/%{virtual_network_peering_name}" % path_params
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation VirtualNetworkPeerings_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation VirtualNetworkPeerings_List")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
    ...
    path_params[:virtual_network_name] = ENV["azure_virtual_network_name"] unless ENV["azure_virtual_network_name"].nil?
    path_params[:virtual_network_name] = resource[:virtual_network_name] unless resource.nil? or resource[:virtual_network_name].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualNetworks/%{virtual_network_name}/virtualNetworkPeerings" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json text/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation VirtualNetworkPeerings_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    query_params["api-version"] = key_values["api-version"] unless key_values["api-version"].nil?
