...
Puppet::Type.type(:azure_virtual_wan).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          tags: item["tags"],
          type: item["type"],
          wan_parameters: item["WANParameters"],
          ensure: :present,
        }

        self.deep_delete(hash, [:etag])

        self.deep_delete(hash, [:properties, "p2SVpnServerConfigurations", "etag"])

        self.deep_delete(hash, [:properties, "p2SVpnServerConfigurations", "properties", "p2SVpnGateways"])

        self.deep_delete(hash, [:properties, "p2SVpnServerConfigurations", "properties", "p2SVpnServerConfigRadiusClientRootCertificates", "properties", "provisioningState"])

        self.deep_delete(hash, [:properties, "p2SVpnServerConfigurations", "properties", "p2SVpnServerConfigRadiusServerRootCertificates", "properties", "provisioningState"])

        self.deep_delete(hash, [:properties, "p2SVpnServerConfigurations", "properties", "p2SVpnServerConfigVpnClientRevokedCertificates", "properties", "provisioningState"])

        self.deep_delete(hash, [:properties, "p2SVpnServerConfigurations", "properties", "p2SVpnServerConfigVpnClientRootCertificates", "properties", "provisioningState"])
        self.deep_delete(hash, [:properties, "p2SVpnServerConfigurations", "properties", "provisioningState"])

        self.deep_delete(hash, [:properties, "virtualHubs"])
        self.deep_delete(hash, [:properties, "vpnSites"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      wan_parameters: instance.wan_parameters.respond_to?(:to_hash) ? instance.wan_parameters.to_hash : instance.wan_parameters,
      object: instance,
    }
  end
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type VirtualWAN")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type VirtualWAN - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    virtual_wan = {}
    virtual_wan["etag"] = resource[:etag] unless resource[:etag].nil?
    virtual_wan["id"] = resource[:id] unless resource[:id].nil?
    virtual_wan["location"] = resource[:location] unless resource[:location].nil?
    virtual_wan["name"] = resource[:name] unless resource[:name].nil?
    virtual_wan["properties"] = resource[:properties] unless resource[:properties].nil?
    virtual_wan["tags"] = resource[:tags] unless resource[:tags].nil?
    virtual_wan["type"] = resource[:type] unless resource[:type].nil?
    return virtual_wan
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation VirtualWans_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Network/virtualWans", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation VirtualWans_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    op_params = [
      self.op_param("_virtual_wan_name", "path", "_virtual_wan_name", "_virtual_wan_name"),
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("etag", "body", "etag", "etag"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("location", "body", "location", "location"),
      ...
      self.op_param("tags", "body", "tags", "tags"),
      self.op_param("type", "body", "type", "type"),
      self.op_param("VirtualWANName", "path", "name", "virtual_wan_name"),
      self.op_param("WANParameters", "body", "wan_parameters", "wan_parameters"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
      name = i[:name]
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualWans/%{_virtual_wan_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation VirtualWans_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualWans/%{_virtual_wan_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation VirtualWans_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualWans", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation VirtualWans_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualWans/%{_virtual_wan_name}", "Get", "[application/json]")
  end
