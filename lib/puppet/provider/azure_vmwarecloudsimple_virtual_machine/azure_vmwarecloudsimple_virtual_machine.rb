...
Puppet::Type.type(:azure_vmwarecloudsimple_virtual_machine).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          tags: item["tags"],
          type: item["type"],
          virtual_machine_request: item["virtualMachineRequest"],
          ensure: :present,
        }

        self.deep_delete(hash, [:id])

        self.deep_delete(hash, [:properties, "controllers"])

        self.deep_delete(hash, [:properties, "disks", "virtualDiskName"])
        self.deep_delete(hash, [:properties, "dnsname"])
        self.deep_delete(hash, [:properties, "folder"])

        self.deep_delete(hash, [:properties, "nics", "network", "assignable"])
        self.deep_delete(hash, [:properties, "nics", "network", "name"])

        self.deep_delete(hash, [:properties, "nics", "network", "properties", "privateCloudId"])
        self.deep_delete(hash, [:properties, "nics", "network", "type"])
        self.deep_delete(hash, [:properties, "nics", "virtualNicName"])
        self.deep_delete(hash, [:properties, "provisioningState"])
        self.deep_delete(hash, [:properties, "publicIP"])

        self.deep_delete(hash, [:properties, "resourcePool", "name"])
        self.deep_delete(hash, [:properties, "resourcePool", "privateCloudId"])

        self.deep_delete(hash, [:properties, "resourcePool", "properties", "fullName"])
        self.deep_delete(hash, [:properties, "resourcePool", "type"])
        self.deep_delete(hash, [:properties, "status"])
        self.deep_delete(hash, [:properties, "vmId"])
        self.deep_delete(hash, [:properties, "vmwaretools"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      referer: instance.referer.respond_to?(:to_hash) ? instance.referer.to_hash : instance.referer,
      ...
      virtual_machine_request: instance.virtual_machine_request.respond_to?(:to_hash) ? instance.virtual_machine_request.to_hash : instance.virtual_machine_request,
      object: instance,
    }
  end
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type VirtualMachine")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type VirtualMachine - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    virtual_machine = {}
    virtual_machine["id"] = resource[:id] unless resource[:id].nil?
    virtual_machine["location"] = resource[:location] unless resource[:location].nil?
    virtual_machine["name"] = resource[:name] unless resource[:name].nil?
    virtual_machine["properties"] = resource[:properties] unless resource[:properties].nil?
    virtual_machine["tags"] = resource[:tags] unless resource[:tags].nil?
    virtual_machine["type"] = resource[:type] unless resource[:type].nil?
    return virtual_machine
  end

  def self.build_key_values
    key_values = {}
    key_values["api-version"] = "2019-04-01"
    key_values
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation virtualMachine_ListBySubscription")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.VMwareCloudSimple/virtualMachines", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation virtualMachine_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    op_params = [
      ...
      self.op_param("name", "body", "name", "name"),
      self.op_param("properties", "body", "properties", "properties"),
      self.op_param("Referer", "header", "referer", "referer"),
      self.op_param("resourceGroupName", "path", "resource_group_name", "resource_group_name"),
      self.op_param("subscriptionId", "path", "subscription_id", "subscription_id"),
      self.op_param("tags", "body", "tags", "tags"),
      self.op_param("type", "body", "type", "type"),
      self.op_param("virtualMachineName", "path", "name", "virtual_machine_name"),
      self.op_param("virtualMachineRequest", "body", "virtual_machine_request", "virtual_machine_request"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
      name = i[:name]
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.VMwareCloudSimple/virtualMachines/%{virtual_machine_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation virtualMachine_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.VMwareCloudSimple/virtualMachines/%{virtual_machine_name}", "Delete", "[application/json]")
  end
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation virtualMachine_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.VMwareCloudSimple/virtualMachines/%{virtual_machine_name}", "Get", "[application/json]")
  end
