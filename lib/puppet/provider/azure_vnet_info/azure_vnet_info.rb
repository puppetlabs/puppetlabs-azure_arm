...
Puppet::Type.type(:azure_vnet_info).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type VnetInfo")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type VnetInfo - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    vnet_info = {}
    vnet_info["id"] = resource[:id] unless resource[:id].nil?
    vnet_info["kind"] = resource[:kind] unless resource[:kind].nil?
    vnet_info["location"] = resource[:location] unless resource[:location].nil?
    vnet_info["name"] = resource[:name] unless resource[:name].nil?
    vnet_info["properties"] = resource[:properties] unless resource[:properties].nil?
    vnet_info["tags"] = resource[:tags] unless resource[:tags].nil?
    vnet_info["type"] = resource[:type] unless resource[:type].nil?
    return vnet_info
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Sites_CreateOrUpdateSiteVNETConnectionSlot")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("connectionEnvelope", "body", "connection_envelope", "connection_envelope"),
      ...
      self.op_param("vnetName", "path", "vnet_name", "vnet_name"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
      name = i[:name]
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/virtualNetworkConnections/%{vnet_name}", "Put", "[]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Sites_DeleteSiteVNETConnectionSlot")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/virtualNetworkConnections/%{vnet_name}", "Delete", "[]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ServerFarms_GetVnetsForServerFarm")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/serverfarms/%{name}/virtualNetworkConnections", "Get", "[]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Sites_GetSiteVNETConnectionSlot")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/virtualNetworkConnections/%{vnet_name}", "Get", "[]")
  end
