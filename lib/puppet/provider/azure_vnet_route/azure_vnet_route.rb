...
Puppet::Type.type(:azure_vnet_route).provide(:arm) do
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    path_params[:route] = key_values["route"] unless key_values["route"].nil?
    path_params[:route] = ENV["azure_route"] unless ENV["azure_route"].nil?
    path_params[:route] = resource[:route] unless resource.nil? or resource[:route].nil?
