...
Puppet::Type.type(:azure_vnet_route).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type VnetRoute")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type VnetRoute - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    vnet_route = {}
    vnet_route["id"] = resource[:id] unless resource[:id].nil?
    vnet_route["kind"] = resource[:kind] unless resource[:kind].nil?
    vnet_route["location"] = resource[:location] unless resource[:location].nil?
    vnet_route["name"] = resource[:name] unless resource[:name].nil?
    vnet_route["properties"] = resource[:properties] unless resource[:properties].nil?
    vnet_route["tags"] = resource[:tags] unless resource[:tags].nil?
    vnet_route["type"] = resource[:type] unless resource[:type].nil?
    return vnet_route
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation ServerFarms_CreateOrUpdateVnetRoute")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("route", "body", "route", "route"),
      self.op_param("routeName", "path", "route_name", "route_name"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/serverfarms/%{name}/virtualNetworkConnections/%{vnet_name}/routes/%{route_name}", "Put", "[]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation ServerFarms_DeleteVnetRoute")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.2"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/serverfarms/%{name}/virtualNetworkConnections/%{vnet_name}/routes/%{route_name}", "Delete", "[]")
  end
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/serverfarms/%{name}/virtualNetworkConnections/%{vnet_name}/routes/%{route_name}", "Get", "[]")
  end
