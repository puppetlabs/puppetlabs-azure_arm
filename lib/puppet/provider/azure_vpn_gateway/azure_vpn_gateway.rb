...
Puppet::Type.type(:azure_vpn_gateway).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          tags: item["tags"],
          type: item["type"],
          vpn_gateway_parameters: item["vpnGatewayParameters"],
          ensure: :present,
        }

        self.deep_delete(hash, [:etag])

        self.deep_delete(hash, [:properties, "connections", "etag"])
        self.deep_delete(hash, [:properties, "connections", "name"])

        self.deep_delete(hash, [:properties, "connections", "properties", "connectionBandwidthInMbps"])

        self.deep_delete(hash, [:properties, "connections", "properties", "egressBytesTransferred"])
        self.deep_delete(hash, [:properties, "connections", "properties", "ingressBytesTransferred"])

        self.deep_delete(hash, [:properties, "connections", "type"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      gateway_name: instance.gateway_name.respond_to?(:to_hash) ? instance.gateway_name.to_hash : instance.gateway_name,
      ...
      vpn_gateway_parameters: instance.vpn_gateway_parameters.respond_to?(:to_hash) ? instance.vpn_gateway_parameters.to_hash : instance.vpn_gateway_parameters,
      object: instance,
    }
  end
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type VpnGateway")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type VpnGateway - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    vpn_gateway = {}
    vpn_gateway["etag"] = resource[:etag] unless resource[:etag].nil?
    vpn_gateway["id"] = resource[:id] unless resource[:id].nil?
    vpn_gateway["location"] = resource[:location] unless resource[:location].nil?
    vpn_gateway["name"] = resource[:name] unless resource[:name].nil?
    vpn_gateway["properties"] = resource[:properties] unless resource[:properties].nil?
    vpn_gateway["tags"] = resource[:tags] unless resource[:tags].nil?
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation VpnGateways_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Network/vpnGateways", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation VpnGateways_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("gatewayName", "path", "gateway_name", "gateway_name"),
      self.op_param("resourceGroupName", "path", "resource_group_name", "resource_group_name"),
      self.op_param("subscriptionId", "path", "subscription_id", "subscription_id"),
      self.op_param("vpnGatewayParameters", "body", "vpn_gateway_parameters", "vpn_gateway_parameters"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
      name = i[:name]
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/vpnGateways/%{gateway_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation VpnGateways_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/vpnGateways/%{gateway_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation VpnGateways_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/vpnGateways", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation VpnGateways_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/vpnGateways/%{gateway_name}", "Get", "[application/json]")
  end
