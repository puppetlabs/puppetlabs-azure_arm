  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "connections", "properties", "vpnLinkConnections", "etag"])

        self.deep_delete(hash, [:properties, "connections", "properties", "vpnLinkConnections", "properties", "egressBytesTransferred"])
        self.deep_delete(hash, [:properties, "connections", "properties", "vpnLinkConnections", "properties", "ingressBytesTransferred"])
        self.deep_delete(hash, [:properties, "connections", "properties", "vpnLinkConnections", "type"])
