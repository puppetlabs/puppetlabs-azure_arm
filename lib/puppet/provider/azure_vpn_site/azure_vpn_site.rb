...
Puppet::Type.type(:azure_vpn_site).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          tags: item["tags"],
          type: item["type"],
          vpn_site_parameters: item["VpnSiteParameters"],
          ensure: :present,
        }
  ...
  def self.instance_to_hash(instance)
    {
      ...
      vpn_site_parameters: instance.vpn_site_parameters.respond_to?(:to_hash) ? instance.vpn_site_parameters.to_hash : instance.vpn_site_parameters,
      object: instance,
    }
  end
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type VpnSite")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type VpnSite - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    vpn_site = {}
    vpn_site["etag"] = resource[:etag] unless resource[:etag].nil?
    vpn_site["id"] = resource[:id] unless resource[:id].nil?
    vpn_site["location"] = resource[:location] unless resource[:location].nil?
    vpn_site["name"] = resource[:name] unless resource[:name].nil?
    vpn_site["properties"] = resource[:properties] unless resource[:properties].nil?
    vpn_site["tags"] = resource[:tags] unless resource[:tags].nil?
    vpn_site["type"] = resource[:type] unless resource[:type].nil?
    return vpn_site
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation VpnSites_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Network/vpnSites", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation VpnSites_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    op_params = [
      ...
      self.op_param("subscriptionId", "path", "subscription_id", "subscription_id"),
      self.op_param("vpnSiteName", "path", "name", "vpn_site_name"),
      self.op_param("VpnSiteParameters", "body", "vpn_site_parameters", "vpn_site_parameters"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
      name = i[:name]
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/vpnSites/%{vpn_site_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation VpnSites_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/vpnSites/%{vpn_site_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation VpnSites_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/vpnSites", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation VpnSites_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/vpnSites/%{vpn_site_name}", "Get", "[application/json]")
  end
