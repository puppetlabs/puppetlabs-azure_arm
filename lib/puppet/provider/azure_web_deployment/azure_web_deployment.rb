...
Puppet::Type.type(:azure_web_deployment).provide(:arm) do
  mk_resource_methods
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type Deployment")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type Deployment - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    deployment = {}
    deployment["id"] = resource[:id] unless resource[:id].nil?
    deployment["kind"] = resource[:kind] unless resource[:kind].nil?
    deployment["location"] = resource[:location] unless resource[:location].nil?
    deployment["name"] = resource[:name] unless resource[:name].nil?
    deployment["properties"] = resource[:properties] unless resource[:properties].nil?
    deployment["tags"] = resource[:tags] unless resource[:tags].nil?
    deployment["type"] = resource[:type] unless resource[:type].nil?
    return deployment
  end
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Sites_CreateInstanceDeployment")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      ...
      self.op_param("deployment", "body", "deployment", "deployment"),
      self.op_param("id", "path", "id", "id"),
      self.op_param("instanceId", "path", "instance_id", "instance_id"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/instances/%{instance_id}/deployments/%{id}", "Put", "[]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Sites_DeleteInstanceDeployment")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/instances/%{instance_id}/deployments/%{id}", "Delete", "[]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Sites_GetInstanceDeployments")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/instances/%{instance_id}/deployments", "Get", "[]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Sites_GetInstanceDeployment")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/instances/%{instance_id}/deployments/%{id}", "Get", "[]")
  end
