...
Puppet::Type.type(:azure_web_service).provide(:arm) do
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    query_params["$skiptoken"] = ENV["azure_$skiptoken"] unless ENV["azure_$skiptoken"].nil?
    query_params["$skiptoken"] = resource[:$skiptoken] unless resource.nil? or resource[:$skiptoken].nil?
    ...
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/providers/Microsoft.MachineLearning/webServices" % path_params
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    query_params["api-version"] = ENV["azure_api_version"] unless ENV["azure_api_version"].nil?
    query_params["api-version"] = resource[:api_version] unless resource.nil? or resource[:api_version].nil?
    path_params[:create_or_update_payload] = key_values["createOrUpdatePayload"] unless key_values["createOrUpdatePayload"].nil?
    path_params[:create_or_update_payload] = ENV["azure_create_or_update_payload"] unless ENV["azure_create_or_update_payload"].nil?
    path_params[:create_or_update_payload] = resource[:create_or_update_payload] unless resource.nil? or resource[:create_or_update_payload].nil?
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    path_params[:web_service_name] = key_values["webServiceName"] unless key_values["webServiceName"].nil?
    path_params[:web_service_name] = ENV["azure_web_service_name"] unless ENV["azure_web_service_name"].nil?
    path_params[:web_service_name] = resource[:name] unless resource.nil? or resource[:name].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.MachineLearning/webServices/%{web_service_name}" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    path_params[:subscription_id] = ENV["azure_subscription_id"] unless ENV["azure_subscription_id"].nil?
    path_params[:subscription_id] = resource[:subscription_id] unless resource.nil? or resource[:subscription_id].nil?
    uri_string = "https://management.azure.com/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.MachineLearning/webServices" % path_params
    uri_string = uri_string + "?" + to_query(query_params)
    header_params['Content-Type'] = 'application/json' # first of [application/json]
    if authenticate(path_params, query_params, header_params, body_params)
      Puppet.info("Authentication succeeded")
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    query_params["api-version"] = ENV["azure_api_version"] unless ENV["azure_api_version"].nil?
    query_params["api-version"] = resource[:api_version] unless resource.nil? or resource[:api_version].nil?
    query_params["region"] = key_values["region"] unless key_values["region"].nil?
    query_params["region"] = ENV["azure_region"] unless ENV["azure_region"].nil?
    query_params["region"] = resource[:region] unless resource.nil? or resource[:region].nil?
    path_params[:resource_group_name] = key_values["resourceGroupName"] unless key_values["resourceGroupName"].nil?
    path_params[:resource_group_name] = ENV["azure_resource_group_name"] unless ENV["azure_resource_group_name"].nil?
    path_params[:resource_group_name] = resource[:resource_group_name] unless resource.nil? or resource[:resource_group_name].nil?
    path_params[:subscription_id] = key_values["subscriptionId"] unless key_values["subscriptionId"].nil?
