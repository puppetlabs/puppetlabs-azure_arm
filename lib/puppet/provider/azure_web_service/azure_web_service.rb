...
Puppet::Type.type(:azure_web_service).provide(:arm) do
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    op_params = [
      self.op_param("$skiptoken", "query", "$skiptoken"),
  ...
  def self.invoke_create(resource = nil, body_params = nil)
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version"),
      self.op_param("createOrUpdatePayload", "body", "create_or_update_payload"),
      self.op_param("resourceGroupName", "path", "resource_group_name"),
      self.op_param("subscriptionId", "path", "subscription_id"),
      self.op_param("webServiceName", "path", "name"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
      name = i[:name]
  ...
  def self.invoke_get_one(resource = nil, body_params = nil)
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version"),
      self.op_param("region", "query", "region"),
      self.op_param("resourceGroupName", "path", "resource_group_name"),
      self.op_param("subscriptionId", "path", "subscription_id"),
      self.op_param("webServiceName", "path", "name"),
    ]
