...
Puppet::Type.type(:azure_web_service).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          create_or_update_payload: item["createOrUpdatePayload"],
          id: item["id"],
        ...
        self.deep_delete(hash, [:properties, "createdOn"])

        self.deep_delete(hash, [:properties, "input", "type"])

        self.deep_delete(hash, [:properties, "modifiedOn"])

        self.deep_delete(hash, [:properties, "provisioningState"])

        self.deep_delete(hash, [:properties, "swaggerLocation"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      create_or_update_payload: instance.create_or_update_payload.respond_to?(:to_hash) ? instance.create_or_update_payload.to_hash : instance.create_or_update_payload,
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type WebService")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type WebService - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    web_service = {}
    web_service["id"] = resource[:id] unless resource[:id].nil?
    web_service["location"] = resource[:location] unless resource[:location].nil?
    web_service["name"] = resource[:name] unless resource[:name].nil?
    web_service["properties"] = resource[:properties] unless resource[:properties].nil?
    web_service["tags"] = resource[:tags] unless resource[:tags].nil?
    web_service["type"] = resource[:type] unless resource[:type].nil?
    return web_service
  end

  def self.build_key_values
    key_values = {}
    key_values["api-version"] = "2017-01-01"
    key_values
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation WebServices_ListBySubscriptionId")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    op_params = [
      self.op_param("$skiptoken", "query", "$skiptoken", "$skiptoken"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.MachineLearning/webServices", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation WebServices_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    op_params = [
      self.op_param("api-version", "query", "api_version", "api_version"),
      self.op_param("createOrUpdatePayload", "body", "create_or_update_payload", "create_or_update_payload"),
      self.op_param("id", "body", "id", "id"),
      self.op_param("location", "body", "location", "location"),
      self.op_param("name", "body", "name", "name"),
      self.op_param("properties", "body", "properties", "properties"),
      ...
      self.op_param("tags", "body", "tags", "tags"),
      self.op_param("type", "body", "type", "type"),
      self.op_param("webServiceName", "path", "name", "web_service_name"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
      name = i[:name]
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.MachineLearning/webServices/%{web_service_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation WebServices_Remove")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.MachineLearning/webServices/%{web_service_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation WebServices_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.MachineLearning/webServices", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation WebServices_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.2.1"
    ...
    op_params = [
      ...
      self.op_param("name", "body", "name", "name"),
      self.op_param("properties", "body", "properties", "properties"),
      self.op_param("region", "query", "region", "region"),
      self.op_param("resourceGroupName", "path", "resource_group_name", "resource_group_name"),
      self.op_param("subscriptionId", "path", "subscription_id", "subscription_id"),
      self.op_param("tags", "body", "tags", "tags"),
      self.op_param("type", "body", "type", "type"),
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.MachineLearning/webServices/%{web_service_name}", "Get", "[application/json]")
  end
