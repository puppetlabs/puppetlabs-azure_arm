...
Puppet::Type.type(:azure_web_test).provide(:arm) do
  mk_resource_methods
    ...
    if items
      items.collect do |item|
        hash = {
          ...
          tags: item["tags"],
          type: item["type"],
          web_test_definition: item["WebTestDefinition"],
          ensure: :present,
        }
  ...
  def self.instance_to_hash(instance)
    {
      ...
      web_test_definition: instance.web_test_definition.respond_to?(:to_hash) ? instance.web_test_definition.to_hash : instance.web_test_definition,
      object: instance,
    }
  end
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type WebTest")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type WebTest - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    web_test = {}
    web_test["id"] = resource[:id] unless resource[:id].nil?
    web_test["kind"] = resource[:kind] unless resource[:kind].nil?
    web_test["location"] = resource[:location] unless resource[:location].nil?
    web_test["name"] = resource[:name] unless resource[:name].nil?
    web_test["properties"] = resource[:properties] unless resource[:properties].nil?
    web_test["tags"] = resource[:tags] unless resource[:tags].nil?
    web_test["type"] = resource[:type] unless resource[:type].nil?
    return web_test
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation WebTests_List")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Insights/webtests", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation WebTests_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    op_params = [
      ...
      self.op_param("subscriptionId", "path", "subscription_id", "subscription_id"),
      self.op_param("WebTestDefinition", "body", "web_test_definition", "web_test_definition"),
      self.op_param("webTestName", "path", "name", "web_test_name"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
      name = i[:name]
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Insights/webtests/%{web_test_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation WebTests_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Insights/webtests/%{web_test_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation WebTests_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Insights/webtests", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation WebTests_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Insights/webtests/%{web_test_name}", "Get", "[application/json]")
  end
