...
Puppet::Type.type(:azure_workflow).provide(:arm) do
  mk_resource_methods
  ...
  def self.fetch_all_as_hash
    ...
    if items
      items.collect do |item|
        ...
        self.deep_delete(hash, [:properties, "accessEndpoint"])
        self.deep_delete(hash, [:properties, "changedTime"])
        self.deep_delete(hash, [:properties, "createdTime"])

        self.deep_delete(hash, [:properties, "integrationAccount", "id"])
        self.deep_delete(hash, [:properties, "integrationAccount", "name"])
        self.deep_delete(hash, [:properties, "integrationAccount", "type"])

        self.deep_delete(hash, [:properties, "version"])
  ...
  def self.instance_to_hash(instance)
    {
      ...
      workflow: instance.workflow.respond_to?(:to_hash) ? instance.workflow.to_hash : instance.workflow,
      object: instance,
    }
  end
  ...
  def create
    @is_create = true
    Puppet.info("Entered create for resource #{name} of type Workflow")
    hash = build_hash
  ...
  def flush
    Puppet.info("Entered flush for resource #{name} of type Workflow - creating ? #{@is_create}, deleting ? #{@is_delete}")
  ...
  def build_hash
    workflow = {}
    workflow["id"] = resource[:id] unless resource[:id].nil?
    workflow["location"] = resource[:location] unless resource[:location].nil?
    workflow["name"] = resource[:name] unless resource[:name].nil?
    workflow["properties"] = resource[:properties] unless resource[:properties].nil?
    workflow["tags"] = resource[:tags] unless resource[:tags].nil?
    workflow["type"] = resource[:type] unless resource[:type].nil?
    return workflow
  end
  ...
  def self.invoke_list_all(resource = nil, body_params = nil)
    ...
    Puppet.info("Calling operation Workflows_ListBySubscription")
    path_params = {}
    query_params = {}
    header_params = {}
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/providers/Microsoft.Logic/workflows", "Get", "[application/json]")
  end

  def self.invoke_create(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Workflows_CreateOrUpdate")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    op_params = [
      ...
      self.op_param("subscriptionId", "path", "subscription_id", "subscription_id"),
      self.op_param("workflow", "body", "workflow", "workflow"),
      self.op_param("workflowName", "path", "name", "workflow_name"),
    ]
    op_params.each do |i|
      inquery = i[:inquery]
      name = i[:name]
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/workflows/%{workflow_name}", "Put", "[application/json]")
  end
  ...
  def self.invoke_delete(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Workflows_Delete")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/workflows/%{workflow_name}", "Delete", "[application/json]")
  end

  def self.invoke_list_with_params(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Workflows_ListByResourceGroup")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/workflows", "Get", "[application/json]")
  end

  def self.invoke_get_one(resource = nil, body_params = nil)
    key_values = self.build_key_values
    Puppet.info("Calling operation Workflows_Get")
    path_params = {}
    query_params = {}
    header_params = {}
    header_params["User-Agent"] = "puppetlabs-azure_arm/0.1.5"
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.azure.com", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/workflows/%{workflow_name}", "Get", "[application/json]")
  end
