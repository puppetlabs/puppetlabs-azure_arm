...
Puppet::Type.newtype(:azure_asset_filter) do
  @doc = "An Asset Filter."
  ...
  validate do
    ...
    required_properties.each do |property|
      ...
      if self[:ensure] == :present && self[property].nil? && self.provider.send(property) == :absent
        raise Puppet::Error, "In azure_asset_filter you must provide a value for #{property}"
      end
    end
  end
  newproperty(:id) do
