...
Puppet::Type.newtype(:azure_budget) do
  ...
  newproperty(:e_tag) do
    desc "eTag of the resource. To handle concurrent update scenarion, this field will be used to determine whether the user is updating the latest version or not."
    validate do |value|
      true
    end
  end
  ...
  newparam(:api_version) do
    desc "Version of the API to be used with the client request. The current version is 2018-03-31."
    validate do |value|
      true
    end
  end
