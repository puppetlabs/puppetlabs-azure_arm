...
Puppet::Type.newtype(:azure_environment) do
  ...
  validate do
    ...
    required_properties.each do |property|
      ...
      if self[:ensure] == :present && self[property].nil? && self.provider.send(property) == :absent
        raise Puppet::Error, "In azure_environment you must provide a value for #{property}"
      end
    end
  end
  newproperty(:id) do
  ...
  newproperty(:properties) do
    desc "The properties of the Environment resource"
    validate do |value|
      true
    end
  end
  ...
  newparam(:environment) do
    desc "Represents an environment instance"
    validate do |value|
      true
    end
  end
  newparam(:environment_setting_name) do
    desc "The name of the environment Setting."
    validate do |value|
      true
    end
  end
