...
Puppet::Type.newtype(:azure_identity_provider_contract) do
  ...
  validate do
    ...
    required_properties.each do |property|
      ...
      if self[:ensure] == :present && self[property].nil? && self.provider.send(property) == :absent
        raise Puppet::Error, "In azure_identity_provider_contract you must provide a value for #{property}"
      end
    end
  end
  newproperty(:id) do
  ...
  newproperty(:properties) do
    desc "Identity Provider contract properties."
    validate do |value|
      true
    end
  end
  ...
  newparam(:identity_provider_name) do
    desc "Identity Provider Type identifier."
    validate do |value|
      true
    end
  end
