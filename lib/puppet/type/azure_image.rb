...
Puppet::Type.newtype(:azure_image) do
  ...
  validate do
    ...
    required_properties.each do |property|
      ...
      if self[:ensure] == :present && self[property].nil? && self.provider.send(property) == :absent
        raise Puppet::Error, "In azure_image you must provide a value for #{property}"
      end
    end
  end
  newproperty(:id) do
  ...
  newparam(:parameters) do
    desc "Parameters supplied to the Create Image operation."
    validate do |value|
      true
    end
  end
