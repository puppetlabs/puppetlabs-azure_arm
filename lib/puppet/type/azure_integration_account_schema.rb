...
Puppet::Type.newtype(:azure_integration_account_schema) do
  ...
  validate do
    ...
    required_properties.each do |property|
      ...
      if self[:ensure] == :present && self[property].nil? && self.provider.send(property) == :absent
        raise Puppet::Error, "In azure_integration_account_schema you must provide a value for #{property}"
      end
    end
  end
  newproperty(:id) do
  ...
  newproperty(:properties) do
    desc "The integration account schema properties."
    validate do |value|
      true
    end
  end
  ...
  newparam(:schema) do
    desc "The integration account schema."
    validate do |value|
      true
    end
  end
  newparam(:schema_name) do
    desc "The integration account schema name."
    validate do |value|
      true
    end
  end
