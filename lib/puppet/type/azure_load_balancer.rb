...
Puppet::Type.newtype(:azure_load_balancer) do
  ...
  validate do
    ...
    required_properties.each do |property|
      ...
      if self[:ensure] == :present && self[property].nil? && self.provider.send(property) == :absent
        raise Puppet::Error, "In azure_load_balancer you must provide a value for #{property}"
      end
    end
  end
  newproperty(:etag) do
  ...
  newproperty(:properties) do
    desc "Properties of load balancer."
    validate do |value|
      true
    end
  end
  newproperty(:sku) do
    desc "The load balancer SKU."
    validate do |value|
      true
    end
  end
  ...
  newparam(:parameters) do
    desc "Parameters supplied to the create or update load balancer operation."
    validate do |value|
      true
    end
  end
