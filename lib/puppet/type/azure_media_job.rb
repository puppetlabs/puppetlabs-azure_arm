...
Puppet::Type.newtype(:azure_media_job) do
  ...
  validate do
    ...
    required_properties.each do |property|
      ...
      if self[:ensure] == :present && self[property].nil? && self.provider.send(property) == :absent
        raise Puppet::Error, "In azure_media_job you must provide a value for #{property}"
      end
    end
  end
  newproperty(:id) do
  ...
  newparam(:transform_name) do
    desc "The Transform name."
    validate do |value|
      true
    end
  end
