...
Puppet::Type.newtype(:azure_mongo_db_collection) do
  ...
  validate do
    ...
    required_properties.each do |property|
      ...
      if self[:ensure] == :present && self[property].nil? && self.provider.send(property) == :absent
        raise Puppet::Error, "In azure_mongo_db_collection you must provide a value for #{property}"
      end
    end
  end
  newproperty(:id) do
  ...
  newproperty(:properties) do
    desc "The properties of an Azure Cosmos DB MongoDB collection"
    validate do |value|
      true
    end
  end
  ...
  newparam(:collection_name) do
    desc "Cosmos DB collection name."
    validate do |value|
      true
    end
  end
  newparam(:create_update_mongo_db_collection_parameters) do
    desc "The parameters to provide for the current MongoDB Collection."
    validate do |value|
      true
    end
  end
