...
Puppet::Type.newtype(:azure_network_web_application_firewall_policy) do
  ...
  validate do
    ...
    required_properties.each do |property|
      ...
      if self[:ensure] == :present && self[property].nil? && self.provider.send(property) == :absent
        raise Puppet::Error, "In azure_network_web_application_firewall_policy you must provide a value for #{property}"
      end
    end
  end
  newproperty(:etag) do
