...
Puppet::Type.newtype(:azure_web_application_firewall_policy) do
  ...
  validate do
    ...
    required_properties.each do |property|
      ...
      if self[:ensure] == :present && self[property].nil? && self.provider.send(property) == :absent
        raise Puppet::Error, "In azure_web_application_firewall_policy you must provide a value for #{property}"
      end
    end
  end
  newproperty(:etag) do
  ...
  newproperty(:properties) do
    desc "Properties of the web application firewall policy."
    validate do |value|
      true
    end
  end
  ...
  newparam(:parameters) do
    desc "Policy to be created."
    validate do |value|
      true
    end
  end
  newparam(:policy_name) do
    desc "The name of the Web Application Firewall Policy."
    validate do |value|
      true
    end
  end
