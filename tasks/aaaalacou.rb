...
def activity_log_alerts_create_or_update(*args)
  header_params = {}
...
def format_params(key_values)
  ...
  op_params = [
      op_param('activityLogAlert', 'body', 'activity_log_alert', 'activity_log_alert'),
      op_param('activityLogAlertName', 'path', 'activity_log_alert_name', 'activity_log_alert_name'),
...
def task
  ...
  params = STDIN.read
  result = activity_log_alerts_create_or_update(params)
