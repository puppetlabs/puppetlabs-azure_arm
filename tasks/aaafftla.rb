...
def azure_firewall_fqdn_tags_list_all(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Network/azureFirewallFqdnTags" % path_params
...
def task
  ...
  params = STDIN.read
  result = azure_firewall_fqdn_tags_list_all(params)
