...
def application_gateways_list_available_ssl_predefined_policies(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Network/applicationGatewayAvailableSslOptions/default/predefinedPolicies" % path_params
...
def task
  ...
  params = STDIN.read
  result = application_gateways_list_available_ssl_predefined_policies(params)
