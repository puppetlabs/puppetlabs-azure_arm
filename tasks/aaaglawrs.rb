...
def application_gateways_list_available_waf_rule_sets(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Network/applicationGatewayAvailableWafRuleSets" % path_params
...
def task
  ...
  params = STDIN.read
  result = application_gateways_list_available_waf_rule_sets(params)
