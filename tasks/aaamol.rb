...
def api_management_operations_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.ApiManagement/operations" % path_params
...
def task
  ...
  params = STDIN.read
  result = api_management_operations_list(params)
