...
def api_management_service_backup(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ApiManagement/service/%{service_name}/backup" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('accesskey', 'body', 'access_key', 'accesskey'),
      op_param('api-version', 'query', 'api_version', 'api_version'),
      op_param('backupname', 'body', 'backup_name', 'backupname'),
      ...
      op_param('storageaccount', 'body', 'storage_account', 'storageaccount'),
...
def task
  ...
  params = STDIN.read
  result = api_management_service_backup(params)
