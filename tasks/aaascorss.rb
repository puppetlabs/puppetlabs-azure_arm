...
def app_service_certificate_orders_retrieve_site_seal(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CertificateRegistration/certificateOrders/%{certificate_order_name}/retrieveSiteSeal" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('certificateOrderName', 'path', 'certificate_order_name', 'certificate_order_name'),
      op_param('lighttheme', 'body', 'light_theme', 'lighttheme'),
      op_param('locale', 'body', 'locale', 'locale'),
      op_param('resourceGroupName', 'path', 'resource_group_name', 'resource_group_name'),
      op_param('siteSealRequest', 'body', 'site_seal_request', 'site_seal_request'),
...
def task
  ...
  params = STDIN.read
  result = app_service_certificate_orders_retrieve_site_seal(params)
