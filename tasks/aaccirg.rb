...
def configurations_create_in_resource_group(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group}/providers/Microsoft.Advisor/configurations" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('configContract', 'body', 'config_contract', 'config_contract'),
...
def task
  ...
  params = STDIN.read
  result = configurations_create_in_resource_group(params)
