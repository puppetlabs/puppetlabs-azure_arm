...
def configurations_create_in_subscription(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Advisor/configurations" % path_params
...
def task
  ...
  params = STDIN.read
  result = configurations_create_in_subscription(params)
