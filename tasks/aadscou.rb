...
def delegation_settings_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ApiManagement/service/%{service_name}/portalsettings/delegation" % path_params
...
def task
  ...
  params = STDIN.read
  result = delegation_settings_create_or_update(params)
