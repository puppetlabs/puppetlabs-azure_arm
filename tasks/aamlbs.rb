...
def mediaservices_list_by_subscription(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Media/mediaservices" % path_params
...
def task
  ...
  params = STDIN.read
  result = mediaservices_list_by_subscription(params)
