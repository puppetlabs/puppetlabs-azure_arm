...
def notification_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ApiManagement/service/%{service_name}/notifications/%{notification_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('notificationName', 'path', 'notification_name', 'notification_name'),
...
def task
  ...
  params = STDIN.read
  result = notification_create_or_update(params)
