...
def services_add_alert_feedback(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.ADHybridHealthService/services/%{service_name}/feedbacktype/alerts/feedback" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('alertFeedback', 'body', 'alert_feedback', 'alert_feedback'),
      op_param('api-version', 'query', 'api_version', 'api_version'),
      op_param('comment', 'body', 'comment', 'comment'),
      op_param('consentedtoshare', 'body', 'consented_to_share', 'consentedtoshare'),
      op_param('createddate', 'body', 'created_date', 'createddate'),
      op_param('feedback', 'body', 'feedback', 'feedback'),
      ...
      op_param('shortname', 'body', 'short_name', 'shortname'),
...
def task
  ...
  params = STDIN.read
  result = services_add_alert_feedback(params)
