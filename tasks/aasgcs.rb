...
def smart_groups_change_state(*args)
  header_params = {}
  ...
  uri_string = "https:////subscriptions/%{subscription_id}/providers/Microsoft.AlertsManagement/smartGroups/%{smart_group_id}/changeState" % path_params
...
def task
  ...
  params = STDIN.read
  result = smart_groups_change_state(params)
