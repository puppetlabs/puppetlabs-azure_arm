...
def servers_list_gateway_status(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.AnalysisServices/servers/%{server_name}/listGatewayStatus" % path_params
...
def task
  ...
  params = STDIN.read
  result = servers_list_gateway_status(params)
