...
def servers_list_skus_for_new(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.AnalysisServices/skus" % path_params
...
def task
  ...
  params = STDIN.read
  result = servers_list_skus_for_new(params)
