...
def service_members_delete(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.ADHybridHealthService/services/%{service_name}/servicemembers/%{service_member_id}" % path_params
...
def task
  ...
  params = STDIN.read
  result = service_members_delete(params)
