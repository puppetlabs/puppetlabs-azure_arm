...
def accounts_check_name_availability(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.DataLakeAnalytics/locations/%{location}/checkNameAvailability" % path_params
...
def task
  ...
  params = STDIN.read
  result = accounts_check_name_availability(params)
