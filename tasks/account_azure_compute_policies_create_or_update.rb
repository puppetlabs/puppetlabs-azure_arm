...
def compute_policies_create_or_update(*args)
  header_params = {}
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('computePolicyName', 'path', 'compute_policy_name', 'compute_policy_name'),
...
def task
  ...
  params = STDIN.read
  result = compute_policies_create_or_update(params)
