...
def data_lake_store_accounts_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataLakeAnalytics/accounts/%{account_name}/dataLakeStoreAccounts/%{data_lake_store_account_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('dataLakeStoreAccountName', 'path', 'data_lake_store_account_name', 'data_lake_store_account_name'),
...
def task
  ...
  params = STDIN.read
  result = data_lake_store_accounts_get(params)
