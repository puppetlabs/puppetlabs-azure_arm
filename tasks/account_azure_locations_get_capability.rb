...
def locations_get_capability(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.DataLakeAnalytics/locations/%{location}/capability" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('accountcount', 'body', 'account_count', 'accountcount'),
      op_param('api-version', 'query', 'api_version', 'api_version'),
      op_param('location', 'path', 'location', 'location'),
      op_param('maxaccountcount', 'body', 'max_account_count', 'maxaccountcount'),
      op_param('migrationstate', 'body', 'migration_state', 'migrationstate'),
...
def task
  ...
  params = STDIN.read
  result = locations_get_capability(params)
