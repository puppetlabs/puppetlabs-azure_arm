...
def locations_get_usage(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.DataLakeStore/locations/%{location}/usages" % path_params
...
def task
  ...
  params = STDIN.read
  result = locations_get_usage(params)
