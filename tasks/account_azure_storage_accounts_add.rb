...
def storage_accounts_add(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataLakeAnalytics/accounts/%{account_name}/storageAccounts/%{storage_account_name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = storage_accounts_add(params)
