...
def storage_accounts_list_sas_tokens(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataLakeAnalytics/accounts/%{account_name}/storageAccounts/%{storage_account_name}/containers/%{container_name}/listSasTokens" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('storageAccountName', 'path', 'storage_account_name', 'storage_account_name'),
...
def task
  ...
  params = STDIN.read
  result = storage_accounts_list_sas_tokens(params)
