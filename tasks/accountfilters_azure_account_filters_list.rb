...
def account_filters_list(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Media/mediaServices/%{account_name}/accountFilters" % path_params
...
def task
  ...
  params = STDIN.read
  result = account_filters_list(params)
