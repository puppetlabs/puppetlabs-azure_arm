...
def mediaservices_sync_storage_keys(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Media/mediaservices/%{account_name}/syncStorageKeys" % path_params
...
def task
  ...
  params = STDIN.read
  result = mediaservices_sync_storage_keys(params)
