...
def action_groups_enable_receiver(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/microsoft.insights/actionGroups/%{action_group_name}/subscribe" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('actionGroupName', 'path', 'action_group_name', 'action_group_name'),
      op_param('api-version', 'query', 'api_version', 'api_version'),
      op_param('enableRequest', 'body', 'enable_request', 'enable_request'),
      op_param('receivername', 'body', 'receiver_name', 'receivername'),
...
def task
  ...
  params = STDIN.read
  result = action_groups_enable_receiver(params)
