...
def adds_services_delete(*args)
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.ADHybridHealthService/addsservices/%{service_name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = adds_services_delete(params)
