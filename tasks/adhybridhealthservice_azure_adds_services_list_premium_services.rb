...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('customnotificationemails', 'body', 'custom_notification_emails', 'customnotificationemails'),
      ...
      op_param('notificationemailenabled', 'body', 'notification_email_enabled', 'notificationemailenabled'),
      op_param('notificationemailenabledforglobaladmins', 'body', 'notification_email_enabled_for_global_admins', 'notificationemailenabledforglobaladmins'),
      op_param('notificationemails', 'body', 'notification_emails', 'notificationemails'),
      op_param('notificationemailsenabledforglobaladmins', 'body', 'notification_emails_enabled_for_global_admins', 'notificationemailsenabledforglobaladmins'),
      op_param('originaldisabledstate', 'body', 'original_disabled_state', 'originaldisabledstate'),
      op_param('resolvedalerts', 'body', 'resolved_alerts', 'resolvedalerts'),
      op_param('serviceid', 'body', 'service_id', 'serviceid'),
      op_param('servicename', 'body', 'service_name', 'servicename'),
      op_param('serviceType', 'query', 'service_type', 'service_type'),
      op_param('signature', 'body', 'signature', 'signature'),
      op_param('simpleproperties', 'body', 'simple_properties', 'simpleproperties'),
