...
def reports_get_dev_ops(*args)
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.ADHybridHealthService/reports/DevOps/IsDevOps" % path_params
...
def task
  ...
  params = STDIN.read
  result = reports_get_dev_ops(params)
