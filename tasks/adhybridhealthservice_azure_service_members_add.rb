...
def service_members_add(*args)
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.ADHybridHealthService/services/%{service_name}/servicemembers" % path_params
...
def task
  ...
  params = STDIN.read
  result = service_members_add(params)
