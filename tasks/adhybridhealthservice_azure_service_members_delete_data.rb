...
def service_members_delete_data(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.ADHybridHealthService/services/%{service_name}/servicemembers/%{service_member_id}/data" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('disabledreason', 'body', 'disabledreason', 'disabledreason'),
      op_param('installedqfes', 'body', 'installedqfes', 'installedqfes'),
      op_param('lastdisabled', 'body', 'lastdisabled', 'lastdisabled'),
      op_param('lastreboot', 'body', 'lastreboot', 'lastreboot'),
      op_param('lastserverreportedmonitoringlevelchange', 'body', 'lastserverreportedmonitoringlevelchange', 'lastserverreportedmonitoringlevelchange'),
      op_param('lastupdated', 'body', 'lastupdated', 'lastupdated'),
      op_param('machineid', 'body', 'machineid', 'machineid'),
      op_param('machinename', 'body', 'machinename', 'machinename'),
      ...
      op_param('osname', 'body', 'osname', 'osname'),
      op_param('osversion', 'body', 'osversion', 'osversion'),
      op_param('properties', 'body', 'properties', 'properties'),
      op_param('recommendedqfes', 'body', 'recommendedqfes', 'recommendedqfes'),
      op_param('resolvedalerts', 'body', 'resolvedalerts', 'resolvedalerts'),
      op_param('role', 'body', 'role', 'role'),
      op_param('serverreportedmonitoringlevel', 'body', 'serverreportedmonitoringlevel', 'serverreportedmonitoringlevel'),
      op_param('service_member_id', 'path', 'service_member_id', 'service_member_id'),
      op_param('serviceid', 'body', 'serviceid', 'serviceid'),
      op_param('servicememberid', 'body', 'servicememberid', 'servicememberid'),
...
def task
  ...
  params = STDIN.read
  result = service_members_delete_data(params)
