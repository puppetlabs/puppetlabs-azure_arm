...
def recommendation_metadata_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.Advisor/metadata/%{name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = recommendation_metadata_get(params)
