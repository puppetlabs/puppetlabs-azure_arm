...
def recommendation_metadata_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.Advisor/metadata" % path_params
...
def task
  ...
  params = STDIN.read
  result = recommendation_metadata_list(params)
