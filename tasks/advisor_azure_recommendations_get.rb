...
def recommendations_get(*args)
  ...
  uri_string = "https://management.azure.com//%{resource_uri}/providers/Microsoft.Advisor/recommendations/%{recommendation_id}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('recommendationId', 'path', 'recommendation_id', 'recommendation_id'),
...
def task
  ...
  params = STDIN.read
  result = recommendations_get(params)
