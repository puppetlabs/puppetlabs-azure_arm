...
def recommendations_list(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Advisor/recommendations" % path_params
...
def task
  ...
  params = STDIN.read
  result = recommendations_list(params)
