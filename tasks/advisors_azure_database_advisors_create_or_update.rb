...
def database_advisors_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Sql/servers/%{server_name}/databases/%{database_name}/advisors/%{advisor_name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = database_advisors_create_or_update(params)
