...
def marketplace_agreements_cancel(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.MarketplaceOrdering/agreements/%{publisher_id}/offers/%{offer_id}/plans/%{plan_id}/cancel" % path_params
...
def task
  ...
  params = STDIN.read
  result = marketplace_agreements_cancel(params)
