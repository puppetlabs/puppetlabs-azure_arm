...
def marketplace_agreements_create(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.MarketplaceOrdering/offerTypes/%{offer_type}/publishers/%{publisher_id}/offers/%{offer_id}/plans/%{plan_id}/agreements/current" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('offerId', 'path', 'offer_id', 'offer_id'),
      op_param('offerType', 'path', 'offer_type', 'offer_type'),
      op_param('parameters', 'body', 'parameters', 'parameters'),
      op_param('planId', 'path', 'plan_id', 'plan_id'),
      op_param('properties', 'body', 'properties', 'properties'),
      op_param('publisherId', 'path', 'publisher_id', 'publisher_id'),
...
def task
  ...
  params = STDIN.read
  result = marketplace_agreements_create(params)
