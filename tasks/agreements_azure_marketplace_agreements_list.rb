...
def marketplace_agreements_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.MarketplaceOrdering/agreements" % path_params
...
def task
  ...
  params = STDIN.read
  result = marketplace_agreements_list(params)
