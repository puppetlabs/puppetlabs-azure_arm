...
def marketplace_agreements_sign(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.MarketplaceOrdering/agreements/%{publisher_id}/offers/%{offer_id}/plans/%{plan_id}/sign" % path_params
...
def task
  ...
  params = STDIN.read
  result = marketplace_agreements_sign(params)
