...
def format_params(key_values)
  ...
  op_params = [
      op_param('actions', 'body', 'actions', 'actions'),
      op_param('api-version', 'query', 'api_version', 'api_version'),
      op_param('condition', 'body', 'condition', 'condition'),
      ...
      op_param('ruleName', 'path', 'rule_name', 'rule_name'),
...
def task
  ...
  params = STDIN.read
  result = alert_rules_delete(params)
