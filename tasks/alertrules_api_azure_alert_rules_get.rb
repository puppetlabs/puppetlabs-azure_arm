...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('isenabled', 'body', 'isenabled', 'isenabled'),
      op_param('lastupdatedtime', 'body', 'lastupdatedtime', 'lastupdatedtime'),
