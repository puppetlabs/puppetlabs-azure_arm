...
def alerts_get_by_id(*args)
  ...
  uri_string = "https://management.azure.com//%{scope}/providers/Microsoft.AlertsManagement/alerts/%{alert_id}" % path_params
...
def task
  ...
  params = STDIN.read
  result = alerts_get_by_id(params)
