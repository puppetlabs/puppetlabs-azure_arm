...
def alerts_get_history(*args)
  ...
  uri_string = "https://management.azure.com//%{scope}/providers/Microsoft.AlertsManagement/alerts/%{alert_id}/history" % path_params
...
def task
  ...
  params = STDIN.read
  result = alerts_get_history(params)
