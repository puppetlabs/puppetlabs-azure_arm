...
def alerts_get_summary(*args)
  ...
  uri_string = "https://management.azure.com//%{scope}/providers/Microsoft.AlertsManagement/alertsSummary" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('alertRule', 'query', 'alert_rule', 'alert_rule'),
      ...
      op_param('groupby', 'query', 'groupby', 'groupby'),
      op_param('includeSmartGroupsCount', 'query', 'include_smart_groups_count', 'include_smart_groups_count'),
...
def task
  ...
  params = STDIN.read
  result = alerts_get_summary(params)
