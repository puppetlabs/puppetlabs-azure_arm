...
def smart_groups_get_by_id(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.AlertsManagement/smartGroups/%{smart_group_id}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('smartGroupId', 'path', 'id', 'smart_group_id'),
...
def task
  ...
  params = STDIN.read
  result = smart_groups_get_by_id(params)
