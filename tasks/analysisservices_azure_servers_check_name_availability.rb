...
def servers_check_name_availability(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.AnalysisServices/locations/%{location}/checkNameAvailability" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('serverParameters', 'body', 'server_parameters', 'server_parameters'),
...
def task
  ...
  params = STDIN.read
  result = servers_check_name_availability(params)
