...
def backend_reconnect(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ApiManagement/service/%{service_name}/backends/%{backendid}/reconnect" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('backendid', 'path', 'backendid', 'backendid'),
...
def task
  ...
  params = STDIN.read
  result = backend_reconnect(params)
