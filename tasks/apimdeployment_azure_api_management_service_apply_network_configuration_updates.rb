...
def api_management_service_apply_network_configuration_updates(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ApiManagement/service/%{service_name}/applynetworkconfigurationupdates" % path_params
...
def task
  ...
  params = STDIN.read
  result = api_management_service_apply_network_configuration_updates(params)
