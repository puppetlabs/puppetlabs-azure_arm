...
def api_management_service_get_sso_token(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ApiManagement/service/%{service_name}/getssotoken" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('redirecturi', 'body', 'redirect_uri', 'redirecturi'),
...
def task
  ...
  params = STDIN.read
  result = api_management_service_get_sso_token(params)
