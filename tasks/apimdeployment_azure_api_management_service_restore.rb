...
def api_management_service_restore(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ApiManagement/service/%{service_name}/restore" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('accesskey', 'body', 'accesskey', 'accesskey'),
      op_param('api-version', 'query', 'api_version', 'api_version'),
      op_param('backupname', 'body', 'backupname', 'backupname'),
      op_param('containername', 'body', 'containername', 'containername'),
      ...
      op_param('storageaccount', 'body', 'storageaccount', 'storageaccount'),
...
def task
  ...
  params = STDIN.read
  result = api_management_service_restore(params)
