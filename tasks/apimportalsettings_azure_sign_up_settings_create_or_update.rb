...
def sign_up_settings_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ApiManagement/service/%{service_name}/portalsettings/signup" % path_params
...
def task
  ...
  params = STDIN.read
  result = sign_up_settings_create_or_update(params)
