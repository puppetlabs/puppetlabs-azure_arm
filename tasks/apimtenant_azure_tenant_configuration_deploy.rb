...
def tenant_configuration_deploy(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ApiManagement/service/%{service_name}/tenant/%{configuration_name}/deploy" % path_params
...
def task
  ...
  params = STDIN.read
  result = tenant_configuration_deploy(params)
