...
def tenant_configuration_save(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ApiManagement/service/%{service_name}/tenant/%{configuration_name}/save" % path_params
...
def task
  ...
  params = STDIN.read
  result = tenant_configuration_save(params)
