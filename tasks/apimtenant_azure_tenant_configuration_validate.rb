...
def tenant_configuration_validate(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ApiManagement/service/%{service_name}/tenant/%{configuration_name}/validate" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('actionlog', 'body', 'action_log', 'actionlog'),
      ...
      op_param('resultinfo', 'body', 'result_info', 'resultinfo'),
...
def task
  ...
  params = STDIN.read
  result = tenant_configuration_validate(params)
