...
def user_generate_sso_url(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ApiManagement/service/%{service_name}/users/%{uid}/generateSsoUrl" % path_params
...
def task
  ...
  params = STDIN.read
  result = user_generate_sso_url(params)
