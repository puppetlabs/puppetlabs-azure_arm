...
def application_type_versions_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ServiceFabric/clusters/%{cluster_name}/applicationTypes/%{application_type_name}/versions/%{version}" % path_params
...
def task
  ...
  params = STDIN.read
  result = application_type_versions_get(params)
