...
def application_types_delete(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ServiceFabric/clusters/%{cluster_name}/applicationTypes/%{application_type_name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = application_types_delete(params)
