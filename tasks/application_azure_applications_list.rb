...
def applications_list(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ServiceFabric/clusters/%{cluster_name}/applications" % path_params
...
def task
  ...
  params = STDIN.read
  result = applications_list(params)
