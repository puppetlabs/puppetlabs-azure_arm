...
def services_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ServiceFabric/clusters/%{cluster_name}/applications/%{application_name}/services/%{service_name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = services_create_or_update(params)
