...
def application_gateways_backend_health(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/applicationGateways/%{application_gateway_name}/backendhealth" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('applicationGatewayName', 'path', 'application_gateway_name', 'application_gateway_name'),
      op_param('backendaddresspools', 'body', 'backend_address_pools', 'backendaddresspools'),
...
def task
  ...
  params = STDIN.read
  result = application_gateways_backend_health(params)
