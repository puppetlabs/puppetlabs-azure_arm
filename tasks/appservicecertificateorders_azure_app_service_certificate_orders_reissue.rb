...
def app_service_certificate_orders_reissue(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CertificateRegistration/certificateOrders/%{certificate_order_name}/reissue" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('reissueCertificateOrderRequest', 'body', 'reissue_certificate_order_request', 'reissue_certificate_order_request'),
...
def task
  ...
  params = STDIN.read
  result = app_service_certificate_orders_reissue(params)
