...
def app_service_certificate_orders_renew(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CertificateRegistration/certificateOrders/%{certificate_order_name}/renew" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('renewCertificateOrderRequest', 'body', 'renew_certificate_order_request', 'renew_certificate_order_request'),
...
def task
  ...
  params = STDIN.read
  result = app_service_certificate_orders_renew(params)
