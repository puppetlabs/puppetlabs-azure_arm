...
def app_service_environments_create_or_update_multi_role_pool(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/hostingEnvironments/%{name}/multiRolePools/default" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('multiRolePoolEnvelope', 'body', 'multi_role_pool_envelope', 'multi_role_pool_envelope'),
...
def task
  ...
  params = STDIN.read
  result = app_service_environments_create_or_update_multi_role_pool(params)
