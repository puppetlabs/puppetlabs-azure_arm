...
def app_service_plans_delete_hybrid_connection(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/serverfarms/%{name}/hybridConnectionNamespaces/%{namespace_name}/relays/%{relay_name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = app_service_plans_delete_hybrid_connection(params)
