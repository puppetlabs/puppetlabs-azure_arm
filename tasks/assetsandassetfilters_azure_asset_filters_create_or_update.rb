...
def asset_filters_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Media/mediaServices/%{account_name}/assets/%{asset_name}/assetFilters/%{filter_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('filterName', 'path', 'filter_name', 'filter_name'),
...
def task
  ...
  params = STDIN.read
  result = asset_filters_create_or_update(params)
