...
def assets_get_encryption_key(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Media/mediaServices/%{account_name}/assets/%{asset_name}/getEncryptionKey" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('assetfileencryptionmetadata', 'body', 'asset_file_encryption_metadata', 'assetfileencryptionmetadata'),
      op_param('assetName', 'path', 'asset_name', 'asset_name'),
...
def task
  ...
  params = STDIN.read
  result = assets_get_encryption_key(params)
