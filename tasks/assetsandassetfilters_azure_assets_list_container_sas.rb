...
def assets_list_container_sas(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Media/mediaServices/%{account_name}/assets/%{asset_name}/listContainerSas" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('expirytime', 'body', 'expiry_time', 'expirytime'),
...
def task
  ...
  params = STDIN.read
  result = assets_list_container_sas(params)
