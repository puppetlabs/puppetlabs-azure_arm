...
def assets_list_streaming_locators(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Media/mediaServices/%{account_name}/assets/%{asset_name}/listStreamingLocators" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('streaminglocators', 'body', 'streaming_locators', 'streaminglocators'),
...
def task
  ...
  params = STDIN.read
  result = assets_list_streaming_locators(params)
