...
def autoscale_settings_delete(*args)
  header_params = {}
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('autoscaleSettingName', 'path', 'name', 'autoscale_setting_name'),
      ...
      op_param('targetresourceuri', 'body', 'target_resource_uri', 'targetresourceuri'),
    ]
  op_params.each do |i|
    location = i[:location]
    name     = i[:name]
...
def task
  ...
  params = STDIN.read
  result = autoscale_settings_delete(params)
