...
def auto_suggest(*args)
  ...
  uri_string = "https://api.cognitive.microsoft.com//Suggestions" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('suggestiongroups', 'body', 'suggestion_groups', 'suggestiongroups'),
