...
def azure_firewalls_list_all(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Network/azureFirewalls" % path_params
...
def task
  ...
  params = STDIN.read
  result = azure_firewalls_list_all(params)
