...
def backup_locations_list(*args)
  header_params = {}
  ...
  uri_string = "https://adminmanagement.local.azurestack.external//subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/Microsoft.Backup.Admin/backupLocations" % path_params
...
def task
  ...
  params = STDIN.read
  result = backup_locations_list(params)
