...
def backup_locations_update(*args)
  header_params = {}
  ...
  uri_string = "https://adminmanagement.local.azurestack.external//subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/Microsoft.Backup.Admin/backupLocations/%{location}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('backup', 'body', 'backup', 'backup'),
...
def task
  ...
  params = STDIN.read
  result = backup_locations_update(params)
