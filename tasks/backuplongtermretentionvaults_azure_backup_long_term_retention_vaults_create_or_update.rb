...
def backup_long_term_retention_vaults_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Sql/servers/%{server_name}/backupLongTermRetentionVaults/%{backup_long_term_retention_vault_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('backupLongTermRetentionVaultName', 'path', 'name', 'backup_long_term_retention_vault_name'),
...
def task
  ...
  params = STDIN.read
  result = backup_long_term_retention_vaults_create_or_update(params)
