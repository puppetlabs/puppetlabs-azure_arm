...
def backups_get(*args)
  ...
  uri_string = "https://adminmanagement.local.azurestack.external//subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/Microsoft.Backup.Admin/backupLocations/%{location}/backups/%{backup}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('backup', 'path', 'backup', 'backup'),
