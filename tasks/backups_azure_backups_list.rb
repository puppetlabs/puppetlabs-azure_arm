...
def backups_list(*args)
  ...
  uri_string = "https://adminmanagement.local.azurestack.external//subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/Microsoft.Backup.Admin/backupLocations/%{location}/backups" % path_params
