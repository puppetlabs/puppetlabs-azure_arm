...
def recoverable_databases_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Sql/servers/%{server_name}/recoverableDatabases/%{database_name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = recoverable_databases_get(params)
