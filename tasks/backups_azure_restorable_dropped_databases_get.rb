...
def restorable_dropped_databases_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Sql/servers/%{server_name}/restorableDroppedDatabases/%{restorable_droppeded_database_id}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('restorableDroppededDatabaseId', 'path', 'restorable_droppeded_database_id', 'restorable_droppeded_database_id'),
...
def task
  ...
  params = STDIN.read
  result = restorable_dropped_databases_get(params)
