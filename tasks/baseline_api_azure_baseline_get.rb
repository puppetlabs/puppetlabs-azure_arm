...
def baseline_get(*args)
  ...
  uri_string = "https://management.azure.com//%{resource_uri}/providers/microsoft.insights/baseline" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('highthresholds', 'body', 'highthresholds', 'highthresholds'),
      op_param('interval', 'query', 'interval', 'interval'),
      op_param('lowthresholds', 'body', 'lowthresholds', 'lowthresholds'),
      op_param('metricnames', 'query', 'metricnames', 'metricnames'),
