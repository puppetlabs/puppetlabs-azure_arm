...
def clusters_list_remote_login_information(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.BatchAI/workspaces/%{workspace_name}/clusters/%{cluster_name}/listRemoteLoginInformation" % path_params
...
def task
  ...
  params = STDIN.read
  result = clusters_list_remote_login_information(params)
