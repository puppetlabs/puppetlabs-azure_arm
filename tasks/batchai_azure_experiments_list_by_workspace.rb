...
def experiments_list_by_workspace(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.BatchAI/workspaces/%{workspace_name}/experiments" % path_params
...
def task
  ...
  params = STDIN.read
  result = experiments_list_by_workspace(params)
