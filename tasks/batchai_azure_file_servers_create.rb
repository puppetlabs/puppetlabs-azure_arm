...
def file_servers_create(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.BatchAI/workspaces/%{workspace_name}/fileServers/%{file_server_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('fileServerName', 'path', 'file_server_name', 'file_server_name'),
...
def task
  ...
  params = STDIN.read
  result = file_servers_create(params)
