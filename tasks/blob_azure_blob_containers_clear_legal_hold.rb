...
def blob_containers_clear_legal_hold(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Storage/storageAccounts/%{account_name}/blobServices/default/containers/%{container_name}/clearLegalHold" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('haslegalhold', 'body', 'haslegalhold', 'haslegalhold'),
      op_param('LegalHold', 'body', 'legal_hold', 'legal_hold'),
...
def task
  ...
  params = STDIN.read
  result = blob_containers_clear_legal_hold(params)
