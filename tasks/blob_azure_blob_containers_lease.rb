...
def blob_containers_lease(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Storage/storageAccounts/%{account_name}/blobServices/default/containers/%{container_name}/lease" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('leaseid', 'body', 'lease_id', 'leaseid'),
      op_param('leasetimeseconds', 'body', 'lease_time_seconds', 'leasetimeseconds'),
...
def task
  ...
  params = STDIN.read
  result = blob_containers_lease(params)
