...
def blob_containers_list(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Storage/storageAccounts/%{account_name}/blobServices/default/containers" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('$maxpagesize', 'query', '$maxpagesize', '$maxpagesize'),
      op_param('$skipToken', 'query', '$skip_token', '$skip_token'),
...
def task
  ...
  params = STDIN.read
  result = blob_containers_list(params)
