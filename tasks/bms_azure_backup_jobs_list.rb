...
def backup_jobs_list(*args)
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{vault_name}/backupJobs" % path_params
...
def task
  ...
  params = STDIN.read
  result = backup_jobs_list(params)
