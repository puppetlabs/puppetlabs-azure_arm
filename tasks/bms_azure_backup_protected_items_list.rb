...
def backup_protected_items_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{vault_name}/backupProtectedItems" % path_params
...
def task
  ...
  params = STDIN.read
  result = backup_protected_items_list(params)
