...
def backup_protection_intent_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{vault_name}/backupProtectionIntents" % path_params
...
def task
  ...
  params = STDIN.read
  result = backup_protection_intent_list(params)
