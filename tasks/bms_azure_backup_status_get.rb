...
def backup_status_get(*args)
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/providers/Microsoft.RecoveryServices/locations/%{azure_region}/backupStatus" % path_params
...
def task
  ...
  params = STDIN.read
  result = backup_status_get(params)
