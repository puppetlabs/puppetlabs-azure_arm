...
def backup_usage_summaries_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{vault_name}/backupUsageSummaries" % path_params
...
def task
  ...
  params = STDIN.read
  result = backup_usage_summaries_list(params)
