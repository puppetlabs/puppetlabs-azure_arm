...
def export_jobs_operation_results_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{vault_name}/backupJobs/operationResults/%{operation_id}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('headers', 'body', 'headers', 'headers'),
      op_param('operation', 'body', 'operation', 'operation'),
...
def task
  ...
  params = STDIN.read
  result = export_jobs_operation_results_get(params)
