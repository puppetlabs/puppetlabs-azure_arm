...
def feature_support_validate(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/providers/Microsoft.RecoveryServices/locations/%{azure_region}/backupValidateFeatures" % path_params
...
def task
  ...
  params = STDIN.read
  result = feature_support_validate(params)
