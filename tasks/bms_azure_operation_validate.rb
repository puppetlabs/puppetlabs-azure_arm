...
def operation_validate(*args)
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{vault_name}/backupValidateOperation" % path_params
...
def task
  ...
  params = STDIN.read
  result = operation_validate(params)
