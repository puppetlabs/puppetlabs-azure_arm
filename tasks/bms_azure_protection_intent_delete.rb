...
def protection_intent_delete(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{vault_name}/backupFabrics/%{fabric_name}/backupProtectionIntent/%{intent_object_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('intentObjectName', 'path', 'intent_object_name', 'intent_object_name'),
      op_param('itemid', 'body', 'item_id', 'itemid'),
      op_param('policyid', 'body', 'policy_id', 'policyid'),
      op_param('protectionintentitemtype', 'body', 'protection_intent_item_type', 'protectionintentitemtype'),
      op_param('protectionstate', 'body', 'protection_state', 'protectionstate'),
...
def task
  ...
  params = STDIN.read
  result = protection_intent_delete(params)
