...
def protection_intent_validate(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/providers/Microsoft.RecoveryServices/locations/%{azure_region}/backupPreValidateProtection" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('recommendation', 'body', 'recommendation', 'recommendation'),
...
def task
  ...
  params = STDIN.read
  result = protection_intent_validate(params)
