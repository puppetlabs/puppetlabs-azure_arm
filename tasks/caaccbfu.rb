...
def component_current_billing_features_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Insights/components/%{resource_name}/currentbillingfeatures" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('BillingFeaturesProperties', 'body', 'billing_features_properties', 'billing_features_properties'),
      op_param('currentbillingfeatures', 'body', 'current_billing_features', 'currentbillingfeatures'),
      op_param('datavolumecap', 'body', 'data_volume_cap', 'datavolumecap'),
...
def task
  ...
  params = STDIN.read
  result = component_current_billing_features_update(params)
