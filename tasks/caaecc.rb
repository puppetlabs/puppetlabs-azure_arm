...
def export_configurations_create(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Insights/components/%{resource_name}/exportconfiguration" % path_params
...
def task
  ...
  params = STDIN.read
  result = export_configurations_create(params)
