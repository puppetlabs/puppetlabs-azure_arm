...
def export_configurations_delete(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Insights/components/%{resource_name}/exportconfiguration/%{export_id}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('applicationname', 'body', 'application_name', 'applicationname'),
      op_param('containername', 'body', 'container_name', 'containername'),
      op_param('destinationaccountid', 'body', 'destination_account_id', 'destinationaccountid'),
      op_param('destinationstoragelocationid', 'body', 'destination_storage_location_id', 'destinationstoragelocationid'),
      op_param('destinationstoragesubscriptionid', 'body', 'destination_storage_subscription_id', 'destinationstoragesubscriptionid'),
      op_param('destinationtype', 'body', 'destination_type', 'destinationtype'),
      op_param('export_id', 'path', 'export_id', 'export_id'),
      op_param('exportid', 'body', 'export_id', 'exportid'),
      op_param('exportstatus', 'body', 'export_status', 'exportstatus'),
      op_param('instrumentationkey', 'body', 'instrumentation_key', 'instrumentationkey'),
      op_param('isuserenabled', 'body', 'is_user_enabled', 'isuserenabled'),
      op_param('lastgaptime', 'body', 'last_gap_time', 'lastgaptime'),
      op_param('lastsuccesstime', 'body', 'last_success_time', 'lastsuccesstime'),
      op_param('lastuserupdate', 'body', 'last_user_update', 'lastuserupdate'),
      op_param('notificationqueueenabled', 'body', 'notification_queue_enabled', 'notificationqueueenabled'),
      op_param('permanenterrorreason', 'body', 'permanent_error_reason', 'permanenterrorreason'),
      op_param('recordtypes', 'body', 'record_types', 'recordtypes'),
      ...
      op_param('storagename', 'body', 'storage_name', 'storagename'),
...
def task
  ...
  params = STDIN.read
  result = export_configurations_delete(params)
