...
def export_configurations_update(*args)
  header_params = {}
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('destinationaddress', 'body', 'destination_address', 'destinationaddress'),
      ...
      op_param('exportId', 'path', 'export_id', 'export_id'),
      op_param('ExportProperties', 'body', 'export_properties', 'export_properties'),
      op_param('isenabled', 'body', 'is_enabled', 'isenabled'),
      op_param('notificationqueueenabled', 'body', 'notification_queue_enabled', 'notificationqueueenabled'),
      op_param('notificationqueueuri', 'body', 'notification_queue_uri', 'notificationqueueuri'),
...
def task
  ...
  params = STDIN.read
  result = export_configurations_update(params)
