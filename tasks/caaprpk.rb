...
def authorization_policies_regenerate_primary_key(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CustomerInsights/hubs/%{hub_name}/authorizationPolicies/%{authorization_policy_name}/regeneratePrimaryKey" % path_params
...
def task
  ...
  params = STDIN.read
  result = authorization_policies_regenerate_primary_key(params)
