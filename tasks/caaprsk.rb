...
def authorization_policies_regenerate_secondary_key(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CustomerInsights/hubs/%{hub_name}/authorizationPolicies/%{authorization_policy_name}/regenerateSecondaryKey" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('authorizationPolicyName', 'path', 'authorization_policy_name', 'authorization_policy_name'),
      op_param('hubName', 'path', 'hub_name', 'hub_name'),
      op_param('permissions', 'body', 'permissions', 'permissions'),
      op_param('policyname', 'body', 'policyname', 'policyname'),
...
def task
  ...
  params = STDIN.read
  result = authorization_policies_regenerate_secondary_key(params)
