...
def catalog_list_external_data_sources(*args)
  header_params = {}
  ...
  uri_string = "https:////catalog/usql/databases/%{database_name}/externaldatasources" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = Catalog_ListExternalDataSources(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = catalog_list_external_data_sources(params)
