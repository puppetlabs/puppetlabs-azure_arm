...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('colnames', 'body', 'colnames', 'colnames'),
      op_param('computeaccountname', 'body', 'computeaccountname', 'computeaccountname'),
      op_param('createtime', 'body', 'createtime', 'createtime'),
      op_param('database_name', 'path', 'database_name', 'database_name'),
      op_param('databasename', 'body', 'databasename', 'databasename'),
      op_param('filterdefinition', 'body', 'filterdefinition', 'filterdefinition'),
      op_param('hasfilter', 'body', 'hasfilter', 'hasfilter'),
      op_param('isautocreated', 'body', 'isautocreated', 'isautocreated'),
      op_param('isusercreated', 'body', 'isusercreated', 'isusercreated'),
      op_param('schema_name', 'path', 'schema_name', 'schema_name'),
      op_param('schemaname', 'body', 'schemaname', 'schemaname'),
      op_param('statdatapath', 'body', 'statdatapath', 'statdatapath'),
      op_param('statisticsname', 'body', 'statisticsname', 'statisticsname'),
      op_param('tablename', 'body', 'tablename', 'tablename'),
      op_param('updatetime', 'body', 'updatetime', 'updatetime'),
      op_param('userstatname', 'body', 'userstatname', 'userstatname'),
