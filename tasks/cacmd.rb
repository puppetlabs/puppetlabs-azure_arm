...
def connector_mappings_delete(*args)
  header_params = {}
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('connectormappingname', 'body', 'connector_mapping_name', 'connectormappingname'),
      op_param('connectorname', 'body', 'connector_name', 'connectorname'),
      op_param('connectortype', 'body', 'connector_type', 'connectortype'),
      op_param('created', 'body', 'created', 'created'),
      op_param('dataformatid', 'body', 'data_format_id', 'dataformatid'),
      op_param('description', 'body', 'description', 'description'),
      op_param('displayname', 'body', 'display_name', 'displayname'),
      op_param('entitytype', 'body', 'entity_type', 'entitytype'),
      op_param('entitytypename', 'body', 'entity_type_name', 'entitytypename'),
      ...
      op_param('mappingproperties', 'body', 'mapping_properties', 'mappingproperties'),
      op_param('nextruntime', 'body', 'next_run_time', 'nextruntime'),
...
def task
  ...
  params = STDIN.read
  result = connector_mappings_delete(params)
