...
def check_name_availability_with_subscription(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Cdn/checkNameAvailability" % path_params
...
def task
  ...
  params = STDIN.read
  result = check_name_availability_with_subscription(params)
