...
def database_accounts_create_or_update(*args)
  header_params = {}
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('createUpdateParameters', 'body', 'create_update_parameters', 'create_update_parameters'),
...
def task
  ...
  params = STDIN.read
  result = database_accounts_create_or_update(params)
