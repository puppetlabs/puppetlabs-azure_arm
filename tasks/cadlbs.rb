...
def dimensions_list_by_subscription(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.CostManagement/dimensions" % path_params
...
def task
  ...
  params = STDIN.read
  result = dimensions_list_by_subscription(params)
