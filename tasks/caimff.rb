...
def image_moderation_find_faces(*args)
  header_params = {}
  ...
  uri_string = "https:////contentmoderator/moderate/v1.0/ProcessImage/FindFaces" % path_params
...
def task
  ...
  params = STDIN.read
  result = image_moderation_find_faces(params)
