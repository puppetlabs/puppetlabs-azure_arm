...
def list_management_term_delete_term(*args)
  header_params = {}
  ...
  uri_string = "https:////contentmoderator/lists/v1.0/termlists/%{list_id}/terms/%{term}" % path_params
...
def task
  ...
  params = STDIN.read
  result = list_management_term_delete_term(params)
