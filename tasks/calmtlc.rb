...
def list_management_term_lists_create(*args)
  header_params = {}
  ...
  uri_string = "https:////contentmoderator/lists/v1.0/termlists" % path_params
...
def task
  ...
  params = STDIN.read
  result = list_management_term_lists_create(params)
