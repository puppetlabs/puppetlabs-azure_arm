...
def list_management_term_lists_delete(*args)
  header_params = {}
  ...
  uri_string = "https:////contentmoderator/lists/v1.0/termlists/%{list_id}" % path_params
...
def task
  ...
  params = STDIN.read
  result = list_management_term_lists_delete(params)
