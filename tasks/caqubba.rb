...
def query_usage_by_billing_account(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.Billing/billingAccounts/%{billing_account_id}/providers/Microsoft.CostManagement/Query" % path_params
...
def task
  ...
  params = STDIN.read
  result = query_usage_by_billing_account(params)
