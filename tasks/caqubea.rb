...
def query_usage_by_enrollment_account(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.Billing/billingAccounts/%{billing_account_id}/enrollmentAccounts/%{enrollment_account_id}/providers/Microsoft.CostManagement/Query" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('billingAccountId', 'path', 'billing_account_id', 'billing_account_id'),
      op_param('dataset', 'body', 'dataset', 'dataset'),
      op_param('enrollmentAccountId', 'path', 'enrollment_account_id', 'enrollment_account_id'),
      op_param('parameters', 'body', 'parameters', 'parameters'),
      op_param('timeframe', 'body', 'timeframe', 'timeframe'),
      op_param('timeperiod', 'body', 'timeperiod', 'timeperiod'),
...
def task
  ...
  params = STDIN.read
  result = query_usage_by_enrollment_account(params)
