...
def query_usage_by_managment_group(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.Management/managementGroups/%{management_group_id}/providers/Microsoft.CostManagement/Query" % path_params
...
def task
  ...
  params = STDIN.read
  result = query_usage_by_managment_group(params)
