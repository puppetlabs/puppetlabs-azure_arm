...
def query_usage_by_resource_group(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/Microsoft.CostManagement/Query" % path_params
...
def task
  ...
  params = STDIN.read
  result = query_usage_by_resource_group(params)
