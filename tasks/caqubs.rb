...
def query_usage_by_subscription(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.CostManagement/Query" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('timeperiod', 'body', 'time_period', 'timeperiod'),
...
def task
  ...
  params = STDIN.read
  result = query_usage_by_subscription(params)
