...
def registries_check_name_availability(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.ContainerRegistry/checkNameAvailability" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('registryNameCheckRequest', 'body', 'registry_name_check_request', 'registry_name_check_request'),
...
def task
  ...
  params = STDIN.read
  result = registries_check_name_availability(params)
