...
def reservation_recommendations_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Consumption/reservationRecommendations" % path_params
...
def task
  ...
  params = STDIN.read
  result = reservation_recommendations_list(params)
