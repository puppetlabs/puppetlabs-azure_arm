...
def catalog_list_acls_by_database(*args)
  header_params = {}
  ...
  uri_string = "https:////catalog/usql/databases/%{database_name}/acl" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = Catalog_ListAclsByDatabase(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = catalog_list_acls_by_database(params)
