...
def catalog_list_credentials(*args)
  header_params = {}
  ...
  uri_string = "https:////catalog/usql/databases/%{database_name}/credentials" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = Catalog_ListCredentials(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = catalog_list_credentials(params)
