...
def catalog_list_schemas(*args)
  ...
  uri_string = "https:////catalog/usql/databases/%{database_name}/schemas" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = Catalog_ListSchemas(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = catalog_list_schemas(params)
