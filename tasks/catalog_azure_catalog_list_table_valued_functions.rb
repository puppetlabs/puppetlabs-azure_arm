...
def catalog_list_table_valued_functions(*args)
  header_params = {}
  ...
  uri_string = "https:////catalog/usql/databases/%{database_name}/schemas/%{schema_name}/tablevaluedfunctions" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = Catalog_ListTableValuedFunctions(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = catalog_list_table_valued_functions(params)
