...
def catalog_list_types(*args)
  ...
  uri_string = "https:////catalog/usql/databases/%{database_name}/schemas/%{schema_name}/types" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = Catalog_ListTypes(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = catalog_list_types(params)
