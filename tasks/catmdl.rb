...
def text_moderation_detect_language(*args)
  header_params = {}
  ...
  uri_string = "https:////contentmoderator/moderate/v1.0/ProcessText/DetectLanguage" % path_params
...
def task
  ...
  params = STDIN.read
  result = text_moderation_detect_language(params)
