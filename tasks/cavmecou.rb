...
def virtual_machine_extensions_create_or_update(*args)
  header_params = {}
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('extensionParameters', 'body', 'extension_parameters', 'extension_parameters'),
      ...
      op_param('vmExtensionName', 'path', 'vm_extension_name', 'vm_extension_name'),
...
def task
  ...
  params = STDIN.read
  result = virtual_machine_extensions_create_or_update(params)
