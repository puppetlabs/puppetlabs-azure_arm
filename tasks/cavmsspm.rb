...
def virtual_machine_scale_sets_perform_maintenance(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/virtualMachineScaleSets/%{vm_scale_set_name}/performMaintenance" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('vmInstanceIDs', 'body', 'vm_instance_i_ds', 'vm_instance_i_ds'),
...
def task
  ...
  params = STDIN.read
  result = virtual_machine_scale_sets_perform_maintenance(params)
