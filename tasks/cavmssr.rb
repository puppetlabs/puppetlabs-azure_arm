...
def virtual_machine_scale_sets_reimage(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/virtualMachineScaleSets/%{vm_scale_set_name}/reimage" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('instanceids', 'body', 'instance_ids', 'instanceids'),
      ...
      op_param('vmScaleSetReimageInput', 'body', 'vm_scale_set_reimage_input', 'vm_scale_set_reimage_input'),
    ]
  op_params.each do |i|
    location = i[:location]
    name     = i[:name]
...
def task
  ...
  params = STDIN.read
  result = virtual_machine_scale_sets_reimage(params)
