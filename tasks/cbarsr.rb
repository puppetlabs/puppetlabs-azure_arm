...
def registries_schedule_run(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ContainerRegistry/registries/%{registry_name}/scheduleRun" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('isarchiveenabled', 'body', 'is_archive_enabled', 'isarchiveenabled'),
      ...
      op_param('runRequest', 'body', 'run_request', 'run_request'),
...
def task
  ...
  params = STDIN.read
  result = registries_schedule_run(params)
