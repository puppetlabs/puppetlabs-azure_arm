...
def check_name_availability(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.Cdn/checkNameAvailability" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('nameavailable', 'body', 'nameavailable', 'nameavailable'),
...
def task
  ...
  params = STDIN.read
  result = check_name_availability(params)
