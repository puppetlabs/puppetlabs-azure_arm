...
def custom_domains_enable_custom_https(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Cdn/profiles/%{profile_name}/endpoints/%{endpoint_name}/customDomains/%{custom_domain_name}/enableCustomHttps" % path_params
...
def task
  ...
  params = STDIN.read
  result = custom_domains_enable_custom_https(params)
