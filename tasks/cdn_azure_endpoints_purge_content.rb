...
def endpoints_purge_content(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Cdn/profiles/%{profile_name}/endpoints/%{endpoint_name}/purge" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('contentFilePaths', 'body', 'content_file_paths', 'content_file_paths'),
      op_param('contentpaths', 'body', 'content_paths', 'contentpaths'),
...
def task
  ...
  params = STDIN.read
  result = endpoints_purge_content(params)
