...
def endpoints_validate_custom_domain(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Cdn/profiles/%{profile_name}/endpoints/%{endpoint_name}/validateCustomDomain" % path_params
...
def task
  ...
  params = STDIN.read
  result = endpoints_validate_custom_domain(params)
