...
def origins_get(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Cdn/profiles/%{profile_name}/endpoints/%{endpoint_name}/origins/%{origin_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('originName', 'path', 'origin_name', 'origin_name'),
