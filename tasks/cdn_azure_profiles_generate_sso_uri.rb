...
def profiles_generate_sso_uri(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Cdn/profiles/%{profile_name}/generateSsoUri" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('ssourivalue', 'body', 'sso_uri_value', 'ssourivalue'),
...
def task
  ...
  params = STDIN.read
  result = profiles_generate_sso_uri(params)
