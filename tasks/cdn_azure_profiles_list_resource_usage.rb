...
def profiles_list_resource_usage(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Cdn/profiles/%{profile_name}/checkResourceUsage" % path_params
...
def task
  ...
  params = STDIN.read
  result = profiles_list_resource_usage(params)
