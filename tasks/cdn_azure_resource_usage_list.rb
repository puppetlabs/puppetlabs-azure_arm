...
def resource_usage_list(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Cdn/checkResourceUsage" % path_params
...
def task
  ...
  params = STDIN.read
  result = resource_usage_list(params)
