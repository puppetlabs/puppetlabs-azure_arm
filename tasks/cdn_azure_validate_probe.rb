...
def validate_probe(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Cdn/validateProbe" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('isvalid', 'body', 'is_valid', 'isvalid'),
