...
def cluster_versions_get(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.ServiceFabric/locations/%{location}/clusterVersions/%{cluster_version}" % path_params
