...
def accounts_get_usages(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CognitiveServices/accounts/%{account_name}/usages" % path_params
...
def task
  ...
  params = STDIN.read
  result = accounts_get_usages(params)
