...
def accounts_list_keys(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CognitiveServices/accounts/%{account_name}/listKeys" % path_params
...
def task
  ...
  params = STDIN.read
  result = accounts_list_keys(params)
