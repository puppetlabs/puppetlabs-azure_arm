...
def check_sku_availability_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.CognitiveServices/locations/%{location}/checkSkuAvailability" % path_params
...
def task
  ...
  params = STDIN.read
  result = check_sku_availability_list(params)
