...
def resource_skus_list(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.CognitiveServices/skus" % path_params
...
def task
  ...
  params = STDIN.read
  result = resource_skus_list(params)
