...
def compliance_results_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//%{resource_id}/providers/Microsoft.Security/complianceResults/%{compliance_result_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('complianceResultName', 'path', 'name', 'compliance_result_name'),
...
def task
  ...
  params = STDIN.read
  result = compliance_results_get(params)
