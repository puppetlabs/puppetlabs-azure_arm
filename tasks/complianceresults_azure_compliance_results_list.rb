...
def compliance_results_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//%{scope}/providers/Microsoft.Security/complianceResults" % path_params
...
def task
  ...
  params = STDIN.read
  result = compliance_results_list(params)
