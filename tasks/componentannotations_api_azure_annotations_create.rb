...
def annotations_create(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Insights/components/%{resource_name}/Annotations" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('AnnotationProperties', 'body', 'annotation_properties', 'annotation_properties'),
...
def task
  ...
  params = STDIN.read
  result = annotations_create(params)
