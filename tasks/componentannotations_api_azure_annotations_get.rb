...
def annotations_get(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Insights/components/%{resource_name}/Annotations/%{annotation_id}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('annotationId', 'path', 'annotation_id', 'annotation_id'),
