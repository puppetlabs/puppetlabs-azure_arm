...
def proactive_detection_configurations_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Insights/components/%{resource_name}/ProactiveDetectionConfigs/%{_configuration_id}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('_configuration_id', 'path', '_configuration_id', '_configuration_id'),
      op_param('api-version', 'query', 'api_version', 'api_version'),
      op_param('ConfigurationId', 'path', 'configuration_id', 'configuration_id'),
      op_param('customemails', 'body', 'custom_emails', 'customemails'),
      op_param('enabled', 'body', 'enabled', 'enabled'),
      op_param('lastupdatedtime', 'body', 'last_updated_time', 'lastupdatedtime'),
      op_param('name', 'body', 'name', 'name'),
      op_param('ProactiveDetectionProperties', 'body', 'proactive_detection_properties', 'proactive_detection_properties'),
      ...
      op_param('ruledefinitions', 'body', 'rule_definitions', 'ruledefinitions'),
      op_param('sendemailstosubscriptionowners', 'body', 'send_emails_to_subscription_owners', 'sendemailstosubscriptionowners'),
...
def task
  ...
  params = STDIN.read
  result = proactive_detection_configurations_update(params)
