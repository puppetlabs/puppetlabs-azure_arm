...
def work_item_configurations_create(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Insights/components/%{resource_name}/WorkItemConfigs" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('connectordataconfiguration', 'body', 'connector_data_configuration', 'connectordataconfiguration'),
      op_param('connectorid', 'body', 'connector_id', 'connectorid'),
      ...
      op_param('validateonly', 'body', 'validate_only', 'validateonly'),
      op_param('WorkItemConfigurationProperties', 'body', 'work_item_configuration_properties', 'work_item_configuration_properties'),
      op_param('workitemproperties', 'body', 'work_item_properties', 'workitemproperties'),
    ]
  op_params.each do |i|
    location = i[:location]
    name     = i[:name]
...
def task
  ...
  params = STDIN.read
  result = work_item_configurations_create(params)
