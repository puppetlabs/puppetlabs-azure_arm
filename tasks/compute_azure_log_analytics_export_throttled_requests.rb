...
def log_analytics_export_throttled_requests(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Compute/locations/%{location}/logAnalytics/apiAccess/getThrottledRequests" % path_params
...
def task
  ...
  params = STDIN.read
  result = log_analytics_export_throttled_requests(params)
