...
def virtual_machine_images_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Compute/locations/%{location}/publishers/%{publisher_name}/artifacttypes/vmimage/offers/%{offer}/skus/%{skus}/versions" % path_params
...
def task
  ...
  params = STDIN.read
  result = virtual_machine_images_list(params)
