...
def virtual_machine_images_list_skus(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Compute/locations/%{location}/publishers/%{publisher_name}/artifacttypes/vmimage/offers/%{offer}/skus" % path_params
...
def task
  ...
  params = STDIN.read
  result = virtual_machine_images_list_skus(params)
