...
def virtual_machine_scale_sets_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/virtualMachineScaleSets" % path_params
...
def task
  ...
  params = STDIN.read
  result = virtual_machine_scale_sets_list(params)
