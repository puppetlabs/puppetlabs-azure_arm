...
def virtual_machine_scale_sets_start(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/virtualMachineScaleSets/%{vm_scale_set_name}/start" % path_params
...
def task
  ...
  params = STDIN.read
  result = virtual_machine_scale_sets_start(params)
