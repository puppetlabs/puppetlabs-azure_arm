...
def virtual_machine_sizes_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Compute/locations/%{location}/vmSizes" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('maxdatadiskcount', 'body', 'max_data_disk_count', 'maxdatadiskcount'),
      op_param('memoryinmb', 'body', 'memory_in_mb', 'memoryinmb'),
      op_param('name', 'body', 'name', 'name'),
      op_param('numberofcores', 'body', 'number_of_cores', 'numberofcores'),
      op_param('osdisksizeinmb', 'body', 'os_disk_size_in_mb', 'osdisksizeinmb'),
      op_param('resourcedisksizeinmb', 'body', 'resource_disk_size_in_mb', 'resourcedisksizeinmb'),
...
def task
  ...
  params = STDIN.read
  result = virtual_machine_sizes_list(params)
