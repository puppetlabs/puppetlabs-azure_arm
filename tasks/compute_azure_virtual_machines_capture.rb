...
def virtual_machines_capture(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/virtualMachines/%{vm_name}/capture" % path_params
...
def task
  ...
  params = STDIN.read
  result = virtual_machines_capture(params)
