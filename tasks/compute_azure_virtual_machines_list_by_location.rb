...
def virtual_machines_list_by_location(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Compute/locations/%{location}/virtualMachines" % path_params
...
def task
  ...
  params = STDIN.read
  result = virtual_machines_list_by_location(params)
