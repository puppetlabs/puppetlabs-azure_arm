...
def analyze_image_by_domain(*args)
  header_params = {}
  ...
  uri_string = "https://westcentralus.api.cognitive.microsoft.com//models/%{model}/analyze" % path_params
...
def task
  ...
  params = STDIN.read
  result = analyze_image_by_domain(params)
