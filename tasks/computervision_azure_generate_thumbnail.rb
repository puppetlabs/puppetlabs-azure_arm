...
def generate_thumbnail(*args)
  ...
  uri_string = "https://westcentralus.api.cognitive.microsoft.com//generateThumbnail" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('smartCropping', 'query', 'smart_cropping', 'smart_cropping'),
...
def task
  ...
  params = STDIN.read
  result = generate_thumbnail(params)
