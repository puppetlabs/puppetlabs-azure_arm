...
def recognize_printed_text(*args)
  header_params = {}
  ...
  uri_string = "https://westcentralus.api.cognitive.microsoft.com//ocr" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('detectOrientation', 'query', 'detect_orientation', 'detect_orientation'),
...
def task
  ...
  params = STDIN.read
  result = recognize_printed_text(params)
