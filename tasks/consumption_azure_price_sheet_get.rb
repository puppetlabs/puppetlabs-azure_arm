...
def price_sheet_get(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Consumption/pricesheets/default" % path_params
