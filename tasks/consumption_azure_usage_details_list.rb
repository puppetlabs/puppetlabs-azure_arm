...
def usage_details_list(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Consumption/usageDetails" % path_params
...
def task
  ...
  params = STDIN.read
  result = usage_details_list(params)
