...
def container_groups_start(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ContainerInstance/containerGroups/%{container_group_name}/start" % path_params
...
def task
  ...
  params = STDIN.read
  result = container_groups_start(params)
