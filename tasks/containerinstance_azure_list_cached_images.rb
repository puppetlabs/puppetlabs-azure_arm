...
def list_cached_images(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.ContainerInstance/locations/%{location}/cachedImages" % path_params
...
def task
  ...
  params = STDIN.read
  result = list_cached_images(params)
