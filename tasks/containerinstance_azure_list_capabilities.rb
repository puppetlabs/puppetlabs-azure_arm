...
def list_capabilities(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.ContainerInstance/locations/%{location}/capabilities" % path_params
...
def task
  ...
  params = STDIN.read
  result = list_capabilities(params)
