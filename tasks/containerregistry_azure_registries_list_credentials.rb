...
def registries_list_credentials(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ContainerRegistry/registries/%{registry_name}/listCredentials" % path_params
...
def task
  ...
  params = STDIN.read
  result = registries_list_credentials(params)
