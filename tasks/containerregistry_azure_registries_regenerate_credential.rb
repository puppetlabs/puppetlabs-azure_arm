...
def registries_regenerate_credential(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ContainerRegistry/registries/%{registry_name}/regenerateCredential" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('passwords', 'body', 'passwords', 'passwords'),
      op_param('regenerateCredentialParameters', 'body', 'regenerate_credential_parameters', 'regenerate_credential_parameters'),
...
def task
  ...
  params = STDIN.read
  result = registries_regenerate_credential(params)
