...
def webhooks_list_events(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ContainerRegistry/registries/%{registry_name}/webhooks/%{webhook_name}/listEvents" % path_params
...
def task
  ...
  params = STDIN.read
  result = webhooks_list_events(params)
