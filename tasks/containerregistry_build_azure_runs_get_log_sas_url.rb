...
def runs_get_log_sas_url(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ContainerRegistry/registries/%{registry_name}/runs/%{run_id}/listLogSasUrl" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('loglink', 'body', 'log_link', 'loglink'),
...
def task
  ...
  params = STDIN.read
  result = runs_get_log_sas_url(params)
