...
def content_key_policies_get_policy_properties_with_secrets(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Media/mediaServices/%{account_name}/contentKeyPolicies/%{content_key_policy_name}/getPolicyPropertiesWithSecrets" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('contentKeyPolicyName', 'path', 'content_key_policy_name', 'content_key_policy_name'),
      ...
      op_param('options', 'body', 'options', 'options'),
...
def task
  ...
  params = STDIN.read
  result = content_key_policies_get_policy_properties_with_secrets(params)
