...
def image_moderation_evaluate(*args)
  header_params = {}
  ...
  uri_string = "https:////contentmoderator/moderate/v1.0/ProcessImage/Evaluate" % path_params
...
def task
  ...
  params = STDIN.read
  result = image_moderation_evaluate(params)
