...
def list_management_image_lists_refresh_index(*args)
  header_params = {}
  ...
  uri_string = "https:////contentmoderator/lists/v1.0/imagelists/%{list_id}/RefreshIndex" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('advancedinfo', 'body', 'advanced_info', 'advancedinfo'),
      op_param('contentsourceid', 'body', 'content_source_id', 'contentsourceid'),
      op_param('isupdatesuccess', 'body', 'is_update_success', 'isupdatesuccess'),
...
def task
  ...
  params = STDIN.read
  result = list_management_image_lists_refresh_index(params)
