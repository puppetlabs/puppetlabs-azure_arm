...
def reviews_get_job_details(*args)
  header_params = {}
  ...
  uri_string = "https:////contentmoderator/review/v1.0/teams/%{team_name}/jobs/%{_job_id}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('_job_id', 'path', '_job_id', '_job_id'),
...
def task
  ...
  params = STDIN.read
  result = reviews_get_job_details(params)
