...
def reviews_get_review(*args)
  ...
  uri_string = "https:////contentmoderator/review/v1.0/teams/%{team_name}/reviews/%{review_id}" % path_params
...
def task
  ...
  params = STDIN.read
  result = reviews_get_review(params)
