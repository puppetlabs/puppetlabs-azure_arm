...
def reviews_publish_video_review(*args)
  header_params = {}
  ...
  uri_string = "https:////contentmoderator/review/v1.0/teams/%{team_name}/reviews/%{review_id}/publish" % path_params
...
def task
  ...
  params = STDIN.read
  result = reviews_publish_video_review(params)
