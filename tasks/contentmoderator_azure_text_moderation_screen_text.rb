...
def text_moderation_screen_text(*args)
  header_params = {}
  ...
  uri_string = "https:////contentmoderator/moderate/v1.0/ProcessText/Screen/" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('autocorrect', 'query', 'autocorrect', 'autocorrect'),
      op_param('autocorrectedtext', 'body', 'auto_corrected_text', 'autocorrectedtext'),
      op_param('classification', 'body', 'classification', 'classification'),
      op_param('classify', 'query', 'classify', 'classify'),
      ...
      op_param('misrepresentation', 'body', 'misrepresentation', 'misrepresentation'),
      op_param('normalizedtext', 'body', 'normalized_text', 'normalizedtext'),
      op_param('originaltext', 'body', 'original_text', 'originaltext'),
      op_param('pii', 'body', 'pii', 'pii'),
      op_param('status', 'body', 'status', 'status'),
      op_param('terms', 'body', 'terms', 'terms'),
      op_param('Text Content', 'body', 'text _content', 'text _content'),
...
def task
  ...
  params = STDIN.read
  result = text_moderation_screen_text(params)
