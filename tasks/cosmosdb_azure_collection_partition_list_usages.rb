...
def collection_partition_list_usages(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/databases/%{database_rid}/collections/%{collection_rid}/partitions/usages" % path_params
...
def task
  ...
  params = STDIN.read
  result = collection_partition_list_usages(params)
