...
def database_accounts_list_connection_strings(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/listConnectionStrings" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('connectionstrings', 'body', 'connection_strings', 'connectionstrings'),
...
def task
  ...
  params = STDIN.read
  result = database_accounts_list_connection_strings(params)
