...
def database_accounts_list_metrics(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/metrics" % path_params
...
def task
  ...
  params = STDIN.read
  result = database_accounts_list_metrics(params)
