...
def database_accounts_offline_region(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/offlineRegion" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('regionParameterForOffline', 'body', 'region_parameter_for_offline', 'region_parameter_for_offline'),
...
def task
  ...
  params = STDIN.read
  result = database_accounts_offline_region(params)
