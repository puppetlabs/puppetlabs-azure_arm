...
def database_accounts_online_region(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/onlineRegion" % path_params
...
def task
  ...
  params = STDIN.read
  result = database_accounts_online_region(params)
