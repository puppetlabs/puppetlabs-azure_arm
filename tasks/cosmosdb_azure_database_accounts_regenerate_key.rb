...
def database_accounts_regenerate_key(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/regenerateKey" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('keykind', 'body', 'key_kind', 'keykind'),
      op_param('keyToRegenerate', 'body', 'key_to_regenerate', 'key_to_regenerate'),
...
def task
  ...
  params = STDIN.read
  result = database_accounts_regenerate_key(params)
