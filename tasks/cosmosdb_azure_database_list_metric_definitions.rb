...
def database_list_metric_definitions(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/databases/%{database_rid}/metricDefinitions" % path_params
...
def task
  ...
  params = STDIN.read
  result = database_list_metric_definitions(params)
