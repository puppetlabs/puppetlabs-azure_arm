...
def database_list_metrics(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/databases/%{database_rid}/metrics" % path_params
...
def task
  ...
  params = STDIN.read
  result = database_list_metrics(params)
