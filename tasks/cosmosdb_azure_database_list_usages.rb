...
def database_list_usages(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/databases/%{database_rid}/usages" % path_params
...
def task
  ...
  params = STDIN.read
  result = database_list_usages(params)
