...
def percentile_target_list_metrics(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DocumentDB/databaseAccounts/%{account_name}/targetRegion/%{target_region}/percentile/metrics" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('targetRegion', 'path', 'target_region', 'target_region'),
...
def task
  ...
  params = STDIN.read
  result = percentile_target_list_metrics(params)
