...
def exports_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//%{scope}/providers/Microsoft.CostManagement/exports/%{export_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('exportName', 'path', 'export_name', 'export_name'),
...
def task
  ...
  params = STDIN.read
  result = exports_create_or_update(params)
