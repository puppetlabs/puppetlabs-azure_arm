...
def exports_execute(*args)
  ...
  uri_string = "https://management.azure.com//%{scope}/providers/Microsoft.CostManagement/exports/%{export_name}/run" % path_params
