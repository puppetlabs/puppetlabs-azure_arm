...
def query_usage_by_department(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.Billing/billingAccounts/%{billing_account_id}/departments/%{department_id}/providers/Microsoft.CostManagement/Query" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('departmentId', 'path', 'department_id', 'department_id'),
...
def task
  ...
  params = STDIN.read
  result = query_usage_by_department(params)
