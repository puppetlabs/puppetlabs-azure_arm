...
def query_usage_by_scope(*args)
  ...
  uri_string = "https://management.azure.com//%{scope}/providers/Microsoft.CostManagement/query" % path_params
...
def task
  ...
  params = STDIN.read
  result = query_usage_by_scope(params)
