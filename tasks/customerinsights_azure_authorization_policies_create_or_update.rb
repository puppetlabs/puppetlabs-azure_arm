...
def authorization_policies_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CustomerInsights/hubs/%{hub_name}/authorizationPolicies/%{authorization_policy_name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = authorization_policies_create_or_update(params)
