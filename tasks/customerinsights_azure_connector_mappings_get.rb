...
def connector_mappings_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CustomerInsights/hubs/%{hub_name}/connectors/%{connector_name}/mappings/%{mapping_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('connector_name', 'path', 'connector_name', 'connector_name'),
      op_param('connectormappingname', 'body', 'connectormappingname', 'connectormappingname'),
      op_param('connectorname', 'body', 'connectorname', 'connectorname'),
      op_param('connectortype', 'body', 'connectortype', 'connectortype'),
      op_param('created', 'body', 'created', 'created'),
      op_param('dataformatid', 'body', 'dataformatid', 'dataformatid'),
      op_param('description', 'body', 'description', 'description'),
      op_param('displayname', 'body', 'displayname', 'displayname'),
      op_param('entitytype', 'body', 'entitytype', 'entitytype'),
      op_param('entitytypename', 'body', 'entitytypename', 'entitytypename'),
      op_param('hubName', 'path', 'hub_name', 'hub_name'),
      op_param('lastmodified', 'body', 'lastmodified', 'lastmodified'),
      op_param('mappingName', 'path', 'mapping_name', 'mapping_name'),
      op_param('mappingproperties', 'body', 'mappingproperties', 'mappingproperties'),
      op_param('nextruntime', 'body', 'nextruntime', 'nextruntime'),
      op_param('resourceGroupName', 'path', 'resource_group_name', 'resource_group_name'),
      op_param('runid', 'body', 'runid', 'runid'),
...
def task
  ...
  params = STDIN.read
  result = connector_mappings_get(params)
