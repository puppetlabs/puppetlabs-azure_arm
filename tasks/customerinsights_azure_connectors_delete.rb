...
def connectors_delete(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CustomerInsights/hubs/%{hub_name}/connectors/%{connector_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('isinternal', 'body', 'is_internal', 'isinternal'),
...
def task
  ...
  params = STDIN.read
  result = connectors_delete(params)
