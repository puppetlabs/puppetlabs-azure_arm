...
def connectors_list_by_hub(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CustomerInsights/hubs/%{hub_name}/connectors" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('connectorid', 'body', 'connectorid', 'connectorid'),
      op_param('connectorname', 'body', 'connectorname', 'connectorname'),
      op_param('connectorproperties', 'body', 'connectorproperties', 'connectorproperties'),
      ...
      op_param('isinternal', 'body', 'isinternal', 'isinternal'),
...
def task
  ...
  params = STDIN.read
  result = connectors_list_by_hub(params)
