...
def images_get_upload_url_for_data(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CustomerInsights/hubs/%{hub_name}/images/getDataImageUploadUrl" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('contenturl', 'body', 'contenturl', 'contenturl'),
      op_param('hubName', 'path', 'hub_name', 'hub_name'),
      op_param('imageexists', 'body', 'imageexists', 'imageexists'),
...
def task
  ...
  params = STDIN.read
  result = images_get_upload_url_for_data(params)
