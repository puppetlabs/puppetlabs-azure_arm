...
def images_get_upload_url_for_entity_type(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CustomerInsights/hubs/%{hub_name}/images/getEntityTypeImageUploadUrl" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('contenturl', 'body', 'content_url', 'contenturl'),
      op_param('hubName', 'path', 'hub_name', 'hub_name'),
      op_param('imageexists', 'body', 'image_exists', 'imageexists'),
...
def task
  ...
  params = STDIN.read
  result = images_get_upload_url_for_entity_type(params)
