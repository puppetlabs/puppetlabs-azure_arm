...
def interactions_list_by_hub(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CustomerInsights/hubs/%{hub_name}/interactions" % path_params
...
def task
  ...
  params = STDIN.read
  result = interactions_list_by_hub(params)
