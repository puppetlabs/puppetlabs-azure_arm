...
def links_list_by_hub(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CustomerInsights/hubs/%{hub_name}/links" % path_params
...
def task
  ...
  params = STDIN.read
  result = links_list_by_hub(params)
