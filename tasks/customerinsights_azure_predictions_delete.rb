...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('autoanalyze', 'body', 'auto_analyze', 'autoanalyze'),
      ...
      op_param('involvedinteractiontypes', 'body', 'involved_interaction_types', 'involvedinteractiontypes'),
      op_param('involvedkpitypes', 'body', 'involved_kpi_types', 'involvedkpitypes'),
      op_param('involvedrelationships', 'body', 'involved_relationships', 'involvedrelationships'),
      op_param('mappings', 'body', 'mappings', 'mappings'),
      op_param('negativeoutcomeexpression', 'body', 'negative_outcome_expression', 'negativeoutcomeexpression'),
      op_param('positiveoutcomeexpression', 'body', 'positive_outcome_expression', 'positiveoutcomeexpression'),
      op_param('prediction_name', 'path', 'prediction_name', 'prediction_name'),
      op_param('predictionname', 'body', 'predictionname', 'predictionname'),
      op_param('primaryprofiletype', 'body', 'primary_profile_type', 'primaryprofiletype'),
      ...
      op_param('scopeexpression', 'body', 'scope_expression', 'scopeexpression'),
      op_param('scorelabel', 'body', 'score_label', 'scorelabel'),
      op_param('subscriptionId', 'path', 'subscription_id', 'subscription_id'),
      op_param('systemgeneratedentities', 'body', 'system_generated_entities', 'systemgeneratedentities'),
...
def task
  ...
  params = STDIN.read
  result = predictions_delete(params)
