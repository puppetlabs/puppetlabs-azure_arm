...
def predictions_get(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CustomerInsights/hubs/%{hub_name}/predictions/%{prediction_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('autoanalyze', 'body', 'autoanalyze', 'autoanalyze'),
      op_param('description', 'body', 'description', 'description'),
      op_param('displayname', 'body', 'displayname', 'displayname'),
      op_param('grades', 'body', 'grades', 'grades'),
      op_param('hubName', 'path', 'hub_name', 'hub_name'),
      op_param('involvedinteractiontypes', 'body', 'involvedinteractiontypes', 'involvedinteractiontypes'),
      op_param('involvedkpitypes', 'body', 'involvedkpitypes', 'involvedkpitypes'),
      op_param('involvedrelationships', 'body', 'involvedrelationships', 'involvedrelationships'),
      op_param('mappings', 'body', 'mappings', 'mappings'),
      op_param('negativeoutcomeexpression', 'body', 'negativeoutcomeexpression', 'negativeoutcomeexpression'),
      op_param('positiveoutcomeexpression', 'body', 'positiveoutcomeexpression', 'positiveoutcomeexpression'),
      op_param('prediction_name', 'path', 'prediction_name', 'prediction_name'),
      op_param('predictionname', 'body', 'predictionname', 'predictionname'),
      op_param('primaryprofiletype', 'body', 'primaryprofiletype', 'primaryprofiletype'),
      op_param('provisioningstate', 'body', 'provisioningstate', 'provisioningstate'),
      op_param('resourceGroupName', 'path', 'resource_group_name', 'resource_group_name'),
      op_param('scopeexpression', 'body', 'scopeexpression', 'scopeexpression'),
      op_param('scorelabel', 'body', 'scorelabel', 'scorelabel'),
      op_param('subscriptionId', 'path', 'subscription_id', 'subscription_id'),
      op_param('systemgeneratedentities', 'body', 'systemgeneratedentities', 'systemgeneratedentities'),
