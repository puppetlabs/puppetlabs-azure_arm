...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('assignmentname', 'body', 'assignmentname', 'assignmentname'),
      op_param('conflationpolicies', 'body', 'conflationpolicies', 'conflationpolicies'),
      ...
      op_param('relationshiplinks', 'body', 'relationshiplinks', 'relationshiplinks'),
      ...
      op_param('roleassignments', 'body', 'roleassignments', 'roleassignments'),
      op_param('saspolicies', 'body', 'saspolicies', 'saspolicies'),
      ...
      op_param('widgettypes', 'body', 'widgettypes', 'widgettypes'),
    ]
  op_params.each do |i|
    location = i[:location]
    name     = i[:name]
...
def task
  ...
  params = STDIN.read
  result = role_assignments_get(params)
