...
def views_delete(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CustomerInsights/hubs/%{hub_name}/views/%{view_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('view_name', 'path', 'view_name', 'view_name'),
