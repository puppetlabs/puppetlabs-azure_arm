...
def views_list_by_hub(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CustomerInsights/hubs/%{hub_name}/views" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('userid', 'body', 'userid', 'userid'),
...
def task
  ...
  params = STDIN.read
  result = views_list_by_hub(params)
