...
def activity_runs_query_by_pipeline_run(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}/pipelineruns/%{run_id}/queryActivityruns" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('filterParameters', 'body', 'filter_parameters', 'filter_parameters'),
      op_param('resourceGroupName', 'path', 'resource_group_name', 'resource_group_name'),
      op_param('runId', 'path', 'run_id', 'run_id'),
...
def task
  ...
  params = STDIN.read
  result = activity_runs_query_by_pipeline_run(params)
