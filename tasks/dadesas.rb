...
def diagnostics_execute_site_analysis_slot(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{site_name}/slots/%{slot}/diagnostics/%{diagnostic_category}/analyses/%{analysis_name}/execute" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('analysisName', 'path', 'analysis_name', 'analysis_name'),
...
def task
  ...
  params = STDIN.read
  result = diagnostics_execute_site_analysis_slot(params)
