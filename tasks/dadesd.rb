...
def diagnostics_execute_site_detector(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{site_name}/diagnostics/%{diagnostic_category}/detectors/%{detector_name}/execute" % path_params
...
def task
  ...
  params = STDIN.read
  result = diagnostics_execute_site_detector(params)
