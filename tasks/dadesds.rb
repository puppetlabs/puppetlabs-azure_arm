...
def diagnostics_execute_site_detector_slot(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{site_name}/slots/%{slot}/diagnostics/%{diagnostic_category}/detectors/%{detector_name}/execute" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('detectorName', 'path', 'detector_name', 'detector_name'),
      op_param('diagnosticCategory', 'path', 'diagnostic_category', 'diagnostic_category'),
      op_param('endTime', 'query', 'end_time', 'end_time'),
      ...
      op_param('siteName', 'path', 'site_name', 'site_name'),
      op_param('slot', 'path', 'slot', 'slot'),
      op_param('startTime', 'query', 'start_time', 'start_time'),
      op_param('subscriptionId', 'path', 'subscription_id', 'subscription_id'),
      op_param('timeGrain', 'query', 'time_grain', 'time_grain'),
...
def task
  ...
  params = STDIN.read
  result = diagnostics_execute_site_detector_slot(params)
