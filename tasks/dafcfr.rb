...
def factories_configure_factory_repo(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.DataFactory/locations/%{location_id}/configureFactoryRepo" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('factoryRepoUpdate', 'body', 'factory_repo_update', 'factory_repo_update'),
      op_param('locationId', 'path', 'location_id', 'location_id'),
...
def task
  ...
  params = STDIN.read
  result = factories_configure_factory_repo(params)
