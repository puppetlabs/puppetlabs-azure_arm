...
def factories_get_git_hub_access_token(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}/getGitHubAccessToken" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('githubaccesscode', 'body', 'git_hub_access_code', 'githubaccesscode'),
      op_param('githubaccesstokenbaseurl', 'body', 'git_hub_access_token_base_url', 'githubaccesstokenbaseurl'),
      op_param('gitHubAccessTokenRequest', 'body', 'git_hub_access_token_request', 'git_hub_access_token_request'),
      op_param('githubclientid', 'body', 'git_hub_client_id', 'githubclientid'),
...
def task
  ...
  params = STDIN.read
  result = factories_get_git_hub_access_token(params)
