...
def integration_runtimes_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}/integrationRuntimes/%{integration_runtime_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('integrationRuntime', 'body', 'integration_runtime', 'integration_runtime'),
...
def task
  ...
  params = STDIN.read
  result = integration_runtimes_create_or_update(params)
