...
def integration_runtimes_list_auth_keys(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}/integrationRuntimes/%{integration_runtime_name}/listAuthKeys" % path_params
...
def task
  ...
  params = STDIN.read
  result = integration_runtimes_list_auth_keys(params)
