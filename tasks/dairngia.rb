...
def integration_runtime_nodes_get_ip_address(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}/integrationRuntimes/%{integration_runtime_name}/nodes/%{node_name}/ipAddress" % path_params
...
def task
  ...
  params = STDIN.read
  result = integration_runtime_nodes_get_ip_address(params)
