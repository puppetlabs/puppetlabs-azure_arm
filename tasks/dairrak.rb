...
def integration_runtimes_regenerate_auth_key(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}/integrationRuntimes/%{integration_runtime_name}/regenerateAuthKey" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('regenerateKeyParameters', 'body', 'regenerate_key_parameters', 'regenerate_key_parameters'),
...
def task
  ...
  params = STDIN.read
  result = integration_runtimes_regenerate_auth_key(params)
