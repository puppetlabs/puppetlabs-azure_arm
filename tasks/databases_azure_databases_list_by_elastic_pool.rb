...
def databases_list_by_elastic_pool(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Sql/servers/%{server_name}/elasticPools/%{elastic_pool_name}/databases" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('elasticPoolName', 'path', 'elastic_pool_name', 'elastic_pool_name'),
...
def task
  ...
  params = STDIN.read
  result = databases_list_by_elastic_pool(params)
