...
def jobs_book_shipment_pick_up(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataBox/jobs/%{job_name}/bookShipmentPickUp" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('shipmentlocation', 'body', 'shipment_location', 'shipmentlocation'),
      op_param('shipmentPickUpRequest', 'body', 'shipment_pick_up_request', 'shipment_pick_up_request'),
...
def task
  ...
  params = STDIN.read
  result = jobs_book_shipment_pick_up(params)
