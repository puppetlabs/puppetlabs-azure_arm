...
def jobs_cancel(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataBox/jobs/%{job_name}/cancel" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('cancellationReason', 'body', 'cancellation_reason', 'cancellation_reason'),
