...
def jobs_list_credentials(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataBox/jobs/%{job_name}/listCredentials" % path_params
...
def task
  ...
  params = STDIN.read
  result = jobs_list_credentials(params)
