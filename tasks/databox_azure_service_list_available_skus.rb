...
def service_list_available_skus(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.DataBox/locations/%{location}/availableSkus" % path_params
...
def task
  ...
  params = STDIN.read
  result = service_list_available_skus(params)
