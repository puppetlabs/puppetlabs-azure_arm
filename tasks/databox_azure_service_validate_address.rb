...
def service_validate_address(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.DataBox/locations/%{location}/validateAddress" % path_params
...
def task
  ...
  params = STDIN.read
  result = service_validate_address(params)
