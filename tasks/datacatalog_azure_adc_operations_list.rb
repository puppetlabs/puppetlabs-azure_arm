...
def adc_operations_list(*args)
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.DataCatalog/operations" % path_params
...
def task
  ...
  params = STDIN.read
  result = adc_operations_list(params)
