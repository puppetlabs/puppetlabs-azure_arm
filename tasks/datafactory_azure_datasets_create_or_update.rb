...
def datasets_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}/datasets/%{dataset_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('datasetName', 'path', 'dataset_name', 'dataset_name'),
...
def task
  ...
  params = STDIN.read
  result = datasets_create_or_update(params)
