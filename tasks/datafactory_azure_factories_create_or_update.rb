...
def factories_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('factory', 'body', 'factory', 'factory'),
...
def task
  ...
  params = STDIN.read
  result = factories_create_or_update(params)
