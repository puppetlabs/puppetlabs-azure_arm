...
def factories_get_data_plane_access(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}/getDataPlaneAccess" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('accessresourcepath', 'body', 'access_resource_path', 'accessresourcepath'),
      op_param('api-version', 'query', 'api_version', 'api_version'),
      op_param('expiretime', 'body', 'expire_time', 'expiretime'),
      ...
      op_param('profilename', 'body', 'profile_name', 'profilename'),
...
def task
  ...
  params = STDIN.read
  result = factories_get_data_plane_access(params)
