...
def integration_runtime_object_metadata_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}/integrationRuntimes/%{integration_runtime_name}/getObjectMetadata" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('getMetadataRequest', 'body', 'get_metadata_request', 'get_metadata_request'),
...
def task
  ...
  params = STDIN.read
  result = integration_runtime_object_metadata_get(params)
