...
def integration_runtimes_create_linked_integration_runtime(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}/integrationRuntimes/%{integration_runtime_name}/linkedIntegrationRuntime" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('createLinkedIntegrationRuntimeRequest', 'body', 'create_linked_integration_runtime_request', 'create_linked_integration_runtime_request'),
      op_param('error', 'body', 'error', 'error'),
      op_param('factoryName', 'path', 'factory_name', 'factory_name'),
      op_param('integrationRuntimeName', 'path', 'integration_runtime_name', 'integration_runtime_name'),
...
def task
  ...
  params = STDIN.read
  result = integration_runtimes_create_linked_integration_runtime(params)
