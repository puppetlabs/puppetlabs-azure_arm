...
def integration_runtimes_remove_links(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}/integrationRuntimes/%{integration_runtime_name}/removeLinks" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('linkedIntegrationRuntimeRequest', 'body', 'linked_integration_runtime_request', 'linked_integration_runtime_request'),
...
def task
  ...
  params = STDIN.read
  result = integration_runtimes_remove_links(params)
