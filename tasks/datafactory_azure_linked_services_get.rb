...
def linked_services_get(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}/linkedservices/%{linked_service_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('connectvia', 'body', 'connect_via', 'connectvia'),
      ...
      op_param('linkedServiceName', 'path', 'linked_service_name', 'linked_service_name'),
...
def task
  ...
  params = STDIN.read
  result = linked_services_get(params)
