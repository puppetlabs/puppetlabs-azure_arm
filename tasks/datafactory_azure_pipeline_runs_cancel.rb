...
def pipeline_runs_cancel(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}/pipelineruns/%{run_id}/cancel" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('isRecursive', 'query', 'is_recursive', 'is_recursive'),
...
def task
  ...
  params = STDIN.read
  result = pipeline_runs_cancel(params)
