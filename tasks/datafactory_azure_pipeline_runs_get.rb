...
def pipeline_runs_get(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}/pipelineruns/%{run_id}" % path_params
...
def task
  ...
  params = STDIN.read
  result = pipeline_runs_get(params)
