...
def pipelines_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}/pipelines/%{pipeline_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('pipeline', 'body', 'pipeline', 'pipeline'),
...
def task
  ...
  params = STDIN.read
  result = pipelines_create_or_update(params)
