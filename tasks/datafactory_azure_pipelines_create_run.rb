...
def pipelines_create_run(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}/pipelines/%{pipeline_name}/createRun" % path_params
...
def task
  ...
  params = STDIN.read
  result = pipelines_create_run(params)
