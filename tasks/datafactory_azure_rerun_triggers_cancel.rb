...
def rerun_triggers_cancel(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}/triggers/%{trigger_name}/rerunTriggers/%{rerun_trigger_name}/cancel" % path_params
...
def task
  ...
  params = STDIN.read
  result = rerun_triggers_cancel(params)
