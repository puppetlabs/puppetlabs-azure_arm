...
def rerun_triggers_start(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}/triggers/%{trigger_name}/rerunTriggers/%{rerun_trigger_name}/start" % path_params
...
def task
  ...
  params = STDIN.read
  result = rerun_triggers_start(params)
