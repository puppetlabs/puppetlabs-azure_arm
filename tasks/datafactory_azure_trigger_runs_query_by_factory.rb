...
def trigger_runs_query_by_factory(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}/queryTriggerRuns" % path_params
...
def task
  ...
  params = STDIN.read
  result = trigger_runs_query_by_factory(params)
