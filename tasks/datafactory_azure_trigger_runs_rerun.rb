...
def trigger_runs_rerun(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}/triggers/%{trigger_name}/triggerRuns/%{run_id}/rerun" % path_params
...
def task
  ...
  params = STDIN.read
  result = trigger_runs_rerun(params)
