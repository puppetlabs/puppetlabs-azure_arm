...
def triggers_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}/triggers/%{trigger_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('trigger', 'body', 'trigger', 'trigger'),
...
def task
  ...
  params = STDIN.read
  result = triggers_create_or_update(params)
