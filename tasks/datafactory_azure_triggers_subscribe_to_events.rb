...
def triggers_subscribe_to_events(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataFactory/factories/%{factory_name}/triggers/%{trigger_name}/subscribeToEvents" % path_params
...
def task
  ...
  params = STDIN.read
  result = triggers_subscribe_to_events(params)
