...
def ddos_custom_policies_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/ddosCustomPolicies/%{ddos_custom_policy_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('ddosCustomPolicyName', 'path', 'ddos_custom_policy_name', 'ddos_custom_policy_name'),
...
def task
  ...
  params = STDIN.read
  result = ddos_custom_policies_create_or_update(params)
