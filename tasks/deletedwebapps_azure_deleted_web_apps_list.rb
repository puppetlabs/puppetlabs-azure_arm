...
def deleted_web_apps_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Web/deletedSites" % path_params
...
def task
  ...
  params = STDIN.read
  result = deleted_web_apps_list(params)
