...
def extensions_list_by_database(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Sql/servers/%{server_name}/databases/%{database_name}/extensions" % path_params
...
def task
  ...
  params = STDIN.read
  result = extensions_list_by_database(params)
