...
def controllers_create(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DevSpaces/controllers/%{name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('controller', 'body', 'controller', 'controller'),
...
def task
  ...
  params = STDIN.read
  result = controllers_create(params)
