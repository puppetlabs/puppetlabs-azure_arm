...
def diagnostics_get_site_analysis(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{site_name}/diagnostics/%{diagnostic_category}/analyses/%{analysis_name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = diagnostics_get_site_analysis(params)
