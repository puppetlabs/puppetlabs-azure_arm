...
def disks_grant_access(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/disks/%{disk_name}/beginGetAccess" % path_params
...
def task
  ...
  params = STDIN.read
  result = disks_grant_access(params)
