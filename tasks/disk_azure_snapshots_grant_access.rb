...
def snapshots_grant_access(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/snapshots/%{snapshot_name}/beginGetAccess" % path_params
...
def task
  ...
  params = STDIN.read
  result = snapshots_grant_access(params)
