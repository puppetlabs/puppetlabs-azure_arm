...
def dns_resource_reference_get_by_target_resources(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Network/getDnsResourceReference" % path_params
...
def task
  ...
  params = STDIN.read
  result = dns_resource_reference_get_by_target_resources(params)
