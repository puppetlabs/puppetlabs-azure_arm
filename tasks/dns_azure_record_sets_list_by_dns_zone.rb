...
def record_sets_list_by_dns_zone(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/dnsZones/%{zone_name}/recordsets" % path_params
...
def task
  ...
  params = STDIN.read
  result = record_sets_list_by_dns_zone(params)
