...
def domains_check_availability(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.DomainRegistration/checkDomainAvailability" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('available', 'body', 'available', 'available'),
      op_param('domaintype', 'body', 'domain_type', 'domaintype'),
      op_param('identifier', 'body', 'identifier', 'identifier'),
...
def task
  ...
  params = STDIN.read
  result = domains_check_availability(params)
