...
def domain_service_operations_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.AAD/operations" % path_params
...
def task
  ...
  params = STDIN.read
  result = domain_service_operations_list(params)
