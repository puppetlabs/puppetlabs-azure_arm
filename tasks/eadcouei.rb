...
def devices_create_or_update_extended_info(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/%{device_name}/getExtendedInformation" % path_params
...
def task
  ...
  params = STDIN.read
  result = devices_create_or_update_extended_info(params)
