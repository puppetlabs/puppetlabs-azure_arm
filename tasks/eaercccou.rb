...
def express_route_cross_connections_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/expressRouteCrossConnections/%{cross_connection_name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = express_route_cross_connections_create_or_update(params)
