...
def express_route_service_providers_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Network/expressRouteServiceProviders" % path_params
...
def task
  ...
  params = STDIN.read
  result = express_route_service_providers_list(params)
