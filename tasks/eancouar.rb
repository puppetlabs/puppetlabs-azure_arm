...
def namespaces_create_or_update_authorization_rule(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.EventHub/namespaces/%{namespace_name}/AuthorizationRules/%{authorization_rule_name}" % path_params
