...
def devices_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/%{device_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('DataBoxEdgeDevice', 'body', 'data_box_edge_device', 'data_box_edge_device'),
...
def task
  ...
  params = STDIN.read
  result = devices_create_or_update(params)
