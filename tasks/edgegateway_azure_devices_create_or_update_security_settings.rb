...
def devices_create_or_update_security_settings(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/%{device_name}/securitySettings/default/update" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('securitySettings', 'body', 'security_settings', 'security_settings'),
...
def task
  ...
  params = STDIN.read
  result = devices_create_or_update_security_settings(params)
