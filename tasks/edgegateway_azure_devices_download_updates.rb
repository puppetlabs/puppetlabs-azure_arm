...
def devices_download_updates(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/%{device_name}/downloadUpdates" % path_params
...
def task
  ...
  params = STDIN.read
  result = devices_download_updates(params)
