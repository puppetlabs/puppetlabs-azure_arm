...
def devices_get_network_settings(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/%{device_name}/networkSettings/default" % path_params
...
def task
  ...
  params = STDIN.read
  result = devices_get_network_settings(params)
