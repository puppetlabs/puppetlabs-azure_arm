...
def devices_install_updates(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/%{device_name}/installUpdates" % path_params
...
def task
  ...
  params = STDIN.read
  result = devices_install_updates(params)
