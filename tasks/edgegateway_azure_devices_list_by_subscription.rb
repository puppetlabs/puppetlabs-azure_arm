...
def devices_list_by_subscription(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices" % path_params
...
def task
  ...
  params = STDIN.read
  result = devices_list_by_subscription(params)
