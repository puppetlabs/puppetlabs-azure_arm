...
def operations_status_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/%{device_name}/operationsStatus/%{name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = operations_status_get(params)
