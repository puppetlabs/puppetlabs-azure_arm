...
def orders_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/%{device_name}/orders/default" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('order', 'body', 'order', 'order'),
...
def task
  ...
  params = STDIN.read
  result = orders_create_or_update(params)
