...
def storage_account_credentials_create_or_update(*args)
  header_params = {}
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('storageAccountCredential', 'body', 'storage_account_credential', 'storage_account_credential'),
...
def task
  ...
  params = STDIN.read
  result = storage_account_credentials_create_or_update(params)
