...
def entities_search(*args)
  ...
  uri_string = "https://api.cognitive.microsoft.com//entities" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('contractualrules', 'body', 'contractual_rules', 'contractualrules'),
