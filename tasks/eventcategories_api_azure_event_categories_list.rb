...
def event_categories_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/microsoft.insights/eventcategories" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('localizedvalue', 'body', 'localized_value', 'localizedvalue'),
...
def task
  ...
  params = STDIN.read
  result = event_categories_list(params)
