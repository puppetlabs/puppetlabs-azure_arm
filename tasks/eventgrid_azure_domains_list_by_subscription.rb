...
def domains_list_by_subscription(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.EventGrid/domains" % path_params
...
def task
  ...
  params = STDIN.read
  result = domains_list_by_subscription(params)
