...
def domains_list_shared_access_keys(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.EventGrid/domains/%{domain_name}/listKeys" % path_params
...
def task
  ...
  params = STDIN.read
  result = domains_list_shared_access_keys(params)
