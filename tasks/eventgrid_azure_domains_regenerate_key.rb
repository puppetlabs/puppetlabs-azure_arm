...
def domains_regenerate_key(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.EventGrid/domains/%{domain_name}/regenerateKey" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('domainName', 'path', 'domain_name', 'domain_name'),
...
def task
  ...
  params = STDIN.read
  result = domains_regenerate_key(params)
