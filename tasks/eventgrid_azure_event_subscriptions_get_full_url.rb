...
def event_subscriptions_get_full_url(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//%{scope}/providers/Microsoft.EventGrid/eventSubscriptions/%{event_subscription_name}/getFullUrl" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('eventSubscriptionName', 'path', 'event_subscription_name', 'event_subscription_name'),
...
def task
  ...
  params = STDIN.read
  result = event_subscriptions_get_full_url(params)
