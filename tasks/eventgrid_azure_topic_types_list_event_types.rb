...
def topic_types_list_event_types(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.EventGrid/topicTypes/%{topic_type_name}/eventTypes" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('topicTypeName', 'path', 'topic_type_name', 'topic_type_name'),
...
def task
  ...
  params = STDIN.read
  result = topic_types_list_event_types(params)
