...
def topics_list_event_types(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/%{provider_namespace}/%{resource_type_name}/%{resource_name}/providers/Microsoft.EventGrid/eventTypes" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('providerNamespace', 'path', 'provider_namespace', 'provider_namespace'),
      ...
      op_param('resourceTypeName', 'path', 'resource_type_name', 'resource_type_name'),
...
def task
  ...
  params = STDIN.read
  result = topics_list_event_types(params)
