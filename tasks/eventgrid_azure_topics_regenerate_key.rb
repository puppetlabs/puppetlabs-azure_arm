...
def topics_regenerate_key(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.EventGrid/topics/%{topic_name}/regenerateKey" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('regenerateKeyRequest', 'body', 'regenerate_key_request', 'regenerate_key_request'),
...
def task
  ...
  params = STDIN.read
  result = topics_regenerate_key(params)
