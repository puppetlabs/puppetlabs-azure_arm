...
def consumer_groups_create_or_update(*args)
  header_params = {}
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('consumerGroupName', 'path', 'consumer_group_name', 'consumer_group_name'),
...
def task
  ...
  params = STDIN.read
  result = consumer_groups_create_or_update(params)
