...
def namespaces_get_network_rule_set(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.EventHub/namespaces/%{namespace_name}/networkRuleSets/default" % path_params
...
def task
  ...
  params = STDIN.read
  result = namespaces_get_network_rule_set(params)
