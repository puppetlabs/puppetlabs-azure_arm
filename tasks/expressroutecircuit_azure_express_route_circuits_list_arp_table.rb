...
def express_route_circuits_list_arp_table(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/expressRouteCircuits/%{circuit_name}/peerings/%{peering_name}/arpTables/%{device_path}" % path_params
...
def task
  ...
  params = STDIN.read
  result = express_route_circuits_list_arp_table(params)
