...
def express_route_circuits_list_routes_table_summary(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/expressRouteCircuits/%{circuit_name}/peerings/%{peering_name}/routeTablesSummary/%{device_path}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('circuitName', 'path', 'circuit_name', 'circuit_name'),
...
def task
  ...
  params = STDIN.read
  result = express_route_circuits_list_routes_table_summary(params)
