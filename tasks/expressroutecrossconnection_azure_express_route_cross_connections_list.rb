...
def express_route_cross_connections_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Network/expressRouteCrossConnections" % path_params
...
def task
  ...
  params = STDIN.read
  result = express_route_cross_connections_list(params)
