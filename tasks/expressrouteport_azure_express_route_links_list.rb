...
def express_route_links_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/ExpressRoutePorts/%{express_route_port_name}/links" % path_params
...
def task
  ...
  params = STDIN.read
  result = express_route_links_list(params)
