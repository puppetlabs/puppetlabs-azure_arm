...
def express_route_ports_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Network/ExpressRoutePorts" % path_params
...
def task
  ...
  params = STDIN.read
  result = express_route_ports_list(params)
