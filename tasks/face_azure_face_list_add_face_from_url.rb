...
def face_list_add_face_from_url(*args)
  header_params = {}
  ...
  uri_string = "https:////facelists/%{face_list_id}/persistedfaces" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('faceListId', 'path', 'face_list_id', 'face_list_id'),
...
def task
  ...
  params = STDIN.read
  result = face_list_add_face_from_url(params)
