...
def face_list_create(*args)
  ...
  uri_string = "https:////facelists/%{face_list_id}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('recognitionmodel', 'body', 'recognition_model', 'recognitionmodel'),
...
def task
  ...
  params = STDIN.read
  result = face_list_create(params)
