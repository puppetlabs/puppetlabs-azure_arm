...
def large_face_list_get_face(*args)
  header_params = {}
  ...
  uri_string = "https:////largefacelists/%{large_face_list_id}/persistedfaces/%{persisted_face_id}" % path_params
...
def task
  ...
  params = STDIN.read
  result = large_face_list_get_face(params)
