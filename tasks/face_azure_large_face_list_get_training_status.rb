...
def large_face_list_get_training_status(*args)
  header_params = {}
  ...
  uri_string = "https:////largefacelists/%{large_face_list_id}/training" % path_params
...
def task
  ...
  params = STDIN.read
  result = large_face_list_get_training_status(params)
