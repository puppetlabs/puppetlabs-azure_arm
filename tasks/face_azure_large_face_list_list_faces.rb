...
def large_face_list_list_faces(*args)
  header_params = {}
  ...
  uri_string = "https:////largefacelists/%{large_face_list_id}/persistedfaces" % path_params
...
def task
  ...
  params = STDIN.read
  result = large_face_list_list_faces(params)
