...
def large_person_group_create(*args)
  header_params = {}
  ...
  uri_string = "https:////largepersongroups/%{large_person_group_id}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('recognitionmodel', 'body', 'recognitionmodel', 'recognitionmodel'),
...
def task
  ...
  params = STDIN.read
  result = large_person_group_create(params)
