...
def large_person_group_person_add_face_from_url(*args)
  header_params = {}
  ...
  uri_string = "https:////largepersongroups/%{large_person_group_id}/persons/%{person_id}/persistedfaces" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('persistedfaceid', 'body', 'persistedfaceid', 'persistedfaceid'),
      op_param('personId', 'path', 'person_id', 'person_id'),
...
def task
  ...
  params = STDIN.read
  result = large_person_group_person_add_face_from_url(params)
