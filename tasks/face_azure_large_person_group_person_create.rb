...
def large_person_group_person_create(*args)
  header_params = {}
  ...
  uri_string = "https:////largepersongroups/%{large_person_group_id}/persons" % path_params
...
def task
  ...
  params = STDIN.read
  result = large_person_group_person_create(params)
