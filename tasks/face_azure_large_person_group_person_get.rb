...
def large_person_group_person_get(*args)
  header_params = {}
  ...
  uri_string = "https:////largepersongroups/%{large_person_group_id}/persons/%{person_id}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('largePersonGroupId', 'path', 'large_person_group_id', 'large_person_group_id'),
      op_param('name', 'body', 'name', 'name'),
      op_param('persistedfaceids', 'body', 'persistedfaceids', 'persistedfaceids'),
      op_param('person_id', 'path', 'person_id', 'person_id'),
      op_param('personid', 'body', 'personid', 'personid'),
      op_param('userdata', 'body', 'userdata', 'userdata'),
    ]
  op_params.each do |i|
    location = i[:location]
    name     = i[:name]
...
def task
  ...
  params = STDIN.read
  result = large_person_group_person_get(params)
