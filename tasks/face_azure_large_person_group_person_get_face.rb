...
def large_person_group_person_get_face(*args)
  header_params = {}
  ...
  uri_string = "https:////largepersongroups/%{large_person_group_id}/persons/%{person_id}/persistedfaces/%{persisted_face_id}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('persistedFaceId', 'path', 'persisted_face_id', 'persisted_face_id'),
...
def task
  ...
  params = STDIN.read
  result = large_person_group_person_get_face(params)
