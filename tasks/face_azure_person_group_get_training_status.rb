...
def person_group_get_training_status(*args)
  header_params = {}
  ...
  uri_string = "https:////persongroups/%{person_group_id}/training" % path_params
...
def task
  ...
  params = STDIN.read
  result = person_group_get_training_status(params)
