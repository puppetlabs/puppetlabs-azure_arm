...
def person_group_person_add_face_from_url(*args)
  header_params = {}
  ...
  uri_string = "https:////persongroups/%{person_group_id}/persons/%{person_id}/persistedfaces" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('personGroupId', 'path', 'person_group_id', 'person_group_id'),
...
def task
  ...
  params = STDIN.read
  result = person_group_person_add_face_from_url(params)
