...
def person_group_person_get(*args)
  header_params = {}
  ...
  uri_string = "https:////persongroups/%{person_group_id}/persons/%{person_id}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('persistedfaceids', 'body', 'persisted_face_ids', 'persistedfaceids'),
...
def task
  ...
  params = STDIN.read
  result = person_group_person_get(params)
