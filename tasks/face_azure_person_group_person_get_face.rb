...
def person_group_person_get_face(*args)
  header_params = {}
  ...
  uri_string = "https:////persongroups/%{person_group_id}/persons/%{person_id}/persistedfaces/%{persisted_face_id}" % path_params
...
def task
  ...
  params = STDIN.read
  result = person_group_person_get_face(params)
