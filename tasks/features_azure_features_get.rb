...
def features_get(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Features/providers/%{resource_provider_namespace}/features/%{feature_name}" % path_params
