...
def features_list_all(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Features/features" % path_params
...
def task
  ...
  params = STDIN.read
  result = features_list_all(params)
