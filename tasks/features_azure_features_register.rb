...
def features_register(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Features/providers/%{resource_provider_namespace}/features/%{feature_name}/register" % path_params
...
def task
  ...
  params = STDIN.read
  result = features_register(params)
