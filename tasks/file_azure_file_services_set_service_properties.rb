...
def file_services_set_service_properties(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Storage/storageAccounts/%{account_name}/fileServices/%{_file_services_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('_file_services_name', 'path', '_file_services_name', '_file_services_name'),
      op_param('accountName', 'path', 'account_name', 'account_name'),
      op_param('api-version', 'query', 'api_version', 'api_version'),
      op_param('FileServicesName', 'path', 'file_services_name', 'file_services_name'),
...
def task
  ...
  params = STDIN.read
  result = file_services_set_service_properties(params)
