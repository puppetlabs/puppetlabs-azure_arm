...
def file_shares_create(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Storage/storageAccounts/%{account_name}/fileServices/default/shares/%{share_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('fileShare', 'body', 'file_share', 'file_share'),
      op_param('resourceGroupName', 'path', 'resource_group_name', 'resource_group_name'),
      op_param('shareName', 'path', 'share_name', 'share_name'),
...
def task
  ...
  params = STDIN.read
  result = file_shares_create(params)
