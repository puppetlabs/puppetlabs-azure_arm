...
def file_system_check_access(*args)
  header_params = {}
  ...
  uri_string = "https:////webhdfs/v1/%{path}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('fsaction', 'query', 'fsaction', 'fsaction'),
...
def authenticate
  ...
  params = STDIN.read
  result = FileSystem_CheckAccess(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = file_system_check_access(params)
