...
def firewall_policies_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/firewallPolicies" % path_params
...
def task
  ...
  params = STDIN.read
  result = firewall_policies_list(params)
