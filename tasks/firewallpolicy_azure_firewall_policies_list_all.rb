...
def firewall_policies_list_all(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Network/firewallPolicies" % path_params
...
def task
  ...
  params = STDIN.read
  result = firewall_policies_list_all(params)
