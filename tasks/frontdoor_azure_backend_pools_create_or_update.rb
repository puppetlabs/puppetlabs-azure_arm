...
def backend_pools_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/frontDoors/%{front_door_name}/backendPools/%{backend_pool_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('backendPoolName', 'path', 'backend_pool_name', 'backend_pool_name'),
      op_param('backendPoolParameters', 'body', 'backend_pool_parameters', 'backend_pool_parameters'),
...
def task
  ...
  params = STDIN.read
  result = backend_pools_create_or_update(params)
