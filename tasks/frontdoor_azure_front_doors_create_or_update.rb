...
def front_doors_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/frontDoors/%{front_door_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('frontDoorParameters', 'body', 'front_door_parameters', 'front_door_parameters'),
...
def task
  ...
  params = STDIN.read
  result = front_doors_create_or_update(params)
