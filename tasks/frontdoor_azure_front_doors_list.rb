...
def front_doors_list(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Network/frontDoors" % path_params
...
def task
  ...
  params = STDIN.read
  result = front_doors_list(params)
