...
def frontend_endpoints_delete(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/frontDoors/%{front_door_name}/frontendEndpoints/%{frontend_endpoint_name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = frontend_endpoints_delete(params)
