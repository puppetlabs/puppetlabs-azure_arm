...
def frontend_endpoints_enable_https(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/frontDoors/%{front_door_name}/frontendEndpoints/%{frontend_endpoint_name}/enableHttps" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('customHttpsConfiguration', 'body', 'custom_https_configuration', 'custom_https_configuration'),
      op_param('frontDoorName', 'path', 'front_door_name', 'front_door_name'),
      op_param('frontendEndpointName', 'path', 'frontend_endpoint_name', 'frontend_endpoint_name'),
...
def task
  ...
  params = STDIN.read
  result = frontend_endpoints_enable_https(params)
