...
def health_probe_settings_delete(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/frontDoors/%{front_door_name}/healthProbeSettings/%{health_probe_settings_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('healthProbeSettingsName', 'path', 'health_probe_settings_name', 'health_probe_settings_name'),
...
def task
  ...
  params = STDIN.read
  result = health_probe_settings_delete(params)
