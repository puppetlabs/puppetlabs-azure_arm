...
def load_balancing_settings_delete(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/frontDoors/%{front_door_name}/loadBalancingSettings/%{load_balancing_settings_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('loadBalancingSettingsName', 'path', 'load_balancing_settings_name', 'load_balancing_settings_name'),
...
def task
  ...
  params = STDIN.read
  result = load_balancing_settings_delete(params)
