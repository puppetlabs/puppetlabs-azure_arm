...
def routing_rules_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/frontDoors/%{front_door_name}/routingRules/%{routing_rule_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('routingRuleName', 'path', 'routing_rule_name', 'routing_rule_name'),
      op_param('routingRuleParameters', 'body', 'routing_rule_parameters', 'routing_rule_parameters'),
...
def task
  ...
  params = STDIN.read
  result = routing_rules_create_or_update(params)
