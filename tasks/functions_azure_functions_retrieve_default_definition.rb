...
def functions_retrieve_default_definition(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/Microsoft.StreamAnalytics/streamingjobs/%{job_name}/functions/%{function_name}/RetrieveDefaultDefinition" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('bindingtype', 'body', 'binding_type', 'bindingtype'),
      op_param('functionName', 'path', 'function_name', 'function_name'),
      op_param('functionRetrieveDefaultDefinitionParameters', 'body', 'function_retrieve_default_definition_parameters', 'function_retrieve_default_definition_parameters'),
...
def task
  ...
  params = STDIN.read
  result = functions_retrieve_default_definition(params)
