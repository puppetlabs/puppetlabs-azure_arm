...
def galleries_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/galleries/%{gallery_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('gallery', 'body', 'gallery', 'gallery'),
...
def task
  ...
  params = STDIN.read
  result = galleries_create_or_update(params)
