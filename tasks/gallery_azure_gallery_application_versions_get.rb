...
def gallery_application_versions_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/galleries/%{gallery_name}/applications/%{gallery_application_name}/versions/%{gallery_application_version_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('galleryApplicationName', 'path', 'gallery_application_name', 'gallery_application_name'),
      op_param('galleryApplicationVersionName', 'path', 'gallery_application_version_name', 'gallery_application_version_name'),
...
def task
  ...
  params = STDIN.read
  result = gallery_application_versions_get(params)
