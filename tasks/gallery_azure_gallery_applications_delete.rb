...
def gallery_applications_delete(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/galleries/%{gallery_name}/applications/%{gallery_application_name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = gallery_applications_delete(params)
