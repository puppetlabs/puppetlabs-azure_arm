...
def gallery_image_versions_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/galleries/%{gallery_name}/images/%{gallery_image_name}/versions/%{gallery_image_version_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('galleryImageName', 'path', 'gallery_image_name', 'gallery_image_name'),
      op_param('galleryImageVersion', 'body', 'gallery_image_version', 'gallery_image_version'),
      op_param('galleryImageVersionName', 'path', 'gallery_image_version_name', 'gallery_image_version_name'),
      op_param('galleryName', 'path', 'gallery_name', 'gallery_name'),
...
def task
  ...
  params = STDIN.read
  result = gallery_image_versions_create_or_update(params)
