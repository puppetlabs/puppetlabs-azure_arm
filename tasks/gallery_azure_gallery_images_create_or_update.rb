...
def gallery_images_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/galleries/%{gallery_name}/images/%{gallery_image_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('galleryImage', 'body', 'gallery_image', 'gallery_image'),
...
def task
  ...
  params = STDIN.read
  result = gallery_images_create_or_update(params)
