...
def applications_add_owner(*args)
  header_params = {}
  ...
  uri_string = "https://graph.windows.net//%{tenant_id}/applications/%{application_object_id}/$links/owners" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('applicationObjectId', 'path', 'application_object_id', 'application_object_id'),
...
def task
  ...
  params = STDIN.read
  result = applications_add_owner(params)
