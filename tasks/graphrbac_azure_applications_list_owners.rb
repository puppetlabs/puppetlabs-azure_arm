...
def applications_list_owners(*args)
  header_params = {}
  ...
  uri_string = "https://graph.windows.net//%{tenant_id}/applications/%{application_object_id}/owners" % path_params
...
def task
  ...
  params = STDIN.read
  result = applications_list_owners(params)
