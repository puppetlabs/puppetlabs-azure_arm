...
def deleted_applications_restore(*args)
  header_params = {}
  ...
  uri_string = "https://graph.windows.net//%{tenant_id}/deletedApplications/%{object_id}/restore" % path_params
...
def task
  ...
  params = STDIN.read
  result = deleted_applications_restore(params)
