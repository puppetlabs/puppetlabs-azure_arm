...
def domains_get(*args)
  ...
  uri_string = "https://graph.windows.net//%{tenant_id}/domains/%{domain_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('domainName', 'path', 'name', 'domain_name'),
      op_param('isdefault', 'body', 'is_default', 'isdefault'),
      op_param('isverified', 'body', 'is_verified', 'isverified'),
