...
def groups_add_member(*args)
  ...
  uri_string = "https://graph.windows.net//%{tenant_id}/groups/%{group_object_id}/$links/members" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('groupObjectId', 'path', 'group_object_id', 'group_object_id'),
...
def task
  ...
  params = STDIN.read
  result = groups_add_member(params)
