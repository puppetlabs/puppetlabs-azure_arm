...
def groups_get(*args)
  ...
  uri_string = "https://graph.windows.net//%{tenant_id}/groups/%{object_id}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('deletiontimestamp', 'body', 'deletion_timestamp', 'deletiontimestamp'),
      op_param('displayname', 'body', 'display_name', 'displayname'),
      op_param('mail', 'body', 'mail', 'mail'),
      op_param('mailenabled', 'body', 'mail_enabled', 'mailenabled'),
      op_param('mailnickname', 'body', 'mail_nickname', 'mailnickname'),
      op_param('object_id', 'path', 'object_id', 'object_id'),
      op_param('objectid', 'body', 'object_id', 'objectid'),
      op_param('objecttype', 'body', 'object_type', 'objecttype'),
      op_param('securityenabled', 'body', 'security_enabled', 'securityenabled'),
