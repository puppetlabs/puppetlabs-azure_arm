...
def groups_get_group_members(*args)
  header_params = {}
  ...
  uri_string = "https://graph.windows.net//%{tenant_id}/groups/%{object_id}/members" % path_params
...
def task
  ...
  params = STDIN.read
  result = groups_get_group_members(params)
