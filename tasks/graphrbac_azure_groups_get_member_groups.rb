...
def groups_get_member_groups(*args)
  header_params = {}
  ...
  uri_string = "https://graph.windows.net//%{tenant_id}/groups/%{object_id}/getMemberGroups" % path_params
...
def task
  ...
  params = STDIN.read
  result = groups_get_member_groups(params)
