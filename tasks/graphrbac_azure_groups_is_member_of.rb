...
def groups_is_member_of(*args)
  ...
  uri_string = "https://graph.windows.net//%{tenant_id}/isMemberOf" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('groupid', 'body', 'group_id', 'groupid'),
      op_param('memberid', 'body', 'member_id', 'memberid'),
...
def task
  ...
  params = STDIN.read
  result = groups_is_member_of(params)
