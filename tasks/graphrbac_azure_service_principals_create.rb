...
def service_principals_create(*args)
  header_params = {}
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('appid', 'body', 'app_id', 'appid'),
      op_param('approleassignmentrequired', 'body', 'app_role_assignment_required', 'approleassignmentrequired'),
      ...
      op_param('publishername', 'body', 'publisher_name', 'publishername'),
      op_param('replyurls', 'body', 'reply_urls', 'replyurls'),
      op_param('samlmetadataurl', 'body', 'saml_metadata_url', 'samlmetadataurl'),
      op_param('serviceprincipalnames', 'body', 'service_principal_names', 'serviceprincipalnames'),
...
def task
  ...
  params = STDIN.read
  result = service_principals_create(params)
