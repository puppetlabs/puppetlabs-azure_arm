...
def service_principals_list_owners(*args)
  header_params = {}
  ...
  uri_string = "https://graph.windows.net//%{tenant_id}/servicePrincipals/%{object_id}/owners" % path_params
...
def task
  ...
  params = STDIN.read
  result = service_principals_list_owners(params)
