...
def users_get_member_groups(*args)
  header_params = {}
  ...
  uri_string = "https://graph.windows.net//%{tenant_id}/users/%{object_id}/getMemberGroups" % path_params
...
def task
  ...
  params = STDIN.read
  result = users_get_member_groups(params)
