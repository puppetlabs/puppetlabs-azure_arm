...
def operation_results_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.HealthcareApis/locations/%{location_name}/operationresults/%{operation_result_id}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('operationResultId', 'path', 'operation_result_id', 'operation_result_id'),
...
def task
  ...
  params = STDIN.read
  result = operation_results_get(params)
