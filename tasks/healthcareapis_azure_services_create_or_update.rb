...
def services_create_or_update(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.HealthcareApis/services/%{resource_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('serviceDescription', 'body', 'service_description', 'service_description'),
