...
def data_managers_list(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.HybridData/dataManagers" % path_params
...
def task
  ...
  params = STDIN.read
  result = data_managers_list(params)
