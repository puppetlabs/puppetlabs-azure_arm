...
def data_services_get(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.HybridData/dataManagers/%{data_manager_name}/dataServices/%{data_service_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('dataServiceName', 'path', 'name', 'data_service_name'),
...
def task
  ...
  params = STDIN.read
  result = data_services_get(params)
