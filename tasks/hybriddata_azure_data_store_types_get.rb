...
def data_store_types_get(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.HybridData/dataManagers/%{data_manager_name}/dataStoreTypes/%{data_store_type_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('dataStoreTypeName', 'path', 'name', 'data_store_type_name'),
...
def task
  ...
  params = STDIN.read
  result = data_store_types_get(params)
