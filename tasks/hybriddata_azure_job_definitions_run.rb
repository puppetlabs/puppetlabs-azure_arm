...
def job_definitions_run(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.HybridData/dataManagers/%{data_manager_name}/dataServices/%{data_service_name}/jobDefinitions/%{job_definition_name}/run" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('customersecrets', 'body', 'customer_secrets', 'customersecrets'),
      op_param('dataManagerName', 'path', 'data_manager_name', 'data_manager_name'),
      op_param('dataserviceinput', 'body', 'data_service_input', 'dataserviceinput'),
      op_param('dataServiceName', 'path', 'data_service_name', 'data_service_name'),
      op_param('jobDefinitionName', 'path', 'job_definition_name', 'job_definition_name'),
      op_param('resourceGroupName', 'path', 'resource_group_name', 'resource_group_name'),
      op_param('runParameters', 'body', 'run_parameters', 'run_parameters'),
      op_param('subscriptionId', 'path', 'subscription_id', 'subscription_id'),
      op_param('userconfirmation', 'body', 'user_confirmation', 'userconfirmation'),
    ]
  op_params.each do |i|
    location = i[:location]
    name     = i[:name]
...
def task
  ...
  params = STDIN.read
  result = job_definitions_run(params)
