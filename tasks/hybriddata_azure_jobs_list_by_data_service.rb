...
def jobs_list_by_data_service(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.HybridData/dataManagers/%{data_manager_name}/dataServices/%{data_service_name}/jobs" % path_params
...
def task
  ...
  params = STDIN.read
  result = jobs_list_by_data_service(params)
