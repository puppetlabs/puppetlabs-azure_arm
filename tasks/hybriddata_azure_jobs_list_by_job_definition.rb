...
def jobs_list_by_job_definition(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.HybridData/dataManagers/%{data_manager_name}/dataServices/%{data_service_name}/jobDefinitions/%{job_definition_name}/jobs" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('endtime', 'body', 'endtime', 'endtime'),
      ...
      op_param('starttime', 'body', 'starttime', 'starttime'),
...
def task
  ...
  params = STDIN.read
  result = jobs_list_by_job_definition(params)
