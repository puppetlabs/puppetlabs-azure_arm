...
def public_keys_get(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.HybridData/dataManagers/%{data_manager_name}/publicKeys/%{public_key_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('publicKeyName', 'path', 'name', 'public_key_name'),
