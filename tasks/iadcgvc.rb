...
def dps_certificate_generate_verification_code(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Devices/provisioningServices/%{provisioning_service_name}/certificates/%{certificate_name}/generateVerificationCode" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('certificate.lastUpdated', 'query', 'certificate.last_updated', 'certificate.last_updated'),
      op_param('certificate.name', 'query', 'certificate.name', 'certificate.name'),
      op_param('certificate.nonce', 'query', 'certificate.nonce', 'certificate.nonce'),
...
def task
  ...
  params = STDIN.read
  result = dps_certificate_generate_verification_code(params)
