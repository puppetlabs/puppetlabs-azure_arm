...
def iot_dps_resource_check_provisioning_service_name_availability(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Devices/checkProvisioningServiceNameAvailability" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('arguments', 'body', 'arguments', 'arguments'),
...
def task
  ...
  params = STDIN.read
  result = iot_dps_resource_check_provisioning_service_name_availability(params)
