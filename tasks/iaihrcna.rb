...
def iot_hub_resource_check_name_availability(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Devices/checkNameAvailability" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('operationInputs', 'body', 'operation_inputs', 'operation_inputs'),
...
def task
  ...
  params = STDIN.read
  result = iot_hub_resource_check_name_availability(params)
