...
def resource_provider_common_get_subscription_quota(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Devices/usages" % path_params
...
def task
  ...
  params = STDIN.read
  result = resource_provider_common_get_subscription_quota(params)
