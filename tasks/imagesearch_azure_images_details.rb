...
def images_details(*args)
  ...
  uri_string = "https://api.cognitive.microsoft.com//images/details" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('cab', 'query', 'cab', 'cab'),
      op_param('cal', 'query', 'cal', 'cal'),
      op_param('car', 'query', 'car', 'car'),
      op_param('cat', 'query', 'cat', 'cat'),
      op_param('cc', 'query', 'cc', 'cc'),
      op_param('Content-Type', 'header', 'content_type', 'content_type'),
      op_param('ct', 'query', 'ct', 'ct'),
      op_param('errors', 'body', 'errors', 'errors'),
      op_param('id', 'body', 'id', 'id'),
      op_param('imgUrl', 'query', 'img_url', 'img_url'),
      op_param('insightsToken', 'query', 'insights_token', 'insights_token'),
      op_param('mkt', 'query', 'mkt', 'mkt'),
      op_param('modules', 'query', 'modules', 'modules'),
