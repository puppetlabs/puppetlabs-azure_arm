...
def gallery_application_get(*args)
  header_params = {}
  ...
  uri_string = "https://169.254.169.254//applications/app" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('incarnationId', 'query', 'incarnation_id', 'incarnation_id'),
...
def authenticate
  ...
  params = STDIN.read
  result = GalleryApplication_Get(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = gallery_application_get(params)
