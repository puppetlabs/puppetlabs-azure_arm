...
def identity_get_info(*args)
  ...
  uri_string = "https://169.254.169.254//identity/info" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('error_description', 'body', 'error_description', 'error_description'),
...
def authenticate
  ...
  params = STDIN.read
  result = Identity_GetInfo(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = identity_get_info(params)
