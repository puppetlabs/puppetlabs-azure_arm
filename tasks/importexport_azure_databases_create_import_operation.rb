...
def databases_create_import_operation(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Sql/servers/%{server_name}/databases/%{database_name}/extensions/%{extension_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('extensionName', 'path', 'extension_name', 'extension_name'),
...
def task
  ...
  params = STDIN.read
  result = databases_create_import_operation(params)
