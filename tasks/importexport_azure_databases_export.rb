...
def databases_export(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Sql/servers/%{server_name}/databases/%{database_name}/export" % path_params
...
def task
  ...
  params = STDIN.read
  result = databases_export(params)
