...
def databases_import(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Sql/servers/%{server_name}/import" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('edition', 'body', 'edition', 'edition'),
      op_param('maxsizebytes', 'body', 'max_size_bytes', 'maxsizebytes'),
      ...
      op_param('serviceobjectivename', 'body', 'service_objective_name', 'serviceobjectivename'),
...
def task
  ...
  params = STDIN.read
  result = databases_import(params)
