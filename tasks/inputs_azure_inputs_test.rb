...
def inputs_test(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/Microsoft.StreamAnalytics/streamingjobs/%{job_name}/inputs/%{input_name}/test" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('inputName', 'path', 'input_name', 'input_name'),
