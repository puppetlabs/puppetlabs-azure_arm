...
def apps_check_subdomain_availability(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.IoTCentral/checkSubdomainAvailability" % path_params
...
def task
  ...
  params = STDIN.read
  result = apps_check_subdomain_availability(params)
