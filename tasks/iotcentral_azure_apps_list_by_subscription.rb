...
def apps_list_by_subscription(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.IoTCentral/IoTApps" % path_params
...
def task
  ...
  params = STDIN.read
  result = apps_list_by_subscription(params)
