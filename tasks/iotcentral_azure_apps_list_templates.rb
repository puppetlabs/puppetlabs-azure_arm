...
def apps_list_templates(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.IoTCentral/appTemplates" % path_params
...
def task
  ...
  params = STDIN.read
  result = apps_list_templates(params)
