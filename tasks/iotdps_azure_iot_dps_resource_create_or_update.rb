...
def iot_dps_resource_create_or_update(*args)
  header_params = {}
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('iotDpsDescription', 'body', 'iot_dps_description', 'iot_dps_description'),
...
def task
  ...
  params = STDIN.read
  result = iot_dps_resource_create_or_update(params)
