...
def iot_dps_resource_list_keys(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Devices/provisioningServices/%{provisioning_service_name}/listkeys" % path_params
...
def task
  ...
  params = STDIN.read
  result = iot_dps_resource_list_keys(params)
