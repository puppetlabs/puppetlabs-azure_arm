...
def iot_dps_resource_list_keys_for_key_name(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Devices/provisioningServices/%{provisioning_service_name}/keys/%{key_name}/listkeys" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('keyName', 'path', 'key_name', 'key_name'),
...
def task
  ...
  params = STDIN.read
  result = iot_dps_resource_list_keys_for_key_name(params)
