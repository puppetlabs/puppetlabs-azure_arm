...
def certificates_create_or_update(*args)
  header_params = {}
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('certificateDescription', 'body', 'certificate_description', 'certificate_description'),
...
def task
  ...
  params = STDIN.read
  result = certificates_create_or_update(params)
