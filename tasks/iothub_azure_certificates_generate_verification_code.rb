...
def certificates_generate_verification_code(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Devices/IotHubs/%{resource_name}/certificates/%{certificate_name}/generateVerificationCode" % path_params
...
def task
  ...
  params = STDIN.read
  result = certificates_generate_verification_code(params)
