...
def certificates_verify(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Devices/IotHubs/%{resource_name}/certificates/%{certificate_name}/verify" % path_params
...
def task
  ...
  params = STDIN.read
  result = certificates_verify(params)
