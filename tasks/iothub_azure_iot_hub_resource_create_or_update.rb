...
def iot_hub_resource_create_or_update(*args)
  header_params = {}
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('iotHubDescription', 'body', 'iot_hub_description', 'iot_hub_description'),
...
def task
  ...
  params = STDIN.read
  result = iot_hub_resource_create_or_update(params)
