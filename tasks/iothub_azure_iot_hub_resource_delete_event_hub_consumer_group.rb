...
def iot_hub_resource_delete_event_hub_consumer_group(*args)
  header_params = {}
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('eventHubEndpointName', 'path', 'event_hub_endpoint_name', 'event_hub_endpoint_name'),
...
def task
  ...
  params = STDIN.read
  result = iot_hub_resource_delete_event_hub_consumer_group(params)
