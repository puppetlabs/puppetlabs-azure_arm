...
def iot_hub_resource_get_job(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Devices/IotHubs/%{resource_name}/jobs/%{job_id}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('jobId', 'path', 'job_id', 'job_id'),
...
def task
  ...
  params = STDIN.read
  result = iot_hub_resource_get_job(params)
