...
def iot_hub_resource_get_stats(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Devices/IotHubs/%{resource_name}/IotHubStats" % path_params
...
def task
  ...
  params = STDIN.read
  result = iot_hub_resource_get_stats(params)
