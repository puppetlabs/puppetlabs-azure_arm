...
def iot_hub_resource_import_devices(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Devices/IotHubs/%{resource_name}/importDevices" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('importDevicesParameters', 'body', 'import_devices_parameters', 'import_devices_parameters'),
...
def task
  ...
  params = STDIN.read
  result = iot_hub_resource_import_devices(params)
