...
def iot_hub_resource_test_all_routes(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Devices/IotHubs/%{iot_hub_name}/routing/routes/$testall" % path_params
...
def task
  ...
  params = STDIN.read
  result = iot_hub_resource_test_all_routes(params)
