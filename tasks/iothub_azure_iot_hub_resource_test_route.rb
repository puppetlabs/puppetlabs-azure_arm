...
def iot_hub_resource_test_route(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Devices/IotHubs/%{iot_hub_name}/routing/routes/$testnew" % path_params
...
def task
  ...
  params = STDIN.read
  result = iot_hub_resource_test_route(params)
