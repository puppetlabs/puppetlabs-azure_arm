...
def job_create(*args)
  ...
  uri_string = "https:////Jobs/%{job_identity}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('degreeofparallelism', 'body', 'degree_of_parallelism', 'degreeofparallelism'),
      op_param('degreeofparallelismpercent', 'body', 'degree_of_parallelism_percent', 'degreeofparallelismpercent'),
      op_param('endtime', 'body', 'end_time', 'endtime'),
      op_param('errormessage', 'body', 'error_message', 'errormessage'),
      op_param('hierarchyqueuenode', 'body', 'hierarchy_queue_node', 'hierarchyqueuenode'),
      op_param('jobid', 'body', 'job_id', 'jobid'),
      op_param('jobIdentity', 'path', 'job_identity', 'job_identity'),
      op_param('logfilepatterns', 'body', 'log_file_patterns', 'logfilepatterns'),
      op_param('logfolder', 'body', 'log_folder', 'logfolder'),
      op_param('name', 'body', 'name', 'name'),
      op_param('parameters', 'body', 'parameters', 'parameters'),
      op_param('priority', 'body', 'priority', 'priority'),
      ...
      op_param('stateauditrecords', 'body', 'state_audit_records', 'stateauditrecords'),
      op_param('submitter', 'body', 'submitter', 'submitter'),
      op_param('submittime', 'body', 'submit_time', 'submittime'),
