...
def pipeline_get(*args)
  ...
  uri_string = "https:////pipelines/%{pipeline_identity}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('pipelineid', 'body', 'pipeline_id', 'pipelineid'),
      op_param('pipelineIdentity', 'path', 'pipeline_identity', 'pipeline_identity'),
      op_param('pipelinename', 'body', 'pipeline_name', 'pipelinename'),
      op_param('pipelineuri', 'body', 'pipeline_uri', 'pipelineuri'),
      op_param('recurrences', 'body', 'recurrences', 'recurrences'),
      op_param('runs', 'body', 'runs', 'runs'),
