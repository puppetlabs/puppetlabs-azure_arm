...
def recurrence_get(*args)
  ...
  uri_string = "https:////recurrences/%{recurrence_identity}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('recurrenceIdentity', 'path', 'recurrence_identity', 'recurrence_identity'),
