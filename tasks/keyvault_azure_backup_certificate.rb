...
def backup_certificate(*args)
  ...
  uri_string = "https:////certificates/%{certificate_name}/backup" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = BackupCertificate(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = backup_certificate(params)
