...
def backup_storage_account(*args)
  header_params = {}
  ...
  uri_string = "https:////storage/%{storage_account_name}/backup" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = BackupStorageAccount(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = backup_storage_account(params)
