...
def delete_certificate_contacts(*args)
  header_params = {}
  ...
  uri_string = "https:////certificates/contacts" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = DeleteCertificateContacts(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = delete_certificate_contacts(params)
