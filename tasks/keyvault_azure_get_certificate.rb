...
def get_certificate(*args)
  ...
  uri_string = "https:////certificates/%{certificate_name}/%{certificate_version}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('certificate-version', 'path', 'certificate_version', 'certificate_version'),
