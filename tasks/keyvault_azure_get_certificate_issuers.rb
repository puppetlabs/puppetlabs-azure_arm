...
def get_certificate_issuers(*args)
  header_params = {}
  ...
  uri_string = "https:////certificates/issuers" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetCertificateIssuers(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_certificate_issuers(params)
