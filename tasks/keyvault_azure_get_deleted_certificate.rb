...
def get_deleted_certificate(*args)
  header_params = {}
  ...
  uri_string = "https:////deletedcertificates/%{certificate_name}" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetDeletedCertificate(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_deleted_certificate(params)
