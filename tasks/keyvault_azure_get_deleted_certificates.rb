...
def get_deleted_certificates(*args)
  header_params = {}
  ...
  uri_string = "https:////deletedcertificates" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetDeletedCertificates(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_deleted_certificates(params)
