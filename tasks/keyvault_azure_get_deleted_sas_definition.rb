...
def get_deleted_sas_definition(*args)
  header_params = {}
  ...
  uri_string = "https:////deletedstorage/%{storage_account_name}/sas/%{sas_definition_name}" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetDeletedSasDefinition(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_deleted_sas_definition(params)
