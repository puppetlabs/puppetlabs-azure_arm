...
def get_deleted_sas_definitions(*args)
  header_params = {}
  ...
  uri_string = "https:////deletedstorage/%{storage_account_name}/sas" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetDeletedSasDefinitions(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_deleted_sas_definitions(params)
