...
def get_deleted_storage_accounts(*args)
  header_params = {}
  ...
  uri_string = "https:////deletedstorage" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetDeletedStorageAccounts(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_deleted_storage_accounts(params)
