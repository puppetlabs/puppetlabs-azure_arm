...
def get_secret(*args)
  ...
  uri_string = "https:////secrets/%{secret_name}/%{secret_version}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('secret-version', 'path', 'secret_version', 'secret_version'),
