...
def merge_certificate(*args)
  ...
  uri_string = "https:////certificates/%{certificate_name}/pending/merge" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = MergeCertificate(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = merge_certificate(params)
