...
def recover_deleted_secret(*args)
  header_params = {}
  ...
  uri_string = "https:////deletedsecrets/%{secret_name}/recover" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = RecoverDeletedSecret(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = recover_deleted_secret(params)
