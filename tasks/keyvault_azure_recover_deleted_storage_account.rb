...
def recover_deleted_storage_account(*args)
  header_params = {}
  ...
  uri_string = "https:////deletedstorage/%{storage_account_name}/recover" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('activekeyname', 'body', 'activekeyname', 'activekeyname'),
      op_param('api-version', 'query', 'api_version', 'api_version'),
      op_param('attributes', 'body', 'attributes', 'attributes'),
      op_param('autoregeneratekey', 'body', 'autoregeneratekey', 'autoregeneratekey'),
      op_param('id', 'body', 'id', 'id'),
      op_param('regenerationperiod', 'body', 'regenerationperiod', 'regenerationperiod'),
      op_param('resourceid', 'body', 'resourceid', 'resourceid'),
...
def authenticate
  ...
  params = STDIN.read
  result = RecoverDeletedStorageAccount(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = recover_deleted_storage_account(params)
