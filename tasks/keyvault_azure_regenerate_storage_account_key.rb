...
def regenerate_storage_account_key(*args)
  header_params = {}
  ...
  uri_string = "https:////storage/%{storage_account_name}/regeneratekey" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = RegenerateStorageAccountKey(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = regenerate_storage_account_key(params)
