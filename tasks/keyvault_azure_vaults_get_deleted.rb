...
def vaults_get_deleted(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.KeyVault/locations/%{location}/deletedVaults/%{vault_name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = vaults_get_deleted(params)
