...
def vaults_list_deleted(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.KeyVault/deletedVaults" % path_params
...
def task
  ...
  params = STDIN.read
  result = vaults_list_deleted(params)
