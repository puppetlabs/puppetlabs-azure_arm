...
def vaults_update_access_policy(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.KeyVault/vaults/%{vault_name}/accessPolicies/%{operation_kind}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('operationKind', 'path', 'operation_kind', 'operation_kind'),
...
def task
  ...
  params = STDIN.read
  result = vaults_update_access_policy(params)
