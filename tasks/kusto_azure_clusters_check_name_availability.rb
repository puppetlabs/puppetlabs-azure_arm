...
def clusters_check_name_availability(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Kusto/locations/%{location}/checkNameAvailability" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('clusterName', 'body', 'cluster_name', 'cluster_name'),
...
def task
  ...
  params = STDIN.read
  result = clusters_check_name_availability(params)
