...
def clusters_list_skus(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Kusto/skus" % path_params
...
def task
  ...
  params = STDIN.read
  result = clusters_list_skus(params)
