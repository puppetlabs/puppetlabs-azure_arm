...
def clusters_list_skus_by_resource(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Kusto/clusters/%{cluster_name}/skus" % path_params
...
def task
  ...
  params = STDIN.read
  result = clusters_list_skus_by_resource(params)
