...
def data_connections_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Kusto/clusters/%{cluster_name}/databases/%{database_name}/dataConnections/%{data_connection_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('dataConnectionName', 'path', 'data_connection_name', 'data_connection_name'),
...
def task
  ...
  params = STDIN.read
  result = data_connections_create_or_update(params)
