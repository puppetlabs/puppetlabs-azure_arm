...
def data_connections_list_by_database(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Kusto/clusters/%{cluster_name}/databases/%{database_name}/dataConnections" % path_params
...
def task
  ...
  params = STDIN.read
  result = data_connections_list_by_database(params)
