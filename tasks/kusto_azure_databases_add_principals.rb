...
def databases_add_principals(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Kusto/clusters/%{cluster_name}/databases/%{database_name}/addPrincipals" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('databasePrincipalsToAdd', 'body', 'database_principals_to_add', 'database_principals_to_add'),
...
def task
  ...
  params = STDIN.read
  result = databases_add_principals(params)
