...
def databases_check_name_availability(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Kusto/clusters/%{cluster_name}/checkNameAvailability" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('databaseName', 'body', 'database_name', 'database_name'),
...
def task
  ...
  params = STDIN.read
  result = databases_check_name_availability(params)
