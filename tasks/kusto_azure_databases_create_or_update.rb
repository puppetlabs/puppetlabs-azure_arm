...
def databases_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Kusto/clusters/%{cluster_name}/databases/%{database_name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = databases_create_or_update(params)
