...
def databases_list_by_cluster(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Kusto/clusters/%{cluster_name}/databases" % path_params
...
def task
  ...
  params = STDIN.read
  result = databases_list_by_cluster(params)
