...
def databases_remove_principals(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Kusto/clusters/%{cluster_name}/databases/%{database_name}/removePrincipals" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('databasePrincipalsToRemove', 'body', 'database_principals_to_remove', 'database_principals_to_remove'),
...
def task
  ...
  params = STDIN.read
  result = databases_remove_principals(params)
