...
def apps_add_custom_prebuilt_domain(*args)
  header_params = {}
  ...
  uri_string = "https:////apps/customprebuiltdomains" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('prebuiltDomainCreateObject', 'body', 'prebuilt_domain_create_object', 'prebuilt_domain_create_object'),
    ]
  op_params.each do |i|
    location = i[:location]
    name     = i[:name]
...
def task
  ...
  params = STDIN.read
  result = apps_add_custom_prebuilt_domain(params)
