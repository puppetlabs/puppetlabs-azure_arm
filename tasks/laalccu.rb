...
def agreements_list_content_callback_url(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}/agreements/%{agreement_name}/listContentCallbackUrl" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('agreementName', 'path', 'agreement_name', 'agreement_name'),
      ...
      op_param('notafter', 'body', 'notafter', 'notafter'),
...
def task
  ...
  params = STDIN.read
  result = agreements_list_content_callback_url(params)
