...
def connection_gateway_installations_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Web/locations/%{location}/connectionGatewayInstallations" % path_params
...
def task
  ...
  params = STDIN.read
  result = connection_gateway_installations_list(params)
