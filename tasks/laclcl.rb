...
def connections_list_consent_links(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/connections/%{connection_name}/listConsentLinks" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('listConsentLink', 'body', 'list_consent_link', 'list_consent_link'),
...
def task
  ...
  params = STDIN.read
  result = connections_list_consent_links(params)
