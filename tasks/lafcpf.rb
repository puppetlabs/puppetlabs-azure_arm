...
def features_create_pattern_feature(*args)
  header_params = {}
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/patterns" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('patternCreateObject', 'body', 'pattern_create_object', 'pattern_create_object'),
...
def task
  ...
  params = STDIN.read
  result = features_create_pattern_feature(params)
