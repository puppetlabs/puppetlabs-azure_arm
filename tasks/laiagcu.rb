...
def integration_accounts_get_callback_url(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}/listCallbackUrl" % path_params
...
def task
  ...
  params = STDIN.read
  result = integration_accounts_get_callback_url(params)
