...
def model_add_custom_prebuilt_entity(*args)
  header_params = {}
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/customprebuiltentities" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('domainname', 'body', 'domain_name', 'domainname'),
      op_param('modelname', 'body', 'model_name', 'modelname'),
      op_param('prebuiltDomainModelCreateObject', 'body', 'prebuilt_domain_model_create_object', 'prebuilt_domain_model_create_object'),
...
def task
  ...
  params = STDIN.read
  result = model_add_custom_prebuilt_entity(params)
