...
def model_add_custom_prebuilt_intent(*args)
  header_params = {}
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/customprebuiltintents" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('domainname', 'body', 'domainname', 'domainname'),
      op_param('modelname', 'body', 'modelname', 'modelname'),
...
def task
  ...
  params = STDIN.read
  result = model_add_custom_prebuilt_intent(params)
