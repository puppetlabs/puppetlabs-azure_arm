...
def model_add_hierarchical_entity(*args)
  header_params = {}
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/hierarchicalentities" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('hierarchicalModelCreateObject', 'body', 'hierarchical_model_create_object', 'hierarchical_model_create_object'),
...
def task
  ...
  params = STDIN.read
  result = model_add_hierarchical_entity(params)
