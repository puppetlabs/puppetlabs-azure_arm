...
def model_add_hierarchical_entity_child(*args)
  header_params = {}
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/hierarchicalentities/%{h_entity_id}/children" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('hierarchicalChildModelCreateObject', 'body', 'hierarchical_child_model_create_object', 'hierarchical_child_model_create_object'),
...
def task
  ...
  params = STDIN.read
  result = model_add_hierarchical_entity_child(params)
