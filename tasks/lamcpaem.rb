...
def model_create_pattern_any_entity_model(*args)
  header_params = {}
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/patternanyentities" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('extractorCreateObject', 'body', 'extractor_create_object', 'extractor_create_object'),
...
def task
  ...
  params = STDIN.read
  result = model_create_pattern_any_entity_model(params)
