...
def model_create_pattern_any_entity_role(*args)
  header_params = {}
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/patternanyentities/%{entity_id}/roles" % path_params
...
def task
  ...
  params = STDIN.read
  result = model_create_pattern_any_entity_role(params)
