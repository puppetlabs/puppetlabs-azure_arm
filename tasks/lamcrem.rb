...
def model_create_regex_entity_model(*args)
  header_params = {}
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/regexentities" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('regexEntityExtractorCreateObj', 'body', 'regex_entity_extractor_create_obj', 'regex_entity_extractor_create_obj'),
      op_param('regexpattern', 'body', 'regex_pattern', 'regexpattern'),
...
def task
  ...
  params = STDIN.read
  result = model_create_regex_entity_model(params)
