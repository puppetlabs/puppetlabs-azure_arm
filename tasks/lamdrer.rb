...
def model_delete_regex_entity_role(*args)
  header_params = {}
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/regexentities/%{entity_id}/roles/%{role_id}" % path_params
...
def task
  ...
  params = STDIN.read
  result = model_delete_regex_entity_role(params)
