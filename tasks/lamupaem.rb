...
def model_update_pattern_any_entity_model(*args)
  header_params = {}
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/patternanyentities/%{entity_id}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('explicitlist', 'body', 'explicit_list', 'explicitlist'),
      op_param('name', 'body', 'name', 'name'),
      op_param('patternAnyUpdateObject', 'body', 'pattern_any_update_object', 'pattern_any_update_object'),
...
def task
  ...
  params = STDIN.read
  result = model_update_pattern_any_entity_model(params)
