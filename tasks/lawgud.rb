...
def workflows_generate_upgraded_definition(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/workflows/%{workflow_name}/generateUpgradedDefinition" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('targetschemaversion', 'body', 'target_schema_version', 'targetschemaversion'),
...
def task
  ...
  params = STDIN.read
  result = workflows_generate_upgraded_definition(params)
