...
def workflow_run_actions_list_expression_traces(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/workflows/%{workflow_name}/runs/%{run_name}/actions/%{action_name}/listExpressionTraces" % path_params
...
def task
  ...
  params = STDIN.read
  result = workflow_run_actions_list_expression_traces(params)
