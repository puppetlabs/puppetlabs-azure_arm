...
def load_balancer_probes_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/loadBalancers/%{load_balancer_name}/probes/%{probe_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('loadBalancerName', 'path', 'load_balancer_name', 'load_balancer_name'),
      op_param('name', 'body', 'name', 'name'),
      op_param('probeName', 'path', 'name', 'probe_name'),
...
def task
  ...
  params = STDIN.read
  result = load_balancer_probes_get(params)
