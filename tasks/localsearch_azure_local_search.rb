...
def local_search(*args)
  ...
  uri_string = "https://api.cognitive.microsoft.com//localbusinesses/v7.0/search" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('adaptivecard', 'body', 'adaptive_card', 'adaptivecard'),
      op_param('cc', 'query', 'cc', 'cc'),
      op_param('count', 'query', 'count', 'count'),
      op_param('first', 'query', 'first', 'first'),
      op_param('id', 'body', 'id', 'id'),
      op_param('immediateaction', 'body', 'immediate_action', 'immediateaction'),
      op_param('localcategories', 'query', 'localcategories', 'localcategories'),
      op_param('localcircularview', 'query', 'localcircularview', 'localcircularview'),
      op_param('localmapview', 'query', 'localmapview', 'localmapview'),
      op_param('lottery', 'body', 'lottery', 'lottery'),
      op_param('mkt', 'query', 'mkt', 'mkt'),
      op_param('places', 'body', 'places', 'places'),
      op_param('potentialaction', 'body', 'potential_action', 'potentialaction'),
      op_param('Pragma', 'header', 'pragma', 'pragma'),
      op_param('preferredclickthroughurl', 'body', 'preferred_clickthrough_url', 'preferredclickthroughurl'),
      op_param('q', 'query', 'q', 'q'),
      op_param('querycontext', 'body', 'query_context', 'querycontext'),
      op_param('readlink', 'body', 'read_link', 'readlink'),
      op_param('ResponseFormat', 'query', 'response_format', 'response_format'),
      op_param('SafeSearch', 'query', 'safe_search', 'safe_search'),
      op_param('searchresultsconfidencescore', 'body', 'search_results_confidence_score', 'searchresultsconfidencescore'),
