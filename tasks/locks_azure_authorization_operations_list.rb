...
def authorization_operations_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.Authorization/operations" % path_params
...
def task
  ...
  params = STDIN.read
  result = authorization_operations_list(params)
