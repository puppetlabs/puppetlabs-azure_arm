...
def management_locks_list_by_scope(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//%{scope}/providers/Microsoft.Authorization/locks" % path_params
...
def task
  ...
  params = STDIN.read
  result = management_locks_list_by_scope(params)
