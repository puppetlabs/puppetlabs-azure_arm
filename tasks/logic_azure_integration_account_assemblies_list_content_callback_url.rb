...
def integration_account_assemblies_list_content_callback_url(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}/assemblies/%{assembly_artifact_name}/listContentCallbackUrl" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('assemblyArtifactName', 'path', 'assembly_artifact_name', 'assembly_artifact_name'),
...
def task
  ...
  params = STDIN.read
  result = integration_account_assemblies_list_content_callback_url(params)
