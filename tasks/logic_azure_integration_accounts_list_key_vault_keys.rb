...
def integration_accounts_list_key_vault_keys(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}/listKeyVaultKeys" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('keyvault', 'body', 'key_vault', 'keyvault'),
      op_param('listKeyVaultKeys', 'body', 'list_key_vault_keys', 'list_key_vault_keys'),
      op_param('resourceGroupName', 'path', 'resource_group_name', 'resource_group_name'),
      op_param('skiptoken', 'body', 'skip_token', 'skiptoken'),
...
def task
  ...
  params = STDIN.read
  result = integration_accounts_list_key_vault_keys(params)
