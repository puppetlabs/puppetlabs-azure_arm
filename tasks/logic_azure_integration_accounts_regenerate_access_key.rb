...
def integration_accounts_regenerate_access_key(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}/regenerateAccessKey" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('regenerateAccessKey', 'body', 'regenerate_access_key', 'regenerate_access_key'),
...
def task
  ...
  params = STDIN.read
  result = integration_accounts_regenerate_access_key(params)
