...
def maps_list_content_callback_url(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}/maps/%{map_name}/listContentCallbackUrl" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('basepath', 'body', 'base_path', 'basepath'),
      op_param('integrationAccountName', 'path', 'integration_account_name', 'integration_account_name'),
      op_param('listContentCallbackUrl', 'body', 'list_content_callback_url', 'list_content_callback_url'),
      op_param('mapName', 'path', 'map_name', 'map_name'),
      op_param('method', 'body', 'method', 'method'),
      op_param('queries', 'body', 'queries', 'queries'),
      op_param('relativepath', 'body', 'relative_path', 'relativepath'),
      op_param('relativepathparameters', 'body', 'relative_path_parameters', 'relativepathparameters'),
...
def task
  ...
  params = STDIN.read
  result = maps_list_content_callback_url(params)
