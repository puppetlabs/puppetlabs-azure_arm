...
def partners_list_content_callback_url(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/integrationAccounts/%{integration_account_name}/partners/%{partner_name}/listContentCallbackUrl" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('partnerName', 'path', 'partner_name', 'partner_name'),
...
def task
  ...
  params = STDIN.read
  result = partners_list_content_callback_url(params)
