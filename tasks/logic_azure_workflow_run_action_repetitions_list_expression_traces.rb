...
def workflow_run_action_repetitions_list_expression_traces(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/workflows/%{workflow_name}/runs/%{run_name}/actions/%{action_name}/repetitions/%{repetition_name}/listExpressionTraces" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('actionName', 'path', 'action_name', 'action_name'),
      op_param('api-version', 'query', 'api_version', 'api_version'),
      op_param('inputs', 'body', 'inputs', 'inputs'),
      op_param('repetitionName', 'path', 'repetition_name', 'repetition_name'),
      op_param('resourceGroupName', 'path', 'resource_group_name', 'resource_group_name'),
      op_param('runName', 'path', 'run_name', 'run_name'),
...
def task
  ...
  params = STDIN.read
  result = workflow_run_action_repetitions_list_expression_traces(params)
