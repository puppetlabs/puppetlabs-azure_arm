...
def workflow_run_operations_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/workflows/%{workflow_name}/runs/%{run_name}/operations/%{operation_id}" % path_params
...
def task
  ...
  params = STDIN.read
  result = workflow_run_operations_get(params)
