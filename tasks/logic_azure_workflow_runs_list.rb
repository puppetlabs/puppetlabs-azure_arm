...
def workflow_runs_list(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/workflows/%{workflow_name}/runs" % path_params
...
def task
  ...
  params = STDIN.read
  result = workflow_runs_list(params)
