...
def workflow_trigger_histories_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/workflows/%{workflow_name}/triggers/%{trigger_name}/histories/%{history_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('historyName', 'path', 'history_name', 'history_name'),
...
def task
  ...
  params = STDIN.read
  result = workflow_trigger_histories_get(params)
