...
def workflow_trigger_histories_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/workflows/%{workflow_name}/triggers/%{trigger_name}/histories" % path_params
...
def task
  ...
  params = STDIN.read
  result = workflow_trigger_histories_list(params)
