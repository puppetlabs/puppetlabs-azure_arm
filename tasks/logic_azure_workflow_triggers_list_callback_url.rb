...
def workflow_triggers_list_callback_url(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/workflows/%{workflow_name}/triggers/%{trigger_name}/listCallbackUrl" % path_params
...
def task
  ...
  params = STDIN.read
  result = workflow_triggers_list_callback_url(params)
