...
def workflow_triggers_run(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/workflows/%{workflow_name}/triggers/%{trigger_name}/run" % path_params
...
def task
  ...
  params = STDIN.read
  result = workflow_triggers_run(params)
