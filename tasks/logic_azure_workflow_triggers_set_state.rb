...
def workflow_triggers_set_state(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/workflows/%{workflow_name}/triggers/%{trigger_name}/setState" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('setState', 'body', 'set_state', 'set_state'),
...
def task
  ...
  params = STDIN.read
  result = workflow_triggers_set_state(params)
