...
def workflow_versions_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/workflows/%{workflow_name}/versions/%{version_id}" % path_params
...
def task
  ...
  params = STDIN.read
  result = workflow_versions_get(params)
