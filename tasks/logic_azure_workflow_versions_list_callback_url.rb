...
def workflow_versions_list_callback_url(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/workflows/%{workflow_name}/versions/%{version_id}/triggers/%{trigger_name}/listCallbackUrl" % path_params
...
def task
  ...
  params = STDIN.read
  result = workflow_versions_list_callback_url(params)
