...
def workflows_list_callback_url(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/workflows/%{workflow_name}/listCallbackUrl" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('listCallbackUrl', 'body', 'list_callback_url', 'list_callback_url'),
...
def task
  ...
  params = STDIN.read
  result = workflows_list_callback_url(params)
