...
def workflows_regenerate_access_key(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Logic/workflows/%{workflow_name}/regenerateAccessKey" % path_params
...
def task
  ...
  params = STDIN.read
  result = workflows_regenerate_access_key(params)
