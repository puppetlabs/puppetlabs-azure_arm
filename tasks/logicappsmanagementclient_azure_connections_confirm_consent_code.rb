...
def connections_confirm_consent_code(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/connections/%{connection_name}/confirmConsentCode" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('confirmConsentCode', 'body', 'confirm_consent_code', 'confirm_consent_code'),
      op_param('connectionName', 'path', 'connection_name', 'connection_name'),
      op_param('objectid', 'body', 'object_id', 'objectid'),
...
def task
  ...
  params = STDIN.read
  result = connections_confirm_consent_code(params)
