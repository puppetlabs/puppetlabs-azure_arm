...
def managed_apis_list(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Web/locations/%{location}/managedApis" % path_params
...
def task
  ...
  params = STDIN.read
  result = managed_apis_list(params)
