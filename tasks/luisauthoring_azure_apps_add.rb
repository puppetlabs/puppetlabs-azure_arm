...
def apps_add(*args)
  ...
  uri_string = "https:////apps/" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('applicationCreateObject', 'body', 'application_create_object', 'application_create_object'),
      op_param('culture', 'body', 'culture', 'culture'),
      op_param('description', 'body', 'description', 'description'),
      op_param('domain', 'body', 'domain', 'domain'),
      op_param('initialversionid', 'body', 'initial_version_id', 'initialversionid'),
      op_param('name', 'body', 'name', 'name'),
      op_param('usagescenario', 'body', 'usage_scenario', 'usagescenario'),
    ]
  op_params.each do |i|
    location = i[:location]
    name     = i[:name]
