...
def apps_update_settings(*args)
  ...
  uri_string = "https:////apps/%{app_id}/settings" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('applicationSettingUpdateObject', 'body', 'application_setting_update_object', 'application_setting_update_object'),
...
def task
  ...
  params = STDIN.read
  result = apps_update_settings(params)
