...
def examples_batch(*args)
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/examples" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('exampleLabelObjectArray', 'body', 'example_label_object_array', 'example_label_object_array'),
