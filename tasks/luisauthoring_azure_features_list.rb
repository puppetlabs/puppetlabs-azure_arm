...
def features_list(*args)
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/features" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('patternfeatures', 'body', 'pattern_features', 'patternfeatures'),
      op_param('phraselistfeatures', 'body', 'phraselist_features', 'phraselistfeatures'),
