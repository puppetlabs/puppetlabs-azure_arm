...
def features_update_pattern_feature(*args)
  header_params = {}
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/patterns/%{pattern_id}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('patternId', 'path', 'pattern_id', 'pattern_id'),
      op_param('patternUpdateObject', 'body', 'pattern_update_object', 'pattern_update_object'),
...
def task
  ...
  params = STDIN.read
  result = features_update_pattern_feature(params)
