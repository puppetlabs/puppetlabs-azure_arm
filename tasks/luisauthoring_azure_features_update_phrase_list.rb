...
def features_update_phrase_list(*args)
  header_params = {}
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/phraselists/%{phraselist_id}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('isactive', 'body', 'is_active', 'isactive'),
      op_param('isexchangeable', 'body', 'is_exchangeable', 'isexchangeable'),
      op_param('name', 'body', 'name', 'name'),
      op_param('phraselistId', 'path', 'phraselist_id', 'phraselist_id'),
      op_param('phraselistUpdateObject', 'body', 'phraselist_update_object', 'phraselist_update_object'),
...
def task
  ...
  params = STDIN.read
  result = features_update_phrase_list(params)
