...
def model_add_composite_entity(*args)
  header_params = {}
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/compositeentities" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('compositeModelCreateObject', 'body', 'composite_model_create_object', 'composite_model_create_object'),
...
def task
  ...
  params = STDIN.read
  result = model_add_composite_entity(params)
