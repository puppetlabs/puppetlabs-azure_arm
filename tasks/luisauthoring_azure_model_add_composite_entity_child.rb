...
def model_add_composite_entity_child(*args)
  header_params = {}
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/compositeentities/%{c_entity_id}/children" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('compositeChildModelCreateObject', 'body', 'composite_child_model_create_object', 'composite_child_model_create_object'),
...
def task
  ...
  params = STDIN.read
  result = model_add_composite_entity_child(params)
