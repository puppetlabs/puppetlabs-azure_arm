...
def model_add_custom_prebuilt_domain(*args)
  header_params = {}
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/customprebuiltdomains" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('prebuiltDomainObject', 'body', 'prebuilt_domain_object', 'prebuilt_domain_object'),
...
def task
  ...
  params = STDIN.read
  result = model_add_custom_prebuilt_domain(params)
