...
def model_add_entity(*args)
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/entities" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('modelCreateObject', 'body', 'model_create_object', 'model_create_object'),
...
def task
  ...
  params = STDIN.read
  result = model_add_entity(params)
