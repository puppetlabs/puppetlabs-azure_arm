...
def model_add_explicit_list_item(*args)
  header_params = {}
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/patternanyentities/%{entity_id}/explicitlist" % path_params
...
def task
  ...
  params = STDIN.read
  result = model_add_explicit_list_item(params)
