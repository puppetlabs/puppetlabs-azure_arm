...
def model_add_intent(*args)
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/intents" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('intentCreateObject', 'body', 'intent_create_object', 'intent_create_object'),
...
def task
  ...
  params = STDIN.read
  result = model_add_intent(params)
