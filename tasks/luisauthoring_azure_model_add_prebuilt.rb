...
def model_add_prebuilt(*args)
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/prebuilts" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('prebuiltExtractorNames', 'body', 'prebuilt_extractor_names', 'prebuilt_extractor_names'),
...
def task
  ...
  params = STDIN.read
  result = model_add_prebuilt(params)
