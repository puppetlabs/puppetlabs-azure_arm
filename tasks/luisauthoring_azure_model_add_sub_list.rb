...
def model_add_sub_list(*args)
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/closedlists/%{cl_entity_id}/sublists" % path_params
...
def task
  ...
  params = STDIN.read
  result = model_add_sub_list(params)
