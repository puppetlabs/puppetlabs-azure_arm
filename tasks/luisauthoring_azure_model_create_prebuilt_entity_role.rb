...
def model_create_prebuilt_entity_role(*args)
  header_params = {}
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/prebuilts/%{entity_id}/roles" % path_params
...
def task
  ...
  params = STDIN.read
  result = model_create_prebuilt_entity_role(params)
