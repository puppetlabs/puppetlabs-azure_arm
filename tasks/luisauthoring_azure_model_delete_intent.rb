...
def model_delete_intent(*args)
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/intents/%{intent_id}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('deleteUtterances', 'query', 'delete_utterances', 'delete_utterances'),
...
def task
  ...
  params = STDIN.read
  result = model_delete_intent(params)
