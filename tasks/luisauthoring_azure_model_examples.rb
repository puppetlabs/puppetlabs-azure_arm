...
def model_examples(*args)
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/models/%{model_id}/examples" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('modelId', 'path', 'model_id', 'model_id'),
