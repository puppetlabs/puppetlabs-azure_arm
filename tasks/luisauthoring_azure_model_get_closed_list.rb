...
def model_get_closed_list(*args)
  header_params = {}
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/closedlists/%{cl_entity_id}" % path_params
...
def task
  ...
  params = STDIN.read
  result = model_get_closed_list(params)
