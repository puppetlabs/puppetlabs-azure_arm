...
def model_get_entity(*args)
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/entities/%{entity_id}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('customprebuiltdomainname', 'body', 'custom_prebuilt_domain_name', 'customprebuiltdomainname'),
      op_param('customprebuiltmodelname', 'body', 'custom_prebuilt_model_name', 'customprebuiltmodelname'),
      op_param('entityId', 'path', 'entity_id', 'entity_id'),
      op_param('id', 'body', 'id', 'id'),
      op_param('name', 'body', 'name', 'name'),
      op_param('readabletype', 'body', 'readable_type', 'readabletype'),
      op_param('roles', 'body', 'roles', 'roles'),
      op_param('typeid', 'body', 'type_id', 'typeid'),
...
def task
  ...
  params = STDIN.read
  result = model_get_entity(params)
