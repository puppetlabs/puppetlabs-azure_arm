...
def model_get_prebuilt(*args)
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/prebuilts/%{prebuilt_id}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('prebuiltId', 'path', 'prebuilt_id', 'prebuilt_id'),
...
def task
  ...
  params = STDIN.read
  result = model_get_prebuilt(params)
