...
def model_update_regex_entity_model(*args)
  header_params = {}
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/regexentities/%{regex_entity_id}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('regexEntityId', 'path', 'regex_entity_id', 'regex_entity_id'),
      op_param('regexEntityUpdateObject', 'body', 'regex_entity_update_object', 'regex_entity_update_object'),
...
def task
  ...
  params = STDIN.read
  result = model_update_regex_entity_model(params)
