...
def pattern_delete_pattern(*args)
  header_params = {}
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/patternrules/%{pattern_id}" % path_params
...
def task
  ...
  params = STDIN.read
  result = pattern_delete_pattern(params)
