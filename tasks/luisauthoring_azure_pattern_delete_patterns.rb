...
def pattern_delete_patterns(*args)
  header_params = {}
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/patternrules" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('patternIds', 'body', 'pattern_ids', 'pattern_ids'),
...
def task
  ...
  params = STDIN.read
  result = pattern_delete_patterns(params)
