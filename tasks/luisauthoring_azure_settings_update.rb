...
def settings_update(*args)
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/settings" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('listOfAppVersionSettingObject', 'body', 'list_of_app_version_setting_object', 'list_of_app_version_setting_object'),
