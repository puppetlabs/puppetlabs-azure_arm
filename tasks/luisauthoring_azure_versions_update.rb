...
def versions_update(*args)
  ...
  uri_string = "https:////apps/%{app_id}/versions/%{version_id}/" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('versionUpdateObject', 'body', 'version_update_object', 'version_update_object'),
    ]
  op_params.each do |i|
    location = i[:location]
    name     = i[:name]
