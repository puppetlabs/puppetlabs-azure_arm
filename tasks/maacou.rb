...
def applications_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Solutions/applications/%{application_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('applicationName', 'path', 'application_name', 'application_name'),
...
def task
  ...
  params = STDIN.read
  result = applications_create_or_update(params)
