...
def application_definitions_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Solutions/applicationDefinitions/%{application_definition_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('applicationDefinitionName', 'path', 'application_definition_name', 'application_definition_name'),
...
def task
  ...
  params = STDIN.read
  result = application_definitions_create_or_update(params)
