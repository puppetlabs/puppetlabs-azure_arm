...
def assessments_get_report_download_url(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Migrate/projects/%{project_name}/groups/%{group_name}/assessments/%{assessment_name}/downloadUrl" % path_params
...
def task
  ...
  params = STDIN.read
  result = assessments_get_report_download_url(params)
