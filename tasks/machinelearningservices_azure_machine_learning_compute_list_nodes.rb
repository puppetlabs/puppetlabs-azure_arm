...
def machine_learning_compute_list_nodes(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.MachineLearningServices/workspaces/%{workspace_name}/computes/%{compute_name}/listNodes" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('computetype', 'body', 'compute_type', 'computetype'),
...
def task
  ...
  params = STDIN.read
  result = machine_learning_compute_list_nodes(params)
