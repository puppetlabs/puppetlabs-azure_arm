...
def workspaces_list_keys(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.MachineLearningServices/workspaces/%{workspace_name}/listKeys" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('appinsightsinstrumentationkey', 'body', 'app_insights_instrumentation_key', 'appinsightsinstrumentationkey'),
      op_param('containerregistrycredentials', 'body', 'container_registry_credentials', 'containerregistrycredentials'),
      op_param('resourceGroupName', 'path', 'resource_group_name', 'resource_group_name'),
      op_param('subscriptionId', 'path', 'subscription_id', 'subscription_id'),
      op_param('userstoragekey', 'body', 'user_storage_key', 'userstoragekey'),
      op_param('userstorageresourceid', 'body', 'user_storage_resource_id', 'userstorageresourceid'),
...
def task
  ...
  params = STDIN.read
  result = workspaces_list_keys(params)
