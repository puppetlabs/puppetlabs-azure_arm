...
def global_users_get_operation_batch_status(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.LabServices/users/%{user_name}/getOperationBatchStatus" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('operationBatchStatusPayload', 'body', 'operation_batch_status_payload', 'operation_batch_status_payload'),
...
def task
  ...
  params = STDIN.read
  result = global_users_get_operation_batch_status(params)
