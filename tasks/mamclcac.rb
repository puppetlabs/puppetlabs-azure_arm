...
def managed_clusters_list_cluster_admin_credentials(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ContainerService/managedClusters/%{resource_name}/listClusterAdminCredential" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('kubeconfigs', 'body', 'kubeconfigs', 'kubeconfigs'),
...
def task
  ...
  params = STDIN.read
  result = managed_clusters_list_cluster_admin_credentials(params)
