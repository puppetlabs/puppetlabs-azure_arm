...
def managed_clusters_list_cluster_user_credentials(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ContainerService/managedClusters/%{resource_name}/listClusterUserCredential" % path_params
...
def task
  ...
  params = STDIN.read
  result = managed_clusters_list_cluster_user_credentials(params)
