...
def managed_clusters_reset_aad_profile(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ContainerService/managedClusters/%{resource_name}/resetAADProfile" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('clientappid', 'body', 'client_app_id', 'clientappid'),
      ...
      op_param('serverappid', 'body', 'server_app_id', 'serverappid'),
      op_param('serverappsecret', 'body', 'server_app_secret', 'serverappsecret'),
...
def task
  ...
  params = STDIN.read
  result = managed_clusters_reset_aad_profile(params)
