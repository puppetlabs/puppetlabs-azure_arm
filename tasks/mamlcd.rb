...
def machine_learning_compute_delete(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.MachineLearningServices/workspaces/%{workspace_name}/computes/%{compute_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('computeName', 'path', 'compute_name', 'compute_name'),
      op_param('error', 'body', 'error', 'error'),
      op_param('resourceGroupName', 'path', 'resource_group_name', 'resource_group_name'),
      op_param('subscriptionId', 'path', 'subscription_id', 'subscription_id'),
      op_param('underlyingResourceAction', 'query', 'underlying_resource_action', 'underlying_resource_action'),
...
def task
  ...
  params = STDIN.read
  result = machine_learning_compute_delete(params)
