...
def agent_pools_delete(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ContainerService/managedClusters/%{resource_name}/agentPools/%{agent_pool_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('agentPoolName', 'path', 'agent_pool_name', 'agent_pool_name'),
...
def task
  ...
  params = STDIN.read
  result = agent_pools_delete(params)
