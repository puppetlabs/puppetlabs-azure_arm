...
def managed_clusters_get_access_profile(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ContainerService/managedClusters/%{resource_name}/accessProfiles/%{role_name}/listCredential" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('roleName', 'path', 'role_name', 'role_name'),
...
def task
  ...
  params = STDIN.read
  result = managed_clusters_get_access_profile(params)
