...
def managed_clusters_reset_service_principal_profile(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ContainerService/managedClusters/%{resource_name}/resetServicePrincipalProfile" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('secret', 'body', 'secret', 'secret'),
...
def task
  ...
  params = STDIN.read
  result = managed_clusters_reset_service_principal_profile(params)
