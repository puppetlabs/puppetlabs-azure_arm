...
def accounts_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Maps/accounts/%{account_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('MapsAccountCreateParameters', 'body', 'maps_account_create_parameters', 'maps_account_create_parameters'),
...
def task
  ...
  params = STDIN.read
  result = accounts_create_or_update(params)
