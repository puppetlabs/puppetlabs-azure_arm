...
def accounts_list_operations(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.Maps/operations" % path_params
...
def task
  ...
  params = STDIN.read
  result = accounts_list_operations(params)
