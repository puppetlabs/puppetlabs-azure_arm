...
def accounts_regenerate_keys(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Maps/accounts/%{account_name}/regenerateKey" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('keySpecification', 'body', 'key_specification', 'key_specification'),
...
def task
  ...
  params = STDIN.read
  result = accounts_regenerate_keys(params)
