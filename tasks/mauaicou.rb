...
def user_assigned_identities_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/%{resource_name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = user_assigned_identities_create_or_update(params)
