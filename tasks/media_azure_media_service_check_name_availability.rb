...
def media_service_check_name_availability(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Media/CheckNameAvailability" % path_params
...
def task
  ...
  params = STDIN.read
  result = media_service_check_name_availability(params)
