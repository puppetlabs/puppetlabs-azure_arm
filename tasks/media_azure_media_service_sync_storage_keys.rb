...
def media_service_sync_storage_keys(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Media/mediaservices/%{media_service_name}/syncStorageKeys" % path_params
...
def task
  ...
  params = STDIN.read
  result = media_service_sync_storage_keys(params)
