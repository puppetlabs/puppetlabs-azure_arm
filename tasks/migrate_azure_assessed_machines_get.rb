...
def assessed_machines_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Migrate/projects/%{project_name}/groups/%{group_name}/assessments/%{assessment_name}/assessedMachines/%{assessed_machine_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('assessedMachineName', 'path', 'assessed_machine_name', 'assessed_machine_name'),
      op_param('assessmentName', 'path', 'assessment_name', 'assessment_name'),
...
def task
  ...
  params = STDIN.read
  result = assessed_machines_get(params)
