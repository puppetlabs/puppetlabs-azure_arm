...
def assessment_options_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Migrate/locations/%{location_name}/assessmentOptions" % path_params
...
def task
  ...
  params = STDIN.read
  result = assessment_options_get(params)
