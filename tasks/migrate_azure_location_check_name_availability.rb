...
def location_check_name_availability(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Migrate/locations/%{location_name}/checkNameAvailability" % path_params
...
def task
  ...
  params = STDIN.read
  result = location_check_name_availability(params)
