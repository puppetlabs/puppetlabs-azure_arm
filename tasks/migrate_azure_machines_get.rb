...
def machines_get(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Migrate/projects/%{project_name}/machines/%{machine_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('machineName', 'path', 'machine_name', 'machine_name'),
