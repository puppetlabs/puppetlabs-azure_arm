...
def machines_list_by_project(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Migrate/projects/%{project_name}/machines" % path_params
...
def task
  ...
  params = STDIN.read
  result = machines_list_by_project(params)
