...
def environment_settings_claim_any(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.LabServices/labaccounts/%{lab_account_name}/labs/%{lab_name}/environmentsettings/%{environment_setting_name}/claimAny" % path_params
...
def task
  ...
  params = STDIN.read
  result = environment_settings_claim_any(params)
