...
def environment_settings_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.LabServices/labaccounts/%{lab_account_name}/labs/%{lab_name}/environmentsettings/%{environment_setting_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('environmentSetting', 'body', 'environment_setting', 'environment_setting'),
...
def task
  ...
  params = STDIN.read
  result = environment_settings_create_or_update(params)
