...
def environments_reset_password(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.LabServices/labaccounts/%{lab_account_name}/labs/%{lab_name}/environmentsettings/%{environment_setting_name}/environments/%{environment_name}/resetPassword" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('environmentid', 'body', 'environment_id', 'environmentid'),
      op_param('environmentName', 'path', 'environment_name', 'environment_name'),
...
def task
  ...
  params = STDIN.read
  result = environments_reset_password(params)
