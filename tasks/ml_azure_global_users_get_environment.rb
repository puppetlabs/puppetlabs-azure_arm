...
def global_users_get_environment(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.LabServices/users/%{user_name}/getEnvironment" % path_params
...
def task
  ...
  params = STDIN.read
  result = global_users_get_environment(params)
