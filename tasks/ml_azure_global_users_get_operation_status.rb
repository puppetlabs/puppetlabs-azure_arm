...
def global_users_get_operation_status(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.LabServices/users/%{user_name}/getOperationStatus" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('operationStatusPayload', 'body', 'operation_status_payload', 'operation_status_payload'),
      op_param('operationurl', 'body', 'operation_url', 'operationurl'),
...
def task
  ...
  params = STDIN.read
  result = global_users_get_operation_status(params)
