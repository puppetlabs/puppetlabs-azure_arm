...
def global_users_get_personal_preferences(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.LabServices/users/%{user_name}/getPersonalPreferences" % path_params
...
def task
  ...
  params = STDIN.read
  result = global_users_get_personal_preferences(params)
