...
def global_users_list_environments(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.LabServices/users/%{user_name}/listEnvironments" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('labid', 'body', 'lab_id', 'labid'),
...
def task
  ...
  params = STDIN.read
  result = global_users_list_environments(params)
