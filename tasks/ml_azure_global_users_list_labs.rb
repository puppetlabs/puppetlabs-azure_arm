...
def global_users_list_labs(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.LabServices/users/%{user_name}/listLabs" % path_params
...
def task
  ...
  params = STDIN.read
  result = global_users_list_labs(params)
