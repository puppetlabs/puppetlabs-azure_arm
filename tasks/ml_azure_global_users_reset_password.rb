...
def global_users_reset_password(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.LabServices/users/%{user_name}/resetPassword" % path_params
...
def task
  ...
  params = STDIN.read
  result = global_users_reset_password(params)
