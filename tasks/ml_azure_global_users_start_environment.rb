...
def global_users_start_environment(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.LabServices/users/%{user_name}/startEnvironment" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('environmentOperationsPayload', 'body', 'environment_operations_payload', 'environment_operations_payload'),
...
def task
  ...
  params = STDIN.read
  result = global_users_start_environment(params)
