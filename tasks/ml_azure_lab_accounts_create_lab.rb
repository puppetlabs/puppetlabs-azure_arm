...
def lab_accounts_create_lab(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.LabServices/labaccounts/%{lab_account_name}/createLab" % path_params
...
def task
  ...
  params = STDIN.read
  result = lab_accounts_create_lab(params)
