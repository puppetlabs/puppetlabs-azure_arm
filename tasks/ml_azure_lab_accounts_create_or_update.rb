...
def lab_accounts_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.LabServices/labaccounts/%{lab_account_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('labAccount', 'body', 'lab_account', 'lab_account'),
...
def task
  ...
  params = STDIN.read
  result = lab_accounts_create_or_update(params)
