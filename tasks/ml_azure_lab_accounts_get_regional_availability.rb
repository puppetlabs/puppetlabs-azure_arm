...
def lab_accounts_get_regional_availability(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.LabServices/labaccounts/%{lab_account_name}/getRegionalAvailability" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('regionalavailability', 'body', 'regional_availability', 'regionalavailability'),
...
def task
  ...
  params = STDIN.read
  result = lab_accounts_get_regional_availability(params)
