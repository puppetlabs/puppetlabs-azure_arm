...
def lab_accounts_list_by_subscription(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.LabServices/labaccounts" % path_params
...
def task
  ...
  params = STDIN.read
  result = lab_accounts_list_by_subscription(params)
