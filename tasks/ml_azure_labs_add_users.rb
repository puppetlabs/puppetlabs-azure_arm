...
def labs_add_users(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.LabServices/labaccounts/%{lab_account_name}/labs/%{lab_name}/addUsers" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('addUsersPayload', 'body', 'add_users_payload', 'add_users_payload'),
      op_param('api-version', 'query', 'api_version', 'api_version'),
      op_param('emailaddresses', 'body', 'email_addresses', 'emailaddresses'),
