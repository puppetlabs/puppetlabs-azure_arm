...
def operations_get(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.LabServices/locations/%{location_name}/operations/%{operation_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('operationName', 'path', 'operation_name', 'operation_name'),
