...
def provider_operations_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.LabServices/operations" % path_params
...
def task
  ...
  params = STDIN.read
  result = provider_operations_list(params)
