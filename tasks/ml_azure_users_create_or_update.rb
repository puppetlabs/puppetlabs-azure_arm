...
def users_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.LabServices/labaccounts/%{lab_account_name}/labs/%{lab_name}/users/%{user_name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = users_create_or_update(params)
