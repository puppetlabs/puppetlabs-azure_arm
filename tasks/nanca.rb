...
def namespaces_check_availability(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.NotificationHubs/checkNamespaceAvailability" % path_params
...
def task
  ...
  params = STDIN.read
  result = namespaces_check_availability(params)
