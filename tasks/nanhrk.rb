...
def notification_hubs_regenerate_keys(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.NotificationHubs/namespaces/%{namespace_name}/notificationHubs/%{notification_hub_name}/AuthorizationRules/%{authorization_rule_name}/regenerateKeys" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('notificationHubName', 'path', 'notification_hub_name', 'notification_hub_name'),
      op_param('parameters', 'body', 'parameters', 'parameters'),
      op_param('policykey', 'body', 'policykey', 'policykey'),
...
def task
  ...
  params = STDIN.read
  result = notification_hubs_regenerate_keys(params)
