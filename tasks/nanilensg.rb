...
def network_interfaces_list_effective_network_security_groups(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkInterfaces/%{network_interface_name}/effectiveNetworkSecurityGroups" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('networkInterfaceName', 'path', 'network_interface_name', 'network_interface_name'),
...
def task
  ...
  params = STDIN.read
  result = network_interfaces_list_effective_network_security_groups(params)
