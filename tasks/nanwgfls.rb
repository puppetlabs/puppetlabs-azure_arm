...
def network_watchers_get_flow_log_status(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkWatchers/%{network_watcher_name}/queryFlowLogStatus" % path_params
...
def task
  ...
  params = STDIN.read
  result = network_watchers_get_flow_log_status(params)
