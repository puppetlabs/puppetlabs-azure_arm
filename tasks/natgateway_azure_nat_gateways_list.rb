...
def nat_gateways_list(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/natGateways" % path_params
...
def task
  ...
  params = STDIN.read
  result = nat_gateways_list(params)
