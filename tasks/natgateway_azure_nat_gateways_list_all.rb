...
def nat_gateways_list_all(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Network/natGateways" % path_params
...
def task
  ...
  params = STDIN.read
  result = nat_gateways_list_all(params)
