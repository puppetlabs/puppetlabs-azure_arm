...
def mount_targets_list(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.NetApp/netAppAccounts/%{account_name}/capacityPools/%{pool_name}/volumes/%{volume_name}/mountTargets" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('poolName', 'path', 'pool_name', 'pool_name'),
...
def task
  ...
  params = STDIN.read
  result = mount_targets_list(params)
