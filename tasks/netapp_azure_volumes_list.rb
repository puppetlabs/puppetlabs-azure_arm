...
def volumes_list(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.NetApp/netAppAccounts/%{account_name}/capacityPools/%{pool_name}/volumes" % path_params
