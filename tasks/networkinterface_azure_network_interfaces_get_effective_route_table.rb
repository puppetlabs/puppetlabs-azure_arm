...
def network_interfaces_get_effective_route_table(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkInterfaces/%{network_interface_name}/effectiveRouteTable" % path_params
...
def task
  ...
  params = STDIN.read
  result = network_interfaces_get_effective_route_table(params)
