...
def network_interfaces_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkInterfaces" % path_params
...
def task
  ...
  params = STDIN.read
  result = network_interfaces_list(params)
