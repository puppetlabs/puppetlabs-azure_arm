...
def network_profiles_list_all(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Network/networkProfiles" % path_params
...
def task
  ...
  params = STDIN.read
  result = network_profiles_list_all(params)
