...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('networkSecurityGroupName', 'path', 'network_security_group_name', 'network_security_group_name'),
...
def task
  ...
  params = STDIN.read
  result = security_rules_list(params)
