...
def network_watchers_get_troubleshooting(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/networkWatchers/%{network_watcher_name}/troubleshoot" % path_params
...
def task
  ...
  params = STDIN.read
  result = network_watchers_get_troubleshooting(params)
