...
def news_category(*args)
  ...
  uri_string = "https://api.cognitive.microsoft.com//news" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('followupqueries', 'body', 'followupqueries', 'followupqueries'),
      op_param('headlineCount', 'query', 'headline_count', 'headline_count'),
      ...
      op_param('totalestimatedmatches', 'body', 'totalestimatedmatches', 'totalestimatedmatches'),
      op_param('User-Agent', 'header', 'user_agent', 'user_agent'),
      op_param('value', 'body', 'value', 'value'),
      op_param('websearchurl', 'body', 'websearchurl', 'websearchurl'),
