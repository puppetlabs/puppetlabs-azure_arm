...
def news_trending(*args)
  ...
  uri_string = "https://api.cognitive.microsoft.com//news/trendingtopics" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('since', 'query', 'since', 'since'),
