...
def notification_hubs_check_notification_hub_availability(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.NotificationHubs/namespaces/%{namespace_name}/checkNotificationHubAvailability" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('isavailiable', 'body', 'is_availiable', 'isavailiable'),
...
def task
  ...
  params = STDIN.read
  result = notification_hubs_check_notification_hub_availability(params)
