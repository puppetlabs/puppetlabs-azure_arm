...
def notification_hubs_get_pns_credentials(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.NotificationHubs/namespaces/%{namespace_name}/notificationHubs/%{notification_hub_name}/pnsCredentials" % path_params
...
def task
  ...
  params = STDIN.read
  result = notification_hubs_get_pns_credentials(params)
