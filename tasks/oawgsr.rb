...
def workspaces_get_search_results(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/Microsoft.OperationalInsights/workspaces/%{workspace_name}/search" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('end', 'body', 'end', 'end'),
      op_param('highlight', 'body', 'highlight', 'highlight'),
      ...
      op_param('start', 'body', 'start', 'start'),
...
def task
  ...
  params = STDIN.read
  result = workspaces_get_search_results(params)
