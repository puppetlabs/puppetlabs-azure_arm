...
def workspaces_regenerate_shared_keys(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/Microsoft.OperationalInsights/workspaces/%{workspace_name}/regenerateSharedKey" % path_params
...
def task
  ...
  params = STDIN.read
  result = workspaces_regenerate_shared_keys(params)
