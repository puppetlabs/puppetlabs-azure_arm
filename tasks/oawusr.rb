...
def workspaces_update_search_results(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/Microsoft.OperationalInsights/workspaces/%{workspace_name}/search/%{id}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('metadata', 'body', 'meta_data', 'metadata'),
...
def task
  ...
  params = STDIN.read
  result = workspaces_update_search_results(params)
