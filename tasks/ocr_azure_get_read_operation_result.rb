...
def get_read_operation_result(*args)
  header_params = {}
  ...
  uri_string = "https://westcentralus.api.cognitive.microsoft.com//read/operations/%{operation_id}" % path_params
...
def task
  ...
  params = STDIN.read
  result = get_read_operation_result(params)
