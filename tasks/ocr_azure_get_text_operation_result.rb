...
def get_text_operation_result(*args)
  header_params = {}
  ...
  uri_string = "https://westcentralus.api.cognitive.microsoft.com//textOperations/%{operation_id}" % path_params
...
def task
  ...
  params = STDIN.read
  result = get_text_operation_result(params)
