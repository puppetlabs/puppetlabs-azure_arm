...
def capacities_check_name_availability(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.PowerBIDedicated/locations/%{location}/checkNameAvailability" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('capacityParameters', 'body', 'capacity_parameters', 'capacity_parameters'),
...
def task
  ...
  params = STDIN.read
  result = capacities_check_name_availability(params)
