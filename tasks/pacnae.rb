...
def check_name_availability_execute(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.DBforPostgreSQL/checkNameAvailability" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('nameAvailabilityRequest', 'body', 'name_availability_request', 'name_availability_request'),
...
def task
  ...
  params = STDIN.read
  result = check_name_availability_execute(params)
