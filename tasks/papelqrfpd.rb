...
def policy_events_list_query_results_for_policy_definition(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/%{authorization_namespace}/policyDefinitions/%{policy_definition_name}/providers/Microsoft.PolicyInsights/policyEvents/%{policy_events_resource}/queryResults" % path_params
...
def task
  ...
  params = STDIN.read
  result = policy_events_list_query_results_for_policy_definition(params)
