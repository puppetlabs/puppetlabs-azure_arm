...
def predict_image_url_with_no_store(*args)
  header_params = {}
  ...
  uri_string = "https://southcentralus.api.cognitive.microsoft.com//%{project_id}/url/nostore" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = PredictImageUrlWithNoStore(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = predict_image_url_with_no_store(params)
