...
def policy_set_definitions_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Authorization/policySetDefinitions/%{policy_set_definition_name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = policy_set_definitions_create_or_update(params)
