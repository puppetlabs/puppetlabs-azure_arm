...
def policy_states_list_query_results_for_management_group(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/%{management_groups_namespace}/managementGroups/%{management_group_name}/providers/Microsoft.PolicyInsights/policyStates/%{policy_states_resource}/queryResults" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('managementGroupName', 'path', 'management_group_name', 'management_group_name'),
      op_param('managementGroupsNamespace', 'path', 'management_groups_namespace', 'management_groups_namespace'),
...
def task
  ...
  params = STDIN.read
  result = policy_states_list_query_results_for_management_group(params)
