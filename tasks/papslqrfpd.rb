...
def policy_states_list_query_results_for_policy_definition(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/%{authorization_namespace}/policyDefinitions/%{policy_definition_name}/providers/Microsoft.PolicyInsights/policyStates/%{policy_states_resource}/queryResults" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('policyDefinitionName', 'path', 'policy_definition_name', 'policy_definition_name'),
...
def task
  ...
  params = STDIN.read
  result = policy_states_list_query_results_for_policy_definition(params)
