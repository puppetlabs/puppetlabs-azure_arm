...
def policy_states_list_query_results_for_policy_set_definition(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/%{authorization_namespace}/policySetDefinitions/%{policy_set_definition_name}/providers/Microsoft.PolicyInsights/policyStates/%{policy_states_resource}/queryResults" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('policySetDefinitionName', 'path', 'policy_set_definition_name', 'policy_set_definition_name'),
...
def task
  ...
  params = STDIN.read
  result = policy_states_list_query_results_for_policy_set_definition(params)
