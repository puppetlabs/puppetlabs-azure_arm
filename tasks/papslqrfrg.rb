...
def policy_states_list_query_results_for_resource_group(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.PolicyInsights/policyStates/%{policy_states_resource}/queryResults" % path_params
...
def task
  ...
  params = STDIN.read
  result = policy_states_list_query_results_for_resource_group(params)
