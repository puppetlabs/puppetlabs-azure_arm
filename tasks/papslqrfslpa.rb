...
def policy_states_list_query_results_for_subscription_level_policy_assignment(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/%{authorization_namespace}/policyAssignments/%{policy_assignment_name}/providers/Microsoft.PolicyInsights/policyStates/%{policy_states_resource}/queryResults" % path_params
...
def task
  ...
  params = STDIN.read
  result = policy_states_list_query_results_for_subscription_level_policy_assignment(params)
