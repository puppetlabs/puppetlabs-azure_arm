...
def policy_states_summarize_for_policy_set_definition(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/%{authorization_namespace}/policySetDefinitions/%{policy_set_definition_name}/providers/Microsoft.PolicyInsights/policyStates/%{policy_states_summary_resource}/summarize" % path_params
...
def task
  ...
  params = STDIN.read
  result = policy_states_summarize_for_policy_set_definition(params)
