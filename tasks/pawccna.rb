...
def workspace_collections_check_name_availability(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.PowerBI/locations/%{location}/checkNameAvailability" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = WorkspaceCollections_checkNameAvailability(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = workspace_collections_check_name_availability(params)
