...
def policy_events_get_metadata(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//%{scope}/providers/Microsoft.PolicyInsights/policyEvents/$metadata" % path_params
...
def task
  ...
  params = STDIN.read
  result = policy_events_get_metadata(params)
