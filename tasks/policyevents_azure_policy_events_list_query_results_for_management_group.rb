...
def policy_events_list_query_results_for_management_group(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/%{management_groups_namespace}/managementGroups/%{management_group_name}/providers/Microsoft.PolicyInsights/policyEvents/%{policy_events_resource}/queryResults" % path_params
...
def task
  ...
  params = STDIN.read
  result = policy_events_list_query_results_for_management_group(params)
