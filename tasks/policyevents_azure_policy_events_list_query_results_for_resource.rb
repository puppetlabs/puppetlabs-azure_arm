...
def policy_events_list_query_results_for_resource(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//%{resource_id}/providers/Microsoft.PolicyInsights/policyEvents/%{policy_events_resource}/queryResults" % path_params
...
def task
  ...
  params = STDIN.read
  result = policy_events_list_query_results_for_resource(params)
