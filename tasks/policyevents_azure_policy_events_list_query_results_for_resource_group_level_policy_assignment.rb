...
def policy_events_list_query_results_for_resource_group_level_policy_assignment(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/%{authorization_namespace}/policyAssignments/%{policy_assignment_name}/providers/Microsoft.PolicyInsights/policyEvents/%{policy_events_resource}/queryResults" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('policyEventsResource', 'path', 'policy_events_resource', 'policy_events_resource'),
...
def task
  ...
  params = STDIN.read
  result = policy_events_list_query_results_for_resource_group_level_policy_assignment(params)
