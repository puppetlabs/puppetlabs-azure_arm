...
def policy_set_definitions_create_or_update_at_management_group(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.Management/managementgroups/%{management_group_id}/providers/Microsoft.Authorization/policySetDefinitions/%{policy_set_definition_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('errorcode', 'body', 'errorcode', 'errorcode'),
      op_param('errormessage', 'body', 'errormessage', 'errormessage'),
      op_param('httpstatus', 'body', 'httpstatus', 'httpstatus'),
      op_param('managementGroupId', 'path', 'management_group_id', 'management_group_id'),
...
def task
  ...
  params = STDIN.read
  result = policy_set_definitions_create_or_update_at_management_group(params)
