...
def policy_states_get_metadata(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//%{scope}/providers/Microsoft.PolicyInsights/policyStates/$metadata" % path_params
...
def task
  ...
  params = STDIN.read
  result = policy_states_get_metadata(params)
