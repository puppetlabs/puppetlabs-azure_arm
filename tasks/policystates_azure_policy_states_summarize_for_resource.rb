...
def policy_states_summarize_for_resource(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//%{resource_id}/providers/Microsoft.PolicyInsights/policyStates/%{policy_states_summary_resource}/summarize" % path_params
...
def task
  ...
  params = STDIN.read
  result = policy_states_summarize_for_resource(params)
