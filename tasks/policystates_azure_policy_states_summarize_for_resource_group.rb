...
def policy_states_summarize_for_resource_group(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.PolicyInsights/policyStates/%{policy_states_summary_resource}/summarize" % path_params
...
def task
  ...
  params = STDIN.read
  result = policy_states_summarize_for_resource_group(params)
