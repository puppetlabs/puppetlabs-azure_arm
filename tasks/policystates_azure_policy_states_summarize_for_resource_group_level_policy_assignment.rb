...
def policy_states_summarize_for_resource_group_level_policy_assignment(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/%{authorization_namespace}/policyAssignments/%{policy_assignment_name}/providers/Microsoft.PolicyInsights/policyStates/%{policy_states_summary_resource}/summarize" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('policyStatesSummaryResource', 'path', 'policy_states_summary_resource', 'policy_states_summary_resource'),
...
def task
  ...
  params = STDIN.read
  result = policy_states_summarize_for_resource_group_level_policy_assignment(params)
