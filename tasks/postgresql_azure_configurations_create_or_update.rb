...
def configurations_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DBforPostgreSQL/servers/%{server_name}/configurations/%{configuration_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('configurationName', 'path', 'name', 'configuration_name'),
...
def task
  ...
  params = STDIN.read
  result = configurations_create_or_update(params)
