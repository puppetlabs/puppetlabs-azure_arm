...
def firewall_rules_list_by_server(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DBforPostgreSQL/servers/%{server_name}/firewallRules" % path_params
...
def task
  ...
  params = STDIN.read
  result = firewall_rules_list_by_server(params)
