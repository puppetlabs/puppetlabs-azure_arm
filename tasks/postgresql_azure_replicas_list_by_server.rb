...
def replicas_list_by_server(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DBforPostgreSQL/servers/%{server_name}/Replicas" % path_params
...
def task
  ...
  params = STDIN.read
  result = replicas_list_by_server(params)
