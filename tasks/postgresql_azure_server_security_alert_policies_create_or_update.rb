...
def server_security_alert_policies_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.DBforPostgreSQL/servers/%{server_name}/securityAlertPolicies/%{security_alert_policy_name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = server_security_alert_policies_create_or_update(params)
