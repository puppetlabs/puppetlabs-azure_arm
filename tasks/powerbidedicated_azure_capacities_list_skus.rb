...
def capacities_list_skus(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.PowerBIDedicated/skus" % path_params
...
def task
  ...
  params = STDIN.read
  result = capacities_list_skus(params)
