...
def get_available_operations(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.PowerBI/operations" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = getAvailableOperations(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_available_operations(params)
