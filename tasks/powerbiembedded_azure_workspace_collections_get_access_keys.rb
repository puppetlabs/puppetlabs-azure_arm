...
def workspace_collections_get_access_keys(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.PowerBI/workspaceCollections/%{workspace_collection_name}/listKeys" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = WorkspaceCollections_getAccessKeys(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = workspace_collections_get_access_keys(params)
