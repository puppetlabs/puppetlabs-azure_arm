...
def workspace_collections_list_by_subscription(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.PowerBI/workspaceCollections" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = WorkspaceCollections_listBySubscription(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = workspace_collections_list_by_subscription(params)
