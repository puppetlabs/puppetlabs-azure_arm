...
def workspaces_list(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.PowerBI/workspaceCollections/%{workspace_collection_name}/workspaces" % path_params
