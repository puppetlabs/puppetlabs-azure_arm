...
def classify_image(*args)
  ...
  uri_string = "https://southcentralus.api.cognitive.microsoft.com//%{project_id}/classify/iterations/%{published_name}/image" % path_params
