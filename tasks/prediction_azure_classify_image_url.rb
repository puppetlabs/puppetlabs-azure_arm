...
def classify_image_url(*args)
  ...
  uri_string = "https://southcentralus.api.cognitive.microsoft.com//%{project_id}/classify/iterations/%{published_name}/url" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = ClassifyImageUrl(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = classify_image_url(params)
