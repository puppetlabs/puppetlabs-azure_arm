...
def classify_image_with_no_store(*args)
  header_params = {}
  ...
  uri_string = "https://southcentralus.api.cognitive.microsoft.com//%{project_id}/classify/iterations/%{published_name}/image/nostore" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = ClassifyImageWithNoStore(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = classify_image_with_no_store(params)
