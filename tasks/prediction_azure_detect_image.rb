...
def detect_image(*args)
  ...
  uri_string = "https://southcentralus.api.cognitive.microsoft.com//%{project_id}/detect/iterations/%{published_name}/image" % path_params
