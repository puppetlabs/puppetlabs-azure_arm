...
def detect_image_url(*args)
  ...
  uri_string = "https://southcentralus.api.cognitive.microsoft.com//%{project_id}/detect/iterations/%{published_name}/url" % path_params
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = detect_image_url(params)
