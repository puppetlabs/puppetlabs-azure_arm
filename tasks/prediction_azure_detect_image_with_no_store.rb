...
def detect_image_with_no_store(*args)
  header_params = {}
  ...
  uri_string = "https://southcentralus.api.cognitive.microsoft.com//%{project_id}/detect/iterations/%{published_name}/image/nostore" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = DetectImageWithNoStore(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = detect_image_with_no_store(params)
