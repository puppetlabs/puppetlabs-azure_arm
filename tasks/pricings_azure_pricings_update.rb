...
def pricings_update(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Security/pricings/%{pricing_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('pricing', 'body', 'pricing', 'pricing'),
      op_param('pricingName', 'path', 'name', 'pricing_name'),
