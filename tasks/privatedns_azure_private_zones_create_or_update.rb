...
def private_zones_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/privateDnsZones/%{private_zone_name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = private_zones_create_or_update(params)
