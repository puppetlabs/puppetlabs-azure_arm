...
def private_zones_list(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Network/privateDnsZones" % path_params
...
def task
  ...
  params = STDIN.read
  result = private_zones_list(params)
