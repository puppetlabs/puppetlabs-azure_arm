...
def record_sets_list_by_type(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/privateDnsZones/%{private_zone_name}/%{record_type}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('$recordsetnamesuffix', 'query', '$recordsetnamesuffix', '$recordsetnamesuffix'),
...
def task
  ...
  params = STDIN.read
  result = record_sets_list_by_type(params)
