...
def private_endpoints_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/privateEndpoints" % path_params
...
def task
  ...
  params = STDIN.read
  result = private_endpoints_list(params)
