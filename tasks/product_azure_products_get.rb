...
def products_get(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group}/providers/Microsoft.AzureStack/registrations/%{registration_name}/products/%{product_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('productName', 'path', 'name', 'product_name'),
