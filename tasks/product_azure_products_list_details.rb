...
def products_list_details(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group}/providers/Microsoft.AzureStack/registrations/%{registration_name}/products/%{product_name}/listDetails" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('gallerypackageblobsasuri', 'body', 'gallery_package_blob_sas_uri', 'gallerypackageblobsasuri'),
      op_param('productkind', 'body', 'product_kind', 'productkind'),
      op_param('productName', 'path', 'product_name', 'product_name'),
      op_param('properties', 'body', 'properties', 'properties'),
      op_param('registrationName', 'path', 'registration_name', 'registration_name'),
      op_param('resourceGroup', 'path', 'resource_group', 'resource_group'),
...
def task
  ...
  params = STDIN.read
  result = products_list_details(params)
