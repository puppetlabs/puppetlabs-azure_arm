...
def provider_get_available_stacks(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.Web/availableStacks" % path_params
...
def task
  ...
  params = STDIN.read
  result = provider_get_available_stacks(params)
