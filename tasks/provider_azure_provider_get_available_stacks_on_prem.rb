...
def provider_get_available_stacks_on_prem(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Web/availableStacks" % path_params
...
def task
  ...
  params = STDIN.read
  result = provider_get_available_stacks_on_prem(params)
