...
def knowledgebase_create(*args)
  ...
  uri_string = "https:////knowledgebases/create" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('createKbPayload', 'body', 'create_kb_payload', 'create_kb_payload'),
...
def task
  ...
  params = STDIN.read
  result = knowledgebase_create(params)
