...
def runtime_train(*args)
  ...
  uri_string = "https:////knowledgebases/%{kb_id}/train" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('trainPayload', 'body', 'train_payload', 'train_payload'),
    ]
  op_params.each do |i|
    location = i[:location]
    name     = i[:name]
