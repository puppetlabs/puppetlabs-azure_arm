...
def query_statistics_list_by_query(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Sql/servers/%{server_name}/databases/%{database_name}/topQueries/%{query_id}/statistics" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('queryId', 'path', 'query_id', 'query_id'),
...
def task
  ...
  params = STDIN.read
  result = query_statistics_list_by_query(params)
