...
def availability_statuses_list_by_subscription_id(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.ResourceHealth/availabilityStatuses" % path_params
...
def task
  ...
  params = STDIN.read
  result = availability_statuses_list_by_subscription_id(params)
