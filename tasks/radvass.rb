...
def deployments_validate_at_subscription_scope(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Resources/deployments/%{deployment_name}/validate" % path_params
...
def task
  ...
  params = STDIN.read
  result = deployments_validate_at_subscription_scope(params)
