...
def hybrid_connections_create_or_update_authorization_rule(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Relay/namespaces/%{namespace_name}/hybridConnections/%{hybrid_connection_name}/authorizationRules/%{authorization_rule_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('hybridConnectionName', 'path', 'hybrid_connection_name', 'hybrid_connection_name'),
...
def task
  ...
  params = STDIN.read
  result = hybrid_connections_create_or_update_authorization_rule(params)
