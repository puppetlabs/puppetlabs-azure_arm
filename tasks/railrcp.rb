...
def item_level_recovery_connections_provision(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{vault_name}/backupFabrics/%{fabric_name}/protectionContainers/%{container_name}/protectedItems/%{protected_item_name}/recoveryPoints/%{recovery_point_id}/provisionInstantItemRecovery" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('recoveryPointId', 'path', 'recovery_point_id', 'recovery_point_id'),
      op_param('resourceGroupName', 'path', 'resource_group_name', 'resource_group_name'),
      op_param('resourceILRRequest', 'body', 'resource_ilr_request', 'resource_ilr_request'),
...
def task
  ...
  params = STDIN.read
  result = item_level_recovery_connections_provision(params)
