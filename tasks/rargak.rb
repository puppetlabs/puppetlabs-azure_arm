...
def registrations_get_activation_key(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group}/providers/Microsoft.AzureStack/registrations/%{registration_name}/getactivationkey" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('activationkey', 'body', 'activation_key', 'activationkey'),
...
def task
  ...
  params = STDIN.read
  result = registrations_get_activation_key(params)
