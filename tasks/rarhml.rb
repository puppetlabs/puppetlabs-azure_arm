...
def resource_health_metadata_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Web/resourceHealthMetadata" % path_params
...
def task
  ...
  params = STDIN.read
  result = resource_health_metadata_list(params)
