...
def verify_hosting_environment_vnet(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Web/verifyHostingEnvironmentVnet" % path_params
...
def task
  ...
  params = STDIN.read
  result = verify_hosting_environment_vnet(params)
