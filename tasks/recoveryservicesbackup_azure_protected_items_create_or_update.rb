...
def protected_items_create_or_update(*args)
  header_params = {}
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('resourceProtectedItem', 'body', 'resource_protected_item', 'resource_protected_item'),
...
def task
  ...
  params = STDIN.read
  result = protected_items_create_or_update(params)
