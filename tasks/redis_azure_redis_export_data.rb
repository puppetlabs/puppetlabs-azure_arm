...
def redis_export_data(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Cache/Redis/%{name}/export" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('prefix', 'body', 'prefix', 'prefix'),
...
def task
  ...
  params = STDIN.read
  result = redis_export_data(params)
