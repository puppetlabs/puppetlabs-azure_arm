...
def redis_list_upgrade_notifications(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Cache/Redis/%{name}/listUpgradeNotifications" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('history', 'query', 'history', 'history'),
...
def task
  ...
  params = STDIN.read
  result = redis_list_upgrade_notifications(params)
