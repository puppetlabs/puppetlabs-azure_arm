...
def vault_certificates_create(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{vault_name}/certificates/%{certificate_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('certificateRequest', 'body', 'certificate_request', 'certificate_request'),
...
def task
  ...
  params = STDIN.read
  result = vault_certificates_create(params)
