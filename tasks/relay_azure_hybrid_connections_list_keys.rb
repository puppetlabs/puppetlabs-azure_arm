...
def hybrid_connections_list_keys(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Relay/namespaces/%{namespace_name}/hybridConnections/%{hybrid_connection_name}/authorizationRules/%{authorization_rule_name}/listKeys" % path_params
...
def task
  ...
  params = STDIN.read
  result = hybrid_connections_list_keys(params)
