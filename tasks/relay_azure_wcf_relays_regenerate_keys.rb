...
def wcf_relays_regenerate_keys(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Relay/namespaces/%{namespace_name}/wcfRelays/%{relay_name}/authorizationRules/%{authorization_rule_name}/regenerateKeys" % path_params
...
def task
  ...
  params = STDIN.read
  result = wcf_relays_regenerate_keys(params)
