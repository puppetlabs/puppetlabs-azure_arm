...
def replication_usages_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{vault_name}/replicationUsages" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('jobssummary', 'body', 'jobs_summary', 'jobssummary'),
      op_param('monitoringsummary', 'body', 'monitoring_summary', 'monitoringsummary'),
      op_param('protecteditemcount', 'body', 'protected_item_count', 'protecteditemcount'),
      op_param('recoveryplancount', 'body', 'recovery_plan_count', 'recoveryplancount'),
      op_param('recoveryservicesproviderauthtype', 'body', 'recovery_services_provider_auth_type', 'recoveryservicesproviderauthtype'),
      op_param('registeredserverscount', 'body', 'registered_servers_count', 'registeredserverscount'),
...
def task
  ...
  params = STDIN.read
  result = replication_usages_list(params)
