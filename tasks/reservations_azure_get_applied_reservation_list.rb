...
def get_applied_reservation_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Capacity/appliedReservations" % path_params
...
def task
  ...
  params = STDIN.read
  result = get_applied_reservation_list(params)
