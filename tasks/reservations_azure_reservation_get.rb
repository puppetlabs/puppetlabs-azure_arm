...
def reservation_get(*args)
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.Capacity/reservationOrders/%{reservation_order_id}/reservations/%{reservation_id}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('reservationId', 'path', 'reservation_id', 'reservation_id'),
