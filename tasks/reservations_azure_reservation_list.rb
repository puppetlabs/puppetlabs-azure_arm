...
def reservation_list(*args)
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.Capacity/reservationOrders/%{reservation_order_id}/reservations" % path_params
...
def task
  ...
  params = STDIN.read
  result = reservation_list(params)
