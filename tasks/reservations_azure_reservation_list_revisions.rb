...
def reservation_list_revisions(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.Capacity/reservationOrders/%{reservation_order_id}/reservations/%{reservation_id}/revisions" % path_params
...
def task
  ...
  params = STDIN.read
  result = reservation_list_revisions(params)
