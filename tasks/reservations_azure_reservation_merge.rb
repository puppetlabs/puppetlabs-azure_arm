...
def reservation_merge(*args)
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.Capacity/reservationOrders/%{reservation_order_id}/merge" % path_params
...
def task
  ...
  params = STDIN.read
  result = reservation_merge(params)
