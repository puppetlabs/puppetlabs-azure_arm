...
def reservation_order_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.Capacity/reservationOrders/%{reservation_order_id}" % path_params
...
def task
  ...
  params = STDIN.read
  result = reservation_order_get(params)
