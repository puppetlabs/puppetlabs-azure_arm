...
def reservation_order_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.Capacity/reservationOrders" % path_params
...
def task
  ...
  params = STDIN.read
  result = reservation_order_list(params)
