...
def reservation_split(*args)
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.Capacity/reservationOrders/%{reservation_order_id}/split" % path_params
...
def task
  ...
  params = STDIN.read
  result = reservation_split(params)
