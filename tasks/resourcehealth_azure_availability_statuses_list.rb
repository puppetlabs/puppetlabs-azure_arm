...
def availability_statuses_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//%{resource_uri}/providers/Microsoft.ResourceHealth/availabilityStatuses" % path_params
...
def task
  ...
  params = STDIN.read
  result = availability_statuses_list(params)
