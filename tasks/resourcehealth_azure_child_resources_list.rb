...
def child_resources_list(*args)
  ...
  uri_string = "https://management.azure.com//%{resource_uri}/providers/Microsoft.ResourceHealth/childResources" % path_params
...
def task
  ...
  params = STDIN.read
  result = child_resources_list(params)
