...
def get_subscription_deployment_locations(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Web/deploymentLocations" % path_params
...
def task
  ...
  params = STDIN.read
  result = get_subscription_deployment_locations(params)
