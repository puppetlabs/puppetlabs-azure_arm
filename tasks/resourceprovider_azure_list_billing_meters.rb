...
def list_billing_meters(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Web/billingMeters" % path_params
...
def task
  ...
  params = STDIN.read
  result = list_billing_meters(params)
