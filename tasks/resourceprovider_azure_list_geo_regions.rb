...
def list_geo_regions(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Web/geoRegions" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('linuxDynamicWorkersEnabled', 'query', 'linux_dynamic_workers_enabled', 'linux_dynamic_workers_enabled'),
      op_param('linuxWorkersEnabled', 'query', 'linux_workers_enabled', 'linux_workers_enabled'),
      op_param('name', 'body', 'name', 'name'),
      op_param('properties', 'body', 'properties', 'properties'),
      op_param('sku', 'query', 'sku', 'sku'),
      op_param('subscriptionId', 'path', 'subscription_id', 'subscription_id'),
      op_param('type', 'body', 'type', 'type'),
      op_param('xenonWorkersEnabled', 'query', 'xenon_workers_enabled', 'xenon_workers_enabled'),
    ]
  op_params.each do |i|
    location = i[:location]
    name     = i[:name]
...
def task
  ...
  params = STDIN.read
  result = list_geo_regions(params)
