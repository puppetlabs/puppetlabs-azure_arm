...
def validate(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/validate" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('validateRequest', 'body', 'validate_request', 'validate_request'),
    ]
  op_params.each do |i|
    location = i[:location]
    name     = i[:name]
