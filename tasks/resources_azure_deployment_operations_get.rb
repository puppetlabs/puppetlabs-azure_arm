...
def deployment_operations_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/deployments/%{deployment_name}/operations/%{operation_id}" % path_params
...
def task
  ...
  params = STDIN.read
  result = deployment_operations_get(params)
