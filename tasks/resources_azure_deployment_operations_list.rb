...
def deployment_operations_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/deployments/%{deployment_name}/operations" % path_params
...
def task
  ...
  params = STDIN.read
  result = deployment_operations_list(params)
