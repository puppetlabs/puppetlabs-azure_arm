...
def deployments_cancel(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/Microsoft.Resources/deployments/%{deployment_name}/cancel" % path_params
...
def task
  ...
  params = STDIN.read
  result = deployments_cancel(params)
