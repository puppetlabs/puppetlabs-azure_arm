...
def deployments_cancel_at_scope(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//%{scope}/providers/Microsoft.Resources/deployments/%{deployment_name}/cancel" % path_params
...
def task
  ...
  params = STDIN.read
  result = deployments_cancel_at_scope(params)
