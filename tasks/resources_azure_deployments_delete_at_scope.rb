...
def deployments_delete_at_scope(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//%{scope}/providers/Microsoft.Resources/deployments/%{deployment_name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = deployments_delete_at_scope(params)
