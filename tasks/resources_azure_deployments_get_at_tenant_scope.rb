...
def deployments_get_at_tenant_scope(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.Resources/deployments/%{deployment_name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = deployments_get_at_tenant_scope(params)
