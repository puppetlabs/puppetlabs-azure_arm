...
def deployments_list_at_scope(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//%{scope}/providers/Microsoft.Resources/deployments/" % path_params
...
def task
  ...
  params = STDIN.read
  result = deployments_list_at_scope(params)
