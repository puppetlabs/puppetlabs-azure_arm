...
def deployments_validate(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/Microsoft.Resources/deployments/%{deployment_name}/validate" % path_params
...
def task
  ...
  params = STDIN.read
  result = deployments_validate(params)
