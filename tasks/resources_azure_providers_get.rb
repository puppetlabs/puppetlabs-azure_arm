...
def providers_get(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/%{resource_provider_namespace}" % path_params
