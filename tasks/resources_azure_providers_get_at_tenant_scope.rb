...
def providers_get_at_tenant_scope(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/%{resource_provider_namespace}" % path_params
...
def task
  ...
  params = STDIN.read
  result = providers_get_at_tenant_scope(params)
