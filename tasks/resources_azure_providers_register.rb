...
def providers_register(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/%{resource_provider_namespace}/register" % path_params
...
def task
  ...
  params = STDIN.read
  result = providers_register(params)
