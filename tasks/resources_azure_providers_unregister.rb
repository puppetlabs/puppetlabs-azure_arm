...
def providers_unregister(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/%{resource_provider_namespace}/unregister" % path_params
...
def task
  ...
  params = STDIN.read
  result = providers_unregister(params)
