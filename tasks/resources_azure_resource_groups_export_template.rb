...
def resource_groups_export_template(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/exportTemplate" % path_params
...
def task
  ...
  params = STDIN.read
  result = resource_groups_export_template(params)
