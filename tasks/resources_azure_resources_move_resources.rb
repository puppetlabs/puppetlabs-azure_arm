...
def resources_move_resources(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{source_resource_group_name}/moveResources" % path_params
...
def task
  ...
  params = STDIN.read
  result = resources_move_resources(params)
