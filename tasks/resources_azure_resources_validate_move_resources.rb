...
def resources_validate_move_resources(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{source_resource_group_name}/validateMoveResources" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('sourceResourceGroupName', 'path', 'source_resource_group_name', 'source_resource_group_name'),
...
def task
  ...
  params = STDIN.read
  result = resources_validate_move_resources(params)
