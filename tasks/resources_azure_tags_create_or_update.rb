...
def tags_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/tagNames/%{tag_name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = tags_create_or_update(params)
