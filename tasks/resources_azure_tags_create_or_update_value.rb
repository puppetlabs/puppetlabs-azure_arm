...
def tags_create_or_update_value(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/tagNames/%{tag_name}/tagValues/%{tag_value}" % path_params
...
def task
  ...
  params = STDIN.read
  result = tags_create_or_update_value(params)
