...
def virtual_machine_scale_set_v_ms_run_command(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/virtualMachineScaleSets/%{vm_scale_set_name}/virtualmachines/%{instance_id}/runCommand" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('commandid', 'body', 'command_id', 'commandid'),
      ...
      op_param('script', 'body', 'script', 'script'),
...
def task
  ...
  params = STDIN.read
  result = virtual_machine_scale_set_v_ms_run_command(params)
