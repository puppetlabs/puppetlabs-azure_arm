...
def virtual_machines_run_command(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Compute/virtualMachines/%{vm_name}/runCommand" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('commandid', 'body', 'commandid', 'commandid'),
...
def task
  ...
  params = STDIN.read
  result = virtual_machines_run_command(params)
