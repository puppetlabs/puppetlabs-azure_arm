...
def bgp_service_communities_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Network/bgpServiceCommunities" % path_params
...
def task
  ...
  params = STDIN.read
  result = bgp_service_communities_list(params)
