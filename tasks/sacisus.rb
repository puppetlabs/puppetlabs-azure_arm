...
def commit_image_store_upload_session(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//ImageStore/$/CommitUploadSession" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = CommitImageStoreUploadSession(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = commit_image_store_upload_session(params)
