...
def certificate_orders_renew_certificate_order(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CertificateRegistration/certificateOrders/%{name}/renew" % path_params
...
def task
  ...
  params = STDIN.read
  result = certificate_orders_renew_certificate_order(params)
