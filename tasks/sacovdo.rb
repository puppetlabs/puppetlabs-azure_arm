...
def certificate_orders_verify_domain_ownership(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CertificateRegistration/certificateOrders/%{name}/verifyDomainOwnership" % path_params
...
def task
  ...
  params = STDIN.read
  result = certificate_orders_verify_domain_ownership(params)
