...
def get_compose_deployment_status_list(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//ComposeDeployments" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetComposeDeploymentStatusList(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_compose_deployment_status_list(params)
