...
def global_domain_registration_validate_domain_purchase_information(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.DomainRegistration/validateDomainRegistrationInformation" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('domainRegistrationInput', 'body', 'domain_registration_input', 'domain_registration_input'),
...
def task
  ...
  params = STDIN.read
  result = global_domain_registration_validate_domain_purchase_information(params)
