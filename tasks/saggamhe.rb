...
def global_get_all_managed_hosting_environments(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Web/managedHostingEnvironments" % path_params
...
def task
  ...
  params = STDIN.read
  result = global_get_all_managed_hosting_environments(params)
