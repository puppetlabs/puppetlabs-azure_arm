...
def global_update_subscription_publishing_credentials(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Web/publishingCredentials" % path_params
...
def task
  ...
  params = STDIN.read
  result = global_update_subscription_publishing_credentials(params)
