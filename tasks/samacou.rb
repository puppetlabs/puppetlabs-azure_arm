...
def mesh_application_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Resources/Applications/%{application_resource_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('applicationResourceDescription', 'body', 'application_resource_description', 'application_resource_description'),
...
def authenticate
  ...
  params = STDIN.read
  result = MeshApplication_CreateOrUpdate(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = mesh_application_create_or_update(params)
