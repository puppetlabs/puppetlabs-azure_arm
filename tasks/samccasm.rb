...
def migration_configs_create_and_start_migration(*args)
  header_params = {}
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('configName', 'path', 'config_name', 'config_name'),
...
def task
  ...
  params = STDIN.read
  result = migration_configs_create_and_start_migration(params)
