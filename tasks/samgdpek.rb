...
def managers_get_device_public_encryption_key(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorSimple/managers/%{manager_name}/devices/%{device_name}/publicEncryptionKey" % path_params
...
def task
  ...
  params = STDIN.read
  result = managers_get_device_public_encryption_key(params)
