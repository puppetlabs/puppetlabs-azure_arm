...
def replication_fabrics_reassociate_gateway(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationFabrics/%{fabric_name}/reassociateGateway" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('failoverProcessServerRequest', 'body', 'failover_process_server_request', 'failover_process_server_request'),
...
def task
  ...
  params = STDIN.read
  result = replication_fabrics_reassociate_gateway(params)
