...
def recommendations_get_recommendation_by_subscription(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Web/recommendations" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('actionname', 'body', 'action_name', 'actionname'),
      op_param('api-version', 'query', 'api_version', 'api_version'),
      op_param('channels', 'body', 'channels', 'channels'),
      op_param('creationtime', 'body', 'creation_time', 'creationtime'),
      ...
      op_param('nextnotificationtime', 'body', 'next_notification_time', 'nextnotificationtime'),
      op_param('notificationexpirationtime', 'body', 'notification_expiration_time', 'notificationexpirationtime'),
      op_param('notifiedtime', 'body', 'notified_time', 'notifiedtime'),
      op_param('recommendationid', 'body', 'recommendationid', 'recommendationid'),
      op_param('resourceid', 'body', 'resource_id', 'resourceid'),
      op_param('resourcescope', 'body', 'resource_scope', 'resourcescope'),
      op_param('rulename', 'body', 'rule_name', 'rulename'),
      op_param('score', 'body', 'score', 'score'),
...
def task
  ...
  params = STDIN.read
  result = recommendations_get_recommendation_by_subscription(params)
