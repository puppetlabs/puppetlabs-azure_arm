...
def replication_network_mappings_create(*args)
  header_params = {}
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('networkMappingName', 'path', 'network_mapping_name', 'network_mapping_name'),
      op_param('networkName', 'path', 'network_name', 'network_name'),
...
def task
  ...
  params = STDIN.read
  result = replication_network_mappings_create(params)
