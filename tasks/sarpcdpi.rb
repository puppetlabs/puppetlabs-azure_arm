...
def replication_protection_containers_discover_protectable_item(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationFabrics/%{fabric_name}/replicationProtectionContainers/%{protection_container_name}/discoverProtectableItem" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('discoverProtectableItemRequest', 'body', 'discover_protectable_item_request', 'discover_protectable_item_request'),
...
def task
  ...
  params = STDIN.read
  result = replication_protection_containers_discover_protectable_item(params)
