...
def replication_protection_container_mappings_delete(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationFabrics/%{fabric_name}/replicationProtectionContainers/%{protection_container_name}/replicationProtectionContainerMappings/%{mapping_name}/remove" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('removalInput', 'body', 'removal_input', 'removal_input'),
...
def task
  ...
  params = STDIN.read
  result = replication_protection_container_mappings_delete(params)
