...
def replication_protected_items_delete(*args)
  header_params = {}
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('disableProtectionInput', 'body', 'disable_protection_input', 'disable_protection_input'),
...
def task
  ...
  params = STDIN.read
  result = replication_protected_items_delete(params)
