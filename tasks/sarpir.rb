...
def replication_protected_items_reprotect(*args)
  header_params = {}
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('rrInput', 'body', 'rr_input', 'rr_input'),
...
def task
  ...
  params = STDIN.read
  result = replication_protected_items_reprotect(params)
