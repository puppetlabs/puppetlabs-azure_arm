...
def replication_protected_items_test_failover_cleanup(*args)
  header_params = {}
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('cleanupInput', 'body', 'cleanup_input', 'cleanup_input'),
...
def task
  ...
  params = STDIN.read
  result = replication_protected_items_test_failover_cleanup(params)
