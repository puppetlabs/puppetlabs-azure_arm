...
def replication_protected_items_unplanned_failover(*args)
  header_params = {}
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('failoverInput', 'body', 'failover_input', 'failover_input'),
...
def task
  ...
  params = STDIN.read
  result = replication_protected_items_unplanned_failover(params)
