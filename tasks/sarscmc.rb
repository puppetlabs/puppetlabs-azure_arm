...
def replication_storage_classification_mappings_create(*args)
  header_params = {}
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('pairingInput', 'body', 'pairing_input', 'pairing_input'),
      ...
      op_param('storageClassificationMappingName', 'path', 'storage_classification_mapping_name', 'storage_classification_mapping_name'),
      op_param('storageClassificationName', 'path', 'storage_classification_name', 'storage_classification_name'),
...
def task
  ...
  params = STDIN.read
  result = replication_storage_classification_mappings_create(params)
