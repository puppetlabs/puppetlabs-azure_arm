...
def sites_add_site_premier_add_on_slot(*args)
  header_params = {}
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('premierAddOn', 'body', 'premier_add_on', 'premier_add_on'),
      op_param('premierAddOnName', 'path', 'premier_add_on_name', 'premier_add_on_name'),
...
def task
  ...
  params = STDIN.read
  result = sites_add_site_premier_add_on_slot(params)
