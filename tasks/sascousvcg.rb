...
def sites_create_or_update_site_vnet_connection_gateway(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/virtualNetworkConnections/%{vnet_name}/gateways/%{gateway_name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = sites_create_or_update_site_vnet_connection_gateway(params)
