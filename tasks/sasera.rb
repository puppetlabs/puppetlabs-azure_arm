...
def server_endpoints_recall_action(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorageSync/storageSyncServices/%{storage_sync_service_name}/syncGroups/%{sync_group_name}/serverEndpoints/%{server_endpoint_name}/recallAction" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('recallpath', 'body', 'recall_path', 'recallpath'),
...
def task
  ...
  params = STDIN.read
  result = server_endpoints_recall_action(params)
