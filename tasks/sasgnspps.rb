...
def sites_generate_new_site_publishing_password_slot(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/newpassword" % path_params
...
def task
  ...
  params = STDIN.read
  result = sites_generate_new_site_publishing_password_slot(params)
