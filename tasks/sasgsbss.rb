...
def sites_get_site_backup_status_secrets(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/backups/%{backup_id}/list" % path_params
...
def task
  ...
  params = STDIN.read
  result = sites_get_site_backup_status_secrets(params)
