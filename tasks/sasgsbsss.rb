...
def sites_get_site_backup_status_secrets_slot(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/backups/%{backup_id}/list" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('backupId', 'path', 'backup_id', 'backup_id'),
...
def task
  ...
  params = STDIN.read
  result = sites_get_site_backup_status_secrets_slot(params)
