...
def streaming_locators_list_paths(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Media/mediaServices/%{account_name}/streamingLocators/%{streaming_locator_name}/listPaths" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('downloadpaths', 'body', 'download_paths', 'downloadpaths'),
      op_param('resourceGroupName', 'path', 'resource_group_name', 'resource_group_name'),
      op_param('streamingLocatorName', 'path', 'streaming_locator_name', 'streaming_locator_name'),
      op_param('streamingpaths', 'body', 'streaming_paths', 'streamingpaths'),
...
def task
  ...
  params = STDIN.read
  result = streaming_locators_list_paths(params)
