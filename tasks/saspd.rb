...
def streaming_policies_delete(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Media/mediaServices/%{account_name}/streamingPolicies/%{streaming_policy_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('streamingPolicyName', 'path', 'streaming_policy_name', 'streaming_policy_name'),
...
def task
  ...
  params = STDIN.read
  result = streaming_policies_delete(params)
