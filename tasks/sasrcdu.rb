...
def start_rollback_compose_deployment_upgrade(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//ComposeDeployments/%{deployment_name}/$/RollbackUpgrade" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = StartRollbackComposeDeploymentUpgrade(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = start_rollback_compose_deployment_upgrade(params)
