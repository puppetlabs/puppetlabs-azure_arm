...
def job_collections_list_by_subscription(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Scheduler/jobCollections" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = JobCollections_ListBySubscription(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = job_collections_list_by_subscription(params)
