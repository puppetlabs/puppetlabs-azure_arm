...
def jobs_list_job_history(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Scheduler/jobCollections/%{job_collection_name}/jobs/%{job_name}/history" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = Jobs_ListJobHistory(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = jobs_list_job_history(params)
