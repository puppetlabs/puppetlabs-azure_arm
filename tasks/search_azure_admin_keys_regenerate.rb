...
def admin_keys_regenerate(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Search/searchServices/%{search_service_name}/regenerateAdminKey/%{key_kind}" % path_params
...
def task
  ...
  params = STDIN.read
  result = admin_keys_regenerate(params)
