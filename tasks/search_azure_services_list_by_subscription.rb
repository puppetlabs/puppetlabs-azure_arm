...
def services_list_by_subscription(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Search/searchServices" % path_params
...
def task
  ...
  params = STDIN.read
  result = services_list_by_subscription(params)
