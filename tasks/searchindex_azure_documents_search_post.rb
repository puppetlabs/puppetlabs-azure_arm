...
def documents_search_post(*args)
  header_params = {}
  ...
  uri_string = "https:////docs/search.post.search" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('searchRequest', 'body', 'search_request', 'search_request'),
...
def authenticate
  ...
  params = STDIN.read
  result = Documents_SearchPost(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = documents_search_post(params)
