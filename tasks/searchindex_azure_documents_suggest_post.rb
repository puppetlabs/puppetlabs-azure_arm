...
def documents_suggest_post(*args)
  header_params = {}
  ...
  uri_string = "https:////docs/search.post.suggest" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('suggestRequest', 'body', 'suggest_request', 'suggest_request'),
...
def authenticate
  ...
  params = STDIN.read
  result = Documents_SuggestPost(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = documents_suggest_post(params)
