...
def data_sources_create(*args)
  ...
  uri_string = "https:////datasources" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('dataSource', 'body', 'data_source', 'data_source'),
...
def authenticate
  ...
  params = STDIN.read
  result = DataSources_Create(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = data_sources_create(params)
