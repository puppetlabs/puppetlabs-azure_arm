...
def synonym_maps_create(*args)
  ...
  uri_string = "https:////synonymmaps" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('synonymMap', 'body', 'synonym_map', 'synonym_map'),
...
def authenticate
  ...
  params = STDIN.read
  result = SynonymMaps_Create(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = synonym_maps_create(params)
