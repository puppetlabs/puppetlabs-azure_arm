...
def secrets_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.KeyVault/vaults/%{vault_name}/secrets/%{secret_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('secretName', 'path', 'secret_name', 'secret_name'),
...
def task
  ...
  params = STDIN.read
  result = secrets_create_or_update(params)
