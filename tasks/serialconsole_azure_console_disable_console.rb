...
def console_disable_console(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.SerialConsole/consoleServices/%{default}/disableConsole" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('default', 'path', 'default', 'default'),
...
def task
  ...
  params = STDIN.read
  result = console_disable_console(params)
