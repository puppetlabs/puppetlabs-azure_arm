...
def console_enable_console(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.SerialConsole/consoleServices/%{default}/enableConsole" % path_params
...
def task
  ...
  params = STDIN.read
  result = console_enable_console(params)
