...
def list_console_disabled(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.SerialConsole/consoleServices/%{default}" % path_params
...
def task
  ...
  params = STDIN.read
  result = list_console_disabled(params)
