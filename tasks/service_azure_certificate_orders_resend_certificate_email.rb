...
def certificate_orders_resend_certificate_email(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.CertificateRegistration/certificateOrders/%{name}/resendEmail" % path_params
...
def task
  ...
  params = STDIN.read
  result = certificate_orders_resend_certificate_email(params)
