...
def certificates_get_certificates(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/certificates" % path_params
...
def task
  ...
  params = STDIN.read
  result = certificates_get_certificates(params)
