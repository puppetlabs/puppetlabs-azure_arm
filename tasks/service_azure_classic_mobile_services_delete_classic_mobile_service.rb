...
def classic_mobile_services_delete_classic_mobile_service(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/classicMobileServices/%{name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = classic_mobile_services_delete_classic_mobile_service(params)
