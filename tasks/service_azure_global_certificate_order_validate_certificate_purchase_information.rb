...
def global_certificate_order_validate_certificate_purchase_information(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.CertificateRegistration/validateCertificateRegistrationInformation" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('certificateOrder', 'body', 'certificate_order', 'certificate_order'),
...
def task
  ...
  params = STDIN.read
  result = global_certificate_order_validate_certificate_purchase_information(params)
