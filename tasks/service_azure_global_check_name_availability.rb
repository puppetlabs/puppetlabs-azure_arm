...
def global_check_name_availability(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Web/checknameavailability" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('isfqdn', 'body', 'is_fqdn', 'isfqdn'),
...
def task
  ...
  params = STDIN.read
  result = global_check_name_availability(params)
