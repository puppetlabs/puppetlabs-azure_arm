...
def global_domain_registration_get_domain_control_center_sso_request(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.DomainRegistration/generateSsoRequest" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('postparameterkey', 'body', 'post_parameter_key', 'postparameterkey'),
      op_param('postparametervalue', 'body', 'post_parameter_value', 'postparametervalue'),
...
def task
  ...
  params = STDIN.read
  result = global_domain_registration_get_domain_control_center_sso_request(params)
