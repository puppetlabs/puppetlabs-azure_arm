...
def global_domain_registration_list_domain_recommendations(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.DomainRegistration/listDomainRecommendations" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('keywords', 'body', 'keywords', 'keywords'),
      op_param('maxdomainrecommendations', 'body', 'max_domain_recommendations', 'maxdomainrecommendations'),
...
def task
  ...
  params = STDIN.read
  result = global_domain_registration_list_domain_recommendations(params)
