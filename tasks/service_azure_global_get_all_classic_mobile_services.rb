...
def global_get_all_classic_mobile_services(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Web/classicMobileServices" % path_params
...
def task
  ...
  params = STDIN.read
  result = global_get_all_classic_mobile_services(params)
