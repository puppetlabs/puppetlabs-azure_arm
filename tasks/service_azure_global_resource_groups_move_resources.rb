...
def global_resource_groups_move_resources(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/moveResources" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('moveResourceEnvelope', 'body', 'move_resource_envelope', 'move_resource_envelope'),
...
def task
  ...
  params = STDIN.read
  result = global_resource_groups_move_resources(params)
