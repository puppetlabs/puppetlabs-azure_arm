...
def hosting_environments_resume_hosting_environment(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/hostingEnvironments/%{name}/resume" % path_params
...
def task
  ...
  params = STDIN.read
  result = hosting_environments_resume_hosting_environment(params)
