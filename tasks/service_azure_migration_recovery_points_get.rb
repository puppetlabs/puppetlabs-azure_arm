...
def migration_recovery_points_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationFabrics/%{fabric_name}/replicationProtectionContainers/%{protection_container_name}/replicationMigrationItems/%{migration_item_name}/migrationRecoveryPoints/%{migration_recovery_point_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('migrationRecoveryPointName', 'path', 'name', 'migration_recovery_point_name'),
...
def task
  ...
  params = STDIN.read
  result = migration_recovery_points_get(params)
