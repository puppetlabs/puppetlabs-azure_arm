...
def provider_get_source_controls(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.Web/sourcecontrols" % path_params
...
def task
  ...
  params = STDIN.read
  result = provider_get_source_controls(params)
