...
def provider_update_publishing_user(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.Web/publishingUsers/web" % path_params
...
def task
  ...
  params = STDIN.read
  result = provider_update_publishing_user(params)
