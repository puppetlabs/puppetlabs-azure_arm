...
def provider_update_source_control(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.Web/sourcecontrols/%{source_control_type}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('requestMessage', 'body', 'request_message', 'request_message'),
      op_param('sourceControlType', 'path', 'type', 'source_control_type'),
...
def task
  ...
  params = STDIN.read
  result = provider_update_source_control(params)
