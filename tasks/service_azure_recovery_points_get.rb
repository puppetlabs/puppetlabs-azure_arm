...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('recoveryPointName', 'path', 'name', 'recovery_point_name'),
...
def task
  ...
  params = STDIN.read
  result = recovery_points_get(params)
