...
def replication_alert_settings_create(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationAlertSettings/%{alert_setting_name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = replication_alert_settings_create(params)
