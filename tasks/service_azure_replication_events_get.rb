...
def replication_events_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationEvents/%{event_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('eventName', 'path', 'name', 'event_name'),
...
def task
  ...
  params = STDIN.read
  result = replication_events_get(params)
