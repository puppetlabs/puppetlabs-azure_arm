...
def replication_fabrics_renew_certificate(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationFabrics/%{fabric_name}/renewCertificate" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('renewCertificate', 'body', 'renew_certificate', 'renew_certificate'),
...
def task
  ...
  params = STDIN.read
  result = replication_fabrics_renew_certificate(params)
