...
def replication_jobs_cancel(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationJobs/%{job_name}/cancel" % path_params
...
def task
  ...
  params = STDIN.read
  result = replication_jobs_cancel(params)
