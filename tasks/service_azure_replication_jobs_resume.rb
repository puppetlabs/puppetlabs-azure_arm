...
def replication_jobs_resume(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationJobs/%{job_name}/resume" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('resumeJobParams', 'body', 'resume_job_params', 'resume_job_params'),
...
def task
  ...
  params = STDIN.read
  result = replication_jobs_resume(params)
