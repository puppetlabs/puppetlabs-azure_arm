...
def replication_logical_networks_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationFabrics/%{fabric_name}/replicationLogicalNetworks/%{logical_network_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('logicalNetworkName', 'path', 'name', 'logical_network_name'),
...
def task
  ...
  params = STDIN.read
  result = replication_logical_networks_get(params)
