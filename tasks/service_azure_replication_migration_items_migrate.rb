...
def replication_migration_items_migrate(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationFabrics/%{fabric_name}/replicationProtectionContainers/%{protection_container_name}/replicationMigrationItems/%{migration_item_name}/migrate" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('migrateInput', 'body', 'migrate_input', 'migrate_input'),
...
def task
  ...
  params = STDIN.read
  result = replication_migration_items_migrate(params)
