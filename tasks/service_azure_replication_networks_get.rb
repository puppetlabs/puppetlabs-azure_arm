...
def replication_networks_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationFabrics/%{fabric_name}/replicationNetworks/%{network_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('networkName', 'path', 'name', 'network_name'),
...
def task
  ...
  params = STDIN.read
  result = replication_networks_get(params)
