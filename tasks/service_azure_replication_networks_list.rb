...
def replication_networks_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationNetworks" % path_params
...
def task
  ...
  params = STDIN.read
  result = replication_networks_list(params)
