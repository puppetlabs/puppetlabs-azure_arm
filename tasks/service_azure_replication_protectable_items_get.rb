...
def replication_protectable_items_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationFabrics/%{fabric_name}/replicationProtectionContainers/%{protection_container_name}/replicationProtectableItems/%{protectable_item_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('protectableItemName', 'path', 'name', 'protectable_item_name'),
...
def task
  ...
  params = STDIN.read
  result = replication_protectable_items_get(params)
