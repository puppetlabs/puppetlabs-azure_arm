...
def replication_protected_items_apply_recovery_point(*args)
  header_params = {}
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('applyRecoveryPointInput', 'body', 'apply_recovery_point_input', 'apply_recovery_point_input'),
      ...
      op_param('replicatedProtectedItemName', 'path', 'replicated_protected_item_name', 'replicated_protected_item_name'),
...
def task
  ...
  params = STDIN.read
  result = replication_protected_items_apply_recovery_point(params)
