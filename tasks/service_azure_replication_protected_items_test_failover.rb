...
def replication_protected_items_test_failover(*args)
  header_params = {}
...
def task
  ...
  params = STDIN.read
  result = replication_protected_items_test_failover(params)
