...
def replication_protection_container_mappings_create(*args)
  header_params = {}
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('creationInput', 'body', 'creation_input', 'creation_input'),
...
def task
  ...
  params = STDIN.read
  result = replication_protection_container_mappings_create(params)
