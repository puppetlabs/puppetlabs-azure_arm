...
def replication_protection_containers_switch_protection(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationFabrics/%{fabric_name}/replicationProtectionContainers/%{protection_container_name}/switchprotection" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('switchInput', 'body', 'switch_input', 'switch_input'),
...
def task
  ...
  params = STDIN.read
  result = replication_protection_containers_switch_protection(params)
