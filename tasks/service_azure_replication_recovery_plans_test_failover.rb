...
def replication_recovery_plans_test_failover(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationRecoveryPlans/%{recovery_plan_name}/testFailover" % path_params
...
def task
  ...
  params = STDIN.read
  result = replication_recovery_plans_test_failover(params)
