...
def replication_recovery_plans_test_failover_cleanup(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationRecoveryPlans/%{recovery_plan_name}/testFailoverCleanup" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('recoveryPlanName', 'path', 'recovery_plan_name', 'recovery_plan_name'),
...
def task
  ...
  params = STDIN.read
  result = replication_recovery_plans_test_failover_cleanup(params)
