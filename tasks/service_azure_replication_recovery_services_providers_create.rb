...
def replication_recovery_services_providers_create(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationFabrics/%{fabric_name}/replicationRecoveryServicesProviders/%{provider_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('addProviderInput', 'body', 'add_provider_input', 'add_provider_input'),
      op_param('api-version', 'query', 'api_version', 'api_version'),
      op_param('fabricName', 'path', 'fabric_name', 'fabric_name'),
      op_param('properties', 'body', 'properties', 'properties'),
      op_param('providerName', 'path', 'provider_name', 'provider_name'),
...
def task
  ...
  params = STDIN.read
  result = replication_recovery_services_providers_create(params)
