...
def replication_vault_health_refresh(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationVaultHealth/default/refresh" % path_params
...
def task
  ...
  params = STDIN.read
  result = replication_vault_health_refresh(params)
