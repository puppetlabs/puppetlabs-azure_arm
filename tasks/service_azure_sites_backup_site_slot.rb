...
def sites_backup_site_slot(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/backup" % path_params
...
def task
  ...
  params = STDIN.read
  result = sites_backup_site_slot(params)
