...
def sites_discover_site_restore(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/backups/discover" % path_params
...
def task
  ...
  params = STDIN.read
  result = sites_discover_site_restore(params)
