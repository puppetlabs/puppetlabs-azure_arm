...
def sites_get_deleted_sites(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/deletedSites" % path_params
...
def task
  ...
  params = STDIN.read
  result = sites_get_deleted_sites(params)
