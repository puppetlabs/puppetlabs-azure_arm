...
def sites_get_site_metrics(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/metrics" % path_params
...
def task
  ...
  params = STDIN.read
  result = sites_get_site_metrics(params)
