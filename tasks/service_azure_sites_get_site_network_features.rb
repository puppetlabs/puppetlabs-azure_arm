...
def sites_get_site_network_features(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/networkFeatures/%{view}" % path_params
...
def task
  ...
  params = STDIN.read
  result = sites_get_site_network_features(params)
