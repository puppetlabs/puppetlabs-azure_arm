...
def sites_get_site_slots(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots" % path_params
...
def task
  ...
  params = STDIN.read
  result = sites_get_site_slots(params)
