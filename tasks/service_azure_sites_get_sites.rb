...
def sites_get_sites(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('includeSiteTypes', 'query', 'include_site_types', 'include_site_types'),
      op_param('includeSlots', 'query', 'include_slots', 'include_slots'),
      op_param('nextlink', 'body', 'next_link', 'nextlink'),
      op_param('propertiesToInclude', 'query', 'properties_to_include', 'properties_to_include'),
