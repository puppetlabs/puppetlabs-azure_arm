...
def sites_is_site_cloneable(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/iscloneable" % path_params
...
def task
  ...
  params = STDIN.read
  result = sites_is_site_cloneable(params)
