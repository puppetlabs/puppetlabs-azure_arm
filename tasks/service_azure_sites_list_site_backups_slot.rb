...
def sites_list_site_backups_slot(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/backups" % path_params
...
def task
  ...
  params = STDIN.read
  result = sites_list_site_backups_slot(params)
