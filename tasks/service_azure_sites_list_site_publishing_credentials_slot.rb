...
def sites_list_site_publishing_credentials_slot(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/config/publishingcredentials/list" % path_params
...
def task
  ...
  params = STDIN.read
  result = sites_list_site_publishing_credentials_slot(params)
