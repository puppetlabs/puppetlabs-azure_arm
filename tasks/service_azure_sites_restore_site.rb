...
def sites_restore_site(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/backups/%{backup_id}/restore" % path_params
...
def task
  ...
  params = STDIN.read
  result = sites_restore_site(params)
