...
def sites_restore_site_slot(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/backups/%{backup_id}/restore" % path_params
...
def task
  ...
  params = STDIN.read
  result = sites_restore_site_slot(params)
