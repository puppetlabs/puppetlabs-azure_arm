...
def sites_start_site(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/start" % path_params
...
def task
  ...
  params = STDIN.read
  result = sites_start_site(params)
