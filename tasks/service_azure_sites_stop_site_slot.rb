...
def sites_stop_site_slot(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/stop" % path_params
...
def task
  ...
  params = STDIN.read
  result = sites_stop_site_slot(params)
