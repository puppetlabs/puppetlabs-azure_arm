...
def sites_sync_site_repository(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/sync" % path_params
...
def task
  ...
  params = STDIN.read
  result = sites_sync_site_repository(params)
