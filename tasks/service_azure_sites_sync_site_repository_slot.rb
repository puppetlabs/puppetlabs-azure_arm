...
def sites_sync_site_repository_slot(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/sync" % path_params
...
def task
  ...
  params = STDIN.read
  result = sites_sync_site_repository_slot(params)
