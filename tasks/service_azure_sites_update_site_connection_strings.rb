...
def sites_update_site_connection_strings(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/config/connectionstrings" % path_params
...
def task
  ...
  params = STDIN.read
  result = sites_update_site_connection_strings(params)
