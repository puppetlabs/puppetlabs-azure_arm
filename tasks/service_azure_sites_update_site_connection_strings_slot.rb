...
def sites_update_site_connection_strings_slot(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/config/connectionstrings" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('connectionStrings', 'body', 'connection_strings', 'connection_strings'),
...
def task
  ...
  params = STDIN.read
  result = sites_update_site_connection_strings_slot(params)
