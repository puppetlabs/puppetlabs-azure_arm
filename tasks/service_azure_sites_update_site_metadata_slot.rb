...
def sites_update_site_metadata_slot(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/config/metadata" % path_params
...
def task
  ...
  params = STDIN.read
  result = sites_update_site_metadata_slot(params)
