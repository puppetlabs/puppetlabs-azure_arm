...
def supported_operating_systems_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{resource_name}/replicationSupportedOperatingSystems" % path_params
...
def task
  ...
  params = STDIN.read
  result = supported_operating_systems_get(params)
