...
def top_level_domains_list_top_level_domain_agreements(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.DomainRegistration/topLevelDomains/%{name}/listAgreements" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('agreementOption', 'body', 'agreement_option', 'agreement_option'),
      op_param('api-version', 'query', 'api_version', 'api_version'),
      op_param('includeprivacy', 'body', 'include_privacy', 'includeprivacy'),
...
def task
  ...
  params = STDIN.read
  result = top_level_domains_list_top_level_domain_agreements(params)
