...
def usage_get_usage(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web.Admin/environments/%{environment_name}/usage" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('batchSize', 'query', 'batch_size', 'batch_size'),
      op_param('environmentName', 'path', 'environment_name', 'environment_name'),
      op_param('lastId', 'query', 'last_id', 'last_id'),
