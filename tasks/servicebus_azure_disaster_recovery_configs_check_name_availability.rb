...
def disaster_recovery_configs_check_name_availability(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ServiceBus/namespaces/%{namespace_name}/disasterRecoveryConfigs/CheckNameAvailability" % path_params
...
def task
  ...
  params = STDIN.read
  result = disaster_recovery_configs_check_name_availability(params)
