...
def disaster_recovery_configs_list_keys(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ServiceBus/namespaces/%{namespace_name}/disasterRecoveryConfigs/%{alias}/AuthorizationRules/%{authorization_rule_name}/listKeys" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('alias', 'path', 'alias', 'alias'),
      op_param('aliasprimaryconnectionstring', 'body', 'aliasprimaryconnectionstring', 'aliasprimaryconnectionstring'),
      op_param('aliassecondaryconnectionstring', 'body', 'aliassecondaryconnectionstring', 'aliassecondaryconnectionstring'),
...
def task
  ...
  params = STDIN.read
  result = disaster_recovery_configs_list_keys(params)
