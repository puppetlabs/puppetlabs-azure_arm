...
def namespaces_check_name_availability(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.ServiceBus/CheckNameAvailability" % path_params
...
def task
  ...
  params = STDIN.read
  result = namespaces_check_name_availability(params)
