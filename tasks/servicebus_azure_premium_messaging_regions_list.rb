...
def premium_messaging_regions_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.ServiceBus/premiumMessagingRegions" % path_params
...
def task
  ...
  params = STDIN.read
  result = premium_messaging_regions_list(params)
