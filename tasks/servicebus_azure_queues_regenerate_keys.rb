...
def queues_regenerate_keys(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ServiceBus/namespaces/%{namespace_name}/queues/%{queue_name}/authorizationRules/%{authorization_rule_name}/regenerateKeys" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('queueName', 'path', 'queue_name', 'queue_name'),
...
def task
  ...
  params = STDIN.read
  result = queues_regenerate_keys(params)
