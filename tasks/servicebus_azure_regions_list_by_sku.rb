...
def regions_list_by_sku(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.ServiceBus/sku/%{sku}/regions" % path_params
...
def task
  ...
  params = STDIN.read
  result = regions_list_by_sku(params)
