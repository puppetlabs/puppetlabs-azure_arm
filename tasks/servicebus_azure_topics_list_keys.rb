...
def topics_list_keys(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ServiceBus/namespaces/%{namespace_name}/topics/%{topic_name}/authorizationRules/%{authorization_rule_name}/ListKeys" % path_params
...
def task
  ...
  params = STDIN.read
  result = topics_list_keys(params)
