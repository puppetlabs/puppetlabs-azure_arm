...
def topics_regenerate_keys(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ServiceBus/namespaces/%{namespace_name}/topics/%{topic_name}/authorizationRules/%{authorization_rule_name}/regenerateKeys" % path_params
...
def task
  ...
  params = STDIN.read
  result = topics_regenerate_keys(params)
