...
def service_diagnostic_settings_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//%{resource_uri}/providers/microsoft.insights/diagnosticSettings/service" % path_params
...
def task
  ...
  params = STDIN.read
  result = service_diagnostic_settings_create_or_update(params)
