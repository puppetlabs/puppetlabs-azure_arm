...
def cluster_versions_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.ServiceFabric/locations/%{location}/clusterVersions" % path_params
...
def task
  ...
  params = STDIN.read
  result = cluster_versions_list(params)
