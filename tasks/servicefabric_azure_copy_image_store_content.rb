...
def copy_image_store_content(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//ImageStore/$/Copy" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('ImageStoreCopyDescription', 'body', 'image_store_copy_description', 'image_store_copy_description'),
...
def authenticate
  ...
  params = STDIN.read
  result = CopyImageStoreContent(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = copy_image_store_content(params)
