...
def create_application(*args)
  ...
  uri_string = "https://localhost:19080//Applications/$/Create" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('ApplicationDescription', 'body', 'application_description', 'application_description'),
...
def authenticate
  ...
  params = STDIN.read
  result = CreateApplication(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = create_application(params)
