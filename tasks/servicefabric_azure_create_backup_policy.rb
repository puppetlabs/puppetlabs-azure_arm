...
def create_backup_policy(*args)
  ...
  uri_string = "https://localhost:19080//BackupRestore/BackupPolicies/$/Create" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = CreateBackupPolicy(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = create_backup_policy(params)
