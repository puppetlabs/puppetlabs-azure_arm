...
def create_name(*args)
  ...
  uri_string = "https://localhost:19080//Names/$/Create" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('NameDescription', 'body', 'name_description', 'name_description'),
