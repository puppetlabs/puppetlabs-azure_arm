...
def create_repair_task(*args)
  ...
  uri_string = "https://localhost:19080//$/CreateRepairTask" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = CreateRepairTask(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = create_repair_task(params)
