...
def delete_application(*args)
  ...
  uri_string = "https://localhost:19080//Applications/%{application_id}/$/Delete" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('ForceRemove', 'query', 'force_remove', 'force_remove'),
...
def authenticate
  ...
  params = STDIN.read
  result = DeleteApplication(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = delete_application(params)
