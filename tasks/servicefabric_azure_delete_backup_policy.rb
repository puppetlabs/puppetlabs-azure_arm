...
def delete_backup_policy(*args)
  ...
  uri_string = "https://localhost:19080//BackupRestore/BackupPolicies/%{backup_policy_name}/$/Delete" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = DeleteBackupPolicy(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = delete_backup_policy(params)
