...
def deploy_service_package_to_node(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Nodes/%{node_name}/$/DeployServicePackage" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('DeployServicePackageToNodeDescription', 'body', 'deploy_service_package_to_node_description', 'deploy_service_package_to_node_description'),
...
def authenticate
  ...
  params = STDIN.read
  result = DeployServicePackageToNode(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = deploy_service_package_to_node(params)
