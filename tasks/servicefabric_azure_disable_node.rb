...
def disable_node(*args)
  ...
  uri_string = "https://localhost:19080//Nodes/%{node_name}/$/Deactivate" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('DeactivationIntentDescription', 'body', 'deactivation_intent_description', 'deactivation_intent_description'),
