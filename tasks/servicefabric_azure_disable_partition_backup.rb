...
def disable_partition_backup(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Partitions/%{partition_id}/$/DisableBackup" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = DisablePartitionBackup(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = disable_partition_backup(params)
