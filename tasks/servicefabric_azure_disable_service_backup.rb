...
def disable_service_backup(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Services/%{service_id}/$/DisableBackup" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = DisableServiceBackup(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = disable_service_backup(params)
