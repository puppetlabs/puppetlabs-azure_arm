...
def enable_application_backup(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Applications/%{application_id}/$/EnableBackup" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('EnableBackupDescription', 'body', 'enable_backup_description', 'enable_backup_description'),
...
def authenticate
  ...
  params = STDIN.read
  result = EnableApplicationBackup(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = enable_application_backup(params)
