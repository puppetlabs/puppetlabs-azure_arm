...
def get_application_info_list(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Applications" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetApplicationInfoList(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_application_info_list(params)
