...
def get_application_load_info(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Applications/%{application_id}/$/GetLoadInformation" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('applicationloadmetricinformation', 'body', 'application_load_metric_information', 'applicationloadmetricinformation'),
      op_param('id', 'body', 'id', 'id'),
      op_param('maximumnodes', 'body', 'maximum_nodes', 'maximumnodes'),
      op_param('minimumnodes', 'body', 'minimum_nodes', 'minimumnodes'),
      op_param('nodecount', 'body', 'node_count', 'nodecount'),
...
def authenticate
  ...
  params = STDIN.read
  result = GetApplicationLoadInfo(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_application_load_info(params)
