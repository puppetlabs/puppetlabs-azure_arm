...
def get_application_name_info(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Services/%{service_id}/$/GetApplicationName" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetApplicationNameInfo(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_application_name_info(params)
