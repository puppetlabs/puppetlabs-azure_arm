...
def get_application_upgrade(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Applications/%{application_id}/$/GetUpgradeProgress" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetApplicationUpgrade(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_application_upgrade(params)
