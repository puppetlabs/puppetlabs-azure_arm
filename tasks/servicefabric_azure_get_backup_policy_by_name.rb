...
def get_backup_policy_by_name(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//BackupRestore/BackupPolicies/%{backup_policy_name}" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetBackupPolicyByName(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_backup_policy_by_name(params)
