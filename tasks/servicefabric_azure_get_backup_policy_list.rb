...
def get_backup_policy_list(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//BackupRestore/BackupPolicies" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetBackupPolicyList(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_backup_policy_list(params)
