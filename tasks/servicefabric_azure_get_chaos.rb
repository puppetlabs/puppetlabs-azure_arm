...
def get_chaos(*args)
  ...
  uri_string = "https://localhost:19080//Tools/Chaos" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('schedulestatus', 'body', 'schedule_status', 'schedulestatus'),
