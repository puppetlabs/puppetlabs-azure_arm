...
def get_chaos_events(*args)
  ...
  uri_string = "https://localhost:19080//Tools/Chaos/Events" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('chaosparameters', 'body', 'chaosparameters', 'chaosparameters'),
      ...
      op_param('schedulestatus', 'body', 'schedulestatus', 'schedulestatus'),
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_chaos_events(params)
