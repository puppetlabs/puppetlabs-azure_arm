...
def get_chaos_schedule(*args)
  ...
  uri_string = "https://localhost:19080//Tools/Chaos/Schedule" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetChaosSchedule(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_chaos_schedule(params)
