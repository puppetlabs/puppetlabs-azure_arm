...
def get_cluster_event_list(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//EventsStore/Cluster/Events" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetClusterEventList(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_cluster_event_list(params)
