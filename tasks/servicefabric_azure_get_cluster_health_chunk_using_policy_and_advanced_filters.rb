...
def get_cluster_health_chunk_using_policy_and_advanced_filters(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//$/GetClusterHealthChunk" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('ClusterHealthChunkQueryDescription', 'body', 'cluster_health_chunk_query_description', 'cluster_health_chunk_query_description'),
...
def authenticate
  ...
  params = STDIN.read
  result = GetClusterHealthChunkUsingPolicyAndAdvancedFilters(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_cluster_health_chunk_using_policy_and_advanced_filters(params)
