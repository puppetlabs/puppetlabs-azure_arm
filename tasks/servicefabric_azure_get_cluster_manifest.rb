...
def get_cluster_manifest(*args)
  ...
  uri_string = "https://localhost:19080//$/GetClusterManifest" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetClusterManifest(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_cluster_manifest(params)
