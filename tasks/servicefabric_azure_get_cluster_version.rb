...
def get_cluster_version(*args)
  ...
  uri_string = "https://localhost:19080//$/GetClusterVersion" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetClusterVersion(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_cluster_version(params)
