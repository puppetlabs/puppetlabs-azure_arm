...
def get_data_loss_progress(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Faults/Services/%{service_id}/$/GetPartitions/%{partition_id}/$/GetDataLossProgress" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetDataLossProgress(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_data_loss_progress(params)
