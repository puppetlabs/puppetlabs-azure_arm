...
def get_name_exists_info(*args)
  ...
  uri_string = "https://localhost:19080//Names/%{name_id}" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetNameExistsInfo(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_name_exists_info(params)
