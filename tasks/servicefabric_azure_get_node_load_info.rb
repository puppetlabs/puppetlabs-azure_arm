...
def get_node_load_info(*args)
  ...
  uri_string = "https://localhost:19080//Nodes/%{node_name}/$/GetLoadInformation" % path_params
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_node_load_info(params)
