...
def get_nodes_event_list(*args)
  ...
  uri_string = "https://localhost:19080//EventsStore/Nodes/Events" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetNodesEventList(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_nodes_event_list(params)
