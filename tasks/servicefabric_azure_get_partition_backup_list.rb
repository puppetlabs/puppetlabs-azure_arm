...
def get_partition_backup_list(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Partitions/%{partition_id}/$/GetBackups" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetPartitionBackupList(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_partition_backup_list(params)
