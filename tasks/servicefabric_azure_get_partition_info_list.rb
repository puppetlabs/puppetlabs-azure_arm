...
def get_partition_info_list(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Services/%{service_id}/$/GetPartitions" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetPartitionInfoList(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_partition_info_list(params)
