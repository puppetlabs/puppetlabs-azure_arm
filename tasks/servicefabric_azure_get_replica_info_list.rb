...
def get_replica_info_list(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Partitions/%{partition_id}/$/GetReplicas" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetReplicaInfoList(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_replica_info_list(params)
