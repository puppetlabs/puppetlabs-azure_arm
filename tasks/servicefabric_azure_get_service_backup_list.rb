...
def get_service_backup_list(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Services/%{service_id}/$/GetBackups" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetServiceBackupList(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_service_backup_list(params)
