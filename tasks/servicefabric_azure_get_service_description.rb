...
def get_service_description(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Services/%{service_id}/$/GetDescription" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetServiceDescription(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_service_description(params)
