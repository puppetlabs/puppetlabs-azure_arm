...
def get_service_manifest(*args)
  ...
  uri_string = "https://localhost:19080//ApplicationTypes/%{application_type_name}/$/GetServiceManifest" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetServiceManifest(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_service_manifest(params)
