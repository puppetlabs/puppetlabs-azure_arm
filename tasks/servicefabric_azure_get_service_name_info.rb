...
def get_service_name_info(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Partitions/%{partition_id}/$/GetServiceName" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetServiceNameInfo(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_service_name_info(params)
