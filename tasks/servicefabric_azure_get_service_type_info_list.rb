...
def get_service_type_info_list(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//ApplicationTypes/%{application_type_name}/$/GetServiceTypes" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetServiceTypeInfoList(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_service_type_info_list(params)
