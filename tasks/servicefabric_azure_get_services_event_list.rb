...
def get_services_event_list(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//EventsStore/Services/Events" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetServicesEventList(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_services_event_list(params)
