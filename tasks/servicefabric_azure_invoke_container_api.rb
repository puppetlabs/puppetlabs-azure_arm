...
def invoke_container_api(*args)
  ...
  uri_string = "https://localhost:19080//Nodes/%{node_name}/$/GetApplications/%{application_id}/$/GetCodePackages/$/ContainerApi" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = InvokeContainerApi(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = invoke_container_api(params)
