...
def invoke_infrastructure_query(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//$/InvokeInfrastructureQuery" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = InvokeInfrastructureQuery(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = invoke_infrastructure_query(params)
