...
def mesh_application_list(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Resources/Applications" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = MeshApplication_List(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = mesh_application_list(params)
