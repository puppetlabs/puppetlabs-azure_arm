...
def mesh_gateway_list(*args)
  ...
  uri_string = "https://localhost:19080//Resources/Gateways" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = MeshGateway_List(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = mesh_gateway_list(params)
