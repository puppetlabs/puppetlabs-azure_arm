...
def mesh_network_list(*args)
  ...
  uri_string = "https://localhost:19080//Resources/Networks" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = MeshNetwork_List(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = mesh_network_list(params)
