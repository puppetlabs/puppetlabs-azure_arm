...
def mesh_secret_value_list(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Resources/Secrets/%{secret_resource_name}/values" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = MeshSecretValue_List(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = mesh_secret_value_list(params)
