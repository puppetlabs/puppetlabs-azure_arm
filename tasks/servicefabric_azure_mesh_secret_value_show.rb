...
def mesh_secret_value_show(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Resources/Secrets/%{secret_resource_name}/values/%{secret_value_resource_name}/list_value" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = MeshSecretValue_Show(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = mesh_secret_value_show(params)
