...
def mesh_service_get(*args)
  ...
  uri_string = "https://localhost:19080//Resources/Applications/%{application_resource_name}/Services/%{service_resource_name}" % path_params
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = mesh_service_get(params)
