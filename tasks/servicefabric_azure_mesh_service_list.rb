...
def mesh_service_list(*args)
  ...
  uri_string = "https://localhost:19080//Resources/Applications/%{application_resource_name}/Services" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = MeshService_List(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = mesh_service_list(params)
