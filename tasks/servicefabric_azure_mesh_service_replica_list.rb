...
def mesh_service_replica_list(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Resources/Applications/%{application_resource_name}/Services/%{service_resource_name}/Replicas" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = MeshServiceReplica_List(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = mesh_service_replica_list(params)
