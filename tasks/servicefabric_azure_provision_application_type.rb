...
def provision_application_type(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//ApplicationTypes/$/Provision" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('ProvisionApplicationTypeDescriptionBaseRequiredBodyParam', 'body', 'provision_application_type_description_base_required_body_param', 'provision_application_type_description_base_required_body_param'),
...
def authenticate
  ...
  params = STDIN.read
  result = ProvisionApplicationType(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = provision_application_type(params)
