...
def provision_cluster(*args)
  ...
  uri_string = "https://localhost:19080//$/Provision" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('ProvisionFabricDescription', 'body', 'provision_fabric_description', 'provision_fabric_description'),
...
def authenticate
  ...
  params = STDIN.read
  result = ProvisionCluster(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = provision_cluster(params)
