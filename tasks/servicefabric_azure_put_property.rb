...
def put_property(*args)
  ...
  uri_string = "https://localhost:19080//Names/%{name_id}/$/GetProperty" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('PropertyDescription', 'body', 'property_description', 'property_description'),
