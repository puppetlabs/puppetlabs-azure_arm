...
def recover_all_partitions(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//$/RecoverAllPartitions" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = RecoverAllPartitions(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = recover_all_partitions(params)
