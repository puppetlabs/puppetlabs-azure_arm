...
def recover_partition(*args)
  ...
  uri_string = "https://localhost:19080//Partitions/%{partition_id}/$/Recover" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = RecoverPartition(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = recover_partition(params)
