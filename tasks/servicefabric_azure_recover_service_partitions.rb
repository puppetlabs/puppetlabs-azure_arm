...
def recover_service_partitions(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Services/$/%{service_id}/$/GetPartitions/$/Recover" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = RecoverServicePartitions(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = recover_service_partitions(params)
