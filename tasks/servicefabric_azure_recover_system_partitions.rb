...
def recover_system_partitions(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//$/RecoverSystemPartitions" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = RecoverSystemPartitions(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = recover_system_partitions(params)
