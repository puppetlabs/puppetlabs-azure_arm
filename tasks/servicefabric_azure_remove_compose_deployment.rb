...
def remove_compose_deployment(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//ComposeDeployments/%{deployment_name}/$/Delete" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = RemoveComposeDeployment(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = remove_compose_deployment(params)
