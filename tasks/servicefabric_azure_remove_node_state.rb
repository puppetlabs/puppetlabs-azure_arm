...
def remove_node_state(*args)
  ...
  uri_string = "https://localhost:19080//Nodes/%{node_name}/$/RemoveNodeState" % path_params
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = remove_node_state(params)
