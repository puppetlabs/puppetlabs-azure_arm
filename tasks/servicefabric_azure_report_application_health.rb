...
def report_application_health(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Applications/%{application_id}/$/ReportHealth" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = ReportApplicationHealth(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = report_application_health(params)
