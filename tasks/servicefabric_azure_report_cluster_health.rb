...
def report_cluster_health(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//$/ReportClusterHealth" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = ReportClusterHealth(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = report_cluster_health(params)
