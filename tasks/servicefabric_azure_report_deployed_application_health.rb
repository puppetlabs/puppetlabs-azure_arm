...
def report_deployed_application_health(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Nodes/%{node_name}/$/GetApplications/%{application_id}/$/ReportHealth" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = ReportDeployedApplicationHealth(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = report_deployed_application_health(params)
