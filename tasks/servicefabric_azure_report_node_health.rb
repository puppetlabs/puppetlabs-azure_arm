...
def report_node_health(*args)
  ...
  uri_string = "https://localhost:19080//Nodes/%{node_name}/$/ReportHealth" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = ReportNodeHealth(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = report_node_health(params)
