...
def report_partition_health(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Partitions/%{partition_id}/$/ReportHealth" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = ReportPartitionHealth(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = report_partition_health(params)
