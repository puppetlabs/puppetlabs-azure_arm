...
def reset_partition_load(*args)
  ...
  uri_string = "https://localhost:19080//Partitions/%{partition_id}/$/ResetLoad" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = ResetPartitionLoad(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = reset_partition_load(params)
