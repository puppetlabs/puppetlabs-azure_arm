...
def resolve_service(*args)
  ...
  uri_string = "https://localhost:19080//Services/%{service_id}/$/ResolvePartition" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('endpoints', 'body', 'endpoints', 'endpoints'),
      op_param('name', 'body', 'name', 'name'),
      op_param('partitioninformation', 'body', 'partition_information', 'partitioninformation'),
      op_param('PartitionKeyType', 'query', 'partition_key_type', 'partition_key_type'),
      op_param('PartitionKeyValue', 'query', 'partition_key_value', 'partition_key_value'),
      op_param('PreviousRspVersion', 'query', 'previous_rsp_version', 'previous_rsp_version'),
