...
def restart_node(*args)
  ...
  uri_string = "https://localhost:19080//Nodes/%{node_name}/$/Restart" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('RestartNodeDescription', 'body', 'restart_node_description', 'restart_node_description'),
