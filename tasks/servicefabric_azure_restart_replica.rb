...
def restart_replica(*args)
  ...
  uri_string = "https://localhost:19080//Nodes/%{node_name}/$/GetPartitions/%{partition_id}/$/GetReplicas/%{replica_id}/$/Restart" % path_params
