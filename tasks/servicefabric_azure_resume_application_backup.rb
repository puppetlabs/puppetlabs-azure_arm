...
def resume_application_backup(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Applications/%{application_id}/$/ResumeBackup" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = ResumeApplicationBackup(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = resume_application_backup(params)
