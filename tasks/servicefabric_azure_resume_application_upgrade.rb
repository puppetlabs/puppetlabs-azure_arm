...
def resume_application_upgrade(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Applications/%{application_id}/$/MoveToNextUpgradeDomain" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('ResumeApplicationUpgradeDescription', 'body', 'resume_application_upgrade_description', 'resume_application_upgrade_description'),
...
def authenticate
  ...
  params = STDIN.read
  result = ResumeApplicationUpgrade(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = resume_application_upgrade(params)
