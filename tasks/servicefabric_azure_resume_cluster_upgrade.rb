...
def resume_cluster_upgrade(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//$/MoveToNextUpgradeDomain" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('ResumeClusterUpgradeDescription', 'body', 'resume_cluster_upgrade_description', 'resume_cluster_upgrade_description'),
...
def authenticate
  ...
  params = STDIN.read
  result = ResumeClusterUpgrade(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = resume_cluster_upgrade(params)
