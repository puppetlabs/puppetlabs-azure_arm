...
def resume_partition_backup(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Partitions/%{partition_id}/$/ResumeBackup" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = ResumePartitionBackup(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = resume_partition_backup(params)
