...
def resume_service_backup(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Services/%{service_id}/$/ResumeBackup" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = ResumeServiceBackup(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = resume_service_backup(params)
