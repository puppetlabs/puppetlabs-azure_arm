...
def rollback_cluster_upgrade(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//$/RollbackUpgrade" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = RollbackClusterUpgrade(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = rollback_cluster_upgrade(params)
