...
def start_chaos(*args)
  ...
  uri_string = "https://localhost:19080//Tools/Chaos/$/Start" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('ChaosParameters', 'body', 'chaos_parameters', 'chaos_parameters'),
