...
def start_cluster_configuration_upgrade(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//$/StartClusterConfigurationUpgrade" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('ClusterConfigurationUpgradeDescription', 'body', 'cluster_configuration_upgrade_description', 'cluster_configuration_upgrade_description'),
...
def authenticate
  ...
  params = STDIN.read
  result = StartClusterConfigurationUpgrade(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = start_cluster_configuration_upgrade(params)
