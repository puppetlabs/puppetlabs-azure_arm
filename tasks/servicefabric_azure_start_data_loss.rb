...
def start_data_loss(*args)
  ...
  uri_string = "https://localhost:19080//Faults/Services/%{service_id}/$/GetPartitions/%{partition_id}/$/StartDataLoss" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('DataLossMode', 'query', 'data_loss_mode', 'data_loss_mode'),
