...
def suspend_application_backup(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Applications/%{application_id}/$/SuspendBackup" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = SuspendApplicationBackup(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = suspend_application_backup(params)
