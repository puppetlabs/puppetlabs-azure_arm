...
def suspend_partition_backup(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Partitions/%{partition_id}/$/SuspendBackup" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = SuspendPartitionBackup(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = suspend_partition_backup(params)
