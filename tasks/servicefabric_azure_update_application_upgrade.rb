...
def update_application_upgrade(*args)
  header_params = {}
  ...
  uri_string = "https://localhost:19080//Applications/%{application_id}/$/UpdateUpgrade" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('ApplicationUpgradeUpdateDescription', 'body', 'application_upgrade_update_description', 'application_upgrade_update_description'),
...
def authenticate
  ...
  params = STDIN.read
  result = UpdateApplicationUpgrade(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = update_application_upgrade(params)
