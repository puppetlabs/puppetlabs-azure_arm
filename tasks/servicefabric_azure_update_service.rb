...
def update_service(*args)
  ...
  uri_string = "https://localhost:19080//Services/%{service_id}/$/Update" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('ServiceUpdateDescription', 'body', 'service_update_description', 'service_update_description'),
