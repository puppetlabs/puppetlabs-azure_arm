...
def service_objectives_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Sql/servers/%{server_name}/serviceObjectives/%{service_objective_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('serviceObjectiveName', 'path', 'name', 'service_objective_name'),
...
def task
  ...
  params = STDIN.read
  result = service_objectives_get(params)
