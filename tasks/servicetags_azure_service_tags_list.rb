...
def service_tags_list(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Network/locations/%{location}/serviceTags" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('changenumber', 'body', 'change_number', 'changenumber'),
      op_param('cloud', 'body', 'cloud', 'cloud'),
      op_param('id', 'body', 'id', 'id'),
      op_param('location', 'path', 'location', 'location'),
      op_param('name', 'body', 'name', 'name'),
      op_param('subscriptionId', 'path', 'subscription_id', 'subscription_id'),
      op_param('type', 'body', 'type', 'type'),
      op_param('values', 'body', 'values', 'values'),
    ]
  op_params.each do |i|
    location = i[:location]
    name     = i[:name]
...
def task
  ...
  params = STDIN.read
  result = service_tags_list(params)
