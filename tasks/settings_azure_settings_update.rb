...
def settings_update(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Security/settings/%{setting_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('settingName', 'path', 'name', 'setting_name'),
