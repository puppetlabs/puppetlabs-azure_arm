...
def signal_r_check_name_availability(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.SignalRService/locations/%{location}/checkNameAvailability" % path_params
...
def task
  ...
  params = STDIN.read
  result = signal_r_check_name_availability(params)
