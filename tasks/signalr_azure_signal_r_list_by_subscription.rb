...
def signal_r_list_by_subscription(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.SignalRService/SignalR" % path_params
...
def task
  ...
  params = STDIN.read
  result = signal_r_list_by_subscription(params)
