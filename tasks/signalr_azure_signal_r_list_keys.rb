...
def signal_r_list_keys(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.SignalRService/SignalR/%{resource_name}/listKeys" % path_params
...
def task
  ...
  params = STDIN.read
  result = signal_r_list_keys(params)
