...
def signal_r_regenerate_key(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.SignalRService/SignalR/%{resource_name}/regenerateKey" % path_params
...
def task
  ...
  params = STDIN.read
  result = signal_r_regenerate_key(params)
