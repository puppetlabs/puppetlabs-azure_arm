...
def spell_checker(*args)
  ...
  uri_string = "https://api.cognitive.microsoft.com//spellcheck" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('ActionType', 'query', 'action_type', 'action_type'),
      ...
      op_param('PostContextText', 'formData', 'post_context_text', 'post_context_text'),
      op_param('Pragma', 'header', 'pragma', 'pragma'),
      op_param('PreContextText', 'formData', 'pre_context_text', 'pre_context_text'),
      op_param('SessionId', 'query', 'session_id', 'session_id'),
      op_param('SetLang', 'query', 'set_lang', 'set_lang'),
      op_param('Text', 'formData', 'text', 'text'),
      op_param('User-Agent', 'header', 'user_agent', 'user_agent'),
      op_param('UserId', 'query', 'user_id', 'user_id'),
