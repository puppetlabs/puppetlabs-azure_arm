...
def service_tier_advisors_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Sql/servers/%{server_name}/databases/%{database_name}/serviceTierAdvisors/%{service_tier_advisor_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('serviceTierAdvisorName', 'path', 'name', 'service_tier_advisor_name'),
...
def task
  ...
  params = STDIN.read
  result = service_tier_advisors_get(params)
