...
def transparent_data_encryptions_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Sql/servers/%{server_name}/databases/%{database_name}/transparentDataEncryption/%{transparent_data_encryption_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('transparentDataEncryptionName', 'path', 'name', 'transparent_data_encryption_name'),
...
def task
  ...
  params = STDIN.read
  result = transparent_data_encryptions_create_or_update(params)
