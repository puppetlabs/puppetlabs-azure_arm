...
def storage_accounts_check_name_availability(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Storage/checkNameAvailability" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('accountName', 'body', 'account_name', 'account_name'),
...
def task
  ...
  params = STDIN.read
  result = storage_accounts_check_name_availability(params)
