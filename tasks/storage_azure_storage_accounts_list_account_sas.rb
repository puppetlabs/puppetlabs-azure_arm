...
def storage_accounts_list_account_sas(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Storage/storageAccounts/%{account_name}/ListAccountSas" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('signedresourcetypes', 'body', 'signed_resource_types', 'signedresourcetypes'),
      op_param('signedservices', 'body', 'signed_services', 'signedservices'),
...
def task
  ...
  params = STDIN.read
  result = storage_accounts_list_account_sas(params)
