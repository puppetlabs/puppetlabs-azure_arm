...
def storage_accounts_list_service_sas(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Storage/storageAccounts/%{account_name}/ListServiceSas" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('canonicalizedresource', 'body', 'canonicalized_resource', 'canonicalizedresource'),
      op_param('endpk', 'body', 'end_pk', 'endpk'),
      op_param('endrk', 'body', 'end_rk', 'endrk'),
      op_param('keytosign', 'body', 'key_to_sign', 'keytosign'),
      op_param('parameters', 'body', 'parameters', 'parameters'),
      op_param('resourceGroupName', 'path', 'resource_group_name', 'resource_group_name'),
      op_param('rscc', 'body', 'rscc', 'rscc'),
      op_param('rscd', 'body', 'rscd', 'rscd'),
      op_param('rsce', 'body', 'rsce', 'rsce'),
      op_param('rscl', 'body', 'rscl', 'rscl'),
      op_param('rsct', 'body', 'rsct', 'rsct'),
      op_param('signedexpiry', 'body', 'signed_expiry', 'signedexpiry'),
      op_param('signedidentifier', 'body', 'signed_identifier', 'signedidentifier'),
      op_param('signedip', 'body', 'signed_ip', 'signedip'),
      op_param('signedpermission', 'body', 'signed_permission', 'signedpermission'),
      op_param('signedprotocol', 'body', 'signed_protocol', 'signedprotocol'),
      op_param('signedresource', 'body', 'signed_resource', 'signedresource'),
      op_param('signedstart', 'body', 'signed_start', 'signedstart'),
      op_param('startpk', 'body', 'start_pk', 'startpk'),
      op_param('startrk', 'body', 'start_rk', 'startrk'),
...
def task
  ...
  params = STDIN.read
  result = storage_accounts_list_service_sas(params)
