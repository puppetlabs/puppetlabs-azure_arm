...
def storage_accounts_regenerate_key(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Storage/storageAccounts/%{account_name}/regenerateKey" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('keys', 'body', 'keys', 'keys'),
      op_param('regenerateKey', 'body', 'regenerate_key', 'regenerate_key'),
...
def task
  ...
  params = STDIN.read
  result = storage_accounts_regenerate_key(params)
