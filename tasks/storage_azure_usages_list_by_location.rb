...
def usages_list_by_location(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Storage/locations/%{location}/usages" % path_params
...
def task
  ...
  params = STDIN.read
  result = usages_list_by_location(params)
