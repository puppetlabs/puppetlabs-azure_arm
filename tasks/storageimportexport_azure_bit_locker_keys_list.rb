...
def bit_locker_keys_list(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.ImportExport/jobs/%{job_name}/listBitLockerKeys" % path_params
...
def task
  ...
  params = STDIN.read
  result = bit_locker_keys_list(params)
