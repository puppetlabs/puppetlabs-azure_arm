...
def locations_get(*args)
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.ImportExport/locations/%{location_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('locationName', 'path', 'name', 'location_name'),
