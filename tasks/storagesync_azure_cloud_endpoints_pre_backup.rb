...
def cloud_endpoints_pre_backup(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorageSync/storageSyncServices/%{storage_sync_service_name}/syncGroups/%{sync_group_name}/cloudEndpoints/%{cloud_endpoint_name}/prebackup" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('azurefileshare', 'body', 'azure_file_share', 'azurefileshare'),
...
def task
  ...
  params = STDIN.read
  result = cloud_endpoints_pre_backup(params)
