...
def registered_servers_trigger_rollover(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorageSync/storageSyncServices/%{storage_sync_service_name}/registeredServers/%{server_id}/triggerRollover" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('servercertificate', 'body', 'server_certificate', 'servercertificate'),
      op_param('serverId', 'path', 'server_id', 'server_id'),
...
def task
  ...
  params = STDIN.read
  result = registered_servers_trigger_rollover(params)
