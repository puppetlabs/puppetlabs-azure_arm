...
def storage_sync_services_check_name_availability(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.StorageSync/locations/%{location_name}/checkNameAvailability" % path_params
...
def task
  ...
  params = STDIN.read
  result = storage_sync_services_check_name_availability(params)
