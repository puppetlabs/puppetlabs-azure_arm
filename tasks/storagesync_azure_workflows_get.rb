...
def workflows_get(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorageSync/storageSyncServices/%{storage_sync_service_name}/workflows/%{workflow_id}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('workflowId', 'path', 'id', 'workflow_id'),
    ]
  op_params.each do |i|
    location = i[:location]
    name     = i[:name]
