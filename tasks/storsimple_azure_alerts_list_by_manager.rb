...
def alerts_list_by_manager(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorSimple/managers/%{manager_name}/alerts" % path_params
...
def task
  ...
  params = STDIN.read
  result = alerts_list_by_manager(params)
