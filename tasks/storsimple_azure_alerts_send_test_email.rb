...
def alerts_send_test_email(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorSimple/managers/%{manager_name}/devices/%{device_name}/sendTestAlertEmail" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('emaillist', 'body', 'email_list', 'emaillist'),
...
def task
  ...
  params = STDIN.read
  result = alerts_send_test_email(params)
