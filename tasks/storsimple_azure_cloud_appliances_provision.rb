...
def cloud_appliances_provision(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorSimple/managers/%{manager_name}/provisionCloudAppliance" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('isvnetdnsconfigured', 'body', 'is_vnet_dns_configured', 'isvnetdnsconfigured'),
      op_param('isvnetexpressconfigured', 'body', 'is_vnet_express_configured', 'isvnetexpressconfigured'),
      op_param('managerName', 'path', 'manager_name', 'manager_name'),
      op_param('modelnumber', 'body', 'model_number', 'modelnumber'),
      ...
      op_param('storageaccountname', 'body', 'storage_account_name', 'storageaccountname'),
      op_param('storageaccounttype', 'body', 'storage_account_type', 'storageaccounttype'),
      op_param('subnetname', 'body', 'subnet_name', 'subnetname'),
      op_param('subscriptionId', 'path', 'subscription_id', 'subscription_id'),
      op_param('vmimagename', 'body', 'vm_image_name', 'vmimagename'),
      op_param('vmtype', 'body', 'vm_type', 'vmtype'),
      op_param('vnetname', 'body', 'vnet_name', 'vnetname'),
      op_param('vnetregion', 'body', 'vnet_region', 'vnetregion'),
    ]
  op_params.each do |i|
    location = i[:location]
    name     = i[:name]
...
def task
  ...
  params = STDIN.read
  result = cloud_appliances_provision(params)
