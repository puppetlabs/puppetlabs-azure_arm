...
def device_settings_create_or_update_alert_settings(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorSimple/managers/%{manager_name}/devices/%{device_name}/alertSettings/default" % path_params
...
def task
  ...
  params = STDIN.read
  result = device_settings_create_or_update_alert_settings(params)
