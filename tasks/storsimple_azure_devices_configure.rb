...
def devices_configure(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorSimple/managers/%{manager_name}/configureDevice" % path_params
...
def task
  ...
  params = STDIN.read
  result = devices_configure(params)
