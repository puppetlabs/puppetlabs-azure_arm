...
def devices_delete(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorSimple/managers/%{manager_name}/devices/%{device_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('deviceName', 'path', 'name', 'device_name'),
