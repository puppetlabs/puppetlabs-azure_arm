...
def devices_get_update_summary(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorSimple/managers/%{manager_name}/devices/%{device_name}/updateSummary/default" % path_params
...
def task
  ...
  params = STDIN.read
  result = devices_get_update_summary(params)
