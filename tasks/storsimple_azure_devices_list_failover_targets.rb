...
def devices_list_failover_targets(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorSimple/managers/%{manager_name}/devices/%{source_device_name}/listFailoverTargets" % path_params
...
def task
  ...
  params = STDIN.read
  result = devices_list_failover_targets(params)
