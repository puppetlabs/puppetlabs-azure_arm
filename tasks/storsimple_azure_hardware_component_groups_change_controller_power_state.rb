...
def hardware_component_groups_change_controller_power_state(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorSimple/managers/%{manager_name}/devices/%{device_name}/hardwareComponentGroups/%{hardware_component_group_name}/changeControllerPowerState" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('hardwareComponentGroupName', 'path', 'hardware_component_group_name', 'hardware_component_group_name'),
...
def task
  ...
  params = STDIN.read
  result = hardware_component_groups_change_controller_power_state(params)
