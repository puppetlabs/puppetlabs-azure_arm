...
def jobs_list_by_device(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorSimple/managers/%{manager_name}/devices/%{device_name}/jobs" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('percentcomplete', 'body', 'percentcomplete', 'percentcomplete'),
...
def task
  ...
  params = STDIN.read
  result = jobs_list_by_device(params)
