...
def managers_get_activation_key(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorSimple/managers/%{manager_name}/listActivationKey" % path_params
...
def task
  ...
  params = STDIN.read
  result = managers_get_activation_key(params)
