...
def managers_regenerate_activation_key(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorSimple/managers/%{manager_name}/regenerateActivationKey" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('activationkey', 'body', 'activationkey', 'activationkey'),
...
def task
  ...
  params = STDIN.read
  result = managers_regenerate_activation_key(params)
