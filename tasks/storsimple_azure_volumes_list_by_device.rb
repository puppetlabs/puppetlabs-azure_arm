...
def volumes_list_by_device(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.StorSimple/managers/%{manager_name}/devices/%{device_name}/volumes" % path_params
...
def task
  ...
  params = STDIN.read
  result = volumes_list_by_device(params)
