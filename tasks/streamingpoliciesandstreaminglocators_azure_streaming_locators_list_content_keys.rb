...
def streaming_locators_list_content_keys(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Media/mediaServices/%{account_name}/streamingLocators/%{streaming_locator_name}/listContentKeys" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('contentkeys', 'body', 'content_keys', 'contentkeys'),
...
def task
  ...
  params = STDIN.read
  result = streaming_locators_list_content_keys(params)
