...
def live_events_reset(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Media/mediaservices/%{account_name}/liveEvents/%{live_event_name}/reset" % path_params
...
def task
  ...
  params = STDIN.read
  result = live_events_reset(params)
