...
def live_outputs_delete(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Media/mediaservices/%{account_name}/liveEvents/%{live_event_name}/liveOutputs/%{live_output_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('liveOutputName', 'path', 'live_output_name', 'live_output_name'),
...
def task
  ...
  params = STDIN.read
  result = live_outputs_delete(params)
