...
def streaming_endpoints_create(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Media/mediaservices/%{account_name}/streamingEndpoints/%{streaming_endpoint_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('autoStart', 'query', 'auto_start', 'auto_start'),
...
def task
  ...
  params = STDIN.read
  result = streaming_endpoints_create(params)
