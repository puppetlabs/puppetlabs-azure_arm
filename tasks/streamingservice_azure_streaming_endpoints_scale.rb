...
def streaming_endpoints_scale(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Media/mediaservices/%{account_name}/streamingEndpoints/%{streaming_endpoint_name}/scale" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('scaleunit', 'body', 'scale_unit', 'scaleunit'),
      op_param('streamingEndpointName', 'path', 'streaming_endpoint_name', 'streaming_endpoint_name'),
...
def task
  ...
  params = STDIN.read
  result = streaming_endpoints_scale(params)
