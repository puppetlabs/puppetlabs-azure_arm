...
def subscriptions_list_locations(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/locations" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('latitude', 'body', 'latitude', 'latitude'),
      op_param('longitude', 'body', 'longitude', 'longitude'),
...
def task
  ...
  params = STDIN.read
  result = subscriptions_list_locations(params)
