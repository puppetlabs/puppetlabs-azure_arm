...
def access_policies_create_or_update(*args)
  header_params = {}
...
def format_params(key_values)
  ...
  op_params = [
      op_param('accessPolicyName', 'path', 'access_policy_name', 'access_policy_name'),
...
def task
  ...
  params = STDIN.read
  result = access_policies_create_or_update(params)
