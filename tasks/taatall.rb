...
def tenant_activity_logs_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/microsoft.insights/eventtypes/management/values" % path_params
...
def task
  ...
  params = STDIN.read
  result = tenant_activity_logs_list(params)
