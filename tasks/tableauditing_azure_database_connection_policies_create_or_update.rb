...
def database_connection_policies_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Sql/servers/%{server_name}/databases/%{database_name}/connectionPolicies/%{connection_policy_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('connectionPolicyName', 'path', 'connection_policy_name', 'connection_policy_name'),
...
def task
  ...
  params = STDIN.read
  result = database_connection_policies_create_or_update(params)
