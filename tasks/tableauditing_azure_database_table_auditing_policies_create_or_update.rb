...
def database_table_auditing_policies_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Sql/servers/%{server_name}/databases/%{database_name}/auditingPolicies/%{table_auditing_policy_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('tableAuditingPolicyName', 'path', 'table_auditing_policy_name', 'table_auditing_policy_name'),
...
def task
  ...
  params = STDIN.read
  result = database_table_auditing_policies_create_or_update(params)
