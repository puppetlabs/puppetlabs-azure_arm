...
def profiles_check_traffic_manager_relative_dns_name_availability(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//providers/Microsoft.Network/checkTrafficManagerNameAvailability" % path_params
...
def task
  ...
  params = STDIN.read
  result = profiles_check_traffic_manager_relative_dns_name_availability(params)
