...
def reference_data_sets_create_or_update(*args)
  header_params = {}
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('referenceDataSetName', 'path', 'reference_data_set_name', 'reference_data_set_name'),
...
def task
  ...
  params = STDIN.read
  result = reference_data_sets_create_or_update(params)
