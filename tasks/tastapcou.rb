...
def server_table_auditing_policies_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Sql/servers/%{server_name}/auditingPolicies/%{table_auditing_policy_name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = server_table_auditing_policies_create_or_update(params)
