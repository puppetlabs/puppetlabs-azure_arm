...
def transformations_create_or_replace(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourcegroups/%{resource_group_name}/providers/Microsoft.StreamAnalytics/streamingjobs/%{job_name}/transformations/%{transformation_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('transformation', 'body', 'transformation', 'transformation'),
      op_param('transformationName', 'path', 'name', 'transformation_name'),
...
def task
  ...
  params = STDIN.read
  result = transformations_create_or_replace(params)
