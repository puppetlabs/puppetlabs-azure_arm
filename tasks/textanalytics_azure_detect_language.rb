...
def detect _language(*args)
  ...
  uri_string = "https:////languages" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('languageBatchInput', 'body', 'language_batch_input', 'language_batch_input'),
...
def task
  ...
  params = STDIN.read
  result = detect _language(params)
