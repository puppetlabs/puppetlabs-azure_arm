...
def top_level_domains_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.DomainRegistration/topLevelDomains/%{name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = top_level_domains_get(params)
