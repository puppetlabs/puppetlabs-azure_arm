...
def endpoints_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/trafficmanagerprofiles/%{profile_name}/%{endpoint_type}/%{endpoint_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('endpointType', 'path', 'endpoint_type', 'endpoint_type'),
...
def task
  ...
  params = STDIN.read
  result = endpoints_create_or_update(params)
