...
def traffic_manager_user_metrics_keys_create_or_update(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Network/trafficManagerUserMetricsKeys/default" % path_params
...
def task
  ...
  params = STDIN.read
  result = traffic_manager_user_metrics_keys_create_or_update(params)
