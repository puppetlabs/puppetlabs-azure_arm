...
def create_images_from_data(*args)
  header_params = {}
  ...
  uri_string = "https://southcentralus.api.cognitive.microsoft.com//projects/%{project_id}/images" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('isbatchsuccessful', 'body', 'isbatchsuccessful', 'isbatchsuccessful'),
...
def authenticate
  ...
  params = STDIN.read
  result = CreateImagesFromData(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = create_images_from_data(params)
