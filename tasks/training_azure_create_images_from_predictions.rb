...
def create_images_from_predictions(*args)
  header_params = {}
  ...
  uri_string = "https://southcentralus.api.cognitive.microsoft.com//projects/%{project_id}/images/predictions" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = CreateImagesFromPredictions(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = create_images_from_predictions(params)
