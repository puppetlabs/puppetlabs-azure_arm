...
def delete_image_tags(*args)
  ...
  uri_string = "https://southcentralus.api.cognitive.microsoft.com//projects/%{project_id}/images/tags" % path_params
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = delete_image_tags(params)
