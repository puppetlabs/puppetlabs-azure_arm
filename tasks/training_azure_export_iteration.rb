...
def export_iteration(*args)
  ...
  uri_string = "https://southcentralus.api.cognitive.microsoft.com//projects/%{project_id}/iterations/%{iteration_id}/export" % path_params
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = export_iteration(params)
