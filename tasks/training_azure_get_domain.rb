...
def get_domain(*args)
  ...
  uri_string = "https://southcentralus.api.cognitive.microsoft.com//domains/%{domain_id}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('domainId', 'path', 'domain_id', 'domain_id'),
