...
def get_image_performance_count(*args)
  header_params = {}
  ...
  uri_string = "https://southcentralus.api.cognitive.microsoft.com//projects/%{project_id}/iterations/%{iteration_id}/performance/images/count" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetImagePerformanceCount(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_image_performance_count(params)
