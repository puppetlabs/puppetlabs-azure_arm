...
def get_images_by_ids(*args)
  ...
  uri_string = "https://southcentralus.api.cognitive.microsoft.com//projects/%{project_id}/images/id" % path_params
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_images_by_ids(params)
