...
def get_iteration(*args)
  ...
  uri_string = "https://southcentralus.api.cognitive.microsoft.com//projects/%{project_id}/iterations/%{iteration_id}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('classificationtype', 'body', 'classification_type', 'classificationtype'),
      ...
      op_param('iterationId', 'path', 'id', 'iteration_id'),
