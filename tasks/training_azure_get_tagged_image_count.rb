...
def get_tagged_image_count(*args)
  header_params = {}
  ...
  uri_string = "https://southcentralus.api.cognitive.microsoft.com//projects/%{project_id}/images/tagged/count" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetTaggedImageCount(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_tagged_image_count(params)
