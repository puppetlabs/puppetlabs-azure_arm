...
def get_tagged_images(*args)
  ...
  uri_string = "https://southcentralus.api.cognitive.microsoft.com//projects/%{project_id}/images/tagged" % path_params
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_tagged_images(params)
