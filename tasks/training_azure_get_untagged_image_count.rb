...
def get_untagged_image_count(*args)
  header_params = {}
  ...
  uri_string = "https://southcentralus.api.cognitive.microsoft.com//projects/%{project_id}/images/untagged/count" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetUntaggedImageCount(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_untagged_image_count(params)
