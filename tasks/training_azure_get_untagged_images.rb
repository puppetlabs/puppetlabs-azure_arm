...
def get_untagged_images(*args)
  ...
  uri_string = "https://southcentralus.api.cognitive.microsoft.com//projects/%{project_id}/images/untagged" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = GetUntaggedImages(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = get_untagged_images(params)
