...
def quick_test_image(*args)
  ...
  uri_string = "https://southcentralus.api.cognitive.microsoft.com//projects/%{project_id}/quicktest/image" % path_params
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = quick_test_image(params)
