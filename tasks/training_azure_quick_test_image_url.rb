...
def quick_test_image_url(*args)
  ...
  uri_string = "https://southcentralus.api.cognitive.microsoft.com//projects/%{project_id}/quicktest/url" % path_params
...
def authenticate
  ...
  params = STDIN.read
  result = QuickTestImageUrl(params)
  exit 0
...
def task
  # Get operation parameters from an input JSON
  params = STDIN.read
  result = quick_test_image_url(params)
