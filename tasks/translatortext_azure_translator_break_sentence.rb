...
def translator_break_sentence(*args)
  header_params = {}
  ...
  uri_string = "https://api.cognitive.microsofttranslator.com//BreakSentence" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('Script', 'query', 'script', 'script'),
...
def task
  ...
  params = STDIN.read
  result = translator_break_sentence(params)
