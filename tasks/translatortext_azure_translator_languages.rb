...
def translator_languages(*args)
  ...
  uri_string = "https://api.cognitive.microsofttranslator.com//Languages" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('scope', 'query', 'scope', 'scope'),
...
def task
  ...
  params = STDIN.read
  result = translator_languages(params)
