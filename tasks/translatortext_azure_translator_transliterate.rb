...
def translator_transliterate(*args)
  header_params = {}
  ...
  uri_string = "https://api.cognitive.microsofttranslator.com//transliterate" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('texts', 'body', 'texts', 'texts'),
...
def task
  ...
  params = STDIN.read
  result = translator_transliterate(params)
