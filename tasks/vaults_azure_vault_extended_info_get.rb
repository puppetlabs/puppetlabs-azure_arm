...
def vault_extended_info_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{vault_name}/extendedInformation/vaultExtendedInfo" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      op_param('algorithm', 'body', 'algorithm', 'algorithm'),
      op_param('api-version', 'query', 'api_version', 'api_version'),
      op_param('encryptionkey', 'body', 'encryption_key', 'encryptionkey'),
      op_param('encryptionkeythumbprint', 'body', 'encryption_key_thumbprint', 'encryptionkeythumbprint'),
      op_param('integritykey', 'body', 'integrity_key', 'integritykey'),
...
def task
  ...
  params = STDIN.read
  result = vault_extended_info_get(params)
