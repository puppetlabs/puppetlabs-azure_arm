...
def vaults_list_by_resource_group(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults" % path_params
...
def task
  ...
  params = STDIN.read
  result = vaults_list_by_resource_group(params)
