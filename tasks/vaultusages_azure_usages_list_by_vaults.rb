...
def usages_list_by_vaults(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//Subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.RecoveryServices/vaults/%{vault_name}/usages" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('currentvalue', 'body', 'current_value', 'currentvalue'),
      op_param('limit', 'body', 'limit', 'limit'),
      op_param('name', 'body', 'name', 'name'),
      op_param('nextresettime', 'body', 'next_reset_time', 'nextresettime'),
      op_param('quotaperiod', 'body', 'quota_period', 'quotaperiod'),
      op_param('resourceGroupName', 'path', 'resource_group_name', 'resource_group_name'),
      op_param('subscriptionId', 'path', 'subscription_id', 'subscription_id'),
      op_param('unit', 'body', 'unit', 'unit'),
...
def task
  ...
  params = STDIN.read
  result = usages_list_by_vaults(params)
