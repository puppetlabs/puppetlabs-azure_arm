...
def vault_extended_info_create_or_update(*args)
  header_params = {}
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('resourceResourceExtendedInfoDetails', 'body', 'resource_resource_extended_info_details', 'resource_resource_extended_info_details'),
...
def task
  ...
  params = STDIN.read
  result = vault_extended_info_create_or_update(params)
