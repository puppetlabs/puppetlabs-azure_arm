...
def virtual_network_gateways_generatevpnclientpackage(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualNetworkGateways/%{virtual_network_gateway_name}/generatevpnclientpackage" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('authenticationmethod', 'body', 'authenticationmethod', 'authenticationmethod'),
      op_param('clientrootcertificates', 'body', 'clientrootcertificates', 'clientrootcertificates'),
      op_param('parameters', 'body', 'parameters', 'parameters'),
      op_param('processorarchitecture', 'body', 'processorarchitecture', 'processorarchitecture'),
      op_param('radiusserverauthcertificate', 'body', 'radiusserverauthcertificate', 'radiusserverauthcertificate'),
...
def task
  ...
  params = STDIN.read
  result = virtual_network_gateways_generatevpnclientpackage(params)
