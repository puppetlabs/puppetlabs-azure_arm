...
def virtual_network_gateways_get_vpnclient_ipsec_parameters(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualNetworkGateways/%{virtual_network_gateway_name}/getvpnclientipsecparameters" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('dhgroup', 'body', 'dhgroup', 'dhgroup'),
      op_param('ikeencryption', 'body', 'ikeencryption', 'ikeencryption'),
      op_param('ikeintegrity', 'body', 'ikeintegrity', 'ikeintegrity'),
      op_param('ipsecencryption', 'body', 'ipsecencryption', 'ipsecencryption'),
      op_param('ipsecintegrity', 'body', 'ipsecintegrity', 'ipsecintegrity'),
      op_param('pfsgroup', 'body', 'pfsgroup', 'pfsgroup'),
      op_param('resourceGroupName', 'path', 'resource_group_name', 'resource_group_name'),
      op_param('sadatasizekilobytes', 'body', 'sadatasizekilobytes', 'sadatasizekilobytes'),
      op_param('salifetimeseconds', 'body', 'salifetimeseconds', 'salifetimeseconds'),
...
def task
  ...
  params = STDIN.read
  result = virtual_network_gateways_get_vpnclient_ipsec_parameters(params)
