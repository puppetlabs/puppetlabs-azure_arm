...
def videos_details(*args)
  ...
  uri_string = "https://api.cognitive.microsoft.com//videos/details" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('relatedvideos', 'body', 'related_videos', 'relatedvideos'),
      ...
      op_param('videoresult', 'body', 'video_result', 'videoresult'),
