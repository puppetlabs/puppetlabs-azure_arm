...
def videos_search(*args)
  ...
  uri_string = "https://api.cognitive.microsoft.com//videos/search" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('isfamilyfriendly', 'body', 'is_family_friendly', 'isfamilyfriendly'),
      op_param('length', 'query', 'length', 'length'),
