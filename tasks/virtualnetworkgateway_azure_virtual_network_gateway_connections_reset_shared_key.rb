...
def virtual_network_gateway_connections_reset_shared_key(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/connections/%{virtual_network_gateway_connection_name}/sharedkey/reset" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('keylength', 'body', 'key_length', 'keylength'),
...
def task
  ...
  params = STDIN.read
  result = virtual_network_gateway_connections_reset_shared_key(params)
