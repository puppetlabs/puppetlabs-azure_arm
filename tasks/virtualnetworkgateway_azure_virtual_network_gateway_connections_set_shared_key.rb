...
def virtual_network_gateway_connections_set_shared_key(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/connections/%{virtual_network_gateway_connection_name}/sharedkey" % path_params
...
def task
  ...
  params = STDIN.read
  result = virtual_network_gateway_connections_set_shared_key(params)
