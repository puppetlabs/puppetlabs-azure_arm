...
def virtual_network_gateways_generate_vpn_profile(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualNetworkGateways/%{virtual_network_gateway_name}/generatevpnprofile" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('authenticationmethod', 'body', 'authentication_method', 'authenticationmethod'),
      op_param('clientrootcertificates', 'body', 'client_root_certificates', 'clientrootcertificates'),
      op_param('parameters', 'body', 'parameters', 'parameters'),
      op_param('processorarchitecture', 'body', 'processor_architecture', 'processorarchitecture'),
      op_param('radiusserverauthcertificate', 'body', 'radius_server_auth_certificate', 'radiusserverauthcertificate'),
...
def task
  ...
  params = STDIN.read
  result = virtual_network_gateways_generate_vpn_profile(params)
