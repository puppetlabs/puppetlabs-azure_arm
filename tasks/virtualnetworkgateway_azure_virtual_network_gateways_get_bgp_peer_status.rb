...
def virtual_network_gateways_get_bgp_peer_status(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualNetworkGateways/%{virtual_network_gateway_name}/getBgpPeerStatus" % path_params
...
def task
  ...
  params = STDIN.read
  result = virtual_network_gateways_get_bgp_peer_status(params)
