...
def virtual_network_gateways_get_learned_routes(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualNetworkGateways/%{virtual_network_gateway_name}/getLearnedRoutes" % path_params
...
def task
  ...
  params = STDIN.read
  result = virtual_network_gateways_get_learned_routes(params)
