...
def p2s_vpn_gateways_generate_vpn_profile(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/p2svpnGateways/%{gateway_name}/generatevpnprofile" % path_params
...
def task
  ...
  params = STDIN.read
  result = p2s_vpn_gateways_generate_vpn_profile(params)
