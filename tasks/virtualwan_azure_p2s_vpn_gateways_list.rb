...
def p2s_vpn_gateways_list(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Network/p2svpnGateways" % path_params
...
def task
  ...
  params = STDIN.read
  result = p2s_vpn_gateways_list(params)
