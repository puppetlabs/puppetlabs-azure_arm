...
def supported_security_providers(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/virtualWans/%{virtual_wan_name}/supportedSecurityProviders" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('supportedproviders', 'body', 'supported_providers', 'supportedproviders'),
...
def task
  ...
  params = STDIN.read
  result = supported_security_providers(params)
