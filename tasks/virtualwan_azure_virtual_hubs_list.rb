...
def virtual_hubs_list(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Network/virtualHubs" % path_params
...
def task
  ...
  params = STDIN.read
  result = virtual_hubs_list(params)
