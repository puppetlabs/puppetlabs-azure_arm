...
def virtual_wans_list(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Network/virtualWans" % path_params
...
def task
  ...
  params = STDIN.read
  result = virtual_wans_list(params)
