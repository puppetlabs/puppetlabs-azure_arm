...
def vpn_gateways_list(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.Network/vpnGateways" % path_params
...
def task
  ...
  params = STDIN.read
  result = vpn_gateways_list(params)
