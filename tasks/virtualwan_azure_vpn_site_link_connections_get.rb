...
def vpn_site_link_connections_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Network/vpnGateways/%{gateway_name}/vpnConnections/%{connection_name}/vpnLinkConnections/%{link_connection_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('connectionName', 'path', 'connection_name', 'connection_name'),
      op_param('etag', 'body', 'etag', 'etag'),
      op_param('gatewayName', 'path', 'gateway_name', 'gateway_name'),
      op_param('id', 'body', 'id', 'id'),
      op_param('linkConnectionName', 'path', 'link_connection_name', 'link_connection_name'),
...
def task
  ...
  params = STDIN.read
  result = vpn_site_link_connections_get(params)
