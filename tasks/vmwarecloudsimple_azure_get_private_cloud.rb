...
def get_private_cloud(*args)
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.VMwareCloudSimple/locations/%{region_id}/privateClouds/%{pc_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('pcName', 'path', 'name', 'pc_name'),
...
def task
  ...
  params = STDIN.read
  result = get_private_cloud(params)
