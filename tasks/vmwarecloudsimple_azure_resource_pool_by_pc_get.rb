...
def resource_pool_by_pc_get(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/providers/Microsoft.VMwareCloudSimple/locations/%{region_id}/privateClouds/%{pc_name}/resourcePools/%{resource_pool_name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('pcName', 'path', 'pc_name', 'pc_name'),
      op_param('regionId', 'path', 'region_id', 'region_id'),
      op_param('resourcePoolName', 'path', 'resource_pool_name', 'resource_pool_name'),
...
def task
  ...
  params = STDIN.read
  result = resource_pool_by_pc_get(params)
