...
def virtual_machine_start(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.VMwareCloudSimple/virtualMachines/%{virtual_machine_name}/start" % path_params
...
def task
  ...
  params = STDIN.read
  result = virtual_machine_start(params)
