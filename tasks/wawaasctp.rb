...
def web_apps_apply_slot_config_to_production(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/applySlotConfig" % path_params
...
def task
  ...
  params = STDIN.read
  result = web_apps_apply_slot_config_to_production(params)
