...
def web_apps_create_instance_ms_deploy_operation(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/instances/%{instance_id}/extensions/MSDeploy" % path_params
...
def task
  ...
  params = STDIN.read
  result = web_apps_create_instance_ms_deploy_operation(params)
