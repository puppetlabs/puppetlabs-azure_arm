...
def web_apps_list_sync_function_triggers_slot(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/listsyncfunctiontriggerstatus" % path_params
...
def task
  ...
  params = STDIN.read
  result = web_apps_list_sync_function_triggers_slot(params)
