...
def web_apps_swap_slot_with_production(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slotsswap" % path_params
...
def task
  ...
  params = STDIN.read
  result = web_apps_swap_slot_with_production(params)
