...
def web_apps_analyze_custom_hostname(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/analyzeCustomHostname" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('hostName', 'query', 'host_name', 'host_name'),
...
def task
  ...
  params = STDIN.read
  result = web_apps_analyze_custom_hostname(params)
