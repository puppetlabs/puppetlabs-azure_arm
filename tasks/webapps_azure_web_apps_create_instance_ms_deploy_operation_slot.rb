...
def web_apps_create_instance_ms_deploy_operation_slot(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/instances/%{instance_id}/extensions/MSDeploy" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('MSDeploy', 'body', 'ms_deploy', 'ms_deploy'),
...
def task
  ...
  params = STDIN.read
  result = web_apps_create_instance_ms_deploy_operation_slot(params)
