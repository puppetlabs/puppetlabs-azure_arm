...
def web_apps_create_or_update_configuration_slot(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/config/web" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('siteConfig', 'body', 'site_config', 'site_config'),
...
def task
  ...
  params = STDIN.read
  result = web_apps_create_or_update_configuration_slot(params)
