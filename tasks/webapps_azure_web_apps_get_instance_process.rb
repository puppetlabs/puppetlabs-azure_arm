...
def web_apps_get_instance_process(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/instances/%{instance_id}/processes/%{process_id}" % path_params
...
def task
  ...
  params = STDIN.read
  result = web_apps_get_instance_process(params)
