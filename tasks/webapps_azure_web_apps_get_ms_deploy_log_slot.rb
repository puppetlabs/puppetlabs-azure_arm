...
def web_apps_get_ms_deploy_log_slot(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/extensions/MSDeploy/log" % path_params
...
def task
  ...
  params = STDIN.read
  result = web_apps_get_ms_deploy_log_slot(params)
