...
def web_apps_get_process_module(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/processes/%{process_id}/modules/%{base_address}" % path_params
...
def task
  ...
  params = STDIN.read
  result = web_apps_get_process_module(params)
