...
def web_apps_get_process_slot(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/processes/%{process_id}" % path_params
...
def task
  ...
  params = STDIN.read
  result = web_apps_get_process_slot(params)
