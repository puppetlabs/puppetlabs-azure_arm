...
def web_apps_get_triggered_web_job(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/triggeredwebjobs/%{web_job_name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = web_apps_get_triggered_web_job(params)
