...
def web_apps_list_azure_storage_accounts(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/config/azurestorageaccounts/list" % path_params
...
def task
  ...
  params = STDIN.read
  result = web_apps_list_azure_storage_accounts(params)
