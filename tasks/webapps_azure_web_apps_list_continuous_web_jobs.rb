...
def web_apps_list_continuous_web_jobs(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/continuouswebjobs" % path_params
...
def task
  ...
  params = STDIN.read
  result = web_apps_list_continuous_web_jobs(params)
