...
def web_apps_list_function_secrets(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/functions/%{function_name}/listsecrets" % path_params
...
def task
  ...
  params = STDIN.read
  result = web_apps_list_function_secrets(params)
