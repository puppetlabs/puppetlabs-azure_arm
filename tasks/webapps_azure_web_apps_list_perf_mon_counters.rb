...
def web_apps_list_perf_mon_counters(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/perfcounters" % path_params
...
def task
  ...
  params = STDIN.read
  result = web_apps_list_perf_mon_counters(params)
