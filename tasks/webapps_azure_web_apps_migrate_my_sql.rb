...
def web_apps_migrate_my_sql(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/migratemysql" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('migrationRequestEnvelope', 'body', 'migration_request_envelope', 'migration_request_envelope'),
...
def task
  ...
  params = STDIN.read
  result = web_apps_migrate_my_sql(params)
