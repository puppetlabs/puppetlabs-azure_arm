...
def web_apps_migrate_storage(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/migrate" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('migrationOptions', 'body', 'migration_options', 'migration_options'),
      ...
      op_param('subscriptionName', 'query', 'subscription_name', 'subscription_name'),
...
def task
  ...
  params = STDIN.read
  result = web_apps_migrate_storage(params)
