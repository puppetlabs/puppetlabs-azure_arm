...
def web_apps_put_private_access_vnet(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/privateAccess/virtualNetworks" % path_params
...
def task
  ...
  params = STDIN.read
  result = web_apps_put_private_access_vnet(params)
