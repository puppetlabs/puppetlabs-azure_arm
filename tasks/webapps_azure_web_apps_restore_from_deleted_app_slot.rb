...
def web_apps_restore_from_deleted_app_slot(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/restoreFromDeletedApp" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('restoreRequest', 'body', 'restore_request', 'restore_request'),
...
def task
  ...
  params = STDIN.read
  result = web_apps_restore_from_deleted_app_slot(params)
