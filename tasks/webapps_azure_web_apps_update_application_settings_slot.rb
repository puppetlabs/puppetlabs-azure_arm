...
def web_apps_update_application_settings_slot(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/config/appsettings" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('appSettings', 'body', 'app_settings', 'app_settings'),
...
def task
  ...
  params = STDIN.read
  result = web_apps_update_application_settings_slot(params)
