...
def web_apps_update_azure_storage_accounts_slot(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/config/azurestorageaccounts" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('azureStorageAccounts', 'body', 'azure_storage_accounts', 'azure_storage_accounts'),
...
def task
  ...
  params = STDIN.read
  result = web_apps_update_azure_storage_accounts_slot(params)
