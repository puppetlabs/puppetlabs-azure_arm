...
def web_apps_update_diagnostic_logs_config_slot(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/slots/%{slot}/config/logs" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('siteLogsConfig', 'body', 'site_logs_config', 'site_logs_config'),
...
def task
  ...
  params = STDIN.read
  result = web_apps_update_diagnostic_logs_config_slot(params)
