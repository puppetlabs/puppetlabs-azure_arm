...
def web_apps_update_slot_configuration_names(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Web/sites/%{name}/config/slotConfigNames" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('slotConfigNames', 'body', 'slot_config_names', 'slot_config_names'),
...
def task
  ...
  params = STDIN.read
  result = web_apps_update_slot_configuration_names(params)
