...
def web_search(*args)
  ...
  uri_string = "https://api.cognitive.microsoft.com//search" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('answerCount', 'query', 'answer_count', 'answer_count'),
      op_param('cc', 'query', 'cc', 'cc'),
      op_param('computation', 'body', 'computation', 'computation'),
      ...
      op_param('news', 'body', 'news', 'news'),
      op_param('offset', 'query', 'offset', 'offset'),
      op_param('Pragma', 'header', 'pragma', 'pragma'),
      op_param('promote', 'query', 'promote', 'promote'),
      op_param('q', 'query', 'q', 'q'),
      op_param('querycontext', 'body', 'query_context', 'querycontext'),
      op_param('rankingresponse', 'body', 'ranking_response', 'rankingresponse'),
      op_param('relatedsearches', 'body', 'related_searches', 'relatedsearches'),
      op_param('responseFilter', 'query', 'response_filter', 'response_filter'),
      op_param('safeSearch', 'query', 'safe_search', 'safe_search'),
      op_param('setLang', 'query', 'set_lang', 'set_lang'),
      op_param('spellsuggestions', 'body', 'spell_suggestions', 'spellsuggestions'),
      op_param('textDecorations', 'query', 'text_decorations', 'text_decorations'),
      op_param('textFormat', 'query', 'text_format', 'text_format'),
      op_param('timezone', 'body', 'time_zone', 'timezone'),
      op_param('User-Agent', 'header', 'user_agent', 'user_agent'),
      op_param('videos', 'body', 'videos', 'videos'),
      op_param('webpages', 'body', 'web_pages', 'webpages'),
