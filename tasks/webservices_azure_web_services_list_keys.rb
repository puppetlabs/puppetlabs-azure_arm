...
def web_services_list_keys(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.MachineLearning/webServices/%{web_service_name}/listKeys" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('primary', 'body', 'primary', 'primary'),
      op_param('resourceGroupName', 'path', 'resource_group_name', 'resource_group_name'),
      op_param('secondary', 'body', 'secondary', 'secondary'),
...
def task
  ...
  params = STDIN.read
  result = web_services_list_keys(params)
