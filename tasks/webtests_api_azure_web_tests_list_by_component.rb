...
def web_tests_list_by_component(*args)
  header_params = {}
  ...
  uri_string = "https://management.azure.com//subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.Insights/components/%{component_name}/webtests" % path_params
...
def format_params(key_values)
  ...
  op_params = [
      ...
      op_param('componentName', 'path', 'component_name', 'component_name'),
...
def task
  ...
  params = STDIN.read
  result = web_tests_list_by_component(params)
